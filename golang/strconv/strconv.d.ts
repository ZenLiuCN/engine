...
declare module 'golang/strconv'{
	// @ts-ignore
	import type {error,bool,int64,rune,uint64,complex128,Struct,float64,byte,int,GoError} from 'go'
	...
	export function parseComplex(s:string,bitSize:int):[complex128,error]
	export function parseFloat(s:string,bitSize:int):[float64,error]
	export function parseInt(s:string,base:int,bitSize:int):[int64,error]
	export function parseUint(s:string,base:int,bitSize:int):[uint64,error]
	...
	export function unquoteChar(s:string,quote:byte):[rune,bool,string,error]
}
