...
declare module 'golang/net'{
	...
	// @ts-ignore
	import type {Struct,bool,GoError,int64,int,Nothing,uint,uint16,error,Ref,byte} from 'go'
	...
	export interface DNSError extends GoError,Struct<DNSError>,Error{
		err:string
		name:string
		server:string
		isTimeout:bool
	...
	export interface IPConn extends io.WriteCloser,Struct<IPConn>,Conn,syscall.Conn,io.ReadCloser,io.ReadWriter,io.ReadWriteCloser,PacketConn{
	...
	export interface TCPConn extends io.WriteCloser,Struct<TCPConn>,syscall.Conn,Conn,io.ReadCloser,io.ReadWriter,io.ReadWriteCloser,io.ReaderFrom{
		syscallConn():syscall.RawConn
	...
	export interface TCPListener extends Listener,syscall.Conn,Struct<TCPListener>,io.Closer{
		syscallConn():syscall.RawConn
	...
	export interface UDPConn extends io.ReadWriter,Struct<UDPConn>,io.ReadWriteCloser,PacketConn,io.WriteCloser,syscall.Conn,Conn,io.ReadCloser{
		syscallConn():syscall.RawConn
	...
	export interface UnixAddr extends Addr,Struct<UnixAddr>{
		name:string
		net:string
		network():string
		string():string
	}
	export interface UnixConn extends syscall.Conn,io.ReadCloser,io.ReadWriter,io.ReadWriteCloser,PacketConn,io.WriteCloser,Struct<UnixConn>,Conn{
		syscallConn():syscall.RawConn
		closeRead()/*error*/
		closeWrite()/*error*/
	...
	export interface UnixListener extends Listener,syscall.Conn,Struct<UnixListener>,io.Closer{
		syscallConn():syscall.RawConn
