...
declare module 'golang/net/mail'{
	...
	// @ts-ignore
	import type {Struct,Ref,error,GoError} from 'go'
...
export function refAddress():Ref<Address>
export function refOfAddress(x:Address):Ref<Address>
export function emptyAddressParser():AddressParser
export function refAddressParser():Ref<AddressParser>
