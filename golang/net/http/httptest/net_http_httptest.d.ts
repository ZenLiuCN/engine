...
declare module 'golang/net/http/httptest'{
	...
	// @ts-ignore
	import type {bool,Struct,error,Ref,int} from 'go'
	//"1.2.3.4"
	...
	export interface ResponseRecorder extends Struct<ResponseRecorder>,io.StringWriter,http.Flusher,http.ResponseWriter,io.Writer{
		code:int
