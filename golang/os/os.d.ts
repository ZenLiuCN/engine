...
declare module 'golang/os'{
	...
	// @ts-ignore
	import type {error,int,Ref,GoError,Struct,int64,uintptr,bool,uint8,rune} from 'go'
	...
	export interface File extends syscall.Conn,io.ReadWriter,io.WriterAt,io.ReaderAt,io.StringWriter,io.ReadCloser,io.ReadSeekCloser,io.ReaderFrom,io.WriteCloser,io.ReadSeeker,io.WriteSeeker,io.Closer,Struct<File>,fs.ReadDirFile,io.ReadWriteCloser,io.ReadWriteSeeker{
	...
	export interface SyscallError extends Struct<SyscallError>,Error,GoError{
		syscall:string
		err:GoError
		error():string
		unwrap()/*error*/
