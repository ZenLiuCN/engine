...
declare module 'golang/syscall'{
	...
	// @ts-ignore
	import type {uintptr,bool,int16,uint32,byte,int32,GoError,int,Ref,uint64,uint16,uint,error,Struct,int64,uint8} from 'go'
	//38
	...
	export function accept(fd:int):[int,Sockaddr,error]
	export function accept4(fd:int,flags:int):[int,Sockaddr,error]
	...
	export function creat(path:string,mode:uint32):[int,error]
	...
	export function epollWait(epfd:int,events:EpollEvent[],msec:int):[int,error]
	...
	export interface Flock_t extends Struct<Flock_t>{
		type:int16
		whence:int16
		pad_cgo_0:Uint8Array/*4*/
		start:int64
		len:int64
		pid:int32
		pad_cgo_1:Uint8Array/*4*/
	}
	export function forkExec(argv0:string,argv:string[],attr:Ref<ProcAttr>):[int,error]
	...
	export function getdents(fd:int,buf:Uint8Array):[int,error]
	...
	export function getpriority(which:int,who:int):[int,error]
	...
	export function getsockoptICMPv6Filter(fd:int,level:int,opt:int):[Ref<ICMPv6Filter>,error]
	export function getsockoptIPMreq(fd:int,level:int,opt:int):[Ref<IPMreq>,error]
	export function getsockoptIPMreqn(fd:int,level:int,opt:int):[Ref<IPMreqn>,error]
	export function getsockoptIPv6MTUInfo(fd:int,level:int,opt:int):[Ref<IPv6MTUInfo>,error]
	export function getsockoptIPv6Mreq(fd:int,level:int,opt:int):[Ref<IPv6Mreq>,error]
	export function getsockoptInet4Addr(fd:int,level:int,opt:int):[Uint8Array/*4*/,error]
	export function getsockoptInt(fd:int,level:int,opt:int):[int,error]
	export function getsockoptUcred(fd:int,level:int,opt:int):[Ref<Ucred>,error]
	...
	export function getxattr(path:string,attr:string,dest:Uint8Array):[int,error]
	//1024
	...
	export function inotifyAddWatch(fd:int,pathname:string,mask:uint32):[int,error]
	...
	export function inotifyRmWatch(fd:int,watchdesc:uint32):[int,error]
	...
	export function klogctl(typ:int,buf:Uint8Array):[int,error]
	//0
	...
	export function listxattr(path:string,dest:Uint8Array):[int,error]
	export function lsfJump(code:int,k:int,jt:int,jf:int):Ref<SockFilter>
	export function lsfSocket(ifindex:int,proto:int):[int,error]
	...
	export function mmap(fd:int,offset:int64,length:int,prot:int,flags:int):[Uint8Array,error]
	...
	export function netlinkRIB(proto:int,family:int):[Uint8Array,error]
	...
	export function open(path:string,mode:int,perm:uint32):[int,error]
	export function openat(dirfd:int,path:string,flags:int,mode:uint32):[int,error]
	//1
	...
	export function pread(fd:int,p:Uint8Array,offset:int64):[int,error]
	...
	export function ptracePeekData(pid:int,addr:uintptr,out:Uint8Array):[int,error]
	export function ptracePeekText(pid:int,addr:uintptr,out:Uint8Array):[int,error]
	export function ptracePokeData(pid:int,addr:uintptr,data:Uint8Array):[int,error]
	export function ptracePokeText(pid:int,addr:uintptr,data:Uint8Array):[int,error]
	...
	export function pwrite(fd:int,p:Uint8Array,offset:int64):[int,error]
	//9
	...
	export function read(fd:int,p:Uint8Array):[int,error]
	export function readDirent(fd:int,buf:Uint8Array):[int,error]
	export function readlink(path:string,buf:Uint8Array):[int,error]
	export function reboot(cmd:int):error
	export function recvfrom(fd:int,p:Uint8Array,flags:int):[int,Sockaddr,error]
	export function recvmsg(fd:int,p:Uint8Array,oob:Uint8Array,flags:int):[int,int,int,Sockaddr,error]
	...
	export function seek(fd:int,offset:int64,whence:int):[int64,error]
	export function select(nfd:int,r:Ref<FdSet>,w:Ref<FdSet>,e:Ref<FdSet>,timeout:Ref<Timeval>):[int,error]
	export function sendfile(outfd:int,infd:int,offset:Ref<int64>,count:int):[int,error]
	export function sendmsg(fd:int,p:Uint8Array,oob:Uint8Array,to:Sockaddr,flags:int):error
	export function sendmsgN(fd:int,p:Uint8Array,oob:Uint8Array,to:Sockaddr,flags:int):[int,error]
	...
	export function setsockoptInet4Addr(fd:int,level:int,opt:int,value:Uint8Array/*4*/):error
	...
	export function socket(domain:int,typ:int,proto:int):[int,error]
	export interface SocketControlMessage extends Struct<SocketControlMessage>{
		header:Cmsghdr
		data:Uint8Array
	}
	export const SocketDisableIPv6:bool
	export function socketpair(domain:int,typ:int,proto:int):[int[]/*2*/,error]
	export function splice(rfd:int,roff:Ref<int64>,wfd:int,woff:Ref<int64>,len:int,flags:int):[int64,error]
	...
	export function tee(rfd:int,wfd:int,len:int,flags:int):[int64,error]
	...
	export interface Utsname extends Struct<Utsname>{
		sysname:Int8Array/*65*/
		nodename:Int8Array/*65*/
		release:Int8Array/*65*/
		version:Int8Array/*65*/
		machine:Int8Array/*65*/
		domainname:Int8Array/*65*/
	}
	//13
	...
	export function wait4(pid:int,wstatus:Ref<WaitStatus>,options:int,rusage:Ref<Rusage>):[int,error]
	...
	export function write(fd:int,p:Uint8Array):[int,error]
	//4
	export const XCASE:int

export function emptyNlAttr():NlAttr
export function refNlAttr():Ref<NlAttr>
export function refOfNlAttr(x:NlAttr):Ref<NlAttr>
export function emptyRtAttr():RtAttr
export function refRtAttr():Ref<RtAttr>
export function refOfRtAttr(x:RtAttr):Ref<RtAttr>
export function emptyRtGenmsg():RtGenmsg
export function refRtGenmsg():Ref<RtGenmsg>
export function refOfRtGenmsg(x:RtGenmsg):Ref<RtGenmsg>
export function emptyFdSet():FdSet
export function refFdSet():Ref<FdSet>
export function refOfFdSet(x:FdSet):Ref<FdSet>
export function emptyIfAddrmsg():IfAddrmsg
export function refIfAddrmsg():Ref<IfAddrmsg>
export function refOfIfAddrmsg(x:IfAddrmsg):Ref<IfAddrmsg>
...
export function refSockFilter():Ref<SockFilter>
export function refOfSockFilter(x:SockFilter):Ref<SockFilter>
export function emptySockaddrNetlink():SockaddrNetlink
export function refSockaddrNetlink():Ref<SockaddrNetlink>
export function refOfSockaddrNetlink(x:SockaddrNetlink):Ref<SockaddrNetlink>
export function emptyTCPInfo():TCPInfo
export function refTCPInfo():Ref<TCPInfo>
export function refOfTCPInfo(x:TCPInfo):Ref<TCPInfo>
...
export function refUtsname():Ref<Utsname>
export function refOfUtsname(x:Utsname):Ref<Utsname>
...
export function refIfInfomsg():Ref<IfInfomsg>
export function refOfIfInfomsg(x:IfInfomsg):Ref<IfInfomsg>
...
export function refDirent():Ref<Dirent>
export function refOfDirent(x:Dirent):Ref<Dirent>
export function emptyICMPv6Filter():ICMPv6Filter
export function refICMPv6Filter():Ref<ICMPv6Filter>
export function refOfICMPv6Filter(x:ICMPv6Filter):Ref<ICMPv6Filter>
export function emptyIPMreqn():IPMreqn
export function refIPMreqn():Ref<IPMreqn>
export function refOfIPMreqn(x:IPMreqn):Ref<IPMreqn>
...
export function refRawSockaddrLinklayer():Ref<RawSockaddrLinklayer>
export function refOfRawSockaddrLinklayer(x:RawSockaddrLinklayer):Ref<RawSockaddrLinklayer>
export function emptyTimex():Timex
export function refTimex():Ref<Timex>
export function refOfTimex(x:Timex):Ref<Timex>
export function emptyCredential():Credential
export function refCredential():Ref<Credential>
export function refOfCredential(x:Credential):Ref<Credential>
export function emptyFsid():Fsid
export function refFsid():Ref<Fsid>
export function refOfFsid(x:Fsid):Ref<Fsid>
export function emptyRlimit():Rlimit
export function refRlimit():Ref<Rlimit>
export function refOfRlimit(x:Rlimit):Ref<Rlimit>
export function emptyRtMsg():RtMsg
export function refRtMsg():Ref<RtMsg>
export function refOfRtMsg(x:RtMsg):Ref<RtMsg>
export function emptyRtNexthop():RtNexthop
export function refRtNexthop():Ref<RtNexthop>
export function refOfRtNexthop(x:RtNexthop):Ref<RtNexthop>
export function emptyUstat_t():Ustat_t
export function refUstat_t():Ref<Ustat_t>
export function refOfUstat_t(x:Ustat_t):Ref<Ustat_t>
export function emptyRawSockaddrNetlink():RawSockaddrNetlink
export function refRawSockaddrNetlink():Ref<RawSockaddrNetlink>
export function refOfRawSockaddrNetlink(x:RawSockaddrNetlink):Ref<RawSockaddrNetlink>
export function emptyStat_t():Stat_t
export function refStat_t():Ref<Stat_t>
export function refOfStat_t(x:Stat_t):Ref<Stat_t>
export function emptyUtimbuf():Utimbuf
export function refUtimbuf():Ref<Utimbuf>
export function refOfUtimbuf(x:Utimbuf):Ref<Utimbuf>
export function emptyNlMsgerr():NlMsgerr
export function refNlMsgerr():Ref<NlMsgerr>
export function refOfNlMsgerr(x:NlMsgerr):Ref<NlMsgerr>
export function emptySockFprog():SockFprog
export function refSockFprog():Ref<SockFprog>
export function refOfSockFprog(x:SockFprog):Ref<SockFprog>
export function emptySockaddrLinklayer():SockaddrLinklayer
export function refSockaddrLinklayer():Ref<SockaddrLinklayer>
export function refOfSockaddrLinklayer(x:SockaddrLinklayer):Ref<SockaddrLinklayer>
export function emptyInet4Pktinfo():Inet4Pktinfo
export function refInet4Pktinfo():Ref<Inet4Pktinfo>
export function refOfInet4Pktinfo(x:Inet4Pktinfo):Ref<Inet4Pktinfo>
export function emptyNlMsghdr():NlMsghdr
export function refNlMsghdr():Ref<NlMsghdr>
export function refOfNlMsghdr(x:NlMsghdr):Ref<NlMsghdr>
...
export function refTermios():Ref<Termios>
export function refOfTermios(x:Termios):Ref<Termios>
export function emptyCmsghdr():Cmsghdr
export function refCmsghdr():Ref<Cmsghdr>
export function refOfCmsghdr(x:Cmsghdr):Ref<Cmsghdr>
export function emptyEpollEvent():EpollEvent
export function refEpollEvent():Ref<EpollEvent>
export function refOfEpollEvent(x:EpollEvent):Ref<EpollEvent>
export function emptyFlock_t():Flock_t
export function refFlock_t():Ref<Flock_t>
export function refOfFlock_t(x:Flock_t):Ref<Flock_t>
...
export function refNetlinkRouteAttr():Ref<NetlinkRouteAttr>
export function refOfNetlinkRouteAttr(x:NetlinkRouteAttr):Ref<NetlinkRouteAttr>
export function emptyNetlinkRouteRequest():NetlinkRouteRequest
export function refNetlinkRouteRequest():Ref<NetlinkRouteRequest>
export function refOfNetlinkRouteRequest(x:NetlinkRouteRequest):Ref<NetlinkRouteRequest>
...
export function refIPv6MTUInfo():Ref<IPv6MTUInfo>
export function refOfIPv6MTUInfo(x:IPv6MTUInfo):Ref<IPv6MTUInfo>
export function emptyNetlinkMessage():NetlinkMessage
export function refNetlinkMessage():Ref<NetlinkMessage>
export function refOfNetlinkMessage(x:NetlinkMessage):Ref<NetlinkMessage>
...
export function refStatfs_t():Ref<Statfs_t>
export function refOfStatfs_t(x:Statfs_t):Ref<Statfs_t>
...
export function refIovec():Ref<Iovec>
export function refOfIovec(x:Iovec):Ref<Iovec>
export function emptyMsghdr():Msghdr
export function refMsghdr():Ref<Msghdr>
export function refOfMsghdr(x:Msghdr):Ref<Msghdr>
export function emptySysProcIDMap():SysProcIDMap
export function refSysProcIDMap():Ref<SysProcIDMap>
export function refOfSysProcIDMap(x:SysProcIDMap):Ref<SysProcIDMap>
export function emptyTms():Tms
export function refTms():Ref<Tms>
export function refOfTms(x:Tms):Ref<Tms>
export function emptyPtraceRegs():PtraceRegs
export function refPtraceRegs():Ref<PtraceRegs>
export function refOfPtraceRegs(x:PtraceRegs):Ref<PtraceRegs>
...
export function refSocketControlMessage():Ref<SocketControlMessage>
export function refOfSocketControlMessage(x:SocketControlMessage):Ref<SocketControlMessage>
export function emptyInet6Pktinfo():Inet6Pktinfo
export function refInet6Pktinfo():Ref<Inet6Pktinfo>
export function refOfInet6Pktinfo(x:Inet6Pktinfo):Ref<Inet6Pktinfo>
export function emptyInotifyEvent():InotifyEvent
export function refInotifyEvent():Ref<InotifyEvent>
export function refOfInotifyEvent(x:InotifyEvent):Ref<InotifyEvent>
...
export function refSysinfo_t():Ref<Sysinfo_t>
export function refOfSysinfo_t(x:Sysinfo_t):Ref<Sysinfo_t>
export function emptyUcred():Ucred
export function refUcred():Ref<Ucred>
export function refOfUcred(x:Ucred):Ref<Ucred>}
