...
declare module 'golang/syscall'{
	...
	// @ts-ignore
	import type {Ref,uint32,GoError,bool,uint8,int,byte,uint16,Alias,error,int32,int64,uintptr,Struct,Nothing} from 'go'
	//2
	...
	export interface CertInfo extends Alias<Nothing>,Struct<CertInfo>{
	}
	...
	export interface CertTrustListInfo extends Struct<CertTrustListInfo>,Alias<Nothing>{
	}
...
Ref<Nothing>	}
	...
	export interface SID extends Alias<Nothing>,Struct<SID>{
		string():[string,error]
		len():int
		copy():[Ref<SID>,error]
