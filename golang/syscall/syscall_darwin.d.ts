...
declare module 'golang/syscall'{
	...
	// @ts-ignore
	import type {int,Ref,uint8,uint64,uint16,Struct,bool,GoError,error,byte,int32,uint32,uintptr,int64,int16} from 'go'
	//16
	...
	export function bpfInterface(fd:int,name:string):[string,error]
	...
	export function fpathconf(fd:int,name:int):[int,error]
	...
	export function getdirentries(fd:int,buf:Uint8Array,basep:Ref<uintptr>):[int,error]
	...
	export function getfsstat(buf:Statfs_t[],flags:int):[int,error]
	...
	export function getsockoptByte(fd:int,level:int,opt:int):[byte,error]
	...
	export interface InterfaceAddrMessage extends Struct<InterfaceAddrMessage>,RoutingMessage{
		header:IfaMsghdr
		data:Uint8Array
	}
	export interface InterfaceMessage extends Struct<InterfaceMessage>,RoutingMessage{
		header:IfMsghdr
		data:Uint8Array
	}
	export interface InterfaceMulticastAddrMessage extends RoutingMessage,Struct<InterfaceMulticastAddrMessage>{
		header:IfmaMsghdr2
		data:Uint8Array
	}
	...
	export function kevent(kq:int,changes:Kevent_t[],events:Kevent_t[],timeout:Ref<Timespec>):[int,error]
	...
	export function pathconf(path:string,name:int):[int,error]
	...
	export function routeRIB(facility:int,param:int):[Uint8Array,error]
	...
	export function setBpfBuflen(fd:int,l:int):[int,error]
	export function setBpfDatalink(fd:int,t:int):[int,error]
	...
	export interface Statfs_t extends Struct<Statfs_t>{
		...
		flags:uint32
		fssubtype:uint32
		fstypename:Int8Array/*16*/
		mntonname:Int8Array/*1024*/
		mntfromname:Int8Array/*1024*/
		reserved:Uint32Array/*8*/
	}
...
export function refBpfProgram():Ref<BpfProgram>
export function refOfBpfProgram(x:BpfProgram):Ref<BpfProgram>
...
export function refFbootstraptransfer_t():Ref<Fbootstraptransfer_t>
export function refOfFbootstraptransfer_t(x:Fbootstraptransfer_t):Ref<Fbootstraptransfer_t>
...
export function refRadvisory_t():Ref<Radvisory_t>
export function refOfRadvisory_t(x:Radvisory_t):Ref<Radvisory_t>
...
export function refRtMetrics():Ref<RtMetrics>
export function refOfRtMetrics(x:RtMetrics):Ref<RtMetrics>
export function emptyBpfInsn():BpfInsn
export function refBpfInsn():Ref<BpfInsn>
export function refOfBpfInsn(x:BpfInsn):Ref<BpfInsn>
...
export function refTimeval32():Ref<Timeval32>
export function refOfTimeval32(x:Timeval32):Ref<Timeval32>
...
export function refIfaMsghdr():Ref<IfaMsghdr>
export function refOfIfaMsghdr(x:IfaMsghdr):Ref<IfaMsghdr>
export function emptyInterfaceMessage():InterfaceMessage
export function refInterfaceMessage():Ref<InterfaceMessage>
export function refOfInterfaceMessage(x:InterfaceMessage):Ref<InterfaceMessage>
export function emptyRouteMessage():RouteMessage
export function refRouteMessage():Ref<RouteMessage>
export function refOfRouteMessage(x:RouteMessage):Ref<RouteMessage>
...
export function refBpfHdr():Ref<BpfHdr>
export function refOfBpfHdr(x:BpfHdr):Ref<BpfHdr>
...
export function refSockaddrDatalink():Ref<SockaddrDatalink>
export function refOfSockaddrDatalink(x:SockaddrDatalink):Ref<SockaddrDatalink>
...
export function refIfmaMsghdr2():Ref<IfmaMsghdr2>
export function refOfIfmaMsghdr2(x:IfmaMsghdr2):Ref<IfmaMsghdr2>
export function emptyIfData():IfData
export function refIfData():Ref<IfData>
export function refOfIfData(x:IfData):Ref<IfData>
export function emptyIfmaMsghdr():IfmaMsghdr
export function refIfmaMsghdr():Ref<IfmaMsghdr>
export function refOfIfmaMsghdr(x:IfmaMsghdr):Ref<IfmaMsghdr>
...
export function refRawSockaddrDatalink():Ref<RawSockaddrDatalink>
export function refOfRawSockaddrDatalink(x:RawSockaddrDatalink):Ref<RawSockaddrDatalink>
export function emptyBpfVersion():BpfVersion
export function refBpfVersion():Ref<BpfVersion>
export function refOfBpfVersion(x:BpfVersion):Ref<BpfVersion>
...
export function refKevent_t():Ref<Kevent_t>
export function refOfKevent_t(x:Kevent_t):Ref<Kevent_t>
...
export function refInterfaceAddrMessage():Ref<InterfaceAddrMessage>
export function refOfInterfaceAddrMessage(x:InterfaceAddrMessage):Ref<InterfaceAddrMessage>
...
export function refIfMsghdr():Ref<IfMsghdr>
export function refOfIfMsghdr(x:IfMsghdr):Ref<IfMsghdr>
...
export function refBpfStat():Ref<BpfStat>
export function refOfBpfStat(x:BpfStat):Ref<BpfStat>
export function emptyInterfaceMulticastAddrMessage():InterfaceMulticastAddrMessage
export function refInterfaceMulticastAddrMessage():Ref<InterfaceMulticastAddrMessage>
export function refOfInterfaceMulticastAddrMessage(x:InterfaceMulticastAddrMessage):Ref<InterfaceMulticastAddrMessage>
...
export function refLog2phys_t():Ref<Log2phys_t>
export function refOfLog2phys_t(x:Log2phys_t):Ref<Log2phys_t>
...
export function refRtMsghdr():Ref<RtMsghdr>
export function refOfRtMsghdr(x:RtMsghdr):Ref<RtMsghdr>
export function emptyFstore_t():Fstore_t
export function refFstore_t():Ref<Fstore_t>
export function refOfFstore_t(x:Fstore_t):Ref<Fstore_t>}
