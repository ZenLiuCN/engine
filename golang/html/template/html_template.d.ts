...
declare module 'golang/html/template'{
	...
	// @ts-ignore
	import type {bool,Ref,error,int,Struct,GoError} from 'go'
	...
	export function parseFS(fs:fs.FS,...patterns:string[]):[Ref<Template>,error]
	...
	export interface Template extends Struct<Template>,json.Token{
		...
		parseFS(fs:fs.FS,...patterns:string[]):[Ref<Template>,error]
	}
