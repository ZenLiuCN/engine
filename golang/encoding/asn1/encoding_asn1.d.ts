...
declare module 'golang/encoding/asn1'{
	// @ts-ignore
	import type {bool,error,GoError,int,Struct} from 'go'
	...
	export function marshalWithParams(val:any,params:string):[Uint8Array,error]
	...
	export function unmarshal(b:Uint8Array,val:any):[Uint8Array,error]
	export function unmarshalWithParams(b:Uint8Array,val:any,params:string):[Uint8Array,error]

export function emptyBitString():BitString
export function refBitString():Ref<BitString>
export function refOfBitString(x:BitString):Ref<BitString>
export function emptyRawValue():RawValue
export function refRawValue():Ref<RawValue>
export function refOfRawValue(x:RawValue):Ref<RawValue>}
