...
declare module 'golang/reflect'{
	// @ts-ignore
	import type {Pointer,uintptr,int64,bool,Struct,complex128,error,int,uint,float64,Ref,uint64,GoError} from 'go'
	...
	export function makeFunc(typ:Type,fn:(args:Value[])=>Value[]):Value
	...
	export interface Type{
		...
		fieldByNameFunc(match:(v1:string)=>bool):[StructField,bool]
	...
	export interface Value extends Struct<Value>{
		...
		fieldByNameFunc(match:(v1:string)=>bool):Value
		canFloat():bool
		float():float64
		index(i:int):Value
		canInt():bool
...
export function refSelectCase():Ref<SelectCase>
export function refOfSelectCase(x:SelectCase):Ref<SelectCase>
export function emptySliceHeader():SliceHeader
export function refSliceHeader():Ref<SliceHeader>
export function refOfSliceHeader(x:SliceHeader):Ref<SliceHeader>
export function emptyStringHeader():StringHeader
export function refStringHeader():Ref<StringHeader>
export function refOfStringHeader(x:StringHeader):Ref<StringHeader>
export function emptyStructField():StructField
export function refStructField():Ref<StructField>
export function refOfStructField(x:StructField):Ref<StructField>
...
export function refMapIter():Ref<MapIter>
export function refOfMapIter(x:MapIter):Ref<MapIter>
export function emptyMethod():Method
export function refMethod():Ref<Method>
export function refOfMethod(x:Method):Ref<Method>}
