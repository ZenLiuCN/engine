...
declare module 'golang/sync/atomic'{
	// @ts-ignore
	import type {uintptr,int32,int64,uint32,uint64,Ref,Struct,bool,Pointer} from 'go'
...
export function refBool():Ref<Bool>
export function refOfBool(x:Bool):Ref<Bool>
export function emptyInt32():Int32
export function refInt32():Ref<Int32>
export function refOfInt32(x:Int32):Ref<Int32>
export function emptyInt64():Int64
export function refInt64():Ref<Int64>
export function refOfInt64(x:Int64):Ref<Int64>
export function emptyUint32():Uint32
export function refUint32():Ref<Uint32>
export function refOfUint32(x:Uint32):Ref<Uint32>
export function emptyUint64():Uint64
export function refUint64():Ref<Uint64>
export function refOfUint64(x:Uint64):Ref<Uint64>
export function emptyUintptr():Uintptr
export function refUintptr():Ref<Uintptr>
export function refOfUintptr(x:Uintptr):Ref<Uintptr>
