...
declare module 'golang/crypto/x509'{
	...
	// @ts-ignore
	import type {GoError,Nothing,Alias,Struct,Ref,bool,int,error} from 'go'
	export const CANotAuthorizedForExtKeyUsage:InvalidReason
	export const CANotAuthorizedForThisName:InvalidReason
	export interface CertPool extends Struct<CertPool>,crypto.DecrypterOpts,crypto.PrivateKey,crypto.PublicKey{
		clone():Ref<CertPool>
	...
	export interface Certificate extends Struct<Certificate>,crypto.DecrypterOpts,crypto.PrivateKey,crypto.PublicKey{
		raw:Uint8Array
	...
	export interface CertificateInvalidError extends Struct<CertificateInvalidError>,Error,GoError{
		cert:Ref<Certificate>
		reason:InvalidReason
		detail:string
		error():string
	}
	export interface CertificateRequest extends Struct<CertificateRequest>,crypto.DecrypterOpts,crypto.PrivateKey,crypto.PublicKey{
		raw:Uint8Array
	...
	export interface ConstraintViolationError extends GoError,Alias<Nothing>,Struct<ConstraintViolationError>,Error{
		error():string
	}
	...
	export interface RevocationList extends Struct<RevocationList>,crypto.DecrypterOpts,crypto.PrivateKey,crypto.PublicKey{
		raw:Uint8Array
	...
	export interface RevocationListEntry extends Struct<RevocationListEntry>,crypto.PrivateKey,crypto.PublicKey,crypto.DecrypterOpts{
		raw:Uint8Array
		serialNumber:Ref<big.Int>
	...
	export interface UnhandledCriticalExtension extends Alias<Nothing>,Struct<UnhandledCriticalExtension>,crypto.DecrypterOpts,crypto.PrivateKey,crypto.PublicKey,GoError{
		error():string
	}
	...
	export interface VerifyOptions extends crypto.PrivateKey,Struct<VerifyOptions>,crypto.PublicKey,crypto.DecrypterOpts{
		dnsName:string
