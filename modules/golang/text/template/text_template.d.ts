...
declare module 'golang/text/template'{
	...
	// @ts-ignore
	import type {GoError,Struct,error,Alias,map,bool,Ref} from 'go'
	export interface ExecError extends GoError,Struct<ExecError>,Error{
	...
	export interface FuncMap extends map<Alias<string>,any>{
