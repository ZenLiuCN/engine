...
declare module 'golang/text/scanner'{
	...
	// @ts-ignore
	import type {int,Struct,bool,Ref,uint,uint64,rune} from 'go'
	//-5
	...
	export interface Position extends fmt.Stringer,Struct<Position>{
	...
	export function emptyRefScanner():Ref<Scanner>
	export function refOfScanner(x:Scanner,v:Ref<Scanner>)
	export function unRefScanner(v:Ref<Scanner>):Scanner
}