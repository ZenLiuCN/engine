...
declare module 'golang/regexp'{
	...
	export interface Regexp extends Struct<Regexp>{
			...
			replaceAllStringFunc(src:string,v1:(v1:string)=>string):string
			replaceAll(src:Uint8Array,repl:Uint8Array):Uint8Array
			replaceAllLiteral(src:Uint8Array,repl:Uint8Array):Uint8Array
			replaceAllFunc(src:Uint8Array,v1:(v1:Uint8Array)=>Uint8Array):Uint8Array
			...
			findSubmatch(b:Uint8Array):Uint8Array[]
			...
			findAll(b:Uint8Array,n:int):Uint8Array[]
			findAllIndex(b:Uint8Array,n:int):int[][]
			findAllString(s:string,n:int):string[]
			findAllStringIndex(s:string,n:int):int[][]
			findAllSubmatch(b:Uint8Array,n:int):Uint8Array[][]
			findAllSubmatchIndex(b:Uint8Array,n:int):int[][]
