...
declare module 'golang/regexp/syntax'{
	...
	// @ts-ignore
	import type {Ref,error,uint8,GoError,int,rune,Struct,uint16,uint32,bool} from 'go'
	...
	export function parse(s:string,flags:Flags):Ref<Regexp>
	...
	export function emptyRefInst():Ref<Inst>
	export function refOfInst(x:Inst,v:Ref<Inst>)
	export function unRefInst(v:Ref<Inst>):Inst
	export function emptyProg():Prog
	export function emptyRefProg():Ref<Prog>
	export function refOfProg(x:Prog,v:Ref<Prog>)
	export function unRefProg(v:Ref<Prog>):Prog
	export function emptyRegexp():Regexp
	export function emptyRefRegexp():Ref<Regexp>
	export function refOfRegexp(x:Regexp,v:Ref<Regexp>)
	export function unRefRegexp(v:Ref<Regexp>):Regexp
}