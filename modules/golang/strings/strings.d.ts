...
declare module 'golang/strings'{
	...
	// @ts-ignore
	import type {Struct,int,error,byte,rune,bool,Ref,int64} from 'go'
	...
	export function containsFunc(s:string,v1:(v1:rune)=>bool):bool
	...
	export function fieldsFunc(s:string,v1:(v1:rune)=>bool):string[]
	...
	export function indexFunc(s:string,v1:(v1:rune)=>bool):int
	...
	export function lastIndexFunc(s:string,v1:(v1:rune)=>bool):int

	export function map(v2:(v1:rune)=>rune,s:string):string

	export function newReader(s:string):Ref<Reader>

	export function newReplacer(...oldnew:string[]):Ref<Replacer>

	export interface Reader extends Struct<Reader>,io.ReaderAt,io.ByteScanner,io.WriterTo,io.ReadSeeker,io.RuneScanner{
	...
	export function trimFunc(s:string,v1:(v1:rune)=>bool):string

	export function trimLeft(s:string,cutset:string):string

	export function trimLeftFunc(s:string,v1:(v1:rune)=>bool):string

	export function trimPrefix(s:string,prefix:string):string

	export function trimRight(s:string,cutset:string):string

	export function trimRightFunc(s:string,v1:(v1:rune)=>bool):string
	...
	export function emptyRefBuilder():Ref<Builder>
	export function refOfBuilder(x:Builder,v:Ref<Builder>)
	export function unRefBuilder(v:Ref<Builder>):Builder
}