...
declare module 'golang/crypto/x509'{
	...
	// @ts-ignore
	import type {Alias,Nothing,Struct,Ref,bool,int,error,GoError} from 'go'
	export const CANotAuthorizedForExtKeyUsage:InvalidReason
	export const CANotAuthorizedForThisName:InvalidReason
	export interface CertPool extends crypto.DecrypterOpts,crypto.PublicKey,crypto.PrivateKey,Struct<CertPool>{
	...
	export interface Certificate extends Struct<Certificate>,crypto.DecrypterOpts,crypto.PublicKey,crypto.PrivateKey{
			...
			verify(opts:VerifyOptions):Ref<Certificate>[][]
			...
			createCRL(rand:io.Reader,priv:any,revokedCerts:pkix.RevokedCertificate[],now:time.Time,expiry:time.Time):Uint8Array
	}
	export interface CertificateInvalidError extends Error,GoError,Struct<CertificateInvalidError>{
	...
	export interface CertificateRequest extends Struct<CertificateRequest>,crypto.PrivateKey,crypto.DecrypterOpts,crypto.PublicKey{
	...
	export interface ConstraintViolationError extends Alias<Nothing>,GoError{

			error():string
	}
	export function createCertificate(rand:io.Reader,template:Ref<Certificate>,parent:Ref<Certificate>,pub:any,priv:any):Uint8Array

	export function createCertificateRequest(rand:io.Reader,template:Ref<CertificateRequest>,priv:any):Uint8Array

	export function createRevocationList(rand:io.Reader,template:Ref<RevocationList>,issuer:Ref<Certificate>,priv:crypto.Signer):Uint8Array
	...
	export function decryptPEMBlock(b:Ref<pem.Block>,password:Uint8Array):Uint8Array
	...
	export function encryptPEMBlock(rand:io.Reader,blockType:string,data:Uint8Array,password:Uint8Array,alg:PEMCipher):Ref<pem.Block>
	...
	export interface HostnameError extends GoError,Struct<HostnameError>,Error{
	...
	export interface RevocationList extends crypto.PrivateKey,Struct<RevocationList>,crypto.DecrypterOpts,crypto.PublicKey{
	...
	export interface RevocationListEntry extends Struct<RevocationListEntry>,crypto.PublicKey,crypto.PrivateKey,crypto.DecrypterOpts{
	...
	export interface UnhandledCriticalExtension extends Alias<Nothing>,GoError{
	...
	export interface VerifyOptions extends Struct<VerifyOptions>,crypto.PublicKey,crypto.PrivateKey,crypto.DecrypterOpts{
	...
	export function emptyRefRevocationList():Ref<RevocationList>
	export function refOfRevocationList(x:RevocationList,v:Ref<RevocationList>)
	export function unRefRevocationList(v:Ref<RevocationList>):RevocationList
	export function emptyRevocationListEntry():RevocationListEntry
	export function emptyRefRevocationListEntry():Ref<RevocationListEntry>
	export function refOfRevocationListEntry(x:RevocationListEntry,v:Ref<RevocationListEntry>)
	export function unRefRevocationListEntry(v:Ref<RevocationListEntry>):RevocationListEntry
	export function emptyVerifyOptions():VerifyOptions
	export function emptyRefVerifyOptions():Ref<VerifyOptions>
	export function refOfVerifyOptions(x:VerifyOptions,v:Ref<VerifyOptions>)
	export function unRefVerifyOptions(v:Ref<VerifyOptions>):VerifyOptions
	...
	export function emptyRefCertificateRequest():Ref<CertificateRequest>
	export function refOfCertificateRequest(x:CertificateRequest,v:Ref<CertificateRequest>)
	export function unRefCertificateRequest(v:Ref<CertificateRequest>):CertificateRequest
}