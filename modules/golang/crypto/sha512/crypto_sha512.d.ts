...
declare module 'golang/crypto/sha512'{
	...
	export function sum384(data:Uint8Array):byte/*48*/

	export function sum512(data:Uint8Array):byte/*64*/

	export function sum512_224(data:Uint8Array):byte/*28*/

	export function sum512_256(data:Uint8Array):byte/*32*/
