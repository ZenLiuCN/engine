...
declare module 'golang/crypto/cipher'{
	...
	// @ts-ignore
	import type {error,Struct,GoError,int,Ref} from 'go'
	...
	export function emptyRefStreamReader():Ref<StreamReader>
	export function refOfStreamReader(x:StreamReader,v:Ref<StreamReader>)
	export function unRefStreamReader(v:Ref<StreamReader>):StreamReader
	export function emptyStreamWriter():StreamWriter
	export function emptyRefStreamWriter():Ref<StreamWriter>
	export function refOfStreamWriter(x:StreamWriter,v:Ref<StreamWriter>)
	export function unRefStreamWriter(v:Ref<StreamWriter>):StreamWriter
}