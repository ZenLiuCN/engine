...
declare module 'golang/os/exec'{
	...
	// @ts-ignore
	import type {GoError,error,Struct,Ref} from 'go'
	...
	export interface ExitError extends Struct<ExitError>,Error,GoError{
	...
	export function emptyRefCmd():Ref<Cmd>
	export function refOfCmd(x:Cmd,v:Ref<Cmd>)
	export function unRefCmd(v:Ref<Cmd>):Cmd
}
