...
declare module 'golang/net/netip'{
	...
	// @ts-ignore
	import type {error,byte,uint16,Struct,bool,int,Ref} from 'go'
	...
	export function addrFrom16(addr:byte/*16*/):Addr

	export function addrFrom4(addr:byte/*4*/):Addr
	...
	export function emptyRefAddr():Ref<Addr>
	export function refOfAddr(x:Addr,v:Ref<Addr>)
	export function unRefAddr(v:Ref<Addr>):Addr
	export function emptyAddrPort():AddrPort
	export function emptyRefAddrPort():Ref<AddrPort>
	export function refOfAddrPort(x:AddrPort,v:Ref<AddrPort>)
	export function unRefAddrPort(v:Ref<AddrPort>):AddrPort
	export function emptyPrefix():Prefix
	export function emptyRefPrefix():Ref<Prefix>
	export function refOfPrefix(x:Prefix,v:Ref<Prefix>)
	export function unRefPrefix(v:Ref<Prefix>):Prefix
}