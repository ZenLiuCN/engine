...
declare module 'golang/net/rpc'{
	...
	export function emptyRefCall():Ref<Call>
	export function refOfCall(x:Call,v:Ref<Call>)
	export function unRefCall(v:Ref<Call>):Call
	export function emptyRequest():Request
	export function emptyRefRequest():Ref<Request>
	export function refOfRequest(x:Request,v:Ref<Request>)
	export function unRefRequest(v:Ref<Request>):Request
