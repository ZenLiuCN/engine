...
declare module 'golang/net/http/httputil'{
	...
	// @ts-ignore
	import type {bool,GoError,Struct,Ref,error,int} from 'go'
	...
	export interface ReverseProxy extends http.Handler,Struct<ReverseProxy>{
	...
	export interface ServerConn extends io.Closer,Struct<ServerConn>{
	...
	export function emptyRefProxyRequest():Ref<ProxyRequest>
	export function refOfProxyRequest(x:ProxyRequest,v:Ref<ProxyRequest>)
	export function unRefProxyRequest(v:Ref<ProxyRequest>):ProxyRequest
	export function emptyReverseProxy():ReverseProxy
	export function emptyRefReverseProxy():Ref<ReverseProxy>
	export function refOfReverseProxy(x:ReverseProxy,v:Ref<ReverseProxy>)
	export function unRefReverseProxy(v:Ref<ReverseProxy>):ReverseProxy
}