...
declare module 'golang/net/http/httptrace'{
	...
	export function emptyRefWroteRequestInfo():Ref<WroteRequestInfo>
	export function refOfWroteRequestInfo(x:WroteRequestInfo,v:Ref<WroteRequestInfo>)
	export function unRefWroteRequestInfo(v:Ref<WroteRequestInfo>):WroteRequestInfo
	export function emptyClientTrace():ClientTrace
	export function emptyRefClientTrace():Ref<ClientTrace>
	export function refOfClientTrace(x:ClientTrace,v:Ref<ClientTrace>)
	export function unRefClientTrace(v:Ref<ClientTrace>):ClientTrace
	export function emptyDNSDoneInfo():DNSDoneInfo
	export function emptyRefDNSDoneInfo():Ref<DNSDoneInfo>
	export function refOfDNSDoneInfo(x:DNSDoneInfo,v:Ref<DNSDoneInfo>)
	export function unRefDNSDoneInfo(v:Ref<DNSDoneInfo>):DNSDoneInfo
	export function emptyDNSStartInfo():DNSStartInfo
	export function emptyRefDNSStartInfo():Ref<DNSStartInfo>
	export function refOfDNSStartInfo(x:DNSStartInfo,v:Ref<DNSStartInfo>)
	export function unRefDNSStartInfo(v:Ref<DNSStartInfo>):DNSStartInfo
	export function emptyGotConnInfo():GotConnInfo
	export function emptyRefGotConnInfo():Ref<GotConnInfo>
	export function refOfGotConnInfo(x:GotConnInfo,v:Ref<GotConnInfo>)
	export function unRefGotConnInfo(v:Ref<GotConnInfo>):GotConnInfo
}