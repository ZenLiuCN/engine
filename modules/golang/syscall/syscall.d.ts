...
declare module 'golang/syscall'{
	...
	// @ts-ignore
	import type {Ref,GoError,uintptr,int64,byte,uint32,bool,int,Alias,uint16,Struct,Nothing,int8,uint8,error,int32} from 'go'
	//2
	...
	export function accept(fd:Handle):[Handle,Sockaddr]
	...
	export function certCreateCertificateContext(certEncodingType:uint32,certEncoded:Ref<byte>,encodedLen:uint32):Ref<CertContext>
	...
	export function certEnumCertificatesInStore(store:Handle,prevContext:Ref<CertContext>):Ref<CertContext>
	...
	export interface CertInfo extends Alias<Nothing>{

	}
	export function certOpenStore(storeProvider:uintptr,msgAndCertEncodingType:uint32,cryptProv:uintptr,flags:uint32,para:uintptr):Handle

	export function certOpenSystemStore(hprov:Handle,name:Ref<uint16>):Handle

	export interface CertRevocationCrlInfo extends Alias<Nothing>{
	...
	export interface CertTrustListInfo extends Alias<Nothing>{
	...
	export function commandLineToArgv(cmd:Ref<uint16>,argc:Ref<int32>):Ref<Ref<uint16/*8192*/>[/*8192*/]>
	...
	export function createFile(name:Ref<uint16>,access:uint32,mode:uint32,sa:Ref<SecurityAttributes>,createmode:uint32,attrs:uint32,templatefile:int32):Handle

	export function createFileMapping(fhandle:Handle,sa:Ref<SecurityAttributes>,prot:uint32,maxSizeHigh:uint32,maxSizeLow:uint32,name:Ref<uint16>):Handle

	export function createHardLink(filename:Ref<uint16>,existingfilename:Ref<uint16>,reserved:uintptr)/*error*/

	export function createIoCompletionPort(filehandle:Handle,cphandle:Handle,key:uint32,threadcnt:uint32):Handle
	...
	export function createToolhelp32Snapshot(flags:uint32,processId:uint32):Handle
	...
	export interface DLL extends Struct<DLL>{
			...
			name:string
			handle:Handle
			findProc(name:string):Ref<Proc>
			mustFindProc(name:string):Ref<Proc>
			release()/*error*/
	}
	export interface DLLError extends Struct<DLLError>,Error,GoError{
	...
	export function findFirstFile(name:Ref<uint16>,data:Ref<Win32finddata>):Handle
	...
	export function formatMessage(flags:uint32,msgsrc:uint32,msgid:uint32,langid:uint32,buf:Uint16Array,args:Ref<byte>):uint32
	...
	export function getCurrentDirectory(buflen:uint32,buf:Ref<uint16>):uint32

	export function getCurrentProcess():Handle

	export function getEnvironmentStrings():Ref<uint16>

	export function getEnvironmentVariable(name:Ref<uint16>,buffer:Ref<uint16>,size:uint32):uint32
	...
	export function getFullPathName(path:Ref<uint16>,buflen:uint32,buf:Ref<uint16>,fname:Ref<Ref<uint16>>):uint32
	...
	export function getLongPathName(path:Ref<uint16>,buf:Ref<uint16>,buflen:uint32):uint32

	export function getProcAddress(module:Handle,procname:string):uintptr
	...
	export function getServByName(name:string,proto:string):Ref<Servent>

	export function getShortPathName(longpath:Ref<uint16>,shortpath:Ref<uint16>,buflen:uint32):uint32
	...
	export function getTempPath(buflen:uint32,buf:Ref<uint16>):uint32
	...
	export function getsockoptInt(fd:Handle,level:int,opt:int):int
	...
	export interface IpAdapterInfo extends Struct<IpAdapterInfo>{
			...
			comboIndex:uint32
			adapterName:byte/*260*/
			description:byte/*132*/
	...
	export interface LazyProc extends Struct<LazyProc>{
			...
			find()/*error*/
			addr():uintptr
			call(...a:uintptr[]):[uintptr,uintptr]
	}
	...
	export function lookupSID(system:string,account:string):[Ref<SID>,string,uint32]
	...
	export function mapViewOfFile(handle:Handle,access:uint32,offsetHigh:uint32,offsetLow:uint32,length:uintptr):uintptr
	...
	export function open(path:string,mode:int,perm:uint32):Handle

	export function openCurrentProcessToken():Token

	export function openProcess(da:uint32,inheritHandle:bool,pid:uint32):Handle
	...
	export function read(fd:Handle,p:Uint8Array):int
	...
	export function recvfrom(fd:Handle,p:Uint8Array,flags:int):[int,Sockaddr]
	...
	export interface SID extends Alias<Nothing>{

			string():string
			len():int
			copy():Ref<SID>
			lookupAccount(system:string):[string,string,uint32]
	}
	...
	export function seek(fd:Handle,offset:int64,whence:int):int64
	...
	export function setFilePointer(handle:Handle,lowoffset:int32,highoffsetptr:Ref<int32>,whence:uint32):uint32
	...
	export function setsockoptInet4Addr(fd:Handle,level:int,opt:int,value:byte/*4*/)/*error*/
	...
	export interface SockaddrGen extends byte/*24*/{
	...
	export interface SockaddrUnix extends Sockaddr,Struct<SockaddrUnix>{

			name:string
	}
	export function socket(domain:int,typ:int,proto:int):Handle
	...
	export interface Timezoneinformation extends Struct<Timezoneinformation>{
			...
			bias:int32
			standardName:uint16/*32*/
			standardDate:Systemtime
			standardBias:int32
			daylightName:uint16/*32*/
	...
	close():error
	getTokenUser():Ref<Tokenuser>
	getTokenPrimaryGroup():Ref<Tokenprimarygroup>
	getUserProfileDirectory():string
	}
	//22
	...
	export function translateAccountName(username:string,from:uint32,to:uint32,initSize:int):string
	...
	export function wsaEnumProtocols(protocols:Ref<int32>,protocolBuffer:Ref<WSAProtocolInfo>,bufferLength:Ref<uint32>):int32
	...
	export function waitForSingleObject(handle:Handle,waitMilliseconds:uint32):uint32
	...
	export interface Win32finddata extends Struct<Win32finddata>{
			...
			reserved1:uint32
			fileName:uint16/*259*/
			alternateFileName:uint16/*13*/
	}
	export function write(fd:Handle,p:Uint8Array):int
	...
	export function emptyRefDNSPTRData():Ref<DNSPTRData>
	export function refOfDNSPTRData(x:DNSPTRData,v:Ref<DNSPTRData>)
	export function unRefDNSPTRData(v:Ref<DNSPTRData>):DNSPTRData
	export function emptySIDAndAttributes():SIDAndAttributes
	export function emptyRefSIDAndAttributes():Ref<SIDAndAttributes>
	export function refOfSIDAndAttributes(x:SIDAndAttributes,v:Ref<SIDAndAttributes>)
	export function unRefSIDAndAttributes(v:Ref<SIDAndAttributes>):SIDAndAttributes
	export function emptyCertEnhKeyUsage():CertEnhKeyUsage
	export function emptyRefCertEnhKeyUsage():Ref<CertEnhKeyUsage>
	export function refOfCertEnhKeyUsage(x:CertEnhKeyUsage,v:Ref<CertEnhKeyUsage>)
	export function unRefCertEnhKeyUsage(v:Ref<CertEnhKeyUsage>):CertEnhKeyUsage
	export function emptyCertRevocationInfo():CertRevocationInfo
	export function emptyRefCertRevocationInfo():Ref<CertRevocationInfo>
	export function refOfCertRevocationInfo(x:CertRevocationInfo,v:Ref<CertRevocationInfo>)
	export function unRefCertRevocationInfo(v:Ref<CertRevocationInfo>):CertRevocationInfo
	export function emptyDNSMXData():DNSMXData
	export function emptyRefDNSMXData():Ref<DNSMXData>
	export function refOfDNSMXData(x:DNSMXData,v:Ref<DNSMXData>)
	export function unRefDNSMXData(v:Ref<DNSMXData>):DNSMXData
	export function emptyDNSTXTData():DNSTXTData
	export function emptyRefDNSTXTData():Ref<DNSTXTData>
	export function refOfDNSTXTData(x:DNSTXTData,v:Ref<DNSTXTData>)
	export function unRefDNSTXTData(v:Ref<DNSTXTData>):DNSTXTData
	export function emptyHostent():Hostent
	export function emptyRefHostent():Ref<Hostent>
	export function refOfHostent(x:Hostent,v:Ref<Hostent>)
	export function unRefHostent(v:Ref<Hostent>):Hostent
	...
	export function emptyRefDNSRecord():Ref<DNSRecord>
	export function refOfDNSRecord(x:DNSRecord,v:Ref<DNSRecord>)
	export function unRefDNSRecord(v:Ref<DNSRecord>):DNSRecord
	...
	export function emptyRefStartupInfo():Ref<StartupInfo>
	export function refOfStartupInfo(x:StartupInfo,v:Ref<StartupInfo>)
	export function unRefStartupInfo(v:Ref<StartupInfo>):StartupInfo
	export function emptySystemtime():Systemtime
	export function emptyRefSystemtime():Ref<Systemtime>
	export function refOfSystemtime(x:Systemtime,v:Ref<Systemtime>)
	export function unRefSystemtime(v:Ref<Systemtime>):Systemtime
	export function emptyWSABuf():WSABuf
	export function emptyRefWSABuf():Ref<WSABuf>
	export function refOfWSABuf(x:WSABuf,v:Ref<WSABuf>)
	export function unRefWSABuf(v:Ref<WSABuf>):WSABuf
	export function emptyDNSSRVData():DNSSRVData
	export function emptyRefDNSSRVData():Ref<DNSSRVData>
	export function refOfDNSSRVData(x:DNSSRVData,v:Ref<DNSSRVData>)
	export function unRefDNSSRVData(v:Ref<DNSSRVData>):DNSSRVData
	export function emptyOverlapped():Overlapped
	export function emptyRefOverlapped():Ref<Overlapped>
	export function refOfOverlapped(x:Overlapped,v:Ref<Overlapped>)
	export function unRefOverlapped(v:Ref<Overlapped>):Overlapped
	export function emptySecurityAttributes():SecurityAttributes
	export function emptyRefSecurityAttributes():Ref<SecurityAttributes>
	export function refOfSecurityAttributes(x:SecurityAttributes,v:Ref<SecurityAttributes>)
	export function unRefSecurityAttributes(v:Ref<SecurityAttributes>):SecurityAttributes
	export function emptyCertSimpleChain():CertSimpleChain
	export function emptyRefCertSimpleChain():Ref<CertSimpleChain>
	export function refOfCertSimpleChain(x:CertSimpleChain,v:Ref<CertSimpleChain>)
	export function unRefCertSimpleChain(v:Ref<CertSimpleChain>):CertSimpleChain
	export function emptyInterfaceInfo():InterfaceInfo
	export function emptyRefInterfaceInfo():Ref<InterfaceInfo>
	export function refOfInterfaceInfo(x:InterfaceInfo,v:Ref<InterfaceInfo>)
	export function unRefInterfaceInfo(v:Ref<InterfaceInfo>):InterfaceInfo
	...
	export function emptyRefProcessInformation():Ref<ProcessInformation>
	export function refOfProcessInformation(x:ProcessInformation,v:Ref<ProcessInformation>)
	export function unRefProcessInformation(v:Ref<ProcessInformation>):ProcessInformation
	...
	export function emptyRefTimezoneinformation():Ref<Timezoneinformation>
	export function refOfTimezoneinformation(x:Timezoneinformation,v:Ref<Timezoneinformation>)
	export function unRefTimezoneinformation(v:Ref<Timezoneinformation>):Timezoneinformation
	export function emptyTokenprimarygroup():Tokenprimarygroup
	export function emptyRefTokenprimarygroup():Ref<Tokenprimarygroup>
	export function refOfTokenprimarygroup(x:Tokenprimarygroup,v:Ref<Tokenprimarygroup>)
	export function unRefTokenprimarygroup(v:Ref<Tokenprimarygroup>):Tokenprimarygroup
	export function emptyCertChainElement():CertChainElement
	export function emptyRefCertChainElement():Ref<CertChainElement>
	export function refOfCertChainElement(x:CertChainElement,v:Ref<CertChainElement>)
	export function unRefCertChainElement(v:Ref<CertChainElement>):CertChainElement
	export function emptyCertChainPolicyStatus():CertChainPolicyStatus
	export function emptyRefCertChainPolicyStatus():Ref<CertChainPolicyStatus>
	export function refOfCertChainPolicyStatus(x:CertChainPolicyStatus,v:Ref<CertChainPolicyStatus>)
	export function unRefCertChainPolicyStatus(v:Ref<CertChainPolicyStatus>):CertChainPolicyStatus
	export function emptyLazyProc():LazyProc
	export function emptyRefLazyProc():Ref<LazyProc>
	export function refOfLazyProc(x:LazyProc,v:Ref<LazyProc>)
	export function unRefLazyProc(v:Ref<LazyProc>):LazyProc
	...
	export function emptyRefTCPKeepalive():Ref<TCPKeepalive>
	export function refOfTCPKeepalive(x:TCPKeepalive,v:Ref<TCPKeepalive>)
	export function unRefTCPKeepalive(v:Ref<TCPKeepalive>):TCPKeepalive
	...
	export function emptyRefWSAData():Ref<WSAData>
	export function refOfWSAData(x:WSAData,v:Ref<WSAData>)
	export function unRefWSAData(v:Ref<WSAData>):WSAData
	export function emptyCertUsageMatch():CertUsageMatch
	export function emptyRefCertUsageMatch():Ref<CertUsageMatch>
	export function refOfCertUsageMatch(x:CertUsageMatch,v:Ref<CertUsageMatch>)
	export function unRefCertUsageMatch(v:Ref<CertUsageMatch>):CertUsageMatch
	export function emptyDLL():DLL
	export function emptyRefDLL():Ref<DLL>
	export function refOfDLL(x:DLL,v:Ref<DLL>)
	export function unRefDLL(v:Ref<DLL>):DLL
	export function emptyFileNotifyInformation():FileNotifyInformation
	export function emptyRefFileNotifyInformation():Ref<FileNotifyInformation>
	export function refOfFileNotifyInformation(x:FileNotifyInformation,v:Ref<FileNotifyInformation>)
	export function unRefFileNotifyInformation(v:Ref<FileNotifyInformation>):FileNotifyInformation
	...
	export function emptyRefWin32FileAttributeData():Ref<Win32FileAttributeData>
	export function refOfWin32FileAttributeData(x:Win32FileAttributeData,v:Ref<Win32FileAttributeData>)
	export function unRefWin32FileAttributeData(v:Ref<Win32FileAttributeData>):Win32FileAttributeData
	export function emptyIpAddrString():IpAddrString
	export function emptyRefIpAddrString():Ref<IpAddrString>
	export function refOfIpAddrString(x:IpAddrString,v:Ref<IpAddrString>)
	export function unRefIpAddrString(v:Ref<IpAddrString>):IpAddrString
	export function emptyIpMaskString():IpMaskString
	export function emptyRefIpMaskString():Ref<IpMaskString>
	export function refOfIpMaskString(x:IpMaskString,v:Ref<IpMaskString>)
	export function unRefIpMaskString(v:Ref<IpMaskString>):IpMaskString
	...
	export function emptyRefFiletime():Ref<Filetime>
	export function refOfFiletime(x:Filetime,v:Ref<Filetime>)
	export function unRefFiletime(v:Ref<Filetime>):Filetime
	export function emptyUserInfo10():UserInfo10
	export function emptyRefUserInfo10():Ref<UserInfo10>
	export function refOfUserInfo10(x:UserInfo10,v:Ref<UserInfo10>)
	export function unRefUserInfo10(v:Ref<UserInfo10>):UserInfo10
	export function emptyAddrinfoW():AddrinfoW
	export function emptyRefAddrinfoW():Ref<AddrinfoW>
	export function refOfAddrinfoW(x:AddrinfoW,v:Ref<AddrinfoW>)
	export function unRefAddrinfoW(v:Ref<AddrinfoW>):AddrinfoW
	export function emptyCertChainPara():CertChainPara
	export function emptyRefCertChainPara():Ref<CertChainPara>
	export function refOfCertChainPara(x:CertChainPara,v:Ref<CertChainPara>)
	export function unRefCertChainPara(v:Ref<CertChainPara>):CertChainPara
	export function emptyProtoent():Protoent
	export function emptyRefProtoent():Ref<Protoent>
	export function refOfProtoent(x:Protoent,v:Ref<Protoent>)
	export function unRefProtoent(v:Ref<Protoent>):Protoent
	...
	export function emptyRefMibIfRow():Ref<MibIfRow>
	export function refOfMibIfRow(x:MibIfRow,v:Ref<MibIfRow>)
	export function unRefMibIfRow(v:Ref<MibIfRow>):MibIfRow
	export function emptyWaitStatus():WaitStatus
	export function emptyRefWaitStatus():Ref<WaitStatus>
	export function refOfWaitStatus(x:WaitStatus,v:Ref<WaitStatus>)
	export function unRefWaitStatus(v:Ref<WaitStatus>):WaitStatus
	export function emptyWin32finddata():Win32finddata
	export function emptyRefWin32finddata():Ref<Win32finddata>
	export function refOfWin32finddata(x:Win32finddata,v:Ref<Win32finddata>)
	export function unRefWin32finddata(v:Ref<Win32finddata>):Win32finddata
	export function emptyCertContext():CertContext
	export function emptyRefCertContext():Ref<CertContext>
	export function refOfCertContext(x:CertContext,v:Ref<CertContext>)
	export function unRefCertContext(v:Ref<CertContext>):CertContext
	export function emptyCertTrustStatus():CertTrustStatus
	export function emptyRefCertTrustStatus():Ref<CertTrustStatus>
	export function refOfCertTrustStatus(x:CertTrustStatus,v:Ref<CertTrustStatus>)
	export function unRefCertTrustStatus(v:Ref<CertTrustStatus>):CertTrustStatus
	export function emptyGUID():GUID
	export function emptyRefGUID():Ref<GUID>
	export function refOfGUID(x:GUID,v:Ref<GUID>)
	export function unRefGUID(v:Ref<GUID>):GUID
	export function emptyIpAddressString():IpAddressString
	export function emptyRefIpAddressString():Ref<IpAddressString>
	export function refOfIpAddressString(x:IpAddressString,v:Ref<IpAddressString>)
	export function unRefIpAddressString(v:Ref<IpAddressString>):IpAddressString
	...
	export function emptyRefSSLExtraCertChainPolicyPara():Ref<SSLExtraCertChainPolicyPara>
	export function refOfSSLExtraCertChainPolicyPara(x:SSLExtraCertChainPolicyPara,v:Ref<SSLExtraCertChainPolicyPara>)
	export function unRefSSLExtraCertChainPolicyPara(v:Ref<SSLExtraCertChainPolicyPara>):SSLExtraCertChainPolicyPara
	export function emptyTokenuser():Tokenuser
	export function emptyRefTokenuser():Ref<Tokenuser>
	export function refOfTokenuser(x:Tokenuser,v:Ref<Tokenuser>)
	export function unRefTokenuser(v:Ref<Tokenuser>):Tokenuser
	export function emptyCertChainContext():CertChainContext
	export function emptyRefCertChainContext():Ref<CertChainContext>
	export function refOfCertChainContext(x:CertChainContext,v:Ref<CertChainContext>)
	export function unRefCertChainContext(v:Ref<CertChainContext>):CertChainContext
	export function emptyProc():Proc
	export function emptyRefProc():Ref<Proc>
	export function refOfProc(x:Proc,v:Ref<Proc>)
	export function unRefProc(v:Ref<Proc>):Proc
	export function emptyProcessEntry32():ProcessEntry32
	export function emptyRefProcessEntry32():Ref<ProcessEntry32>
	export function refOfProcessEntry32(x:ProcessEntry32,v:Ref<ProcessEntry32>)
	export function unRefProcessEntry32(v:Ref<ProcessEntry32>):ProcessEntry32
	...
	export function emptyRefServent():Ref<Servent>
	export function refOfServent(x:Servent,v:Ref<Servent>)
	export function unRefServent(v:Ref<Servent>):Servent
	export function emptyWSAProtocolInfo():WSAProtocolInfo
	export function emptyRefWSAProtocolInfo():Ref<WSAProtocolInfo>
	export function refOfWSAProtocolInfo(x:WSAProtocolInfo,v:Ref<WSAProtocolInfo>)
	export function unRefWSAProtocolInfo(v:Ref<WSAProtocolInfo>):WSAProtocolInfo
	export function emptyByHandleFileInformation():ByHandleFileInformation
	export function emptyRefByHandleFileInformation():Ref<ByHandleFileInformation>
	export function refOfByHandleFileInformation(x:ByHandleFileInformation,v:Ref<ByHandleFileInformation>)
	export function unRefByHandleFileInformation(v:Ref<ByHandleFileInformation>):ByHandleFileInformation
	export function emptyCertChainPolicyPara():CertChainPolicyPara
	export function emptyRefCertChainPolicyPara():Ref<CertChainPolicyPara>
	export function refOfCertChainPolicyPara(x:CertChainPolicyPara,v:Ref<CertChainPolicyPara>)
	export function unRefCertChainPolicyPara(v:Ref<CertChainPolicyPara>):CertChainPolicyPara
	export function emptyIpAdapterInfo():IpAdapterInfo
	export function emptyRefIpAdapterInfo():Ref<IpAdapterInfo>
	export function refOfIpAdapterInfo(x:IpAdapterInfo,v:Ref<IpAdapterInfo>)
	export function unRefIpAdapterInfo(v:Ref<IpAdapterInfo>):IpAdapterInfo
	...
	export function emptyRefTransmitFileBuffers():Ref<TransmitFileBuffers>
	export function refOfTransmitFileBuffers(x:TransmitFileBuffers,v:Ref<TransmitFileBuffers>)
	export function unRefTransmitFileBuffers(v:Ref<TransmitFileBuffers>):TransmitFileBuffers
	export function emptyWSAProtocolChain():WSAProtocolChain
	export function emptyRefWSAProtocolChain():Ref<WSAProtocolChain>
	export function refOfWSAProtocolChain(x:WSAProtocolChain,v:Ref<WSAProtocolChain>)
	export function unRefWSAProtocolChain(v:Ref<WSAProtocolChain>):WSAProtocolChain
}