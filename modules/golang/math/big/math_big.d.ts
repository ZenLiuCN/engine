...
declare module 'golang/math/big'{
	...
	// @ts-ignore
	import type {uint64,float32,uint,Ref,int,float64,error,int8,Struct,byte,rune,GoError,bool,int64} from 'go'
	...
	export interface Float extends fmt.Formatter,fmt.Stringer,Struct<Float>,fmt.Scanner{
	...
	export interface Int extends Struct<Int>,fmt.Formatter,fmt.Stringer,fmt.Scanner{
	...
	export interface Rat extends Struct<Rat>,fmt.Stringer,fmt.Scanner{
