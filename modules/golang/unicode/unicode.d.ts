...
declare module 'golang/unicode'{
	...
	// @ts-ignore
	import type {int,uint16,Ref,uint32,Struct,map,rune,bool} from 'go'
	...
	export const Categories:map<string,Ref<RangeTable>>
	...
	export const FoldCategory:map<string,Ref<RangeTable>>
	export const FoldScript:map<string,Ref<RangeTable>>
	...
	export const Properties:map<string,Ref<RangeTable>>
	...
	export const Scripts:map<string,Ref<RangeTable>>
	...
	export function emptyRefCaseRange():Ref<CaseRange>
	export function refOfCaseRange(x:CaseRange,v:Ref<CaseRange>)
	export function unRefCaseRange(v:Ref<CaseRange>):CaseRange
	export function emptyRange16():Range16
	export function emptyRefRange16():Ref<Range16>
	export function refOfRange16(x:Range16,v:Ref<Range16>)
	export function unRefRange16(v:Ref<Range16>):Range16
	export function emptyRange32():Range32
	export function emptyRefRange32():Ref<Range32>
	export function refOfRange32(x:Range32,v:Ref<Range32>)
	export function unRefRange32(v:Ref<Range32>):Range32
	export function emptyRangeTable():RangeTable
	export function emptyRefRangeTable():Ref<RangeTable>
	export function refOfRangeTable(x:RangeTable,v:Ref<RangeTable>)
	export function unRefRangeTable(v:Ref<RangeTable>):RangeTable
}