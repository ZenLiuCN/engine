...
declare module 'github.com/larksuite/oapi-sdk-go/v3/event/dispatcher'{
	...
	export interface CustomAppTicketEventHandler extends Struct<CustomAppTicketEventHandler>,json.Token,larkevent.EventHandler{

			event():any
			handle(ctx:context.Context,event:any)/*error*/
	}
	export interface EventDispatcher extends json.Token,Struct<EventDispatcher>,larkevent.IReqHandler{
	...
	export interface NotFoundEventHandlerErr extends Error,GoError,Struct<NotFoundEventHandlerErr>{
	...
	export function emptyEventDispatcher():EventDispatcher
	export function emptyRefEventDispatcher():Ref<EventDispatcher>
	export function refOfEventDispatcher(x:EventDispatcher,v:Ref<EventDispatcher>)
	export function unRefEventDispatcher(v:Ref<EventDispatcher>):EventDispatcher
}