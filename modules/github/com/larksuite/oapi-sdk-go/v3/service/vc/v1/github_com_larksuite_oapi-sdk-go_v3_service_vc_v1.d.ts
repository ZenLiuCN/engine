...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/vc/v1'{
	...
	export interface P2MeetingRecordingEndedV1 extends larkevent.EventHandlerModel,Struct<P2MeetingRecordingEndedV1>{
	...
	export interface P2MeetingStartedV1 extends larkevent.EventHandlerModel,Struct<P2MeetingStartedV1>{
	...
	export interface P2RoomDeletedV1Handler extends larkevent.EventHandler,Struct<P2RoomDeletedV1Handler>{
	...
	export interface P2RoomLevelDeletedV1 extends larkevent.EventHandlerModel,Struct<P2RoomLevelDeletedV1>{
	...
	export interface P2RoomLevelUpdatedV1Handler extends larkevent.EventHandler,Struct<P2RoomLevelUpdatedV1Handler>{

			event():any
			handle(ctx:context.Context,event:any)/*error*/
	}
	export interface P2RoomUpdatedV1 extends larkevent.EventHandlerModel,Struct<P2RoomUpdatedV1>{
	...
	export function emptyGetMeetingListReqBuilder():GetMeetingListReqBuilder
	export function emptyRefGetMeetingListReqBuilder():Ref<GetMeetingListReqBuilder>
	export function refOfGetMeetingListReqBuilder(x:GetMeetingListReqBuilder,v:Ref<GetMeetingListReqBuilder>)
	export function unRefGetMeetingListReqBuilder(v:Ref<GetMeetingListReqBuilder>):GetMeetingListReqBuilder
	...
	export function emptyGetReserveConfigAdminReqBuilder():GetReserveConfigAdminReqBuilder
	export function emptyRefGetReserveConfigAdminReqBuilder():Ref<GetReserveConfigAdminReqBuilder>
	export function refOfGetReserveConfigAdminReqBuilder(x:GetReserveConfigAdminReqBuilder,v:Ref<GetReserveConfigAdminReqBuilder>)
	export function unRefGetReserveConfigAdminReqBuilder(v:Ref<GetReserveConfigAdminReqBuilder>):GetReserveConfigAdminReqBuilder
	export function emptyMeetingListExportReqBodyBuilder():MeetingListExportReqBodyBuilder
	export function emptyRefMeetingListExportReqBodyBuilder():Ref<MeetingListExportReqBodyBuilder>
	export function refOfMeetingListExportReqBodyBuilder(x:MeetingListExportReqBodyBuilder,v:Ref<MeetingListExportReqBodyBuilder>)
	export function unRefMeetingListExportReqBodyBuilder(v:Ref<MeetingListExportReqBodyBuilder>):MeetingListExportReqBodyBuilder
	export function emptyParticipantQualityBuilder():ParticipantQualityBuilder
	export function emptyRefParticipantQualityBuilder():Ref<ParticipantQualityBuilder>
	export function refOfParticipantQualityBuilder(x:ParticipantQualityBuilder,v:Ref<ParticipantQualityBuilder>)
	export function unRefParticipantQualityBuilder(v:Ref<ParticipantQualityBuilder>):ParticipantQualityBuilder
	export function emptyApplyReservePathReqBodyBuilder():ApplyReservePathReqBodyBuilder
	export function emptyRefApplyReservePathReqBodyBuilder():Ref<ApplyReservePathReqBodyBuilder>
	export function refOfApplyReservePathReqBodyBuilder(x:ApplyReservePathReqBodyBuilder,v:Ref<ApplyReservePathReqBodyBuilder>)
	export function unRefApplyReservePathReqBodyBuilder(v:Ref<ApplyReservePathReqBodyBuilder>):ApplyReservePathReqBodyBuilder
	...
	export function emptySetCheckboardAccessCodeRoomConfigReqBodyBuilder():SetCheckboardAccessCodeRoomConfigReqBodyBuilder
	export function emptyRefSetCheckboardAccessCodeRoomConfigReqBodyBuilder():Ref<SetCheckboardAccessCodeRoomConfigReqBodyBuilder>
	export function refOfSetCheckboardAccessCodeRoomConfigReqBodyBuilder(x:SetCheckboardAccessCodeRoomConfigReqBodyBuilder,v:Ref<SetCheckboardAccessCodeRoomConfigReqBodyBuilder>)
	export function unRefSetCheckboardAccessCodeRoomConfigReqBodyBuilder(v:Ref<SetCheckboardAccessCodeRoomConfigReqBodyBuilder>):SetCheckboardAccessCodeRoomConfigReqBodyBuilder
	export function emptyRoomStatusBuilder():RoomStatusBuilder
	export function emptyRefRoomStatusBuilder():Ref<RoomStatusBuilder>
	export function refOfRoomStatusBuilder(x:RoomStatusBuilder,v:Ref<RoomStatusBuilder>)
	export function unRefRoomStatusBuilder(v:Ref<RoomStatusBuilder>):RoomStatusBuilder
	...
	export function emptyAlertBuilder():AlertBuilder
	export function emptyRefAlertBuilder():Ref<AlertBuilder>
	export function refOfAlertBuilder(x:AlertBuilder,v:Ref<AlertBuilder>)
	export function unRefAlertBuilder(v:Ref<AlertBuilder>):AlertBuilder
	...
	export function emptyCreateScopeConfigReqBuilder():CreateScopeConfigReqBuilder
	export function emptyRefCreateScopeConfigReqBuilder():Ref<CreateScopeConfigReqBuilder>
	export function refOfCreateScopeConfigReqBuilder(x:CreateScopeConfigReqBuilder,v:Ref<CreateScopeConfigReqBuilder>)
	export function unRefCreateScopeConfigReqBuilder(v:Ref<CreateScopeConfigReqBuilder>):CreateScopeConfigReqBuilder
	...
	export function emptyGetReserveReqBuilder():GetReserveReqBuilder
	export function emptyRefGetReserveReqBuilder():Ref<GetReserveReqBuilder>
	export function refOfGetReserveReqBuilder(x:GetReserveReqBuilder,v:Ref<GetReserveReqBuilder>)
	export function unRefGetReserveReqBuilder(v:Ref<GetReserveReqBuilder>):GetReserveReqBuilder
	...
	export function emptyMgetRoomPathReqBodyBuilder():MgetRoomPathReqBodyBuilder
	export function emptyRefMgetRoomPathReqBodyBuilder():Ref<MgetRoomPathReqBodyBuilder>
	export function refOfMgetRoomPathReqBodyBuilder(x:MgetRoomPathReqBodyBuilder,v:Ref<MgetRoomPathReqBodyBuilder>)
	export function unRefMgetRoomPathReqBodyBuilder(v:Ref<MgetRoomPathReqBodyBuilder>):MgetRoomPathReqBodyBuilder
	...
	export function emptyGetParticipantQualityListReqBuilder():GetParticipantQualityListReqBuilder
	export function emptyRefGetParticipantQualityListReqBuilder():Ref<GetParticipantQualityListReqBuilder>
	export function refOfGetParticipantQualityListReqBuilder(x:GetParticipantQualityListReqBuilder,v:Ref<GetParticipantQualityListReqBuilder>)
	export function unRefGetParticipantQualityListReqBuilder(v:Ref<GetParticipantQualityListReqBuilder>):GetParticipantQualityListReqBuilder
	...
	export function emptyParticipantListExportReqBodyBuilder():ParticipantListExportReqBodyBuilder
	export function emptyRefParticipantListExportReqBodyBuilder():Ref<ParticipantListExportReqBodyBuilder>
	export function refOfParticipantListExportReqBodyBuilder(x:ParticipantListExportReqBodyBuilder,v:Ref<ParticipantListExportReqBodyBuilder>)
	export function unRefParticipantListExportReqBodyBuilder(v:Ref<ParticipantListExportReqBodyBuilder>):ParticipantListExportReqBodyBuilder
	export function emptyMyAiAvPluginCardVaribalesBuilder():MyAiAvPluginCardVaribalesBuilder
	export function emptyRefMyAiAvPluginCardVaribalesBuilder():Ref<MyAiAvPluginCardVaribalesBuilder>
	export function refOfMyAiAvPluginCardVaribalesBuilder(x:MyAiAvPluginCardVaribalesBuilder,v:Ref<MyAiAvPluginCardVaribalesBuilder>)
	export function unRefMyAiAvPluginCardVaribalesBuilder(v:Ref<MyAiAvPluginCardVaribalesBuilder>):MyAiAvPluginCardVaribalesBuilder
	...
	export function emptyMyAiVcRoomRequestCommonParamBuilder():MyAiVcRoomRequestCommonParamBuilder
	export function emptyRefMyAiVcRoomRequestCommonParamBuilder():Ref<MyAiVcRoomRequestCommonParamBuilder>
	export function refOfMyAiVcRoomRequestCommonParamBuilder(x:MyAiVcRoomRequestCommonParamBuilder,v:Ref<MyAiVcRoomRequestCommonParamBuilder>)
	export function unRefMyAiVcRoomRequestCommonParamBuilder(v:Ref<MyAiVcRoomRequestCommonParamBuilder>):MyAiVcRoomRequestCommonParamBuilder
	...
	export function emptyApplyReserveReqBodyBuilder():ApplyReserveReqBodyBuilder
	export function emptyRefApplyReserveReqBodyBuilder():Ref<ApplyReserveReqBodyBuilder>
	export function refOfApplyReserveReqBodyBuilder(x:ApplyReserveReqBodyBuilder,v:Ref<ApplyReserveReqBodyBuilder>)
	export function unRefApplyReserveReqBodyBuilder(v:Ref<ApplyReserveReqBodyBuilder>):ApplyReserveReqBodyBuilder
	...
	export function emptyApprovalConfigEventBuilder():ApprovalConfigEventBuilder
	export function emptyRefApprovalConfigEventBuilder():Ref<ApprovalConfigEventBuilder>
	export function refOfApprovalConfigEventBuilder(x:ApprovalConfigEventBuilder,v:Ref<ApprovalConfigEventBuilder>)
	export function unRefApprovalConfigEventBuilder(v:Ref<ApprovalConfigEventBuilder>):ApprovalConfigEventBuilder
	...
	export function emptyOptionsBuilder():OptionsBuilder
	export function emptyRefOptionsBuilder():Ref<OptionsBuilder>
	export function refOfOptionsBuilder(x:OptionsBuilder,v:Ref<OptionsBuilder>)
	export function unRefOptionsBuilder(v:Ref<OptionsBuilder>):OptionsBuilder
	export function emptyPatchRoomLevelReqBuilder():PatchRoomLevelReqBuilder
	export function emptyRefPatchRoomLevelReqBuilder():Ref<PatchRoomLevelReqBuilder>
	export function refOfPatchRoomLevelReqBuilder(x:PatchRoomLevelReqBuilder,v:Ref<PatchRoomLevelReqBuilder>)
	export function unRefPatchRoomLevelReqBuilder(v:Ref<PatchRoomLevelReqBuilder>):PatchRoomLevelReqBuilder
	...
	export function emptyDelRoomLevelPathReqBodyBuilder():DelRoomLevelPathReqBodyBuilder
	export function emptyRefDelRoomLevelPathReqBodyBuilder():Ref<DelRoomLevelPathReqBodyBuilder>
	export function refOfDelRoomLevelPathReqBodyBuilder(x:DelRoomLevelPathReqBodyBuilder,v:Ref<DelRoomLevelPathReqBodyBuilder>)
	export function unRefDelRoomLevelPathReqBodyBuilder(v:Ref<DelRoomLevelPathReqBodyBuilder>):DelRoomLevelPathReqBodyBuilder
	export function emptyMyAiVcRoomScenarioContextBuilder():MyAiVcRoomScenarioContextBuilder
	export function emptyRefMyAiVcRoomScenarioContextBuilder():Ref<MyAiVcRoomScenarioContextBuilder>
	export function refOfMyAiVcRoomScenarioContextBuilder(x:MyAiVcRoomScenarioContextBuilder,v:Ref<MyAiVcRoomScenarioContextBuilder>)
	export function unRefMyAiVcRoomScenarioContextBuilder(v:Ref<MyAiVcRoomScenarioContextBuilder>):MyAiVcRoomScenarioContextBuilder
	...
	export function emptyMyAiSipPresentBuilder():MyAiSipPresentBuilder
	export function emptyRefMyAiSipPresentBuilder():Ref<MyAiSipPresentBuilder>
	export function refOfMyAiSipPresentBuilder(x:MyAiSipPresentBuilder,v:Ref<MyAiSipPresentBuilder>)
	export function unRefMyAiSipPresentBuilder(v:Ref<MyAiSipPresentBuilder>):MyAiSipPresentBuilder
	export function emptyMyAiVcRoomExtraBuilder():MyAiVcRoomExtraBuilder
	export function emptyRefMyAiVcRoomExtraBuilder():Ref<MyAiVcRoomExtraBuilder>
	export function refOfMyAiVcRoomExtraBuilder(x:MyAiVcRoomExtraBuilder,v:Ref<MyAiVcRoomExtraBuilder>)
	export function unRefMyAiVcRoomExtraBuilder(v:Ref<MyAiVcRoomExtraBuilder>):MyAiVcRoomExtraBuilder
	export function emptySearchRoomReqBodyBuilder():SearchRoomReqBodyBuilder
	export function emptyRefSearchRoomReqBodyBuilder():Ref<SearchRoomReqBodyBuilder>
	export function refOfSearchRoomReqBodyBuilder(x:SearchRoomReqBodyBuilder,v:Ref<SearchRoomReqBodyBuilder>)
	export function unRefSearchRoomReqBodyBuilder(v:Ref<SearchRoomReqBodyBuilder>):SearchRoomReqBodyBuilder
	...
	export function emptyContactBuilder():ContactBuilder
	export function emptyRefContactBuilder():Ref<ContactBuilder>
	export function refOfContactBuilder(x:ContactBuilder,v:Ref<ContactBuilder>)
	export function unRefContactBuilder(v:Ref<ContactBuilder>):ContactBuilder
	export function emptyMeetingWebinarSettingBuilder():MeetingWebinarSettingBuilder
	export function emptyRefMeetingWebinarSettingBuilder():Ref<MeetingWebinarSettingBuilder>
	export function refOfMeetingWebinarSettingBuilder(x:MeetingWebinarSettingBuilder,v:Ref<MeetingWebinarSettingBuilder>)
	export function unRefMeetingWebinarSettingBuilder(v:Ref<MeetingWebinarSettingBuilder>):MeetingWebinarSettingBuilder
	export function emptyMyAiAvPluginPresentInfoBuilder():MyAiAvPluginPresentInfoBuilder
	export function emptyRefMyAiAvPluginPresentInfoBuilder():Ref<MyAiAvPluginPresentInfoBuilder>
	export function refOfMyAiAvPluginPresentInfoBuilder(x:MyAiAvPluginPresentInfoBuilder,v:Ref<MyAiAvPluginPresentInfoBuilder>)
	export function unRefMyAiAvPluginPresentInfoBuilder(v:Ref<MyAiAvPluginPresentInfoBuilder>):MyAiAvPluginPresentInfoBuilder
	...
	export function emptyMyAiPluginContextBuilder():MyAiPluginContextBuilder
	export function emptyRefMyAiPluginContextBuilder():Ref<MyAiPluginContextBuilder>
	export function refOfMyAiPluginContextBuilder(x:MyAiPluginContextBuilder,v:Ref<MyAiPluginContextBuilder>)
	export function unRefMyAiPluginContextBuilder(v:Ref<MyAiPluginContextBuilder>):MyAiPluginContextBuilder
	...
	export function emptyRoomDigitalSignageMaterialBuilder():RoomDigitalSignageMaterialBuilder
	export function emptyRefRoomDigitalSignageMaterialBuilder():Ref<RoomDigitalSignageMaterialBuilder>
	export function refOfRoomDigitalSignageMaterialBuilder(x:RoomDigitalSignageMaterialBuilder,v:Ref<RoomDigitalSignageMaterialBuilder>)
	export function unRefRoomDigitalSignageMaterialBuilder(v:Ref<RoomDigitalSignageMaterialBuilder>):RoomDigitalSignageMaterialBuilder
	...
	export function emptyParticipantQualityListExportReqBuilder():ParticipantQualityListExportReqBuilder
	export function emptyRefParticipantQualityListExportReqBuilder():Ref<ParticipantQualityListExportReqBuilder>
	export function refOfParticipantQualityListExportReqBuilder(x:ParticipantQualityListExportReqBuilder,v:Ref<ParticipantQualityListExportReqBuilder>)
	export function unRefParticipantQualityListExportReqBuilder(v:Ref<ParticipantQualityListExportReqBuilder>):ParticipantQualityListExportReqBuilder
	...
	export function emptyMyAiObjectContextBuilder():MyAiObjectContextBuilder
	export function emptyRefMyAiObjectContextBuilder():Ref<MyAiObjectContextBuilder>
	export function refOfMyAiObjectContextBuilder(x:MyAiObjectContextBuilder,v:Ref<MyAiObjectContextBuilder>)
	export function unRefMyAiObjectContextBuilder(v:Ref<MyAiObjectContextBuilder>):MyAiObjectContextBuilder
	export function emptyQualityAudioBuilder():QualityAudioBuilder
	export function emptyRefQualityAudioBuilder():Ref<QualityAudioBuilder>
	export function refOfQualityAudioBuilder(x:QualityAudioBuilder,v:Ref<QualityAudioBuilder>)
	export function unRefQualityAudioBuilder(v:Ref<QualityAudioBuilder>):QualityAudioBuilder
	...
	export function emptySetCheckboardAccessCodeRoomConfigReqBuilder():SetCheckboardAccessCodeRoomConfigReqBuilder
	export function emptyRefSetCheckboardAccessCodeRoomConfigReqBuilder():Ref<SetCheckboardAccessCodeRoomConfigReqBuilder>
	export function refOfSetCheckboardAccessCodeRoomConfigReqBuilder(x:SetCheckboardAccessCodeRoomConfigReqBuilder,v:Ref<SetCheckboardAccessCodeRoomConfigReqBuilder>)
	export function unRefSetCheckboardAccessCodeRoomConfigReqBuilder(v:Ref<SetCheckboardAccessCodeRoomConfigReqBuilder>):SetCheckboardAccessCodeRoomConfigReqBuilder
	...
	export function emptyReserveAssignHostBuilder():ReserveAssignHostBuilder
	export function emptyRefReserveAssignHostBuilder():Ref<ReserveAssignHostBuilder>
	export function refOfReserveAssignHostBuilder(x:ReserveAssignHostBuilder,v:Ref<ReserveAssignHostBuilder>)
	export function unRefReserveAssignHostBuilder(v:Ref<ReserveAssignHostBuilder>):ReserveAssignHostBuilder
	...
	export function emptyMeetingListExportPathReqBodyBuilder():MeetingListExportPathReqBodyBuilder
	export function emptyRefMeetingListExportPathReqBodyBuilder():Ref<MeetingListExportPathReqBodyBuilder>
	export function refOfMeetingListExportPathReqBodyBuilder(x:MeetingListExportPathReqBodyBuilder,v:Ref<MeetingListExportPathReqBodyBuilder>)
	export function unRefMeetingListExportPathReqBodyBuilder(v:Ref<MeetingListExportPathReqBodyBuilder>):MeetingListExportPathReqBodyBuilder
	...
	export function emptyRoomDigitalSignageBuilder():RoomDigitalSignageBuilder
	export function emptyRefRoomDigitalSignageBuilder():Ref<RoomDigitalSignageBuilder>
	export function refOfRoomDigitalSignageBuilder(x:RoomDigitalSignageBuilder,v:Ref<RoomDigitalSignageBuilder>)
	export function unRefRoomDigitalSignageBuilder(v:Ref<RoomDigitalSignageBuilder>):RoomDigitalSignageBuilder
	export function emptySetHostMeetingPathReqBodyBuilder():SetHostMeetingPathReqBodyBuilder
	export function emptyRefSetHostMeetingPathReqBodyBuilder():Ref<SetHostMeetingPathReqBodyBuilder>
	export function refOfSetHostMeetingPathReqBodyBuilder(x:SetHostMeetingPathReqBodyBuilder,v:Ref<SetHostMeetingPathReqBodyBuilder>)
	export function unRefSetHostMeetingPathReqBodyBuilder(v:Ref<SetHostMeetingPathReqBodyBuilder>):SetHostMeetingPathReqBodyBuilder
	...
	export function emptyMyAiAvPluginContextSystemInfoBuilder():MyAiAvPluginContextSystemInfoBuilder
	export function emptyRefMyAiAvPluginContextSystemInfoBuilder():Ref<MyAiAvPluginContextSystemInfoBuilder>
	export function refOfMyAiAvPluginContextSystemInfoBuilder(x:MyAiAvPluginContextSystemInfoBuilder,v:Ref<MyAiAvPluginContextSystemInfoBuilder>)
	export function unRefMyAiAvPluginContextSystemInfoBuilder(v:Ref<MyAiAvPluginContextSystemInfoBuilder>):MyAiAvPluginContextSystemInfoBuilder
	...
	export function emptyGetResourceReservationListReqBuilder():GetResourceReservationListReqBuilder
	export function emptyRefGetResourceReservationListReqBuilder():Ref<GetResourceReservationListReqBuilder>
	export function refOfGetResourceReservationListReqBuilder(x:GetResourceReservationListReqBuilder,v:Ref<GetResourceReservationListReqBuilder>)
	export function unRefGetResourceReservationListReqBuilder(v:Ref<GetResourceReservationListReqBuilder>):GetResourceReservationListReqBuilder
	export function emptyMyAiAvPluginUploadObjectBuilder():MyAiAvPluginUploadObjectBuilder
	export function emptyRefMyAiAvPluginUploadObjectBuilder():Ref<MyAiAvPluginUploadObjectBuilder>
	export function refOfMyAiAvPluginUploadObjectBuilder(x:MyAiAvPluginUploadObjectBuilder,v:Ref<MyAiAvPluginUploadObjectBuilder>)
	export function unRefMyAiAvPluginUploadObjectBuilder(v:Ref<MyAiAvPluginUploadObjectBuilder>):MyAiAvPluginUploadObjectBuilder
	...
	export function emptyDeleteRoomReqBuilder():DeleteRoomReqBuilder
	export function emptyRefDeleteRoomReqBuilder():Ref<DeleteRoomReqBuilder>
	export function refOfDeleteRoomReqBuilder(x:DeleteRoomReqBuilder,v:Ref<DeleteRoomReqBuilder>)
	export function unRefDeleteRoomReqBuilder(v:Ref<DeleteRoomReqBuilder>):DeleteRoomReqBuilder
	...
	export function emptyMeetingInfoBuilder():MeetingInfoBuilder
	export function emptyRefMeetingInfoBuilder():Ref<MeetingInfoBuilder>
	export function refOfMeetingInfoBuilder(x:MeetingInfoBuilder,v:Ref<MeetingInfoBuilder>)
	export function unRefMeetingInfoBuilder(v:Ref<MeetingInfoBuilder>):MeetingInfoBuilder
	...
	export function emptyPatchReserveConfigPathReqBodyBuilder():PatchReserveConfigPathReqBodyBuilder
	export function emptyRefPatchReserveConfigPathReqBodyBuilder():Ref<PatchReserveConfigPathReqBodyBuilder>
	export function refOfPatchReserveConfigPathReqBodyBuilder(x:PatchReserveConfigPathReqBodyBuilder,v:Ref<PatchReserveConfigPathReqBodyBuilder>)
	export function unRefPatchReserveConfigPathReqBodyBuilder(v:Ref<PatchReserveConfigPathReqBodyBuilder>):PatchReserveConfigPathReqBodyBuilder
	...
	export function emptyMgetRoomReqBodyBuilder():MgetRoomReqBodyBuilder
	export function emptyRefMgetRoomReqBodyBuilder():Ref<MgetRoomReqBodyBuilder>
	export function refOfMgetRoomReqBodyBuilder(x:MgetRoomReqBodyBuilder,v:Ref<MgetRoomReqBodyBuilder>)
	export function unRefMgetRoomReqBodyBuilder(v:Ref<MgetRoomReqBodyBuilder>):MgetRoomReqBodyBuilder
	...
	export function emptyGetRoomReqBuilder():GetRoomReqBuilder
	export function emptyRefGetRoomReqBuilder():Ref<GetRoomReqBuilder>
	export function refOfGetRoomReqBuilder(x:GetRoomReqBuilder,v:Ref<GetRoomReqBuilder>)
	export function unRefGetRoomReqBuilder(v:Ref<GetRoomReqBuilder>):GetRoomReqBuilder
	...
	export function emptyPatchReserveConfigFormReqBodyBuilder():PatchReserveConfigFormReqBodyBuilder
	export function emptyRefPatchReserveConfigFormReqBodyBuilder():Ref<PatchReserveConfigFormReqBodyBuilder>
	export function refOfPatchReserveConfigFormReqBodyBuilder(x:PatchReserveConfigFormReqBodyBuilder,v:Ref<PatchReserveConfigFormReqBodyBuilder>)
	export function unRefPatchReserveConfigFormReqBodyBuilder(v:Ref<PatchReserveConfigFormReqBodyBuilder>):PatchReserveConfigFormReqBodyBuilder
	export function emptyQualityCpuUsageBuilder():QualityCpuUsageBuilder
	export function emptyRefQualityCpuUsageBuilder():Ref<QualityCpuUsageBuilder>
	export function refOfQualityCpuUsageBuilder(x:QualityCpuUsageBuilder,v:Ref<QualityCpuUsageBuilder>)
	export function unRefQualityCpuUsageBuilder(v:Ref<QualityCpuUsageBuilder>):QualityCpuUsageBuilder
	...
	export function emptyP2MeetingJoinMeetingV1Handler():P2MeetingJoinMeetingV1Handler
	export function emptyRefP2MeetingJoinMeetingV1Handler():Ref<P2MeetingJoinMeetingV1Handler>
	export function refOfP2MeetingJoinMeetingV1Handler(x:P2MeetingJoinMeetingV1Handler,v:Ref<P2MeetingJoinMeetingV1Handler>)
	export function unRefP2MeetingJoinMeetingV1Handler(v:Ref<P2MeetingJoinMeetingV1Handler>):P2MeetingJoinMeetingV1Handler
	...
	export function emptyReserveActionPermissionBuilder():ReserveActionPermissionBuilder
	export function emptyRefReserveActionPermissionBuilder():Ref<ReserveActionPermissionBuilder>
	export function refOfReserveActionPermissionBuilder(x:ReserveActionPermissionBuilder,v:Ref<ReserveActionPermissionBuilder>)
	export function unRefReserveActionPermissionBuilder(v:Ref<ReserveActionPermissionBuilder>):ReserveActionPermissionBuilder
	export function emptyStopMeetingRecordingReqBuilder():StopMeetingRecordingReqBuilder
	export function emptyRefStopMeetingRecordingReqBuilder():Ref<StopMeetingRecordingReqBuilder>
	export function refOfStopMeetingRecordingReqBuilder(x:StopMeetingRecordingReqBuilder,v:Ref<StopMeetingRecordingReqBuilder>)
	export function unRefStopMeetingRecordingReqBuilder(v:Ref<StopMeetingRecordingReqBuilder>):StopMeetingRecordingReqBuilder
	...
	export function emptyMyAiVcMeetingSuggestQuestionResultBuilder():MyAiVcMeetingSuggestQuestionResultBuilder
	export function emptyRefMyAiVcMeetingSuggestQuestionResultBuilder():Ref<MyAiVcMeetingSuggestQuestionResultBuilder>
	export function refOfMyAiVcMeetingSuggestQuestionResultBuilder(x:MyAiVcMeetingSuggestQuestionResultBuilder,v:Ref<MyAiVcMeetingSuggestQuestionResultBuilder>)
	export function unRefMyAiVcMeetingSuggestQuestionResultBuilder(v:Ref<MyAiVcMeetingSuggestQuestionResultBuilder>):MyAiVcMeetingSuggestQuestionResultBuilder
	export function emptySetRoomAccessCodeRoomConfigPathReqBodyBuilder():SetRoomAccessCodeRoomConfigPathReqBodyBuilder
	export function emptyRefSetRoomAccessCodeRoomConfigPathReqBodyBuilder():Ref<SetRoomAccessCodeRoomConfigPathReqBodyBuilder>
	export function refOfSetRoomAccessCodeRoomConfigPathReqBodyBuilder(x:SetRoomAccessCodeRoomConfigPathReqBodyBuilder,v:Ref<SetRoomAccessCodeRoomConfigPathReqBodyBuilder>)
	export function unRefSetRoomAccessCodeRoomConfigPathReqBodyBuilder(v:Ref<SetRoomAccessCodeRoomConfigPathReqBodyBuilder>):SetRoomAccessCodeRoomConfigPathReqBodyBuilder
	...
	export function emptyReserveScopeReserveConfigReqBuilder():ReserveScopeReserveConfigReqBuilder
	export function emptyRefReserveScopeReserveConfigReqBuilder():Ref<ReserveScopeReserveConfigReqBuilder>
	export function refOfReserveScopeReserveConfigReqBuilder(x:ReserveScopeReserveConfigReqBuilder,v:Ref<ReserveScopeReserveConfigReqBuilder>)
	export function unRefReserveScopeReserveConfigReqBuilder(v:Ref<ReserveScopeReserveConfigReqBuilder>):ReserveScopeReserveConfigReqBuilder
	...
	export function emptyMaterialDeleteResultBuilder():MaterialDeleteResultBuilder
	export function emptyRefMaterialDeleteResultBuilder():Ref<MaterialDeleteResultBuilder>
	export function refOfMaterialDeleteResultBuilder(x:MaterialDeleteResultBuilder,v:Ref<MaterialDeleteResultBuilder>)
	export function unRefMaterialDeleteResultBuilder(v:Ref<MaterialDeleteResultBuilder>):MaterialDeleteResultBuilder
	...
	export function emptyP2RoomUpdatedV1Handler():P2RoomUpdatedV1Handler
	export function emptyRefP2RoomUpdatedV1Handler():Ref<P2RoomUpdatedV1Handler>
	export function refOfP2RoomUpdatedV1Handler(x:P2RoomUpdatedV1Handler,v:Ref<P2RoomUpdatedV1Handler>)
	export function unRefP2RoomUpdatedV1Handler(v:Ref<P2RoomUpdatedV1Handler>):P2RoomUpdatedV1Handler
	export function emptyGetRoomLevelReqBuilder():GetRoomLevelReqBuilder
	export function emptyRefGetRoomLevelReqBuilder():Ref<GetRoomLevelReqBuilder>
	export function refOfGetRoomLevelReqBuilder(x:GetRoomLevelReqBuilder,v:Ref<GetRoomLevelReqBuilder>)
	export function unRefGetRoomLevelReqBuilder(v:Ref<GetRoomLevelReqBuilder>):GetRoomLevelReqBuilder
	...
	export function emptyMyAiVcMeetingContentCommonResultBuilder():MyAiVcMeetingContentCommonResultBuilder
	export function emptyRefMyAiVcMeetingContentCommonResultBuilder():Ref<MyAiVcMeetingContentCommonResultBuilder>
	export function refOfMyAiVcMeetingContentCommonResultBuilder(x:MyAiVcMeetingContentCommonResultBuilder,v:Ref<MyAiVcMeetingContentCommonResultBuilder>)
	export function unRefMyAiVcMeetingContentCommonResultBuilder(v:Ref<MyAiVcMeetingContentCommonResultBuilder>):MyAiVcMeetingContentCommonResultBuilder
	...
	export function emptyDeleteReserveReqBuilder():DeleteReserveReqBuilder
	export function emptyRefDeleteReserveReqBuilder():Ref<DeleteReserveReqBuilder>
	export function refOfDeleteReserveReqBuilder(x:DeleteReserveReqBuilder,v:Ref<DeleteReserveReqBuilder>)
	export function unRefDeleteReserveReqBuilder(v:Ref<DeleteReserveReqBuilder>):DeleteReserveReqBuilder
	...
	export function emptyReserveCalleeBuilder():ReserveCalleeBuilder
	export function emptyRefReserveCalleeBuilder():Ref<ReserveCalleeBuilder>
	export function refOfReserveCalleeBuilder(x:ReserveCalleeBuilder,v:Ref<ReserveCalleeBuilder>)
	export function unRefReserveCalleeBuilder(v:Ref<ReserveCalleeBuilder>):ReserveCalleeBuilder
	...
	export function emptyDelRoomLevelReqBuilder():DelRoomLevelReqBuilder
	export function emptyRefDelRoomLevelReqBuilder():Ref<DelRoomLevelReqBuilder>
	export function refOfDelRoomLevelReqBuilder(x:DelRoomLevelReqBuilder,v:Ref<DelRoomLevelReqBuilder>)
	export function unRefDelRoomLevelReqBuilder(v:Ref<DelRoomLevelReqBuilder>):DelRoomLevelReqBuilder
	export function emptyInviteMeetingPathReqBodyBuilder():InviteMeetingPathReqBodyBuilder
	export function emptyRefInviteMeetingPathReqBodyBuilder():Ref<InviteMeetingPathReqBodyBuilder>
	export function refOfInviteMeetingPathReqBodyBuilder(x:InviteMeetingPathReqBodyBuilder,v:Ref<InviteMeetingPathReqBodyBuilder>)
	export function unRefInviteMeetingPathReqBodyBuilder(v:Ref<InviteMeetingPathReqBodyBuilder>):InviteMeetingPathReqBodyBuilder
	export function emptyMyAiSipCardVariablesBuilder():MyAiSipCardVariablesBuilder
	export function emptyRefMyAiSipCardVariablesBuilder():Ref<MyAiSipCardVariablesBuilder>
	export function refOfMyAiSipCardVariablesBuilder(x:MyAiSipCardVariablesBuilder,v:Ref<MyAiSipCardVariablesBuilder>)
	export function unRefMyAiSipCardVariablesBuilder(v:Ref<MyAiSipCardVariablesBuilder>):MyAiSipCardVariablesBuilder
	export function emptyP2MeetingRecordingStartedV1Handler():P2MeetingRecordingStartedV1Handler
	export function emptyRefP2MeetingRecordingStartedV1Handler():Ref<P2MeetingRecordingStartedV1Handler>
	export function refOfP2MeetingRecordingStartedV1Handler(x:P2MeetingRecordingStartedV1Handler,v:Ref<P2MeetingRecordingStartedV1Handler>)
	export function unRefP2MeetingRecordingStartedV1Handler(v:Ref<P2MeetingRecordingStartedV1Handler>):P2MeetingRecordingStartedV1Handler
	export function emptyPatchReserveConfigDisableInformPathReqBodyBuilder():PatchReserveConfigDisableInformPathReqBodyBuilder
	export function emptyRefPatchReserveConfigDisableInformPathReqBodyBuilder():Ref<PatchReserveConfigDisableInformPathReqBodyBuilder>
	export function refOfPatchReserveConfigDisableInformPathReqBodyBuilder(x:PatchReserveConfigDisableInformPathReqBodyBuilder,v:Ref<PatchReserveConfigDisableInformPathReqBodyBuilder>)
	export function unRefPatchReserveConfigDisableInformPathReqBodyBuilder(v:Ref<PatchReserveConfigDisableInformPathReqBodyBuilder>):PatchReserveConfigDisableInformPathReqBodyBuilder
	...
	export function emptyParticipantBuilder():ParticipantBuilder
	export function emptyRefParticipantBuilder():Ref<ParticipantBuilder>
	export function refOfParticipantBuilder(x:ParticipantBuilder,v:Ref<ParticipantBuilder>)
	export function unRefParticipantBuilder(v:Ref<ParticipantBuilder>):ParticipantBuilder
	export function emptySetRoomAccessCodeRoomConfigReqBuilder():SetRoomAccessCodeRoomConfigReqBuilder
	export function emptyRefSetRoomAccessCodeRoomConfigReqBuilder():Ref<SetRoomAccessCodeRoomConfigReqBuilder>
	export function refOfSetRoomAccessCodeRoomConfigReqBuilder(x:SetRoomAccessCodeRoomConfigReqBuilder,v:Ref<SetRoomAccessCodeRoomConfigReqBuilder>)
	export function unRefSetRoomAccessCodeRoomConfigReqBuilder(v:Ref<SetRoomAccessCodeRoomConfigReqBuilder>):SetRoomAccessCodeRoomConfigReqBuilder
	export function emptySetRoomConfigPathReqBodyBuilder():SetRoomConfigPathReqBodyBuilder
	export function emptyRefSetRoomConfigPathReqBodyBuilder():Ref<SetRoomConfigPathReqBodyBuilder>
	export function refOfSetRoomConfigPathReqBodyBuilder(x:SetRoomConfigPathReqBodyBuilder,v:Ref<SetRoomConfigPathReqBodyBuilder>)
	export function unRefSetRoomConfigPathReqBodyBuilder(v:Ref<SetRoomConfigPathReqBodyBuilder>):SetRoomConfigPathReqBodyBuilder
	export function emptyListRoomLevelReqBuilder():ListRoomLevelReqBuilder
	export function emptyRefListRoomLevelReqBuilder():Ref<ListRoomLevelReqBuilder>
	export function refOfListRoomLevelReqBuilder(x:ListRoomLevelReqBuilder,v:Ref<ListRoomLevelReqBuilder>)
	export function unRefListRoomLevelReqBuilder(v:Ref<ListRoomLevelReqBuilder>):ListRoomLevelReqBuilder
	export function emptyDepartmentId():DepartmentId
	export function emptyRefDepartmentId():Ref<DepartmentId>
	export function refOfDepartmentId(x:DepartmentId,v:Ref<DepartmentId>)
	export function unRefDepartmentId(v:Ref<DepartmentId>):DepartmentId
	export function emptyP2MeetingShareStartedV1Handler():P2MeetingShareStartedV1Handler
	export function emptyRefP2MeetingShareStartedV1Handler():Ref<P2MeetingShareStartedV1Handler>
	export function refOfP2MeetingShareStartedV1Handler(x:P2MeetingShareStartedV1Handler,v:Ref<P2MeetingShareStartedV1Handler>)
	export function unRefP2MeetingShareStartedV1Handler(v:Ref<P2MeetingShareStartedV1Handler>):P2MeetingShareStartedV1Handler
	export function emptyQueryRoomConfigReqBuilder():QueryRoomConfigReqBuilder
	export function emptyRefQueryRoomConfigReqBuilder():Ref<QueryRoomConfigReqBuilder>
	export function refOfQueryRoomConfigReqBuilder(x:QueryRoomConfigReqBuilder,v:Ref<QueryRoomConfigReqBuilder>)
	export function unRefQueryRoomConfigReqBuilder(v:Ref<QueryRoomConfigReqBuilder>):QueryRoomConfigReqBuilder
	...
	export function emptyMgetRoomReqBuilder():MgetRoomReqBuilder
	export function emptyRefMgetRoomReqBuilder():Ref<MgetRoomReqBuilder>
	export function refOfMgetRoomReqBuilder(x:MgetRoomReqBuilder,v:Ref<MgetRoomReqBuilder>)
	export function unRefMgetRoomReqBuilder(v:Ref<MgetRoomReqBuilder>):MgetRoomReqBuilder
	...
	export function emptySetHostMeetingReqBuilder():SetHostMeetingReqBuilder
	export function emptyRefSetHostMeetingReqBuilder():Ref<SetHostMeetingReqBuilder>
	export function refOfSetHostMeetingReqBuilder(x:SetHostMeetingReqBuilder,v:Ref<SetHostMeetingReqBuilder>)
	export function unRefSetHostMeetingReqBuilder(v:Ref<SetHostMeetingReqBuilder>):SetHostMeetingReqBuilder
	...
	export function emptyP2MeetingAllMeetingStartedV1Handler():P2MeetingAllMeetingStartedV1Handler
	export function emptyRefP2MeetingAllMeetingStartedV1Handler():Ref<P2MeetingAllMeetingStartedV1Handler>
	export function refOfP2MeetingAllMeetingStartedV1Handler(x:P2MeetingAllMeetingStartedV1Handler,v:Ref<P2MeetingAllMeetingStartedV1Handler>)
	export function unRefP2MeetingAllMeetingStartedV1Handler(v:Ref<P2MeetingAllMeetingStartedV1Handler>):P2MeetingAllMeetingStartedV1Handler
	export function emptyP2ReserveConfigUpdatedV1Handler():P2ReserveConfigUpdatedV1Handler
	export function emptyRefP2ReserveConfigUpdatedV1Handler():Ref<P2ReserveConfigUpdatedV1Handler>
	export function refOfP2ReserveConfigUpdatedV1Handler(x:P2ReserveConfigUpdatedV1Handler,v:Ref<P2ReserveConfigUpdatedV1Handler>)
	export function unRefP2ReserveConfigUpdatedV1Handler(v:Ref<P2ReserveConfigUpdatedV1Handler>):P2ReserveConfigUpdatedV1Handler
	export function emptyPatchReserveConfigDisableInformReqBodyBuilder():PatchReserveConfigDisableInformReqBodyBuilder
	export function emptyRefPatchReserveConfigDisableInformReqBodyBuilder():Ref<PatchReserveConfigDisableInformReqBodyBuilder>
	export function refOfPatchReserveConfigDisableInformReqBodyBuilder(x:PatchReserveConfigDisableInformReqBodyBuilder,v:Ref<PatchReserveConfigDisableInformReqBodyBuilder>)
	export function unRefPatchReserveConfigDisableInformReqBodyBuilder(v:Ref<PatchReserveConfigDisableInformReqBodyBuilder>):PatchReserveConfigDisableInformReqBodyBuilder
	...
	export function emptyMyAiVcMeetingScenarioContextBuilder():MyAiVcMeetingScenarioContextBuilder
	export function emptyRefMyAiVcMeetingScenarioContextBuilder():Ref<MyAiVcMeetingScenarioContextBuilder>
	export function refOfMyAiVcMeetingScenarioContextBuilder(x:MyAiVcMeetingScenarioContextBuilder,v:Ref<MyAiVcMeetingScenarioContextBuilder>)
	export function unRefMyAiVcMeetingScenarioContextBuilder(v:Ref<MyAiVcMeetingScenarioContextBuilder>):MyAiVcMeetingScenarioContextBuilder
	export function emptyReportTopUserBuilder():ReportTopUserBuilder
	export function emptyRefReportTopUserBuilder():Ref<ReportTopUserBuilder>
	export function refOfReportTopUserBuilder(x:ReportTopUserBuilder,v:Ref<ReportTopUserBuilder>)
	export function unRefReportTopUserBuilder(v:Ref<ReportTopUserBuilder>):ReportTopUserBuilder
	export function emptyRoomBuilder():RoomBuilder
	export function emptyRefRoomBuilder():Ref<RoomBuilder>
	export function refOfRoomBuilder(x:RoomBuilder,v:Ref<RoomBuilder>)
	export function unRefRoomBuilder(v:Ref<RoomBuilder>):RoomBuilder
	...
	export function emptyMeetingRecordingBuilder():MeetingRecordingBuilder
	export function emptyRefMeetingRecordingBuilder():Ref<MeetingRecordingBuilder>
	export function refOfMeetingRecordingBuilder(x:MeetingRecordingBuilder,v:Ref<MeetingRecordingBuilder>)
	export function unRefMeetingRecordingBuilder(v:Ref<MeetingRecordingBuilder>):MeetingRecordingBuilder
	...
	export function emptyListAlertReqBuilder():ListAlertReqBuilder
	export function emptyRefListAlertReqBuilder():Ref<ListAlertReqBuilder>
	export function refOfListAlertReqBuilder(x:ListAlertReqBuilder,v:Ref<ListAlertReqBuilder>)
	export function unRefListAlertReqBuilder(v:Ref<ListAlertReqBuilder>):ListAlertReqBuilder
	...
	export function emptyReserveCorrectionCheckInfoBuilder():ReserveCorrectionCheckInfoBuilder
	export function emptyRefReserveCorrectionCheckInfoBuilder():Ref<ReserveCorrectionCheckInfoBuilder>
	export function refOfReserveCorrectionCheckInfoBuilder(x:ReserveCorrectionCheckInfoBuilder,v:Ref<ReserveCorrectionCheckInfoBuilder>)
	export function unRefReserveCorrectionCheckInfoBuilder(v:Ref<ReserveCorrectionCheckInfoBuilder>):ReserveCorrectionCheckInfoBuilder
	export function emptySearchRoomLevelReqBuilder():SearchRoomLevelReqBuilder
	export function emptyRefSearchRoomLevelReqBuilder():Ref<SearchRoomLevelReqBuilder>
	export function refOfSearchRoomLevelReqBuilder(x:SearchRoomLevelReqBuilder,v:Ref<SearchRoomLevelReqBuilder>)
	export function unRefSearchRoomLevelReqBuilder(v:Ref<SearchRoomLevelReqBuilder>):SearchRoomLevelReqBuilder
	export function emptySearchRoomReqBuilder():SearchRoomReqBuilder
	export function emptyRefSearchRoomReqBuilder():Ref<SearchRoomReqBuilder>
	export function refOfSearchRoomReqBuilder(x:SearchRoomReqBuilder,v:Ref<SearchRoomReqBuilder>)
	export function unRefSearchRoomReqBuilder(v:Ref<SearchRoomReqBuilder>):SearchRoomReqBuilder
	export function emptyInviteMeetingReqBuilder():InviteMeetingReqBuilder
	export function emptyRefInviteMeetingReqBuilder():Ref<InviteMeetingReqBuilder>
	export function refOfInviteMeetingReqBuilder(x:InviteMeetingReqBuilder,v:Ref<InviteMeetingReqBuilder>)
	export function unRefInviteMeetingReqBuilder(v:Ref<InviteMeetingReqBuilder>):InviteMeetingReqBuilder
	export function emptyMeetingParticipantResultBuilder():MeetingParticipantResultBuilder
	export function emptyRefMeetingParticipantResultBuilder():Ref<MeetingParticipantResultBuilder>
	export function refOfMeetingParticipantResultBuilder(x:MeetingParticipantResultBuilder,v:Ref<MeetingParticipantResultBuilder>)
	export function unRefMeetingParticipantResultBuilder(v:Ref<MeetingParticipantResultBuilder>):MeetingParticipantResultBuilder
	export function emptyMgetRoomLevelPathReqBodyBuilder():MgetRoomLevelPathReqBodyBuilder
	export function emptyRefMgetRoomLevelPathReqBodyBuilder():Ref<MgetRoomLevelPathReqBodyBuilder>
	export function refOfMgetRoomLevelPathReqBodyBuilder(x:MgetRoomLevelPathReqBodyBuilder,v:Ref<MgetRoomLevelPathReqBodyBuilder>)
	export function unRefMgetRoomLevelPathReqBodyBuilder(v:Ref<MgetRoomLevelPathReqBodyBuilder>):MgetRoomLevelPathReqBodyBuilder
	...
	export function emptyP2RoomLevelCreatedV1Handler():P2RoomLevelCreatedV1Handler
	export function emptyRefP2RoomLevelCreatedV1Handler():Ref<P2RoomLevelCreatedV1Handler>
	export function refOfP2RoomLevelCreatedV1Handler(x:P2RoomLevelCreatedV1Handler,v:Ref<P2RoomLevelCreatedV1Handler>)
	export function unRefP2RoomLevelCreatedV1Handler(v:Ref<P2RoomLevelCreatedV1Handler>):P2RoomLevelCreatedV1Handler
	...
	export function emptyReserveScopeConfigEventBuilder():ReserveScopeConfigEventBuilder
	export function emptyRefReserveScopeConfigEventBuilder():Ref<ReserveScopeConfigEventBuilder>
	export function refOfReserveScopeConfigEventBuilder(x:ReserveScopeConfigEventBuilder,v:Ref<ReserveScopeConfigEventBuilder>)
	export function unRefReserveScopeConfigEventBuilder(v:Ref<ReserveScopeConfigEventBuilder>):ReserveScopeConfigEventBuilder
	export function emptyMeetingEventUserBuilder():MeetingEventUserBuilder
	export function emptyRefMeetingEventUserBuilder():Ref<MeetingEventUserBuilder>
	export function refOfMeetingEventUserBuilder(x:MeetingEventUserBuilder,v:Ref<MeetingEventUserBuilder>)
	export function unRefMeetingEventUserBuilder(v:Ref<MeetingEventUserBuilder>):MeetingEventUserBuilder
	...
	export function emptyRoomMeetingReservationBuilder():RoomMeetingReservationBuilder
	export function emptyRefRoomMeetingReservationBuilder():Ref<RoomMeetingReservationBuilder>
	export function refOfRoomMeetingReservationBuilder(x:RoomMeetingReservationBuilder,v:Ref<RoomMeetingReservationBuilder>)
	export function unRefRoomMeetingReservationBuilder(v:Ref<RoomMeetingReservationBuilder>):RoomMeetingReservationBuilder
	export function emptyPatchReserveConfigAdminReqBuilder():PatchReserveConfigAdminReqBuilder
	export function emptyRefPatchReserveConfigAdminReqBuilder():Ref<PatchReserveConfigAdminReqBuilder>
	export function refOfPatchReserveConfigAdminReqBuilder(x:PatchReserveConfigAdminReqBuilder,v:Ref<PatchReserveConfigAdminReqBuilder>)
	export function unRefPatchReserveConfigAdminReqBuilder(v:Ref<PatchReserveConfigAdminReqBuilder>):PatchReserveConfigAdminReqBuilder
	...
	export function emptyMyAiVcMeetingExtraBuilder():MyAiVcMeetingExtraBuilder
	export function emptyRefMyAiVcMeetingExtraBuilder():Ref<MyAiVcMeetingExtraBuilder>
	export function refOfMyAiVcMeetingExtraBuilder(x:MyAiVcMeetingExtraBuilder,v:Ref<MyAiVcMeetingExtraBuilder>)
	export function unRefMyAiVcMeetingExtraBuilder(v:Ref<MyAiVcMeetingExtraBuilder>):MyAiVcMeetingExtraBuilder
	...
	export function emptyParticipantListExportReqBuilder():ParticipantListExportReqBuilder
	export function emptyRefParticipantListExportReqBuilder():Ref<ParticipantListExportReqBuilder>
	export function refOfParticipantListExportReqBuilder(x:ParticipantListExportReqBuilder,v:Ref<ParticipantListExportReqBuilder>)
	export function unRefParticipantListExportReqBuilder(v:Ref<ParticipantListExportReqBuilder>):ParticipantListExportReqBuilder
	export function emptyReserveScopeConfigBuilder():ReserveScopeConfigBuilder
	export function emptyRefReserveScopeConfigBuilder():Ref<ReserveScopeConfigBuilder>
	export function refOfReserveScopeConfigBuilder(x:ReserveScopeConfigBuilder,v:Ref<ReserveScopeConfigBuilder>)
	export function unRefReserveScopeConfigBuilder(v:Ref<ReserveScopeConfigBuilder>):ReserveScopeConfigBuilder
	...
	export function emptyP2MeetingRecordingReadyV1Handler():P2MeetingRecordingReadyV1Handler
	export function emptyRefP2MeetingRecordingReadyV1Handler():Ref<P2MeetingRecordingReadyV1Handler>
	export function refOfP2MeetingRecordingReadyV1Handler(x:P2MeetingRecordingReadyV1Handler,v:Ref<P2MeetingRecordingReadyV1Handler>)
	export function unRefP2MeetingRecordingReadyV1Handler(v:Ref<P2MeetingRecordingReadyV1Handler>):P2MeetingRecordingReadyV1Handler
	...
	export function emptySubscribeUserBuilder():SubscribeUserBuilder
	export function emptyRefSubscribeUserBuilder():Ref<SubscribeUserBuilder>
	export function refOfSubscribeUserBuilder(x:SubscribeUserBuilder,v:Ref<SubscribeUserBuilder>)
	export function unRefSubscribeUserBuilder(v:Ref<SubscribeUserBuilder>):SubscribeUserBuilder
	...
	export function emptyMyAiVcMeetingTodoTaskResultBuilder():MyAiVcMeetingTodoTaskResultBuilder
	export function emptyRefMyAiVcMeetingTodoTaskResultBuilder():Ref<MyAiVcMeetingTodoTaskResultBuilder>
	export function refOfMyAiVcMeetingTodoTaskResultBuilder(x:MyAiVcMeetingTodoTaskResultBuilder,v:Ref<MyAiVcMeetingTodoTaskResultBuilder>)
	export function unRefMyAiVcMeetingTodoTaskResultBuilder(v:Ref<MyAiVcMeetingTodoTaskResultBuilder>):MyAiVcMeetingTodoTaskResultBuilder
	...
	export function emptyReservePermissionCheckerBuilder():ReservePermissionCheckerBuilder
	export function emptyRefReservePermissionCheckerBuilder():Ref<ReservePermissionCheckerBuilder>
	export function refOfReservePermissionCheckerBuilder(x:ReservePermissionCheckerBuilder,v:Ref<ReservePermissionCheckerBuilder>)
	export function unRefReservePermissionCheckerBuilder(v:Ref<ReservePermissionCheckerBuilder>):ReservePermissionCheckerBuilder
	...
	export function emptyUpdateReserveReqBodyBuilder():UpdateReserveReqBodyBuilder
	export function emptyRefUpdateReserveReqBodyBuilder():Ref<UpdateReserveReqBodyBuilder>
	export function refOfUpdateReserveReqBodyBuilder(x:UpdateReserveReqBodyBuilder,v:Ref<UpdateReserveReqBodyBuilder>)
	export function unRefUpdateReserveReqBodyBuilder(v:Ref<UpdateReserveReqBodyBuilder>):UpdateReserveReqBodyBuilder
	export function emptyApplyReserveReqBuilder():ApplyReserveReqBuilder
	export function emptyRefApplyReserveReqBuilder():Ref<ApplyReserveReqBuilder>
	export function refOfApplyReserveReqBuilder(x:ApplyReserveReqBuilder,v:Ref<ApplyReserveReqBuilder>)
	export function unRefApplyReserveReqBuilder(v:Ref<ApplyReserveReqBuilder>):ApplyReserveReqBuilder
	export function emptyP2RoomCreatedV1Handler():P2RoomCreatedV1Handler
	export function emptyRefP2RoomCreatedV1Handler():Ref<P2RoomCreatedV1Handler>
	export function refOfP2RoomCreatedV1Handler(x:P2RoomCreatedV1Handler,v:Ref<P2RoomCreatedV1Handler>)
	export function unRefP2RoomCreatedV1Handler(v:Ref<P2RoomCreatedV1Handler>):P2RoomCreatedV1Handler
	export function emptySubscribeUserEventBuilder():SubscribeUserEventBuilder
	export function emptyRefSubscribeUserEventBuilder():Ref<SubscribeUserEventBuilder>
	export function refOfSubscribeUserEventBuilder(x:SubscribeUserEventBuilder,v:Ref<SubscribeUserEventBuilder>)
	export function unRefSubscribeUserEventBuilder(v:Ref<SubscribeUserEventBuilder>):SubscribeUserEventBuilder
	export function emptyGetMeetingReqBuilder():GetMeetingReqBuilder
	export function emptyRefGetMeetingReqBuilder():Ref<GetMeetingReqBuilder>
	export function refOfGetMeetingReqBuilder(x:GetMeetingReqBuilder,v:Ref<GetMeetingReqBuilder>)
	export function unRefGetMeetingReqBuilder(v:Ref<GetMeetingReqBuilder>):GetMeetingReqBuilder
	...
	export function emptyGetMeetingRecordingReqBuilder():GetMeetingRecordingReqBuilder
	export function emptyRefGetMeetingRecordingReqBuilder():Ref<GetMeetingRecordingReqBuilder>
	export function refOfGetMeetingRecordingReqBuilder(x:GetMeetingRecordingReqBuilder,v:Ref<GetMeetingRecordingReqBuilder>)
	export function unRefGetMeetingRecordingReqBuilder(v:Ref<GetMeetingRecordingReqBuilder>):GetMeetingRecordingReqBuilder
	...
	export function emptyMyAiCallbackActionBuilder():MyAiCallbackActionBuilder
	export function emptyRefMyAiCallbackActionBuilder():Ref<MyAiCallbackActionBuilder>
	export function refOfMyAiCallbackActionBuilder(x:MyAiCallbackActionBuilder,v:Ref<MyAiCallbackActionBuilder>)
	export function unRefMyAiCallbackActionBuilder(v:Ref<MyAiCallbackActionBuilder>):MyAiCallbackActionBuilder
	...
	export function emptyReserveBuilder():ReserveBuilder
	export function emptyRefReserveBuilder():Ref<ReserveBuilder>
	export function refOfReserveBuilder(x:ReserveBuilder,v:Ref<ReserveBuilder>)
	export function unRefReserveBuilder(v:Ref<ReserveBuilder>):ReserveBuilder
	...
	export function emptyMaterialUploadResultBuilder():MaterialUploadResultBuilder
	export function emptyRefMaterialUploadResultBuilder():Ref<MaterialUploadResultBuilder>
	export function refOfMaterialUploadResultBuilder(x:MaterialUploadResultBuilder,v:Ref<MaterialUploadResultBuilder>)
	export function unRefMaterialUploadResultBuilder(v:Ref<MaterialUploadResultBuilder>):MaterialUploadResultBuilder
	export function emptyMyAiResponsePresentBuilder():MyAiResponsePresentBuilder
	export function emptyRefMyAiResponsePresentBuilder():Ref<MyAiResponsePresentBuilder>
	export function refOfMyAiResponsePresentBuilder(x:MyAiResponsePresentBuilder,v:Ref<MyAiResponsePresentBuilder>)
	export function unRefMyAiResponsePresentBuilder(v:Ref<MyAiResponsePresentBuilder>):MyAiResponsePresentBuilder
	...
	export function emptyResourceReservationListExportReqBuilder():ResourceReservationListExportReqBuilder
	export function emptyRefResourceReservationListExportReqBuilder():Ref<ResourceReservationListExportReqBuilder>
	export function refOfResourceReservationListExportReqBuilder(x:ResourceReservationListExportReqBuilder,v:Ref<ResourceReservationListExportReqBuilder>)
	export function unRefResourceReservationListExportReqBuilder(v:Ref<ResourceReservationListExportReqBuilder>):ResourceReservationListExportReqBuilder
	...
	export function emptyMeetingUserBuilder():MeetingUserBuilder
	export function emptyRefMeetingUserBuilder():Ref<MeetingUserBuilder>
	export function refOfMeetingUserBuilder(x:MeetingUserBuilder,v:Ref<MeetingUserBuilder>)
	export function unRefMeetingUserBuilder(v:Ref<MeetingUserBuilder>):MeetingUserBuilder
	...
	export function emptyMeetingParticipantBuilder():MeetingParticipantBuilder
	export function emptyRefMeetingParticipantBuilder():Ref<MeetingParticipantBuilder>
	export function refOfMeetingParticipantBuilder(x:MeetingParticipantBuilder,v:Ref<MeetingParticipantBuilder>)
	export function unRefMeetingParticipantBuilder(v:Ref<MeetingParticipantBuilder>):MeetingParticipantBuilder
	...
	export function emptyScopeConfigBuilder():ScopeConfigBuilder
	export function emptyRefScopeConfigBuilder():Ref<ScopeConfigBuilder>
	export function refOfScopeConfigBuilder(x:ScopeConfigBuilder,v:Ref<ScopeConfigBuilder>)
	export function unRefScopeConfigBuilder(v:Ref<ScopeConfigBuilder>):ScopeConfigBuilder
	export function emptySetPermissionMeetingRecordingReqBuilder():SetPermissionMeetingRecordingReqBuilder
	export function emptyRefSetPermissionMeetingRecordingReqBuilder():Ref<SetPermissionMeetingRecordingReqBuilder>
	export function refOfSetPermissionMeetingRecordingReqBuilder(x:SetPermissionMeetingRecordingReqBuilder,v:Ref<SetPermissionMeetingRecordingReqBuilder>)
	export function unRefSetPermissionMeetingRecordingReqBuilder(v:Ref<SetPermissionMeetingRecordingReqBuilder>):SetPermissionMeetingRecordingReqBuilder
	export function emptyCustomListBuilder():CustomListBuilder
	export function emptyRefCustomListBuilder():Ref<CustomListBuilder>
	export function refOfCustomListBuilder(x:CustomListBuilder,v:Ref<CustomListBuilder>)
	export function unRefCustomListBuilder(v:Ref<CustomListBuilder>):CustomListBuilder
	...
	export function emptyMeetingSecuritySettingBuilder():MeetingSecuritySettingBuilder
	export function emptyRefMeetingSecuritySettingBuilder():Ref<MeetingSecuritySettingBuilder>
	export function refOfMeetingSecuritySettingBuilder(x:MeetingSecuritySettingBuilder,v:Ref<MeetingSecuritySettingBuilder>)
	export function unRefMeetingSecuritySettingBuilder(v:Ref<MeetingSecuritySettingBuilder>):MeetingSecuritySettingBuilder
	export function emptyPatchReserveConfigAdminPathReqBodyBuilder():PatchReserveConfigAdminPathReqBodyBuilder
	export function emptyRefPatchReserveConfigAdminPathReqBodyBuilder():Ref<PatchReserveConfigAdminPathReqBodyBuilder>
	export function refOfPatchReserveConfigAdminPathReqBodyBuilder(x:PatchReserveConfigAdminPathReqBodyBuilder,v:Ref<PatchReserveConfigAdminPathReqBodyBuilder>)
	export function unRefPatchReserveConfigAdminPathReqBodyBuilder(v:Ref<PatchReserveConfigAdminPathReqBodyBuilder>):PatchReserveConfigAdminPathReqBodyBuilder
	export function emptyPatchReserveConfigDisableInformReqBuilder():PatchReserveConfigDisableInformReqBuilder
	export function emptyRefPatchReserveConfigDisableInformReqBuilder():Ref<PatchReserveConfigDisableInformReqBuilder>
	export function refOfPatchReserveConfigDisableInformReqBuilder(x:PatchReserveConfigDisableInformReqBuilder,v:Ref<PatchReserveConfigDisableInformReqBuilder>)
	export function unRefPatchReserveConfigDisableInformReqBuilder(v:Ref<PatchReserveConfigDisableInformReqBuilder>):PatchReserveConfigDisableInformReqBuilder
	export function emptyResourceReservationListExportReqBodyBuilder():ResourceReservationListExportReqBodyBuilder
	export function emptyRefResourceReservationListExportReqBodyBuilder():Ref<ResourceReservationListExportReqBodyBuilder>
	export function refOfResourceReservationListExportReqBodyBuilder(x:ResourceReservationListExportReqBodyBuilder,v:Ref<ResourceReservationListExportReqBodyBuilder>)
	export function unRefResourceReservationListExportReqBodyBuilder(v:Ref<ResourceReservationListExportReqBodyBuilder>):ResourceReservationListExportReqBodyBuilder
	...
	export function emptyReserveCallSettingBuilder():ReserveCallSettingBuilder
	export function emptyRefReserveCallSettingBuilder():Ref<ReserveCallSettingBuilder>
	export function refOfReserveCallSettingBuilder(x:ReserveCallSettingBuilder,v:Ref<ReserveCallSettingBuilder>)
	export function unRefReserveCallSettingBuilder(v:Ref<ReserveCallSettingBuilder>):ReserveCallSettingBuilder
	export function emptyReserveFormConfigBuilder():ReserveFormConfigBuilder
	export function emptyRefReserveFormConfigBuilder():Ref<ReserveFormConfigBuilder>
	export function refOfReserveFormConfigBuilder(x:ReserveFormConfigBuilder,v:Ref<ReserveFormConfigBuilder>)
	export function unRefReserveFormConfigBuilder(v:Ref<ReserveFormConfigBuilder>):ReserveFormConfigBuilder
	export function emptyResourceReservationListExportPathReqBodyBuilder():ResourceReservationListExportPathReqBodyBuilder
	export function emptyRefResourceReservationListExportPathReqBodyBuilder():Ref<ResourceReservationListExportPathReqBodyBuilder>
	export function refOfResourceReservationListExportPathReqBodyBuilder(x:ResourceReservationListExportPathReqBodyBuilder,v:Ref<ResourceReservationListExportPathReqBodyBuilder>)
	export function unRefResourceReservationListExportPathReqBodyBuilder(v:Ref<ResourceReservationListExportPathReqBodyBuilder>):ResourceReservationListExportPathReqBodyBuilder
	export function emptySetRoomAccessCodeRoomConfigReqBodyBuilder():SetRoomAccessCodeRoomConfigReqBodyBuilder
	export function emptyRefSetRoomAccessCodeRoomConfigReqBodyBuilder():Ref<SetRoomAccessCodeRoomConfigReqBodyBuilder>
	export function refOfSetRoomAccessCodeRoomConfigReqBodyBuilder(x:SetRoomAccessCodeRoomConfigReqBodyBuilder,v:Ref<SetRoomAccessCodeRoomConfigReqBodyBuilder>)
	export function unRefSetRoomAccessCodeRoomConfigReqBodyBuilder(v:Ref<SetRoomAccessCodeRoomConfigReqBodyBuilder>):SetRoomAccessCodeRoomConfigReqBodyBuilder
	...
	export function emptyParticipantQualityListExportPathReqBodyBuilder():ParticipantQualityListExportPathReqBodyBuilder
	export function emptyRefParticipantQualityListExportPathReqBodyBuilder():Ref<ParticipantQualityListExportPathReqBodyBuilder>
	export function refOfParticipantQualityListExportPathReqBodyBuilder(x:ParticipantQualityListExportPathReqBodyBuilder,v:Ref<ParticipantQualityListExportPathReqBodyBuilder>)
	export function unRefParticipantQualityListExportPathReqBodyBuilder(v:Ref<ParticipantQualityListExportPathReqBodyBuilder>):ParticipantQualityListExportPathReqBodyBuilder
	export function emptyEndMeetingReqBuilder():EndMeetingReqBuilder
	export function emptyRefEndMeetingReqBuilder():Ref<EndMeetingReqBuilder>
	export function refOfEndMeetingReqBuilder(x:EndMeetingReqBuilder,v:Ref<EndMeetingReqBuilder>)
	export function unRefEndMeetingReqBuilder(v:Ref<EndMeetingReqBuilder>):EndMeetingReqBuilder
	...
	export function emptyListByNoMeetingReqBuilder():ListByNoMeetingReqBuilder
	export function emptyRefListByNoMeetingReqBuilder():Ref<ListByNoMeetingReqBuilder>
	export function refOfListByNoMeetingReqBuilder(x:ListByNoMeetingReqBuilder,v:Ref<ListByNoMeetingReqBuilder>)
	export function unRefListByNoMeetingReqBuilder(v:Ref<ListByNoMeetingReqBuilder>):ListByNoMeetingReqBuilder
	...
	export function emptyP2MeetingLeaveMeetingV1Handler():P2MeetingLeaveMeetingV1Handler
	export function emptyRefP2MeetingLeaveMeetingV1Handler():Ref<P2MeetingLeaveMeetingV1Handler>
	export function refOfP2MeetingLeaveMeetingV1Handler(x:P2MeetingLeaveMeetingV1Handler,v:Ref<P2MeetingLeaveMeetingV1Handler>)
	export function unRefP2MeetingLeaveMeetingV1Handler(v:Ref<P2MeetingLeaveMeetingV1Handler>):P2MeetingLeaveMeetingV1Handler
	export function emptyPatchReserveConfigReqBodyBuilder():PatchReserveConfigReqBodyBuilder
	export function emptyRefPatchReserveConfigReqBodyBuilder():Ref<PatchReserveConfigReqBodyBuilder>
	export function refOfPatchReserveConfigReqBodyBuilder(x:PatchReserveConfigReqBodyBuilder,v:Ref<PatchReserveConfigReqBodyBuilder>)
	export function unRefPatchReserveConfigReqBodyBuilder(v:Ref<PatchReserveConfigReqBodyBuilder>):PatchReserveConfigReqBodyBuilder
	...
	export function emptyP2MeetingRecordingEndedV1Handler():P2MeetingRecordingEndedV1Handler
	export function emptyRefP2MeetingRecordingEndedV1Handler():Ref<P2MeetingRecordingEndedV1Handler>
	export function refOfP2MeetingRecordingEndedV1Handler(x:P2MeetingRecordingEndedV1Handler,v:Ref<P2MeetingRecordingEndedV1Handler>)
	export function unRefP2MeetingRecordingEndedV1Handler(v:Ref<P2MeetingRecordingEndedV1Handler>):P2MeetingRecordingEndedV1Handler
	...
	export function emptyP2MeetingEndedV1Handler():P2MeetingEndedV1Handler
	export function emptyRefP2MeetingEndedV1Handler():Ref<P2MeetingEndedV1Handler>
	export function refOfP2MeetingEndedV1Handler(x:P2MeetingEndedV1Handler,v:Ref<P2MeetingEndedV1Handler>)
	export function unRefP2MeetingEndedV1Handler(v:Ref<P2MeetingEndedV1Handler>):P2MeetingEndedV1Handler
	...
	export function emptyMeetingListExportReqBuilder():MeetingListExportReqBuilder
	export function emptyRefMeetingListExportReqBuilder():Ref<MeetingListExportReqBuilder>
	export function refOfMeetingListExportReqBuilder(x:MeetingListExportReqBuilder,v:Ref<MeetingListExportReqBuilder>)
	export function unRefMeetingListExportReqBuilder(v:Ref<MeetingListExportReqBuilder>):MeetingListExportReqBuilder
	...
	export function emptyReservedRoomBuilder():ReservedRoomBuilder
	export function emptyRefReservedRoomBuilder():Ref<ReservedRoomBuilder>
	export function refOfReservedRoomBuilder(x:ReservedRoomBuilder,v:Ref<ReservedRoomBuilder>)
	export function unRefReservedRoomBuilder(v:Ref<ReservedRoomBuilder>):ReservedRoomBuilder
	...
	export function emptyListRoomReqBuilder():ListRoomReqBuilder
	export function emptyRefListRoomReqBuilder():Ref<ListRoomReqBuilder>
	export function refOfListRoomReqBuilder(x:ListRoomReqBuilder,v:Ref<ListRoomReqBuilder>)
	export function unRefListRoomReqBuilder(v:Ref<ListRoomReqBuilder>):ListRoomReqBuilder
	export function emptyPstnSipInfoBuilder():PstnSipInfoBuilder
	export function emptyRefPstnSipInfoBuilder():Ref<PstnSipInfoBuilder>
	export function refOfPstnSipInfoBuilder(x:PstnSipInfoBuilder,v:Ref<PstnSipInfoBuilder>)
	export function unRefPstnSipInfoBuilder(v:Ref<PstnSipInfoBuilder>):PstnSipInfoBuilder
	...
	export function emptyDownloadExportReqBuilder():DownloadExportReqBuilder
	export function emptyRefDownloadExportReqBuilder():Ref<DownloadExportReqBuilder>
	export function refOfDownloadExportReqBuilder(x:DownloadExportReqBuilder,v:Ref<DownloadExportReqBuilder>)
	export function unRefDownloadExportReqBuilder(v:Ref<DownloadExportReqBuilder>):DownloadExportReqBuilder
	export function emptyMgetRoomLevelReqBodyBuilder():MgetRoomLevelReqBodyBuilder
	export function emptyRefMgetRoomLevelReqBodyBuilder():Ref<MgetRoomLevelReqBodyBuilder>
	export function refOfMgetRoomLevelReqBodyBuilder(x:MgetRoomLevelReqBodyBuilder,v:Ref<MgetRoomLevelReqBodyBuilder>)
	export function unRefMgetRoomLevelReqBodyBuilder(v:Ref<MgetRoomLevelReqBodyBuilder>):MgetRoomLevelReqBodyBuilder
	export function emptyP2MeetingStartedV1Handler():P2MeetingStartedV1Handler
	export function emptyRefP2MeetingStartedV1Handler():Ref<P2MeetingStartedV1Handler>
	export function refOfP2MeetingStartedV1Handler(x:P2MeetingStartedV1Handler,v:Ref<P2MeetingStartedV1Handler>)
	export function unRefP2MeetingStartedV1Handler(v:Ref<P2MeetingStartedV1Handler>):P2MeetingStartedV1Handler
	...
	export function emptySetHostMeetingReqBodyBuilder():SetHostMeetingReqBodyBuilder
	export function emptyRefSetHostMeetingReqBodyBuilder():Ref<SetHostMeetingReqBodyBuilder>
	export function refOfSetHostMeetingReqBodyBuilder(x:SetHostMeetingReqBodyBuilder,v:Ref<SetHostMeetingReqBodyBuilder>)
	export function unRefSetHostMeetingReqBodyBuilder(v:Ref<SetHostMeetingReqBodyBuilder>):SetHostMeetingReqBodyBuilder
	export function emptyGetScopeConfigReqBuilder():GetScopeConfigReqBuilder
	export function emptyRefGetScopeConfigReqBuilder():Ref<GetScopeConfigReqBuilder>
	export function refOfGetScopeConfigReqBuilder(x:GetScopeConfigReqBuilder,v:Ref<GetScopeConfigReqBuilder>)
	export function unRefGetScopeConfigReqBuilder(v:Ref<GetScopeConfigReqBuilder>):GetScopeConfigReqBuilder
	export function emptyMyAiCallbackActionValueBuilder():MyAiCallbackActionValueBuilder
	export function emptyRefMyAiCallbackActionValueBuilder():Ref<MyAiCallbackActionValueBuilder>
	export function refOfMyAiCallbackActionValueBuilder(x:MyAiCallbackActionValueBuilder,v:Ref<MyAiCallbackActionValueBuilder>)
	export function unRefMyAiCallbackActionValueBuilder(v:Ref<MyAiCallbackActionValueBuilder>):MyAiCallbackActionValueBuilder
	export function emptyP2RoomDeletedV1Handler():P2RoomDeletedV1Handler
	export function emptyRefP2RoomDeletedV1Handler():Ref<P2RoomDeletedV1Handler>
	export function refOfP2RoomDeletedV1Handler(x:P2RoomDeletedV1Handler,v:Ref<P2RoomDeletedV1Handler>)
	export function unRefP2RoomDeletedV1Handler(v:Ref<P2RoomDeletedV1Handler>):P2RoomDeletedV1Handler
	...
	export function emptyGetExportReqBuilder():GetExportReqBuilder
	export function emptyRefGetExportReqBuilder():Ref<GetExportReqBuilder>
	export function refOfGetExportReqBuilder(x:GetExportReqBuilder,v:Ref<GetExportReqBuilder>)
	export function unRefGetExportReqBuilder(v:Ref<GetExportReqBuilder>):GetExportReqBuilder
	...
	export function emptyMeetingInviteStatusBuilder():MeetingInviteStatusBuilder
	export function emptyRefMeetingInviteStatusBuilder():Ref<MeetingInviteStatusBuilder>
	export function refOfMeetingInviteStatusBuilder(x:MeetingInviteStatusBuilder,v:Ref<MeetingInviteStatusBuilder>)
	export function unRefMeetingInviteStatusBuilder(v:Ref<MeetingInviteStatusBuilder>):MeetingInviteStatusBuilder
	...
	export function emptyMyAiAvPluginScenarioContextBuilder():MyAiAvPluginScenarioContextBuilder
	export function emptyRefMyAiAvPluginScenarioContextBuilder():Ref<MyAiAvPluginScenarioContextBuilder>
	export function refOfMyAiAvPluginScenarioContextBuilder(x:MyAiAvPluginScenarioContextBuilder,v:Ref<MyAiAvPluginScenarioContextBuilder>)
	export function unRefMyAiAvPluginScenarioContextBuilder(v:Ref<MyAiAvPluginScenarioContextBuilder>):MyAiAvPluginScenarioContextBuilder
	export function emptySetRoomConfigReqBuilder():SetRoomConfigReqBuilder
	export function emptyRefSetRoomConfigReqBuilder():Ref<SetRoomConfigReqBuilder>
	export function refOfSetRoomConfigReqBuilder(x:SetRoomConfigReqBuilder,v:Ref<SetRoomConfigReqBuilder>)
	export function unRefSetRoomConfigReqBuilder(v:Ref<SetRoomConfigReqBuilder>):SetRoomConfigReqBuilder
	...
	export function emptyPatchReserveConfigFormReqBuilder():PatchReserveConfigFormReqBuilder
	export function emptyRefPatchReserveConfigFormReqBuilder():Ref<PatchReserveConfigFormReqBuilder>
	export function refOfPatchReserveConfigFormReqBuilder(x:PatchReserveConfigFormReqBuilder,v:Ref<PatchReserveConfigFormReqBuilder>)
	export function unRefPatchReserveConfigFormReqBuilder(v:Ref<PatchReserveConfigFormReqBuilder>):PatchReserveConfigFormReqBuilder
	export function emptyCreateRoomLevelReqBuilder():CreateRoomLevelReqBuilder
	export function emptyRefCreateRoomLevelReqBuilder():Ref<CreateRoomLevelReqBuilder>
	export function refOfCreateRoomLevelReqBuilder(x:CreateRoomLevelReqBuilder,v:Ref<CreateRoomLevelReqBuilder>)
	export function unRefCreateRoomLevelReqBuilder(v:Ref<CreateRoomLevelReqBuilder>):CreateRoomLevelReqBuilder
	...
	export function emptyGetDailyReportReqBuilder():GetDailyReportReqBuilder
	export function emptyRefGetDailyReportReqBuilder():Ref<GetDailyReportReqBuilder>
	export function refOfGetDailyReportReqBuilder(x:GetDailyReportReqBuilder,v:Ref<GetDailyReportReqBuilder>)
	export function unRefGetDailyReportReqBuilder(v:Ref<GetDailyReportReqBuilder>):GetDailyReportReqBuilder
	...
	export function emptyMyAiAvPluginCardStatusBuilder():MyAiAvPluginCardStatusBuilder
	export function emptyRefMyAiAvPluginCardStatusBuilder():Ref<MyAiAvPluginCardStatusBuilder>
	export function refOfMyAiAvPluginCardStatusBuilder(x:MyAiAvPluginCardStatusBuilder,v:Ref<MyAiAvPluginCardStatusBuilder>)
	export function unRefMyAiAvPluginCardStatusBuilder(v:Ref<MyAiAvPluginCardStatusBuilder>):MyAiAvPluginCardStatusBuilder
	...
	export function emptyParticipantListExportPathReqBodyBuilder():ParticipantListExportPathReqBodyBuilder
	export function emptyRefParticipantListExportPathReqBodyBuilder():Ref<ParticipantListExportPathReqBodyBuilder>
	export function refOfParticipantListExportPathReqBodyBuilder(x:ParticipantListExportPathReqBodyBuilder,v:Ref<ParticipantListExportPathReqBodyBuilder>)
	export function unRefParticipantListExportPathReqBodyBuilder(v:Ref<ParticipantListExportPathReqBodyBuilder>):ParticipantListExportPathReqBodyBuilder
	...
	export function emptyMaterialReviewResultBuilder():MaterialReviewResultBuilder
	export function emptyRefMaterialReviewResultBuilder():Ref<MaterialReviewResultBuilder>
	export function refOfMaterialReviewResultBuilder(x:MaterialReviewResultBuilder,v:Ref<MaterialReviewResultBuilder>)
	export function unRefMaterialReviewResultBuilder(v:Ref<MaterialReviewResultBuilder>):MaterialReviewResultBuilder
	...
	export function emptyMyAiRoomOpenapiResponseBuilder():MyAiRoomOpenapiResponseBuilder
	export function emptyRefMyAiRoomOpenapiResponseBuilder():Ref<MyAiRoomOpenapiResponseBuilder>
	export function refOfMyAiRoomOpenapiResponseBuilder(x:MyAiRoomOpenapiResponseBuilder,v:Ref<MyAiRoomOpenapiResponseBuilder>)
	export function unRefMyAiRoomOpenapiResponseBuilder(v:Ref<MyAiRoomOpenapiResponseBuilder>):MyAiRoomOpenapiResponseBuilder
	...
	export function emptyReportBuilder():ReportBuilder
	export function emptyRefReportBuilder():Ref<ReportBuilder>
	export function refOfReportBuilder(x:ReportBuilder,v:Ref<ReportBuilder>)
	export function unRefReportBuilder(v:Ref<ReportBuilder>):ReportBuilder
	...
	export function emptyKickoutMeetingReqBodyBuilder():KickoutMeetingReqBodyBuilder
	export function emptyRefKickoutMeetingReqBodyBuilder():Ref<KickoutMeetingReqBodyBuilder>
	export function refOfKickoutMeetingReqBodyBuilder(x:KickoutMeetingReqBodyBuilder,v:Ref<KickoutMeetingReqBodyBuilder>)
	export function unRefKickoutMeetingReqBodyBuilder(v:Ref<KickoutMeetingReqBodyBuilder>):KickoutMeetingReqBodyBuilder
	export function emptyMyAiVcMeetingOperationResultBuilder():MyAiVcMeetingOperationResultBuilder
	export function emptyRefMyAiVcMeetingOperationResultBuilder():Ref<MyAiVcMeetingOperationResultBuilder>
	export function refOfMyAiVcMeetingOperationResultBuilder(x:MyAiVcMeetingOperationResultBuilder,v:Ref<MyAiVcMeetingOperationResultBuilder>)
	export function unRefMyAiVcMeetingOperationResultBuilder(v:Ref<MyAiVcMeetingOperationResultBuilder>):MyAiVcMeetingOperationResultBuilder
	...
	export function emptyReserveMeetingSettingBuilder():ReserveMeetingSettingBuilder
	export function emptyRefReserveMeetingSettingBuilder():Ref<ReserveMeetingSettingBuilder>
	export function refOfReserveMeetingSettingBuilder(x:ReserveMeetingSettingBuilder,v:Ref<ReserveMeetingSettingBuilder>)
	export function unRefReserveMeetingSettingBuilder(v:Ref<ReserveMeetingSettingBuilder>):ReserveMeetingSettingBuilder
	...
	export function emptyRoomStatusEventBuilder():RoomStatusEventBuilder
	export function emptyRefRoomStatusEventBuilder():Ref<RoomStatusEventBuilder>
	export function refOfRoomStatusEventBuilder(x:RoomStatusEventBuilder,v:Ref<RoomStatusEventBuilder>)
	export function unRefRoomStatusEventBuilder(v:Ref<RoomStatusEventBuilder>):RoomStatusEventBuilder
	export function emptyGetActiveMeetingReserveReqBuilder():GetActiveMeetingReserveReqBuilder
	export function emptyRefGetActiveMeetingReserveReqBuilder():Ref<GetActiveMeetingReserveReqBuilder>
	export function refOfGetActiveMeetingReserveReqBuilder(x:GetActiveMeetingReserveReqBuilder,v:Ref<GetActiveMeetingReserveReqBuilder>)
	export function unRefGetActiveMeetingReserveReqBuilder(v:Ref<GetActiveMeetingReserveReqBuilder>):GetActiveMeetingReserveReqBuilder
	export function emptyKickoutMeetingReqBuilder():KickoutMeetingReqBuilder
	export function emptyRefKickoutMeetingReqBuilder():Ref<KickoutMeetingReqBuilder>
	export function refOfKickoutMeetingReqBuilder(x:KickoutMeetingReqBuilder,v:Ref<KickoutMeetingReqBuilder>)
	export function unRefKickoutMeetingReqBuilder(v:Ref<KickoutMeetingReqBuilder>):KickoutMeetingReqBuilder
	export function emptyMyAiRoomCommonResultBuilder():MyAiRoomCommonResultBuilder
	export function emptyRefMyAiRoomCommonResultBuilder():Ref<MyAiRoomCommonResultBuilder>
	export function refOfMyAiRoomCommonResultBuilder(x:MyAiRoomCommonResultBuilder,v:Ref<MyAiRoomCommonResultBuilder>)
	export function unRefMyAiRoomCommonResultBuilder(v:Ref<MyAiRoomCommonResultBuilder>):MyAiRoomCommonResultBuilder
	export function emptySetRoomConfigReqBodyBuilder():SetRoomConfigReqBodyBuilder
	export function emptyRefSetRoomConfigReqBodyBuilder():Ref<SetRoomConfigReqBodyBuilder>
	export function refOfSetRoomConfigReqBodyBuilder(x:SetRoomConfigReqBodyBuilder,v:Ref<SetRoomConfigReqBodyBuilder>)
	export function unRefSetRoomConfigReqBodyBuilder(v:Ref<SetRoomConfigReqBodyBuilder>):SetRoomConfigReqBodyBuilder
	export function emptyKickoutMeetingPathReqBodyBuilder():KickoutMeetingPathReqBodyBuilder
	export function emptyRefKickoutMeetingPathReqBodyBuilder():Ref<KickoutMeetingPathReqBodyBuilder>
	export function refOfKickoutMeetingPathReqBodyBuilder(x:KickoutMeetingPathReqBodyBuilder,v:Ref<KickoutMeetingPathReqBodyBuilder>)
	export function unRefKickoutMeetingPathReqBodyBuilder(v:Ref<KickoutMeetingPathReqBodyBuilder>):KickoutMeetingPathReqBodyBuilder
	...
	export function emptyQualityVideoSharingBuilder():QualityVideoSharingBuilder
	export function emptyRefQualityVideoSharingBuilder():Ref<QualityVideoSharingBuilder>
	export function refOfQualityVideoSharingBuilder(x:QualityVideoSharingBuilder,v:Ref<QualityVideoSharingBuilder>)
	export function unRefQualityVideoSharingBuilder(v:Ref<QualityVideoSharingBuilder>):QualityVideoSharingBuilder
	export function emptySetCheckboardAccessCodeRoomConfigPathReqBodyBuilder():SetCheckboardAccessCodeRoomConfigPathReqBodyBuilder
	export function emptyRefSetCheckboardAccessCodeRoomConfigPathReqBodyBuilder():Ref<SetCheckboardAccessCodeRoomConfigPathReqBodyBuilder>
	export function refOfSetCheckboardAccessCodeRoomConfigPathReqBodyBuilder(x:SetCheckboardAccessCodeRoomConfigPathReqBodyBuilder,v:Ref<SetCheckboardAccessCodeRoomConfigPathReqBodyBuilder>)
	export function unRefSetCheckboardAccessCodeRoomConfigPathReqBodyBuilder(v:Ref<SetCheckboardAccessCodeRoomConfigPathReqBodyBuilder>):SetCheckboardAccessCodeRoomConfigPathReqBodyBuilder
	export function emptyStartMeetingRecordingReqBuilder():StartMeetingRecordingReqBuilder
	export function emptyRefStartMeetingRecordingReqBuilder():Ref<StartMeetingRecordingReqBuilder>
	export function refOfStartMeetingRecordingReqBuilder(x:StartMeetingRecordingReqBuilder,v:Ref<StartMeetingRecordingReqBuilder>)
	export function unRefStartMeetingRecordingReqBuilder(v:Ref<StartMeetingRecordingReqBuilder>):StartMeetingRecordingReqBuilder
	...
	export function emptyMeetingBuilder():MeetingBuilder
	export function emptyRefMeetingBuilder():Ref<MeetingBuilder>
	export function refOfMeetingBuilder(x:MeetingBuilder,v:Ref<MeetingBuilder>)
	export function unRefMeetingBuilder(v:Ref<MeetingBuilder>):MeetingBuilder
	...
	export function emptyReserveAdminConfigBuilder():ReserveAdminConfigBuilder
	export function emptyRefReserveAdminConfigBuilder():Ref<ReserveAdminConfigBuilder>
	export function refOfReserveAdminConfigBuilder(x:ReserveAdminConfigBuilder,v:Ref<ReserveAdminConfigBuilder>)
	export function unRefReserveAdminConfigBuilder(v:Ref<ReserveAdminConfigBuilder>):ReserveAdminConfigBuilder
	...
	export function emptyDelRoomLevelReqBodyBuilder():DelRoomLevelReqBodyBuilder
	export function emptyRefDelRoomLevelReqBodyBuilder():Ref<DelRoomLevelReqBodyBuilder>
	export function refOfDelRoomLevelReqBodyBuilder(x:DelRoomLevelReqBodyBuilder,v:Ref<DelRoomLevelReqBodyBuilder>)
	export function unRefDelRoomLevelReqBodyBuilder(v:Ref<DelRoomLevelReqBodyBuilder>):DelRoomLevelReqBodyBuilder
	...
	export function emptyQualityNetworkBuilder():QualityNetworkBuilder
	export function emptyRefQualityNetworkBuilder():Ref<QualityNetworkBuilder>
	export function refOfQualityNetworkBuilder(x:QualityNetworkBuilder,v:Ref<QualityNetworkBuilder>)
	export function unRefQualityNetworkBuilder(v:Ref<QualityNetworkBuilder>):QualityNetworkBuilder
	...
	export function emptyPatchReserveConfigFormPathReqBodyBuilder():PatchReserveConfigFormPathReqBodyBuilder
	export function emptyRefPatchReserveConfigFormPathReqBodyBuilder():Ref<PatchReserveConfigFormPathReqBodyBuilder>
	export function refOfPatchReserveConfigFormPathReqBodyBuilder(x:PatchReserveConfigFormPathReqBodyBuilder,v:Ref<PatchReserveConfigFormPathReqBodyBuilder>)
	export function unRefPatchReserveConfigFormPathReqBodyBuilder(v:Ref<PatchReserveConfigFormPathReqBodyBuilder>):PatchReserveConfigFormPathReqBodyBuilder
	...
	export function emptyGetParticipantListReqBuilder():GetParticipantListReqBuilder
	export function emptyRefGetParticipantListReqBuilder():Ref<GetParticipantListReqBuilder>
	export function refOfGetParticipantListReqBuilder(x:GetParticipantListReqBuilder,v:Ref<GetParticipantListReqBuilder>)
	export function unRefGetParticipantListReqBuilder(v:Ref<GetParticipantListReqBuilder>):GetParticipantListReqBuilder
	export function emptyReportMeetingDailyBuilder():ReportMeetingDailyBuilder
	export function emptyRefReportMeetingDailyBuilder():Ref<ReportMeetingDailyBuilder>
	export function refOfReportMeetingDailyBuilder(x:ReportMeetingDailyBuilder,v:Ref<ReportMeetingDailyBuilder>)
	export function unRefReportMeetingDailyBuilder(v:Ref<ReportMeetingDailyBuilder>):ReportMeetingDailyBuilder
	...
	export function emptyMyAiVcMeetingRecapResultBuilder():MyAiVcMeetingRecapResultBuilder
	export function emptyRefMyAiVcMeetingRecapResultBuilder():Ref<MyAiVcMeetingRecapResultBuilder>
	export function refOfMyAiVcMeetingRecapResultBuilder(x:MyAiVcMeetingRecapResultBuilder,v:Ref<MyAiVcMeetingRecapResultBuilder>)
	export function unRefMyAiVcMeetingRecapResultBuilder(v:Ref<MyAiVcMeetingRecapResultBuilder>):MyAiVcMeetingRecapResultBuilder
	...
	export function emptyDisableInformConfigBuilder():DisableInformConfigBuilder
	export function emptyRefDisableInformConfigBuilder():Ref<DisableInformConfigBuilder>
	export function refOfDisableInformConfigBuilder(x:DisableInformConfigBuilder,v:Ref<DisableInformConfigBuilder>)
	export function unRefDisableInformConfigBuilder(v:Ref<DisableInformConfigBuilder>):DisableInformConfigBuilder
	...
	export function emptyRoomConfigBuilder():RoomConfigBuilder
	export function emptyRefRoomConfigBuilder():Ref<RoomConfigBuilder>
	export function refOfRoomConfigBuilder(x:RoomConfigBuilder,v:Ref<RoomConfigBuilder>)
	export function unRefRoomConfigBuilder(v:Ref<RoomConfigBuilder>):RoomConfigBuilder
	export function emptySearchRoomPathReqBodyBuilder():SearchRoomPathReqBodyBuilder
	export function emptyRefSearchRoomPathReqBodyBuilder():Ref<SearchRoomPathReqBodyBuilder>
	export function refOfSearchRoomPathReqBodyBuilder(x:SearchRoomPathReqBodyBuilder,v:Ref<SearchRoomPathReqBodyBuilder>)
	export function unRefSearchRoomPathReqBodyBuilder(v:Ref<SearchRoomPathReqBodyBuilder>):SearchRoomPathReqBodyBuilder
	...
	export function emptyRoomEventBuilder():RoomEventBuilder
	export function emptyRefRoomEventBuilder():Ref<RoomEventBuilder>
	export function refOfRoomEventBuilder(x:RoomEventBuilder,v:Ref<RoomEventBuilder>)
	export function unRefRoomEventBuilder(v:Ref<RoomEventBuilder>):RoomEventBuilder
	export function emptyUpdateReservePathReqBodyBuilder():UpdateReservePathReqBodyBuilder
	export function emptyRefUpdateReservePathReqBodyBuilder():Ref<UpdateReservePathReqBodyBuilder>
	export function refOfUpdateReservePathReqBodyBuilder(x:UpdateReservePathReqBodyBuilder,v:Ref<UpdateReservePathReqBodyBuilder>)
	export function unRefUpdateReservePathReqBodyBuilder(v:Ref<UpdateReservePathReqBodyBuilder>):UpdateReservePathReqBodyBuilder
	...
	export function emptyMyAiSipImagePropertyBuilder():MyAiSipImagePropertyBuilder
	export function emptyRefMyAiSipImagePropertyBuilder():Ref<MyAiSipImagePropertyBuilder>
	export function refOfMyAiSipImagePropertyBuilder(x:MyAiSipImagePropertyBuilder,v:Ref<MyAiSipImagePropertyBuilder>)
	export function unRefMyAiSipImagePropertyBuilder(v:Ref<MyAiSipImagePropertyBuilder>):MyAiSipImagePropertyBuilder
	...
	export function emptyRecordingPermissionObjectBuilder():RecordingPermissionObjectBuilder
	export function emptyRefRecordingPermissionObjectBuilder():Ref<RecordingPermissionObjectBuilder>
	export function refOfRecordingPermissionObjectBuilder(x:RecordingPermissionObjectBuilder,v:Ref<RecordingPermissionObjectBuilder>)
	export function unRefRecordingPermissionObjectBuilder(v:Ref<RecordingPermissionObjectBuilder>):RecordingPermissionObjectBuilder
	export function emptyRoomLevelBuilder():RoomLevelBuilder
	export function emptyRefRoomLevelBuilder():Ref<RoomLevelBuilder>
	export function refOfRoomLevelBuilder(x:RoomLevelBuilder,v:Ref<RoomLevelBuilder>)
	export function unRefRoomLevelBuilder(v:Ref<RoomLevelBuilder>):RoomLevelBuilder
	export function emptyMeetingAbilityBuilder():MeetingAbilityBuilder
	export function emptyRefMeetingAbilityBuilder():Ref<MeetingAbilityBuilder>
	export function refOfMeetingAbilityBuilder(x:MeetingAbilityBuilder,v:Ref<MeetingAbilityBuilder>)
	export function unRefMeetingAbilityBuilder(v:Ref<MeetingAbilityBuilder>):MeetingAbilityBuilder
	...
	export function emptyGetReserveConfigFormReqBuilder():GetReserveConfigFormReqBuilder
	export function emptyRefGetReserveConfigFormReqBuilder():Ref<GetReserveConfigFormReqBuilder>
	export function refOfGetReserveConfigFormReqBuilder(x:GetReserveConfigFormReqBuilder,v:Ref<GetReserveConfigFormReqBuilder>)
	export function unRefGetReserveConfigFormReqBuilder(v:Ref<GetReserveConfigFormReqBuilder>):GetReserveConfigFormReqBuilder
	...
	export function emptyTimeConfigBuilder():TimeConfigBuilder
	export function emptyRefTimeConfigBuilder():Ref<TimeConfigBuilder>
	export function refOfTimeConfigBuilder(x:TimeConfigBuilder,v:Ref<TimeConfigBuilder>)
	export function unRefTimeConfigBuilder(v:Ref<TimeConfigBuilder>):TimeConfigBuilder
	export function emptyConditionsBuilder():ConditionsBuilder
	export function emptyRefConditionsBuilder():Ref<ConditionsBuilder>
	export function refOfConditionsBuilder(x:ConditionsBuilder,v:Ref<ConditionsBuilder>)
	export function unRefConditionsBuilder(v:Ref<ConditionsBuilder>):ConditionsBuilder
	export function emptyMaterialBuilder():MaterialBuilder
	export function emptyRefMaterialBuilder():Ref<MaterialBuilder>
	export function refOfMaterialBuilder(x:MaterialBuilder,v:Ref<MaterialBuilder>)
	export function unRefMaterialBuilder(v:Ref<MaterialBuilder>):MaterialBuilder
	...
	export function emptySetPermissionMeetingRecordingReqBodyBuilder():SetPermissionMeetingRecordingReqBodyBuilder
	export function emptyRefSetPermissionMeetingRecordingReqBodyBuilder():Ref<SetPermissionMeetingRecordingReqBodyBuilder>
	export function refOfSetPermissionMeetingRecordingReqBodyBuilder(x:SetPermissionMeetingRecordingReqBodyBuilder,v:Ref<SetPermissionMeetingRecordingReqBodyBuilder>)
	export function unRefSetPermissionMeetingRecordingReqBodyBuilder(v:Ref<SetPermissionMeetingRecordingReqBodyBuilder>):SetPermissionMeetingRecordingReqBodyBuilder
	export function emptyStartMeetingRecordingPathReqBodyBuilder():StartMeetingRecordingPathReqBodyBuilder
	export function emptyRefStartMeetingRecordingPathReqBodyBuilder():Ref<StartMeetingRecordingPathReqBodyBuilder>
	export function refOfStartMeetingRecordingPathReqBodyBuilder(x:StartMeetingRecordingPathReqBodyBuilder,v:Ref<StartMeetingRecordingPathReqBodyBuilder>)
	export function unRefStartMeetingRecordingPathReqBodyBuilder(v:Ref<StartMeetingRecordingPathReqBodyBuilder>):StartMeetingRecordingPathReqBodyBuilder
	...
	export function emptyPatchReserveConfigReqBuilder():PatchReserveConfigReqBuilder
	export function emptyRefPatchReserveConfigReqBuilder():Ref<PatchReserveConfigReqBuilder>
	export function refOfPatchReserveConfigReqBuilder(x:PatchReserveConfigReqBuilder,v:Ref<PatchReserveConfigReqBuilder>)
	export function unRefPatchReserveConfigReqBuilder(v:Ref<PatchReserveConfigReqBuilder>):PatchReserveConfigReqBuilder
	...
	export function emptyMyAiAvPluginCardVariablesBuilder():MyAiAvPluginCardVariablesBuilder
	export function emptyRefMyAiAvPluginCardVariablesBuilder():Ref<MyAiAvPluginCardVariablesBuilder>
	export function refOfMyAiAvPluginCardVariablesBuilder(x:MyAiAvPluginCardVariablesBuilder,v:Ref<MyAiAvPluginCardVariablesBuilder>)
	export function unRefMyAiAvPluginCardVariablesBuilder(v:Ref<MyAiAvPluginCardVariablesBuilder>):MyAiAvPluginCardVariablesBuilder
	...
	export function emptyUpdateReserveReqBuilder():UpdateReserveReqBuilder
	export function emptyRefUpdateReserveReqBuilder():Ref<UpdateReserveReqBuilder>
	export function refOfUpdateReserveReqBuilder(x:UpdateReserveReqBuilder,v:Ref<UpdateReserveReqBuilder>)
	export function unRefUpdateReserveReqBuilder(v:Ref<UpdateReserveReqBuilder>):UpdateReserveReqBuilder
	...
	export function emptyGetReserveConfigDisableInformReqBuilder():GetReserveConfigDisableInformReqBuilder
	export function emptyRefGetReserveConfigDisableInformReqBuilder():Ref<GetReserveConfigDisableInformReqBuilder>
	export function refOfGetReserveConfigDisableInformReqBuilder(x:GetReserveConfigDisableInformReqBuilder,v:Ref<GetReserveConfigDisableInformReqBuilder>)
	export function unRefGetReserveConfigDisableInformReqBuilder(v:Ref<GetReserveConfigDisableInformReqBuilder>):GetReserveConfigDisableInformReqBuilder
	export function emptyMgetRoomLevelReqBuilder():MgetRoomLevelReqBuilder
	export function emptyRefMgetRoomLevelReqBuilder():Ref<MgetRoomLevelReqBuilder>
	export function refOfMgetRoomLevelReqBuilder(x:MgetRoomLevelReqBuilder,v:Ref<MgetRoomLevelReqBuilder>)
	export function unRefMgetRoomLevelReqBuilder(v:Ref<MgetRoomLevelReqBuilder>):MgetRoomLevelReqBuilder
	export function emptyPatchRoomReqBuilder():PatchRoomReqBuilder
	export function emptyRefPatchRoomReqBuilder():Ref<PatchRoomReqBuilder>
	export function refOfPatchRoomReqBuilder(x:PatchRoomReqBuilder,v:Ref<PatchRoomReqBuilder>)
	export function unRefPatchRoomReqBuilder(v:Ref<PatchRoomReqBuilder>):PatchRoomReqBuilder
	export function emptyInviteMeetingReqBodyBuilder():InviteMeetingReqBodyBuilder
	export function emptyRefInviteMeetingReqBodyBuilder():Ref<InviteMeetingReqBodyBuilder>
	export function refOfInviteMeetingReqBodyBuilder(x:InviteMeetingReqBodyBuilder,v:Ref<InviteMeetingReqBodyBuilder>)
	export function unRefInviteMeetingReqBodyBuilder(v:Ref<InviteMeetingReqBodyBuilder>):InviteMeetingReqBodyBuilder
	export function emptyGetTopUserReportReqBuilder():GetTopUserReportReqBuilder
	export function emptyRefGetTopUserReportReqBuilder():Ref<GetTopUserReportReqBuilder>
	export function refOfGetTopUserReportReqBuilder(x:GetTopUserReportReqBuilder,v:Ref<GetTopUserReportReqBuilder>)
	export function unRefGetTopUserReportReqBuilder(v:Ref<GetTopUserReportReqBuilder>):GetTopUserReportReqBuilder
	...
	export function emptyP2MeetingShareEndedV1Handler():P2MeetingShareEndedV1Handler
	export function emptyRefP2MeetingShareEndedV1Handler():Ref<P2MeetingShareEndedV1Handler>
	export function refOfP2MeetingShareEndedV1Handler(x:P2MeetingShareEndedV1Handler,v:Ref<P2MeetingShareEndedV1Handler>)
	export function unRefP2MeetingShareEndedV1Handler(v:Ref<P2MeetingShareEndedV1Handler>):P2MeetingShareEndedV1Handler
	export function emptyP2RoomLevelUpdatedV1Handler():P2RoomLevelUpdatedV1Handler
	export function emptyRefP2RoomLevelUpdatedV1Handler():Ref<P2RoomLevelUpdatedV1Handler>
	export function refOfP2RoomLevelUpdatedV1Handler(x:P2RoomLevelUpdatedV1Handler,v:Ref<P2RoomLevelUpdatedV1Handler>)
	export function unRefP2RoomLevelUpdatedV1Handler(v:Ref<P2RoomLevelUpdatedV1Handler>):P2RoomLevelUpdatedV1Handler
	...
	export function emptyStartMeetingRecordingReqBodyBuilder():StartMeetingRecordingReqBodyBuilder
	export function emptyRefStartMeetingRecordingReqBodyBuilder():Ref<StartMeetingRecordingReqBodyBuilder>
	export function refOfStartMeetingRecordingReqBodyBuilder(x:StartMeetingRecordingReqBodyBuilder,v:Ref<StartMeetingRecordingReqBodyBuilder>)
	export function unRefStartMeetingRecordingReqBodyBuilder(v:Ref<StartMeetingRecordingReqBodyBuilder>):StartMeetingRecordingReqBodyBuilder
	export function emptyCreateRoomReqBuilder():CreateRoomReqBuilder
	export function emptyRefCreateRoomReqBuilder():Ref<CreateRoomReqBuilder>
	export function refOfCreateRoomReqBuilder(x:CreateRoomReqBuilder,v:Ref<CreateRoomReqBuilder>)
	export function unRefCreateRoomReqBuilder(v:Ref<CreateRoomReqBuilder>):CreateRoomReqBuilder
	...
	export function emptyPatchReserveConfigAdminReqBodyBuilder():PatchReserveConfigAdminReqBodyBuilder
	export function emptyRefPatchReserveConfigAdminReqBodyBuilder():Ref<PatchReserveConfigAdminReqBodyBuilder>
	export function refOfPatchReserveConfigAdminReqBodyBuilder(x:PatchReserveConfigAdminReqBodyBuilder,v:Ref<PatchReserveConfigAdminReqBodyBuilder>)
	export function unRefPatchReserveConfigAdminReqBodyBuilder(v:Ref<PatchReserveConfigAdminReqBodyBuilder>):PatchReserveConfigAdminReqBodyBuilder
	export function emptyMeetingEventMeetingBuilder():MeetingEventMeetingBuilder
	export function emptyRefMeetingEventMeetingBuilder():Ref<MeetingEventMeetingBuilder>
	export function refOfMeetingEventMeetingBuilder(x:MeetingEventMeetingBuilder,v:Ref<MeetingEventMeetingBuilder>)
	export function unRefMeetingEventMeetingBuilder(v:Ref<MeetingEventMeetingBuilder>):MeetingEventMeetingBuilder
	export function emptyP2RoomLevelDeletedV1Handler():P2RoomLevelDeletedV1Handler
	export function emptyRefP2RoomLevelDeletedV1Handler():Ref<P2RoomLevelDeletedV1Handler>
	export function refOfP2RoomLevelDeletedV1Handler(x:P2RoomLevelDeletedV1Handler,v:Ref<P2RoomLevelDeletedV1Handler>)
	export function unRefP2RoomLevelDeletedV1Handler(v:Ref<P2RoomLevelDeletedV1Handler>):P2RoomLevelDeletedV1Handler
	export function emptyParticipantQualityListExportReqBodyBuilder():ParticipantQualityListExportReqBodyBuilder
	export function emptyRefParticipantQualityListExportReqBodyBuilder():Ref<ParticipantQualityListExportReqBodyBuilder>
	export function refOfParticipantQualityListExportReqBodyBuilder(x:ParticipantQualityListExportReqBodyBuilder,v:Ref<ParticipantQualityListExportReqBodyBuilder>)
	export function unRefParticipantQualityListExportReqBodyBuilder(v:Ref<ParticipantQualityListExportReqBodyBuilder>):ParticipantQualityListExportReqBodyBuilder
	...
	export function emptySubscribeDepartmentBuilder():SubscribeDepartmentBuilder
	export function emptyRefSubscribeDepartmentBuilder():Ref<SubscribeDepartmentBuilder>
	export function refOfSubscribeDepartmentBuilder(x:SubscribeDepartmentBuilder,v:Ref<SubscribeDepartmentBuilder>)
	export function unRefSubscribeDepartmentBuilder(v:Ref<SubscribeDepartmentBuilder>):SubscribeDepartmentBuilder
	export function emptyMyAiVcAnalysisResultBuilder():MyAiVcAnalysisResultBuilder
	export function emptyRefMyAiVcAnalysisResultBuilder():Ref<MyAiVcAnalysisResultBuilder>
	export function refOfMyAiVcAnalysisResultBuilder(x:MyAiVcAnalysisResultBuilder,v:Ref<MyAiVcAnalysisResultBuilder>)
	export function unRefMyAiVcAnalysisResultBuilder(v:Ref<MyAiVcAnalysisResultBuilder>):MyAiVcAnalysisResultBuilder
	...
	export function emptySetPermissionMeetingRecordingPathReqBodyBuilder():SetPermissionMeetingRecordingPathReqBodyBuilder
	export function emptyRefSetPermissionMeetingRecordingPathReqBodyBuilder():Ref<SetPermissionMeetingRecordingPathReqBodyBuilder>
	export function refOfSetPermissionMeetingRecordingPathReqBodyBuilder(x:SetPermissionMeetingRecordingPathReqBodyBuilder,v:Ref<SetPermissionMeetingRecordingPathReqBodyBuilder>)
	export function unRefSetPermissionMeetingRecordingPathReqBodyBuilder(v:Ref<SetPermissionMeetingRecordingPathReqBodyBuilder>):SetPermissionMeetingRecordingPathReqBodyBuilder
	...
	export function emptyP2MeetingAllMeetingEndedV1Handler():P2MeetingAllMeetingEndedV1Handler
	export function emptyRefP2MeetingAllMeetingEndedV1Handler():Ref<P2MeetingAllMeetingEndedV1Handler>
	export function refOfP2MeetingAllMeetingEndedV1Handler(x:P2MeetingAllMeetingEndedV1Handler,v:Ref<P2MeetingAllMeetingEndedV1Handler>)
	export function unRefP2MeetingAllMeetingEndedV1Handler(v:Ref<P2MeetingAllMeetingEndedV1Handler>):P2MeetingAllMeetingEndedV1Handler
