...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/vc/v1'{
	...
	// @ts-ignore
	import type {int,Ref,Struct,error,bool,float64} from 'go'
	//0
	...
	export interface P2MeetingAllMeetingStartedV1 extends larkevent.EventHandlerModel,Struct<P2MeetingAllMeetingStartedV1>{
	...
	export interface P2MeetingRecordingReadyV1 extends larkevent.EventHandlerModel,Struct<P2MeetingRecordingReadyV1>{
	...
	export interface P2RoomCreatedV1Handler extends Struct<P2RoomCreatedV1Handler>,larkevent.EventHandler{

			event():any
			handle(ctx:context.Context,event:any)/*error*/
	}
	export interface P2RoomDeletedV1 extends larkevent.EventHandlerModel,Struct<P2RoomDeletedV1>{
	...
	export interface P2RoomLevelUpdatedV1 extends larkevent.EventHandlerModel,Struct<P2RoomLevelUpdatedV1>{
