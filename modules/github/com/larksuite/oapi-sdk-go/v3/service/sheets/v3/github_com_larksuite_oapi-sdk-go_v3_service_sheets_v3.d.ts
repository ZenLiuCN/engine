...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/sheets/v3'{
	...
	export function emptyFindBuilder():FindBuilder
	export function emptyRefFindBuilder():Ref<FindBuilder>
	export function refOfFindBuilder(x:FindBuilder,v:Ref<FindBuilder>)
	export function unRefFindBuilder(v:Ref<FindBuilder>):FindBuilder
	...
	export function emptyCreateDataValidationBuilder():CreateDataValidationBuilder
	export function emptyRefCreateDataValidationBuilder():Ref<CreateDataValidationBuilder>
	export function refOfCreateDataValidationBuilder(x:CreateDataValidationBuilder,v:Ref<CreateDataValidationBuilder>)
	export function unRefCreateDataValidationBuilder(v:Ref<CreateDataValidationBuilder>):CreateDataValidationBuilder
	...
	export function emptyPatchSpreadsheetSheetFloatImageReqBuilder():PatchSpreadsheetSheetFloatImageReqBuilder
	export function emptyRefPatchSpreadsheetSheetFloatImageReqBuilder():Ref<PatchSpreadsheetSheetFloatImageReqBuilder>
	export function refOfPatchSpreadsheetSheetFloatImageReqBuilder(x:PatchSpreadsheetSheetFloatImageReqBuilder,v:Ref<PatchSpreadsheetSheetFloatImageReqBuilder>)
	export function unRefPatchSpreadsheetSheetFloatImageReqBuilder(v:Ref<PatchSpreadsheetSheetFloatImageReqBuilder>):PatchSpreadsheetSheetFloatImageReqBuilder
	export function emptyGridPropertiesBuilder():GridPropertiesBuilder
	export function emptyRefGridPropertiesBuilder():Ref<GridPropertiesBuilder>
	export function refOfGridPropertiesBuilder(x:GridPropertiesBuilder,v:Ref<GridPropertiesBuilder>)
	export function unRefGridPropertiesBuilder(v:Ref<GridPropertiesBuilder>):GridPropertiesBuilder
	...
	export function emptyPatchDataValidationBuilder():PatchDataValidationBuilder
	export function emptyRefPatchDataValidationBuilder():Ref<PatchDataValidationBuilder>
	export function refOfPatchDataValidationBuilder(x:PatchDataValidationBuilder,v:Ref<PatchDataValidationBuilder>)
	export function unRefPatchDataValidationBuilder(v:Ref<PatchDataValidationBuilder>):PatchDataValidationBuilder
	...
	export function emptyProtectedColumnsBuilder():ProtectedColumnsBuilder
	export function emptyRefProtectedColumnsBuilder():Ref<ProtectedColumnsBuilder>
	export function refOfProtectedColumnsBuilder(x:ProtectedColumnsBuilder,v:Ref<ProtectedColumnsBuilder>)
	export function unRefProtectedColumnsBuilder(v:Ref<ProtectedColumnsBuilder>):ProtectedColumnsBuilder
	export function emptyCreateSpreadsheetReqBuilder():CreateSpreadsheetReqBuilder
	export function emptyRefCreateSpreadsheetReqBuilder():Ref<CreateSpreadsheetReqBuilder>
	export function refOfCreateSpreadsheetReqBuilder(x:CreateSpreadsheetReqBuilder,v:Ref<CreateSpreadsheetReqBuilder>)
	export function unRefCreateSpreadsheetReqBuilder(v:Ref<CreateSpreadsheetReqBuilder>):CreateSpreadsheetReqBuilder
	...
	export function emptyOptionPropertiesBuilder():OptionPropertiesBuilder
	export function emptyRefOptionPropertiesBuilder():Ref<OptionPropertiesBuilder>
	export function refOfOptionPropertiesBuilder(x:OptionPropertiesBuilder,v:Ref<OptionPropertiesBuilder>)
	export function unRefOptionPropertiesBuilder(v:Ref<OptionPropertiesBuilder>):OptionPropertiesBuilder
	...
	export function emptyClearStyleRangesBuilder():ClearStyleRangesBuilder
	export function emptyRefClearStyleRangesBuilder():Ref<ClearStyleRangesBuilder>
	export function refOfClearStyleRangesBuilder(x:ClearStyleRangesBuilder,v:Ref<ClearStyleRangesBuilder>)
	export function unRefClearStyleRangesBuilder(v:Ref<ClearStyleRangesBuilder>):ClearStyleRangesBuilder
	...
	export function emptyPatchProtectedRangeEditorsBuilder():PatchProtectedRangeEditorsBuilder
	export function emptyRefPatchProtectedRangeEditorsBuilder():Ref<PatchProtectedRangeEditorsBuilder>
	export function refOfPatchProtectedRangeEditorsBuilder(x:PatchProtectedRangeEditorsBuilder,v:Ref<PatchProtectedRangeEditorsBuilder>)
	export function unRefPatchProtectedRangeEditorsBuilder(v:Ref<PatchProtectedRangeEditorsBuilder>):PatchProtectedRangeEditorsBuilder
	...
	export function emptyRichValueBuilder():RichValueBuilder
	export function emptyRefRichValueBuilder():Ref<RichValueBuilder>
	export function refOfRichValueBuilder(x:RichValueBuilder,v:Ref<RichValueBuilder>)
	export function unRefRichValueBuilder(v:Ref<RichValueBuilder>):RichValueBuilder
	...
	export function emptyMergeCellBuilder():MergeCellBuilder
	export function emptyRefMergeCellBuilder():Ref<MergeCellBuilder>
	export function refOfMergeCellBuilder(x:MergeCellBuilder,v:Ref<MergeCellBuilder>)
	export function unRefMergeCellBuilder(v:Ref<MergeCellBuilder>):MergeCellBuilder
	export function emptyMoveDimensionSpreadsheetSheetReqBuilder():MoveDimensionSpreadsheetSheetReqBuilder
	export function emptyRefMoveDimensionSpreadsheetSheetReqBuilder():Ref<MoveDimensionSpreadsheetSheetReqBuilder>
	export function refOfMoveDimensionSpreadsheetSheetReqBuilder(x:MoveDimensionSpreadsheetSheetReqBuilder,v:Ref<MoveDimensionSpreadsheetSheetReqBuilder>)
	export function unRefMoveDimensionSpreadsheetSheetReqBuilder(v:Ref<MoveDimensionSpreadsheetSheetReqBuilder>):MoveDimensionSpreadsheetSheetReqBuilder
	...
	export function emptyConditionalFormatRangeBuilder():ConditionalFormatRangeBuilder
	export function emptyRefConditionalFormatRangeBuilder():Ref<ConditionalFormatRangeBuilder>
	export function refOfConditionalFormatRangeBuilder(x:ConditionalFormatRangeBuilder,v:Ref<ConditionalFormatRangeBuilder>)
	export function unRefConditionalFormatRangeBuilder(v:Ref<ConditionalFormatRangeBuilder>):ConditionalFormatRangeBuilder
	...
	export function emptyDeleteSpreadsheetSheetFilterViewReqBuilder():DeleteSpreadsheetSheetFilterViewReqBuilder
	export function emptyRefDeleteSpreadsheetSheetFilterViewReqBuilder():Ref<DeleteSpreadsheetSheetFilterViewReqBuilder>
	export function refOfDeleteSpreadsheetSheetFilterViewReqBuilder(x:DeleteSpreadsheetSheetFilterViewReqBuilder,v:Ref<DeleteSpreadsheetSheetFilterViewReqBuilder>)
	export function unRefDeleteSpreadsheetSheetFilterViewReqBuilder(v:Ref<DeleteSpreadsheetSheetFilterViewReqBuilder>):DeleteSpreadsheetSheetFilterViewReqBuilder
	...
	export function emptyUpdateSpreadsheetSheetFilterReqBuilder():UpdateSpreadsheetSheetFilterReqBuilder
	export function emptyRefUpdateSpreadsheetSheetFilterReqBuilder():Ref<UpdateSpreadsheetSheetFilterReqBuilder>
	export function refOfUpdateSpreadsheetSheetFilterReqBuilder(x:UpdateSpreadsheetSheetFilterReqBuilder,v:Ref<UpdateSpreadsheetSheetFilterReqBuilder>)
	export function unRefUpdateSpreadsheetSheetFilterReqBuilder(v:Ref<UpdateSpreadsheetSheetFilterReqBuilder>):UpdateSpreadsheetSheetFilterReqBuilder
	...
	export function emptyPatchConditionalFormatBuilder():PatchConditionalFormatBuilder
	export function emptyRefPatchConditionalFormatBuilder():Ref<PatchConditionalFormatBuilder>
	export function refOfPatchConditionalFormatBuilder(x:PatchConditionalFormatBuilder,v:Ref<PatchConditionalFormatBuilder>)
	export function unRefPatchConditionalFormatBuilder(v:Ref<PatchConditionalFormatBuilder>):PatchConditionalFormatBuilder
	...
	export function emptyLeftBorderStyleBuilder():LeftBorderStyleBuilder
	export function emptyRefLeftBorderStyleBuilder():Ref<LeftBorderStyleBuilder>
	export function refOfLeftBorderStyleBuilder(x:LeftBorderStyleBuilder,v:Ref<LeftBorderStyleBuilder>)
	export function unRefLeftBorderStyleBuilder(v:Ref<LeftBorderStyleBuilder>):LeftBorderStyleBuilder
	export function emptyQuerySpreadsheetSheetFloatImageReqBuilder():QuerySpreadsheetSheetFloatImageReqBuilder
	export function emptyRefQuerySpreadsheetSheetFloatImageReqBuilder():Ref<QuerySpreadsheetSheetFloatImageReqBuilder>
	export function refOfQuerySpreadsheetSheetFloatImageReqBuilder(x:QuerySpreadsheetSheetFloatImageReqBuilder,v:Ref<QuerySpreadsheetSheetFloatImageReqBuilder>)
	export function unRefQuerySpreadsheetSheetFloatImageReqBuilder(v:Ref<QuerySpreadsheetSheetFloatImageReqBuilder>):QuerySpreadsheetSheetFloatImageReqBuilder
	...
	export function emptyRichTextValueRangeBuilder():RichTextValueRangeBuilder
	export function emptyRefRichTextValueRangeBuilder():Ref<RichTextValueRangeBuilder>
	export function refOfRichTextValueRangeBuilder(x:RichTextValueRangeBuilder,v:Ref<RichTextValueRangeBuilder>)
	export function unRefRichTextValueRangeBuilder(v:Ref<RichTextValueRangeBuilder>):RichTextValueRangeBuilder
	export function emptyAddSheetBuilder():AddSheetBuilder
	export function emptyRefAddSheetBuilder():Ref<AddSheetBuilder>
	export function refOfAddSheetBuilder(x:AddSheetBuilder,v:Ref<AddSheetBuilder>)
	export function unRefAddSheetBuilder(v:Ref<AddSheetBuilder>):AddSheetBuilder
	export function emptyCreateSheetFilterBuilder():CreateSheetFilterBuilder
	export function emptyRefCreateSheetFilterBuilder():Ref<CreateSheetFilterBuilder>
	export function refOfCreateSheetFilterBuilder(x:CreateSheetFilterBuilder,v:Ref<CreateSheetFilterBuilder>)
	export function unRefCreateSheetFilterBuilder(v:Ref<CreateSheetFilterBuilder>):CreateSheetFilterBuilder
	...
	export function emptyUpdateSpreadsheetPropertiesBuilder():UpdateSpreadsheetPropertiesBuilder
	export function emptyRefUpdateSpreadsheetPropertiesBuilder():Ref<UpdateSpreadsheetPropertiesBuilder>
	export function refOfUpdateSpreadsheetPropertiesBuilder(x:UpdateSpreadsheetPropertiesBuilder,v:Ref<UpdateSpreadsheetPropertiesBuilder>)
	export function unRefUpdateSpreadsheetPropertiesBuilder(v:Ref<UpdateSpreadsheetPropertiesBuilder>):UpdateSpreadsheetPropertiesBuilder
	export function emptyInsertDimensionBuilder():InsertDimensionBuilder
	export function emptyRefInsertDimensionBuilder():Ref<InsertDimensionBuilder>
	export function refOfInsertDimensionBuilder(x:InsertDimensionBuilder,v:Ref<InsertDimensionBuilder>)
	export function unRefInsertDimensionBuilder(v:Ref<InsertDimensionBuilder>):InsertDimensionBuilder
	...
	export function emptySegmentStyleStyleBuilder():SegmentStyleStyleBuilder
	export function emptyRefSegmentStyleStyleBuilder():Ref<SegmentStyleStyleBuilder>
	export function refOfSegmentStyleStyleBuilder(x:SegmentStyleStyleBuilder,v:Ref<SegmentStyleStyleBuilder>)
	export function unRefSegmentStyleStyleBuilder(v:Ref<SegmentStyleStyleBuilder>):SegmentStyleStyleBuilder
	export function emptyBooleanRuleConditionBuilder():BooleanRuleConditionBuilder
	export function emptyRefBooleanRuleConditionBuilder():Ref<BooleanRuleConditionBuilder>
	export function refOfBooleanRuleConditionBuilder(x:BooleanRuleConditionBuilder,v:Ref<BooleanRuleConditionBuilder>)
	export function unRefBooleanRuleConditionBuilder(v:Ref<BooleanRuleConditionBuilder>):BooleanRuleConditionBuilder
	...
	export function emptyFindSpreadsheetSheetReqBuilder():FindSpreadsheetSheetReqBuilder
	export function emptyRefFindSpreadsheetSheetReqBuilder():Ref<FindSpreadsheetSheetReqBuilder>
	export function refOfFindSpreadsheetSheetReqBuilder(x:FindSpreadsheetSheetReqBuilder,v:Ref<FindSpreadsheetSheetReqBuilder>)
	export function unRefFindSpreadsheetSheetReqBuilder(v:Ref<FindSpreadsheetSheetReqBuilder>):FindSpreadsheetSheetReqBuilder
	...
	export function emptyProtectedRangeEditorsBuilder():ProtectedRangeEditorsBuilder
	export function emptyRefProtectedRangeEditorsBuilder():Ref<ProtectedRangeEditorsBuilder>
	export function refOfProtectedRangeEditorsBuilder(x:ProtectedRangeEditorsBuilder,v:Ref<ProtectedRangeEditorsBuilder>)
	export function unRefProtectedRangeEditorsBuilder(v:Ref<ProtectedRangeEditorsBuilder>):ProtectedRangeEditorsBuilder
	...
	export function emptyDataValidationRuleBuilder():DataValidationRuleBuilder
	export function emptyRefDataValidationRuleBuilder():Ref<DataValidationRuleBuilder>
	export function refOfDataValidationRuleBuilder(x:DataValidationRuleBuilder,v:Ref<DataValidationRuleBuilder>)
	export function unRefDataValidationRuleBuilder(v:Ref<DataValidationRuleBuilder>):DataValidationRuleBuilder
	export function emptyUpdateSheetFilterBuilder():UpdateSheetFilterBuilder
	export function emptyRefUpdateSheetFilterBuilder():Ref<UpdateSheetFilterBuilder>
	export function refOfUpdateSheetFilterBuilder(x:UpdateSheetFilterBuilder,v:Ref<UpdateSheetFilterBuilder>)
	export function unRefUpdateSheetFilterBuilder(v:Ref<UpdateSheetFilterBuilder>):UpdateSheetFilterBuilder
	export function emptyConditionalFormatRuleBuilder():ConditionalFormatRuleBuilder
	export function emptyRefConditionalFormatRuleBuilder():Ref<ConditionalFormatRuleBuilder>
	export function refOfConditionalFormatRuleBuilder(x:ConditionalFormatRuleBuilder,v:Ref<ConditionalFormatRuleBuilder>)
	export function unRefConditionalFormatRuleBuilder(v:Ref<ConditionalFormatRuleBuilder>):ConditionalFormatRuleBuilder
	...
	export function emptyGetSpreadsheetSheetFloatImageReqBuilder():GetSpreadsheetSheetFloatImageReqBuilder
	export function emptyRefGetSpreadsheetSheetFloatImageReqBuilder():Ref<GetSpreadsheetSheetFloatImageReqBuilder>
	export function refOfGetSpreadsheetSheetFloatImageReqBuilder(x:GetSpreadsheetSheetFloatImageReqBuilder,v:Ref<GetSpreadsheetSheetFloatImageReqBuilder>)
	export function unRefGetSpreadsheetSheetFloatImageReqBuilder(v:Ref<GetSpreadsheetSheetFloatImageReqBuilder>):GetSpreadsheetSheetFloatImageReqBuilder
	...
	export function emptyCheckboxBuilder():CheckboxBuilder
	export function emptyRefCheckboxBuilder():Ref<CheckboxBuilder>
	export function refOfCheckboxBuilder(x:CheckboxBuilder,v:Ref<CheckboxBuilder>)
	export function unRefCheckboxBuilder(v:Ref<CheckboxBuilder>):CheckboxBuilder
	...
	export function emptySingleOptionBuilder():SingleOptionBuilder
	export function emptyRefSingleOptionBuilder():Ref<SingleOptionBuilder>
	export function refOfSingleOptionBuilder(x:SingleOptionBuilder,v:Ref<SingleOptionBuilder>)
	export function unRefSingleOptionBuilder(v:Ref<SingleOptionBuilder>):SingleOptionBuilder
	export function emptyDeleteSpreadsheetSheetFilterViewConditionReqBuilder():DeleteSpreadsheetSheetFilterViewConditionReqBuilder
	export function emptyRefDeleteSpreadsheetSheetFilterViewConditionReqBuilder():Ref<DeleteSpreadsheetSheetFilterViewConditionReqBuilder>
	export function refOfDeleteSpreadsheetSheetFilterViewConditionReqBuilder(x:DeleteSpreadsheetSheetFilterViewConditionReqBuilder,v:Ref<DeleteSpreadsheetSheetFilterViewConditionReqBuilder>)
	export function unRefDeleteSpreadsheetSheetFilterViewConditionReqBuilder(v:Ref<DeleteSpreadsheetSheetFilterViewConditionReqBuilder>):DeleteSpreadsheetSheetFilterViewConditionReqBuilder
	...
	export function emptyUpdateGridPropertiesBuilder():UpdateGridPropertiesBuilder
	export function emptyRefUpdateGridPropertiesBuilder():Ref<UpdateGridPropertiesBuilder>
	export function refOfUpdateGridPropertiesBuilder(x:UpdateGridPropertiesBuilder,v:Ref<UpdateGridPropertiesBuilder>)
	export function unRefUpdateGridPropertiesBuilder(v:Ref<UpdateGridPropertiesBuilder>):UpdateGridPropertiesBuilder
	...
	export function emptyCreateSpreadsheetSheetFilterViewConditionReqBuilder():CreateSpreadsheetSheetFilterViewConditionReqBuilder
	export function emptyRefCreateSpreadsheetSheetFilterViewConditionReqBuilder():Ref<CreateSpreadsheetSheetFilterViewConditionReqBuilder>
	export function refOfCreateSpreadsheetSheetFilterViewConditionReqBuilder(x:CreateSpreadsheetSheetFilterViewConditionReqBuilder,v:Ref<CreateSpreadsheetSheetFilterViewConditionReqBuilder>)
	export function unRefCreateSpreadsheetSheetFilterViewConditionReqBuilder(v:Ref<CreateSpreadsheetSheetFilterViewConditionReqBuilder>):CreateSpreadsheetSheetFilterViewConditionReqBuilder
	export function emptyQuerySpreadsheetSheetReqBuilder():QuerySpreadsheetSheetReqBuilder
	export function emptyRefQuerySpreadsheetSheetReqBuilder():Ref<QuerySpreadsheetSheetReqBuilder>
	export function refOfQuerySpreadsheetSheetReqBuilder(x:QuerySpreadsheetSheetReqBuilder,v:Ref<QuerySpreadsheetSheetReqBuilder>)
	export function unRefQuerySpreadsheetSheetReqBuilder(v:Ref<QuerySpreadsheetSheetReqBuilder>):QuerySpreadsheetSheetReqBuilder
	...
	export function emptyFilterViewBuilder():FilterViewBuilder
	export function emptyRefFilterViewBuilder():Ref<FilterViewBuilder>
	export function refOfFilterViewBuilder(x:FilterViewBuilder,v:Ref<FilterViewBuilder>)
	export function unRefFilterViewBuilder(v:Ref<FilterViewBuilder>):FilterViewBuilder
	export function emptyMentionDocumentBuilder():MentionDocumentBuilder
	export function emptyRefMentionDocumentBuilder():Ref<MentionDocumentBuilder>
	export function refOfMentionDocumentBuilder(x:MentionDocumentBuilder,v:Ref<MentionDocumentBuilder>)
	export function unRefMentionDocumentBuilder(v:Ref<MentionDocumentBuilder>):MentionDocumentBuilder
	export function emptyPlainTextValueRangeBuilder():PlainTextValueRangeBuilder
	export function emptyRefPlainTextValueRangeBuilder():Ref<PlainTextValueRangeBuilder>
	export function refOfPlainTextValueRangeBuilder(x:PlainTextValueRangeBuilder,v:Ref<PlainTextValueRangeBuilder>)
	export function unRefPlainTextValueRangeBuilder(v:Ref<PlainTextValueRangeBuilder>):PlainTextValueRangeBuilder
	...
	export function emptyCellValueBuilder():CellValueBuilder
	export function emptyRefCellValueBuilder():Ref<CellValueBuilder>
	export function refOfCellValueBuilder(x:CellValueBuilder,v:Ref<CellValueBuilder>)
	export function unRefCellValueBuilder(v:Ref<CellValueBuilder>):CellValueBuilder
	export function emptyPatchSpreadsheetSheetFilterViewReqBuilder():PatchSpreadsheetSheetFilterViewReqBuilder
	export function emptyRefPatchSpreadsheetSheetFilterViewReqBuilder():Ref<PatchSpreadsheetSheetFilterViewReqBuilder>
	export function refOfPatchSpreadsheetSheetFilterViewReqBuilder(x:PatchSpreadsheetSheetFilterViewReqBuilder,v:Ref<PatchSpreadsheetSheetFilterViewReqBuilder>)
	export function unRefPatchSpreadsheetSheetFilterViewReqBuilder(v:Ref<PatchSpreadsheetSheetFilterViewReqBuilder>):PatchSpreadsheetSheetFilterViewReqBuilder
	...
	export function emptyTopBorderStyleBuilder():TopBorderStyleBuilder
	export function emptyRefTopBorderStyleBuilder():Ref<TopBorderStyleBuilder>
	export function refOfTopBorderStyleBuilder(x:TopBorderStyleBuilder,v:Ref<TopBorderStyleBuilder>)
	export function unRefTopBorderStyleBuilder(v:Ref<TopBorderStyleBuilder>):TopBorderStyleBuilder
	...
	export function emptyFormulaBuilder():FormulaBuilder
	export function emptyRefFormulaBuilder():Ref<FormulaBuilder>
	export function refOfFormulaBuilder(x:FormulaBuilder,v:Ref<FormulaBuilder>)
	export function unRefFormulaBuilder(v:Ref<FormulaBuilder>):FormulaBuilder
	...
	export function emptyFloatImageBuilder():FloatImageBuilder
	export function emptyRefFloatImageBuilder():Ref<FloatImageBuilder>
	export function refOfFloatImageBuilder(x:FloatImageBuilder,v:Ref<FloatImageBuilder>)
	export function unRefFloatImageBuilder(v:Ref<FloatImageBuilder>):FloatImageBuilder
	export function emptyDimensionPropertiesBuilder():DimensionPropertiesBuilder
	export function emptyRefDimensionPropertiesBuilder():Ref<DimensionPropertiesBuilder>
	export function refOfDimensionPropertiesBuilder(x:DimensionPropertiesBuilder,v:Ref<DimensionPropertiesBuilder>)
	export function unRefDimensionPropertiesBuilder(v:Ref<DimensionPropertiesBuilder>):DimensionPropertiesBuilder
	...
	export function emptyConditionalFormatBuilder():ConditionalFormatBuilder
	export function emptyRefConditionalFormatBuilder():Ref<ConditionalFormatBuilder>
	export function refOfConditionalFormatBuilder(x:ConditionalFormatBuilder,v:Ref<ConditionalFormatBuilder>)
	export function unRefConditionalFormatBuilder(v:Ref<ConditionalFormatBuilder>):ConditionalFormatBuilder
	export function emptyDataValidationBuilder():DataValidationBuilder
	export function emptyRefDataValidationBuilder():Ref<DataValidationBuilder>
	export function refOfDataValidationBuilder(x:DataValidationBuilder,v:Ref<DataValidationBuilder>)
	export function unRefDataValidationBuilder(v:Ref<DataValidationBuilder>):DataValidationBuilder
	export function emptySheetPropertiesBuilder():SheetPropertiesBuilder
	export function emptyRefSheetPropertiesBuilder():Ref<SheetPropertiesBuilder>
	export function refOfSheetPropertiesBuilder(x:SheetPropertiesBuilder,v:Ref<SheetPropertiesBuilder>)
	export function unRefSheetPropertiesBuilder(v:Ref<SheetPropertiesBuilder>):SheetPropertiesBuilder
	export function emptyUpdateDimensionPropertiesBuilder():UpdateDimensionPropertiesBuilder
	export function emptyRefUpdateDimensionPropertiesBuilder():Ref<UpdateDimensionPropertiesBuilder>
	export function refOfUpdateDimensionPropertiesBuilder(x:UpdateDimensionPropertiesBuilder,v:Ref<UpdateDimensionPropertiesBuilder>)
	export function unRefUpdateDimensionPropertiesBuilder(v:Ref<UpdateDimensionPropertiesBuilder>):UpdateDimensionPropertiesBuilder
	...
	export function emptyCreateSpreadsheetSheetFilterViewReqBuilder():CreateSpreadsheetSheetFilterViewReqBuilder
	export function emptyRefCreateSpreadsheetSheetFilterViewReqBuilder():Ref<CreateSpreadsheetSheetFilterViewReqBuilder>
	export function refOfCreateSpreadsheetSheetFilterViewReqBuilder(x:CreateSpreadsheetSheetFilterViewReqBuilder,v:Ref<CreateSpreadsheetSheetFilterViewReqBuilder>)
	export function unRefCreateSpreadsheetSheetFilterViewReqBuilder(v:Ref<CreateSpreadsheetSheetFilterViewReqBuilder>):CreateSpreadsheetSheetFilterViewReqBuilder
	...
	export function emptyUpdateSpreadsheetSheetFilterViewConditionReqBuilder():UpdateSpreadsheetSheetFilterViewConditionReqBuilder
	export function emptyRefUpdateSpreadsheetSheetFilterViewConditionReqBuilder():Ref<UpdateSpreadsheetSheetFilterViewConditionReqBuilder>
	export function refOfUpdateSpreadsheetSheetFilterViewConditionReqBuilder(x:UpdateSpreadsheetSheetFilterViewConditionReqBuilder,v:Ref<UpdateSpreadsheetSheetFilterViewConditionReqBuilder>)
	export function unRefUpdateSpreadsheetSheetFilterViewConditionReqBuilder(v:Ref<UpdateSpreadsheetSheetFilterViewConditionReqBuilder>):UpdateSpreadsheetSheetFilterViewConditionReqBuilder
	...
	export function emptySheetFilterInfoBuilder():SheetFilterInfoBuilder
	export function emptyRefSheetFilterInfoBuilder():Ref<SheetFilterInfoBuilder>
	export function refOfSheetFilterInfoBuilder(x:SheetFilterInfoBuilder,v:Ref<SheetFilterInfoBuilder>)
	export function unRefSheetFilterInfoBuilder(v:Ref<SheetFilterInfoBuilder>):SheetFilterInfoBuilder
	...
	export function emptyGetSpreadsheetSheetFilterReqBuilder():GetSpreadsheetSheetFilterReqBuilder
	export function emptyRefGetSpreadsheetSheetFilterReqBuilder():Ref<GetSpreadsheetSheetFilterReqBuilder>
	export function refOfGetSpreadsheetSheetFilterReqBuilder(x:GetSpreadsheetSheetFilterReqBuilder,v:Ref<GetSpreadsheetSheetFilterReqBuilder>)
	export function unRefGetSpreadsheetSheetFilterReqBuilder(v:Ref<GetSpreadsheetSheetFilterReqBuilder>):GetSpreadsheetSheetFilterReqBuilder
	export function emptyBottomBorderStyleBuilder():BottomBorderStyleBuilder
	export function emptyRefBottomBorderStyleBuilder():Ref<BottomBorderStyleBuilder>
	export function refOfBottomBorderStyleBuilder(x:BottomBorderStyleBuilder,v:Ref<BottomBorderStyleBuilder>)
	export function unRefBottomBorderStyleBuilder(v:Ref<BottomBorderStyleBuilder>):BottomBorderStyleBuilder
	...
	export function emptyTextBuilder():TextBuilder
	export function emptyRefTextBuilder():Ref<TextBuilder>
	export function refOfTextBuilder(x:TextBuilder,v:Ref<TextBuilder>)
	export function unRefTextBuilder(v:Ref<TextBuilder>):TextBuilder
	...
	export function emptyValueBuilder():ValueBuilder
	export function emptyRefValueBuilder():Ref<ValueBuilder>
	export function refOfValueBuilder(x:ValueBuilder,v:Ref<ValueBuilder>)
	export function unRefValueBuilder(v:Ref<ValueBuilder>):ValueBuilder
	export function emptyBitablePropertiesBuilder():BitablePropertiesBuilder
	export function emptyRefBitablePropertiesBuilder():Ref<BitablePropertiesBuilder>
	export function refOfBitablePropertiesBuilder(x:BitablePropertiesBuilder,v:Ref<BitablePropertiesBuilder>)
	export function unRefBitablePropertiesBuilder(v:Ref<BitablePropertiesBuilder>):BitablePropertiesBuilder
	...
	export function emptyCreateSpreadsheetSheetFloatImageReqBuilder():CreateSpreadsheetSheetFloatImageReqBuilder
	export function emptyRefCreateSpreadsheetSheetFloatImageReqBuilder():Ref<CreateSpreadsheetSheetFloatImageReqBuilder>
	export function refOfCreateSpreadsheetSheetFloatImageReqBuilder(x:CreateSpreadsheetSheetFloatImageReqBuilder,v:Ref<CreateSpreadsheetSheetFloatImageReqBuilder>)
	export function unRefCreateSpreadsheetSheetFloatImageReqBuilder(v:Ref<CreateSpreadsheetSheetFloatImageReqBuilder>):CreateSpreadsheetSheetFloatImageReqBuilder
	...
	export function emptySegmentStyleBuilder():SegmentStyleBuilder
	export function emptyRefSegmentStyleBuilder():Ref<SegmentStyleBuilder>
	export function refOfSegmentStyleBuilder(x:SegmentStyleBuilder,v:Ref<SegmentStyleBuilder>)
	export function unRefSegmentStyleBuilder(v:Ref<SegmentStyleBuilder>):SegmentStyleBuilder
	...
	export function emptyReplaceSpreadsheetSheetReqBuilder():ReplaceSpreadsheetSheetReqBuilder
	export function emptyRefReplaceSpreadsheetSheetReqBuilder():Ref<ReplaceSpreadsheetSheetReqBuilder>
	export function refOfReplaceSpreadsheetSheetReqBuilder(x:ReplaceSpreadsheetSheetReqBuilder,v:Ref<ReplaceSpreadsheetSheetReqBuilder>)
	export function unRefReplaceSpreadsheetSheetReqBuilder(v:Ref<ReplaceSpreadsheetSheetReqBuilder>):ReplaceSpreadsheetSheetReqBuilder
	export function emptyValueElementSingleOptionBuilder():ValueElementSingleOptionBuilder
	export function emptyRefValueElementSingleOptionBuilder():Ref<ValueElementSingleOptionBuilder>
	export function refOfValueElementSingleOptionBuilder(x:ValueElementSingleOptionBuilder,v:Ref<ValueElementSingleOptionBuilder>)
	export function unRefValueElementSingleOptionBuilder(v:Ref<ValueElementSingleOptionBuilder>):ValueElementSingleOptionBuilder
	...
	export function emptyMultiRangeBuilder():MultiRangeBuilder
	export function emptyRefMultiRangeBuilder():Ref<MultiRangeBuilder>
	export function refOfMultiRangeBuilder(x:MultiRangeBuilder,v:Ref<MultiRangeBuilder>)
	export function unRefMultiRangeBuilder(v:Ref<MultiRangeBuilder>):MultiRangeBuilder
	...
	export function emptySpreadsheetBuilder():SpreadsheetBuilder
	export function emptyRefSpreadsheetBuilder():Ref<SpreadsheetBuilder>
	export function refOfSpreadsheetBuilder(x:SpreadsheetBuilder,v:Ref<SpreadsheetBuilder>)
	export function unRefSpreadsheetBuilder(v:Ref<SpreadsheetBuilder>):SpreadsheetBuilder
	...
	export function emptyGetSpreadsheetSheetFilterViewReqBuilder():GetSpreadsheetSheetFilterViewReqBuilder
	export function emptyRefGetSpreadsheetSheetFilterViewReqBuilder():Ref<GetSpreadsheetSheetFilterViewReqBuilder>
	export function refOfGetSpreadsheetSheetFilterViewReqBuilder(x:GetSpreadsheetSheetFilterViewReqBuilder,v:Ref<GetSpreadsheetSheetFilterViewReqBuilder>)
	export function unRefGetSpreadsheetSheetFilterViewReqBuilder(v:Ref<GetSpreadsheetSheetFilterViewReqBuilder>):GetSpreadsheetSheetFilterViewReqBuilder
	...
	export function emptyDateTimeBuilder():DateTimeBuilder
	export function emptyRefDateTimeBuilder():Ref<DateTimeBuilder>
	export function refOfDateTimeBuilder(x:DateTimeBuilder,v:Ref<DateTimeBuilder>)
	export function unRefDateTimeBuilder(v:Ref<DateTimeBuilder>):DateTimeBuilder
	...
	export function emptyValueElementBuilder():ValueElementBuilder
	export function emptyRefValueElementBuilder():Ref<ValueElementBuilder>
	export function refOfValueElementBuilder(x:ValueElementBuilder,v:Ref<ValueElementBuilder>)
	export function unRefValueElementBuilder(v:Ref<ValueElementBuilder>):ValueElementBuilder
	export function emptyCellFontStyleBuilder():CellFontStyleBuilder
	export function emptyRefCellFontStyleBuilder():Ref<CellFontStyleBuilder>
	export function refOfCellFontStyleBuilder(x:CellFontStyleBuilder,v:Ref<CellFontStyleBuilder>)
	export function unRefCellFontStyleBuilder(v:Ref<CellFontStyleBuilder>):CellFontStyleBuilder
	...
	export function emptyGetSpreadsheetSheetFilterViewConditionReqBuilder():GetSpreadsheetSheetFilterViewConditionReqBuilder
	export function emptyRefGetSpreadsheetSheetFilterViewConditionReqBuilder():Ref<GetSpreadsheetSheetFilterViewConditionReqBuilder>
	export function refOfGetSpreadsheetSheetFilterViewConditionReqBuilder(x:GetSpreadsheetSheetFilterViewConditionReqBuilder,v:Ref<GetSpreadsheetSheetFilterViewConditionReqBuilder>)
	export function unRefGetSpreadsheetSheetFilterViewConditionReqBuilder(v:Ref<GetSpreadsheetSheetFilterViewConditionReqBuilder>):GetSpreadsheetSheetFilterViewConditionReqBuilder
	export function emptyProtectedRowsBuilder():ProtectedRowsBuilder
	export function emptyRefProtectedRowsBuilder():Ref<ProtectedRowsBuilder>
	export function refOfProtectedRowsBuilder(x:ProtectedRowsBuilder,v:Ref<ProtectedRowsBuilder>)
	export function unRefProtectedRowsBuilder(v:Ref<ProtectedRowsBuilder>):ProtectedRowsBuilder
	...
	export function emptyGetSpreadsheetBuilder():GetSpreadsheetBuilder
	export function emptyRefGetSpreadsheetBuilder():Ref<GetSpreadsheetBuilder>
	export function refOfGetSpreadsheetBuilder(x:GetSpreadsheetBuilder,v:Ref<GetSpreadsheetBuilder>)
	export function unRefGetSpreadsheetBuilder(v:Ref<GetSpreadsheetBuilder>):GetSpreadsheetBuilder
	...
	export function emptyQuerySpreadsheetSheetFilterViewReqBuilder():QuerySpreadsheetSheetFilterViewReqBuilder
	export function emptyRefQuerySpreadsheetSheetFilterViewReqBuilder():Ref<QuerySpreadsheetSheetFilterViewReqBuilder>
	export function refOfQuerySpreadsheetSheetFilterViewReqBuilder(x:QuerySpreadsheetSheetFilterViewReqBuilder,v:Ref<QuerySpreadsheetSheetFilterViewReqBuilder>)
	export function unRefQuerySpreadsheetSheetFilterViewReqBuilder(v:Ref<QuerySpreadsheetSheetFilterViewReqBuilder>):QuerySpreadsheetSheetFilterViewReqBuilder
	...
	export function emptyLinkBuilder():LinkBuilder
	export function emptyRefLinkBuilder():Ref<LinkBuilder>
	export function refOfLinkBuilder(x:LinkBuilder,v:Ref<LinkBuilder>)
	export function unRefLinkBuilder(v:Ref<LinkBuilder>):LinkBuilder
	export function emptyMentionUserBuilder():MentionUserBuilder
	export function emptyRefMentionUserBuilder():Ref<MentionUserBuilder>
	export function refOfMentionUserBuilder(x:MentionUserBuilder,v:Ref<MentionUserBuilder>)
	export function unRefMentionUserBuilder(v:Ref<MentionUserBuilder>):MentionUserBuilder
	export function emptyConditionalFormatStyleBuilder():ConditionalFormatStyleBuilder
	export function emptyRefConditionalFormatStyleBuilder():Ref<ConditionalFormatStyleBuilder>
	export function refOfConditionalFormatStyleBuilder(x:ConditionalFormatStyleBuilder,v:Ref<ConditionalFormatStyleBuilder>)
	export function unRefConditionalFormatStyleBuilder(v:Ref<ConditionalFormatStyleBuilder>):ConditionalFormatStyleBuilder
	...
	export function emptyGetSpreadsheetReqBuilder():GetSpreadsheetReqBuilder
	export function emptyRefGetSpreadsheetReqBuilder():Ref<GetSpreadsheetReqBuilder>
	export function refOfGetSpreadsheetReqBuilder(x:GetSpreadsheetReqBuilder,v:Ref<GetSpreadsheetReqBuilder>)
	export function unRefGetSpreadsheetReqBuilder(v:Ref<GetSpreadsheetReqBuilder>):GetSpreadsheetReqBuilder
	...
	export function emptyClearDataValidationBuilder():ClearDataValidationBuilder
	export function emptyRefClearDataValidationBuilder():Ref<ClearDataValidationBuilder>
	export function refOfClearDataValidationBuilder(x:ClearDataValidationBuilder,v:Ref<ClearDataValidationBuilder>)
	export function unRefClearDataValidationBuilder(v:Ref<ClearDataValidationBuilder>):ClearDataValidationBuilder
	...
	export function emptyStyleRangesBuilder():StyleRangesBuilder
	export function emptyRefStyleRangesBuilder():Ref<StyleRangesBuilder>
	export function refOfStyleRangesBuilder(x:StyleRangesBuilder,v:Ref<StyleRangesBuilder>)
	export function unRefStyleRangesBuilder(v:Ref<StyleRangesBuilder>):StyleRangesBuilder
	...
	export function emptyFilterViewConditionBuilder():FilterViewConditionBuilder
	export function emptyRefFilterViewConditionBuilder():Ref<FilterViewConditionBuilder>
	export function refOfFilterViewConditionBuilder(x:FilterViewConditionBuilder,v:Ref<FilterViewConditionBuilder>)
	export function unRefFilterViewConditionBuilder(v:Ref<FilterViewConditionBuilder>):FilterViewConditionBuilder
	export function emptyGetSpreadsheetSheetReqBuilder():GetSpreadsheetSheetReqBuilder
	export function emptyRefGetSpreadsheetSheetReqBuilder():Ref<GetSpreadsheetSheetReqBuilder>
	export function refOfGetSpreadsheetSheetReqBuilder(x:GetSpreadsheetSheetReqBuilder,v:Ref<GetSpreadsheetSheetReqBuilder>)
	export function unRefGetSpreadsheetSheetReqBuilder(v:Ref<GetSpreadsheetSheetReqBuilder>):GetSpreadsheetSheetReqBuilder
	...
	export function emptyStyleBuilder():StyleBuilder
	export function emptyRefStyleBuilder():Ref<StyleBuilder>
	export function refOfStyleBuilder(x:StyleBuilder,v:Ref<StyleBuilder>)
	export function unRefStyleBuilder(v:Ref<StyleBuilder>):StyleBuilder
	...
	export function emptyCellStyleBuilder():CellStyleBuilder
	export function emptyRefCellStyleBuilder():Ref<CellStyleBuilder>
	export function refOfCellStyleBuilder(x:CellStyleBuilder,v:Ref<CellStyleBuilder>)
	export function unRefCellStyleBuilder(v:Ref<CellStyleBuilder>):CellStyleBuilder
	...
	export function emptyDataValidationValueBuilder():DataValidationValueBuilder
	export function emptyRefDataValidationValueBuilder():Ref<DataValidationValueBuilder>
	export function refOfDataValidationValueBuilder(x:DataValidationValueBuilder,v:Ref<DataValidationValueBuilder>)
	export function unRefDataValidationValueBuilder(v:Ref<DataValidationValueBuilder>):DataValidationValueBuilder
	...
	export function emptyProtectedSheetBuilder():ProtectedSheetBuilder
	export function emptyRefProtectedSheetBuilder():Ref<ProtectedSheetBuilder>
	export function refOfProtectedSheetBuilder(x:ProtectedSheetBuilder,v:Ref<ProtectedSheetBuilder>)
	export function unRefProtectedSheetBuilder(v:Ref<ProtectedSheetBuilder>):ProtectedSheetBuilder
	...
	export function emptyDeleteSpreadsheetSheetFilterReqBuilder():DeleteSpreadsheetSheetFilterReqBuilder
	export function emptyRefDeleteSpreadsheetSheetFilterReqBuilder():Ref<DeleteSpreadsheetSheetFilterReqBuilder>
	export function refOfDeleteSpreadsheetSheetFilterReqBuilder(x:DeleteSpreadsheetSheetFilterReqBuilder,v:Ref<DeleteSpreadsheetSheetFilterReqBuilder>)
	export function unRefDeleteSpreadsheetSheetFilterReqBuilder(v:Ref<DeleteSpreadsheetSheetFilterReqBuilder>):DeleteSpreadsheetSheetFilterReqBuilder
	export function emptyMultipleOptionBuilder():MultipleOptionBuilder
	export function emptyRefMultipleOptionBuilder():Ref<MultipleOptionBuilder>
	export function refOfMultipleOptionBuilder(x:MultipleOptionBuilder,v:Ref<MultipleOptionBuilder>)
	export function unRefMultipleOptionBuilder(v:Ref<MultipleOptionBuilder>):MultipleOptionBuilder
	export function emptyPatchProtectedRangeBuilder():PatchProtectedRangeBuilder
	export function emptyRefPatchProtectedRangeBuilder():Ref<PatchProtectedRangeBuilder>
	export function refOfPatchProtectedRangeBuilder(x:PatchProtectedRangeBuilder,v:Ref<PatchProtectedRangeBuilder>)
	export function unRefPatchProtectedRangeBuilder(v:Ref<PatchProtectedRangeBuilder>):PatchProtectedRangeBuilder
	...
	export function emptyBoolRuleValueBuilder():BoolRuleValueBuilder
	export function emptyRefBoolRuleValueBuilder():Ref<BoolRuleValueBuilder>
	export function refOfBoolRuleValueBuilder(x:BoolRuleValueBuilder,v:Ref<BoolRuleValueBuilder>)
	export function unRefBoolRuleValueBuilder(v:Ref<BoolRuleValueBuilder>):BoolRuleValueBuilder
	export function emptyCreateSpreadsheetSheetFilterReqBuilder():CreateSpreadsheetSheetFilterReqBuilder
	export function emptyRefCreateSpreadsheetSheetFilterReqBuilder():Ref<CreateSpreadsheetSheetFilterReqBuilder>
	export function refOfCreateSpreadsheetSheetFilterReqBuilder(x:CreateSpreadsheetSheetFilterReqBuilder,v:Ref<CreateSpreadsheetSheetFilterReqBuilder>)
	export function unRefCreateSpreadsheetSheetFilterReqBuilder(v:Ref<CreateSpreadsheetSheetFilterReqBuilder>):CreateSpreadsheetSheetFilterReqBuilder
	...
	export function emptyRightBorderStyleBuilder():RightBorderStyleBuilder
	export function emptyRefRightBorderStyleBuilder():Ref<RightBorderStyleBuilder>
	export function refOfRightBorderStyleBuilder(x:RightBorderStyleBuilder,v:Ref<RightBorderStyleBuilder>)
	export function unRefRightBorderStyleBuilder(v:Ref<RightBorderStyleBuilder>):RightBorderStyleBuilder
	export function emptySheetBuilder():SheetBuilder
	export function emptyRefSheetBuilder():Ref<SheetBuilder>
	export function refOfSheetBuilder(x:SheetBuilder,v:Ref<SheetBuilder>)
	export function unRefSheetBuilder(v:Ref<SheetBuilder>):SheetBuilder
	...
	export function emptyFindReplaceResultBuilder():FindReplaceResultBuilder
	export function emptyRefFindReplaceResultBuilder():Ref<FindReplaceResultBuilder>
	export function refOfFindReplaceResultBuilder(x:FindReplaceResultBuilder,v:Ref<FindReplaceResultBuilder>)
	export function unRefFindReplaceResultBuilder(v:Ref<FindReplaceResultBuilder>):FindReplaceResultBuilder
	...
	export function emptyMoveDimensionBuilder():MoveDimensionBuilder
	export function emptyRefMoveDimensionBuilder():Ref<MoveDimensionBuilder>
	export function refOfMoveDimensionBuilder(x:MoveDimensionBuilder,v:Ref<MoveDimensionBuilder>)
	export function unRefMoveDimensionBuilder(v:Ref<MoveDimensionBuilder>):MoveDimensionBuilder
	export function emptyPatchSpreadsheetReqBuilder():PatchSpreadsheetReqBuilder
	export function emptyRefPatchSpreadsheetReqBuilder():Ref<PatchSpreadsheetReqBuilder>
	export function refOfPatchSpreadsheetReqBuilder(x:PatchSpreadsheetReqBuilder,v:Ref<PatchSpreadsheetReqBuilder>)
	export function unRefPatchSpreadsheetReqBuilder(v:Ref<PatchSpreadsheetReqBuilder>):PatchSpreadsheetReqBuilder
	...
	export function emptyReplaceBuilder():ReplaceBuilder
	export function emptyRefReplaceBuilder():Ref<ReplaceBuilder>
	export function refOfReplaceBuilder(x:ReplaceBuilder,v:Ref<ReplaceBuilder>)
	export function unRefReplaceBuilder(v:Ref<ReplaceBuilder>):ReplaceBuilder
	...
	export function emptyAlignmentStyleBuilder():AlignmentStyleBuilder
	export function emptyRefAlignmentStyleBuilder():Ref<AlignmentStyleBuilder>
	export function refOfAlignmentStyleBuilder(x:AlignmentStyleBuilder,v:Ref<AlignmentStyleBuilder>)
	export function unRefAlignmentStyleBuilder(v:Ref<AlignmentStyleBuilder>):AlignmentStyleBuilder
	export function emptyBorderStyleBuilder():BorderStyleBuilder
	export function emptyRefBorderStyleBuilder():Ref<BorderStyleBuilder>
	export function refOfBorderStyleBuilder(x:BorderStyleBuilder,v:Ref<BorderStyleBuilder>)
	export function unRefBorderStyleBuilder(v:Ref<BorderStyleBuilder>):BorderStyleBuilder
	...
	export function emptyQuerySpreadsheetSheetFilterViewConditionReqBuilder():QuerySpreadsheetSheetFilterViewConditionReqBuilder
	export function emptyRefQuerySpreadsheetSheetFilterViewConditionReqBuilder():Ref<QuerySpreadsheetSheetFilterViewConditionReqBuilder>
	export function refOfQuerySpreadsheetSheetFilterViewConditionReqBuilder(x:QuerySpreadsheetSheetFilterViewConditionReqBuilder,v:Ref<QuerySpreadsheetSheetFilterViewConditionReqBuilder>)
	export function unRefQuerySpreadsheetSheetFilterViewConditionReqBuilder(v:Ref<QuerySpreadsheetSheetFilterViewConditionReqBuilder>):QuerySpreadsheetSheetFilterViewConditionReqBuilder
	...
	export function emptyProtectedRangeBuilder():ProtectedRangeBuilder
	export function emptyRefProtectedRangeBuilder():Ref<ProtectedRangeBuilder>
	export function refOfProtectedRangeBuilder(x:ProtectedRangeBuilder,v:Ref<ProtectedRangeBuilder>)
	export function unRefProtectedRangeBuilder(v:Ref<ProtectedRangeBuilder>):ProtectedRangeBuilder
	...
	export function emptyDeleteSpreadsheetSheetFloatImageReqBuilder():DeleteSpreadsheetSheetFloatImageReqBuilder
	export function emptyRefDeleteSpreadsheetSheetFloatImageReqBuilder():Ref<DeleteSpreadsheetSheetFloatImageReqBuilder>
	export function refOfDeleteSpreadsheetSheetFloatImageReqBuilder(x:DeleteSpreadsheetSheetFloatImageReqBuilder,v:Ref<DeleteSpreadsheetSheetFloatImageReqBuilder>)
	export function unRefDeleteSpreadsheetSheetFloatImageReqBuilder(v:Ref<DeleteSpreadsheetSheetFloatImageReqBuilder>):DeleteSpreadsheetSheetFloatImageReqBuilder
	...
	export function emptyFindConditionBuilder():FindConditionBuilder
	export function emptyRefFindConditionBuilder():Ref<FindConditionBuilder>
	export function refOfFindConditionBuilder(x:FindConditionBuilder,v:Ref<FindConditionBuilder>)
	export function unRefFindConditionBuilder(v:Ref<FindConditionBuilder>):FindConditionBuilder
	...
	export function emptyMergeRangeBuilder():MergeRangeBuilder
	export function emptyRefMergeRangeBuilder():Ref<MergeRangeBuilder>
	export function refOfMergeRangeBuilder(x:MergeRangeBuilder,v:Ref<MergeRangeBuilder>)
	export function unRefMergeRangeBuilder(v:Ref<MergeRangeBuilder>):MergeRangeBuilder
	export function emptyAppendDimensionBuilder():AppendDimensionBuilder
	export function emptyRefAppendDimensionBuilder():Ref<AppendDimensionBuilder>
	export function refOfAppendDimensionBuilder(x:AppendDimensionBuilder,v:Ref<AppendDimensionBuilder>)
	export function unRefAppendDimensionBuilder(v:Ref<AppendDimensionBuilder>):AppendDimensionBuilder
	export function emptyClearStyleMultiRangeBuilder():ClearStyleMultiRangeBuilder
	export function emptyRefClearStyleMultiRangeBuilder():Ref<ClearStyleMultiRangeBuilder>
	export function refOfClearStyleMultiRangeBuilder(x:ClearStyleMultiRangeBuilder,v:Ref<ClearStyleMultiRangeBuilder>)
	export function unRefClearStyleMultiRangeBuilder(v:Ref<ClearStyleMultiRangeBuilder>):ClearStyleMultiRangeBuilder
}