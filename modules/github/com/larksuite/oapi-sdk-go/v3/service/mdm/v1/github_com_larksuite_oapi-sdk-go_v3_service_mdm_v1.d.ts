...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/mdm/v1'{
	...
	export function emptyGlAccountBuilder():GlAccountBuilder
	export function emptyRefGlAccountBuilder():Ref<GlAccountBuilder>
	export function refOfGlAccountBuilder(x:GlAccountBuilder,v:Ref<GlAccountBuilder>)
	export function unRefGlAccountBuilder(v:Ref<GlAccountBuilder>):GlAccountBuilder
	export function emptyLegalEntityBuilder():LegalEntityBuilder
	export function emptyRefLegalEntityBuilder():Ref<LegalEntityBuilder>
	export function refOfLegalEntityBuilder(x:LegalEntityBuilder,v:Ref<LegalEntityBuilder>)
	export function unRefLegalEntityBuilder(v:Ref<LegalEntityBuilder>):LegalEntityBuilder
	...
	export function emptyConfigBuilder():ConfigBuilder
	export function emptyRefConfigBuilder():Ref<ConfigBuilder>
	export function refOfConfigBuilder(x:ConfigBuilder,v:Ref<ConfigBuilder>)
	export function unRefConfigBuilder(v:Ref<ConfigBuilder>):ConfigBuilder
	export function emptyDepartmentCostCenterRelationshipBuilder():DepartmentCostCenterRelationshipBuilder
	export function emptyRefDepartmentCostCenterRelationshipBuilder():Ref<DepartmentCostCenterRelationshipBuilder>
	export function refOfDepartmentCostCenterRelationshipBuilder(x:DepartmentCostCenterRelationshipBuilder,v:Ref<DepartmentCostCenterRelationshipBuilder>)
	export function unRefDepartmentCostCenterRelationshipBuilder(v:Ref<DepartmentCostCenterRelationshipBuilder>):DepartmentCostCenterRelationshipBuilder
	...
	export function emptyCompanyAssetBuilder():CompanyAssetBuilder
	export function emptyRefCompanyAssetBuilder():Ref<CompanyAssetBuilder>
	export function refOfCompanyAssetBuilder(x:CompanyAssetBuilder,v:Ref<CompanyAssetBuilder>)
	export function unRefCompanyAssetBuilder(v:Ref<CompanyAssetBuilder>):CompanyAssetBuilder
	...
	export function emptyInternalOrderBuilder():InternalOrderBuilder
	export function emptyRefInternalOrderBuilder():Ref<InternalOrderBuilder>
	export function refOfInternalOrderBuilder(x:InternalOrderBuilder,v:Ref<InternalOrderBuilder>)
	export function unRefInternalOrderBuilder(v:Ref<InternalOrderBuilder>):InternalOrderBuilder
	...
	export function emptyProjectBuilder():ProjectBuilder
	export function emptyRefProjectBuilder():Ref<ProjectBuilder>
	export function refOfProjectBuilder(x:ProjectBuilder,v:Ref<ProjectBuilder>)
	export function unRefProjectBuilder(v:Ref<ProjectBuilder>):ProjectBuilder
	export function emptyVendorAccountBuilder():VendorAccountBuilder
	export function emptyRefVendorAccountBuilder():Ref<VendorAccountBuilder>
	export function refOfVendorAccountBuilder(x:VendorAccountBuilder,v:Ref<VendorAccountBuilder>)
	export function unRefVendorAccountBuilder(v:Ref<VendorAccountBuilder>):VendorAccountBuilder
	export function emptyDepartmentId():DepartmentId
	export function emptyRefDepartmentId():Ref<DepartmentId>
	export function refOfDepartmentId(x:DepartmentId,v:Ref<DepartmentId>)
	export function unRefDepartmentId(v:Ref<DepartmentId>):DepartmentId
	export function emptyFixedExchangeRateBuilder():FixedExchangeRateBuilder
	export function emptyRefFixedExchangeRateBuilder():Ref<FixedExchangeRateBuilder>
	export function refOfFixedExchangeRateBuilder(x:FixedExchangeRateBuilder,v:Ref<FixedExchangeRateBuilder>)
	export function unRefFixedExchangeRateBuilder(v:Ref<FixedExchangeRateBuilder>):FixedExchangeRateBuilder
	...
	export function emptyVendorAddressBuilder():VendorAddressBuilder
	export function emptyRefVendorAddressBuilder():Ref<VendorAddressBuilder>
	export function refOfVendorAddressBuilder(x:VendorAddressBuilder,v:Ref<VendorAddressBuilder>)
	export function unRefVendorAddressBuilder(v:Ref<VendorAddressBuilder>):VendorAddressBuilder
	...
	export function emptyCompanyCompanyBankAccountBuilder():CompanyCompanyBankAccountBuilder
	export function emptyRefCompanyCompanyBankAccountBuilder():Ref<CompanyCompanyBankAccountBuilder>
	export function refOfCompanyCompanyBankAccountBuilder(x:CompanyCompanyBankAccountBuilder,v:Ref<CompanyCompanyBankAccountBuilder>)
	export function unRefCompanyCompanyBankAccountBuilder(v:Ref<CompanyCompanyBankAccountBuilder>):CompanyCompanyBankAccountBuilder
	...
	export function emptyI18nStructBuilder():I18nStructBuilder
	export function emptyRefI18nStructBuilder():Ref<I18nStructBuilder>
	export function refOfI18nStructBuilder(x:I18nStructBuilder,v:Ref<I18nStructBuilder>)
	export function unRefI18nStructBuilder(v:Ref<I18nStructBuilder>):I18nStructBuilder
	...
	export function emptyBindUserAuthDataRelationReqBuilder():BindUserAuthDataRelationReqBuilder
	export function emptyRefBindUserAuthDataRelationReqBuilder():Ref<BindUserAuthDataRelationReqBuilder>
	export function refOfBindUserAuthDataRelationReqBuilder(x:BindUserAuthDataRelationReqBuilder,v:Ref<BindUserAuthDataRelationReqBuilder>)
	export function unRefBindUserAuthDataRelationReqBuilder(v:Ref<BindUserAuthDataRelationReqBuilder>):BindUserAuthDataRelationReqBuilder
	...
	export function emptyMultiLanguageBuilder():MultiLanguageBuilder
	export function emptyRefMultiLanguageBuilder():Ref<MultiLanguageBuilder>
	export function refOfMultiLanguageBuilder(x:MultiLanguageBuilder,v:Ref<MultiLanguageBuilder>)
	export function unRefMultiLanguageBuilder(v:Ref<MultiLanguageBuilder>):MultiLanguageBuilder
	export function emptyVendorBuilder():VendorBuilder
	export function emptyRefVendorBuilder():Ref<VendorBuilder>
	export function refOfVendorBuilder(x:VendorBuilder,v:Ref<VendorBuilder>)
	export function unRefVendorBuilder(v:Ref<VendorBuilder>):VendorBuilder
	export function emptyOpenApiUpdateVendorBuilder():OpenApiUpdateVendorBuilder
	export function emptyRefOpenApiUpdateVendorBuilder():Ref<OpenApiUpdateVendorBuilder>
	export function refOfOpenApiUpdateVendorBuilder(x:OpenApiUpdateVendorBuilder,v:Ref<OpenApiUpdateVendorBuilder>)
	export function unRefOpenApiUpdateVendorBuilder(v:Ref<OpenApiUpdateVendorBuilder>):OpenApiUpdateVendorBuilder
	export function emptyUserAuthDataRelationBuilder():UserAuthDataRelationBuilder
	export function emptyRefUserAuthDataRelationBuilder():Ref<UserAuthDataRelationBuilder>
	export function refOfUserAuthDataRelationBuilder(x:UserAuthDataRelationBuilder,v:Ref<UserAuthDataRelationBuilder>)
	export function unRefUserAuthDataRelationBuilder(v:Ref<UserAuthDataRelationBuilder>):UserAuthDataRelationBuilder
	export function emptyVendorContactBuilder():VendorContactBuilder
	export function emptyRefVendorContactBuilder():Ref<VendorContactBuilder>
	export function refOfVendorContactBuilder(x:VendorContactBuilder,v:Ref<VendorContactBuilder>)
	export function unRefVendorContactBuilder(v:Ref<VendorContactBuilder>):VendorContactBuilder
	...
	export function emptyLegalEntityBankBuilder():LegalEntityBankBuilder
	export function emptyRefLegalEntityBankBuilder():Ref<LegalEntityBankBuilder>
	export function refOfLegalEntityBankBuilder(x:LegalEntityBankBuilder,v:Ref<LegalEntityBankBuilder>)
	export function unRefLegalEntityBankBuilder(v:Ref<LegalEntityBankBuilder>):LegalEntityBankBuilder
	...
	export function emptyUnbindUserAuthDataRelationReqBuilder():UnbindUserAuthDataRelationReqBuilder
	export function emptyRefUnbindUserAuthDataRelationReqBuilder():Ref<UnbindUserAuthDataRelationReqBuilder>
	export function refOfUnbindUserAuthDataRelationReqBuilder(x:UnbindUserAuthDataRelationReqBuilder,v:Ref<UnbindUserAuthDataRelationReqBuilder>)
	export function unRefUnbindUserAuthDataRelationReqBuilder(v:Ref<UnbindUserAuthDataRelationReqBuilder>):UnbindUserAuthDataRelationReqBuilder
	...
	export function emptyAppendixBuilder():AppendixBuilder
	export function emptyRefAppendixBuilder():Ref<AppendixBuilder>
	export function refOfAppendixBuilder(x:AppendixBuilder,v:Ref<AppendixBuilder>)
	export function unRefAppendixBuilder(v:Ref<AppendixBuilder>):AppendixBuilder
	...
	export function emptyProjectCompanyDeptMappingBuilder():ProjectCompanyDeptMappingBuilder
	export function emptyRefProjectCompanyDeptMappingBuilder():Ref<ProjectCompanyDeptMappingBuilder>
	export function refOfProjectCompanyDeptMappingBuilder(x:ProjectCompanyDeptMappingBuilder,v:Ref<ProjectCompanyDeptMappingBuilder>)
	export function unRefProjectCompanyDeptMappingBuilder(v:Ref<ProjectCompanyDeptMappingBuilder>):ProjectCompanyDeptMappingBuilder
	...
	export function emptyExtendFieldBuilder():ExtendFieldBuilder
	export function emptyRefExtendFieldBuilder():Ref<ExtendFieldBuilder>
	export function refOfExtendFieldBuilder(x:ExtendFieldBuilder,v:Ref<ExtendFieldBuilder>)
	export function unRefExtendFieldBuilder(v:Ref<ExtendFieldBuilder>):ExtendFieldBuilder
	export function emptyVendorCompanyViewBuilder():VendorCompanyViewBuilder
	export function emptyRefVendorCompanyViewBuilder():Ref<VendorCompanyViewBuilder>
	export function refOfVendorCompanyViewBuilder(x:VendorCompanyViewBuilder,v:Ref<VendorCompanyViewBuilder>)
	export function unRefVendorCompanyViewBuilder(v:Ref<VendorCompanyViewBuilder>):VendorCompanyViewBuilder
	...
	export function emptyGlAccountCompanyRelationshipBuilder():GlAccountCompanyRelationshipBuilder
	export function emptyRefGlAccountCompanyRelationshipBuilder():Ref<GlAccountCompanyRelationshipBuilder>
	export function refOfGlAccountCompanyRelationshipBuilder(x:GlAccountCompanyRelationshipBuilder,v:Ref<GlAccountCompanyRelationshipBuilder>)
	export function unRefGlAccountCompanyRelationshipBuilder(v:Ref<GlAccountCompanyRelationshipBuilder>):GlAccountCompanyRelationshipBuilder
