...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/contact/v3'{
	...
	// @ts-ignore
	import type {Ref,error,bool,int,Alias,Nothing,Struct} from 'go'
	...
	export interface P2DepartmentDeletedV3Handler extends larkevent.EventHandler,Struct<P2DepartmentDeletedV3Handler>{
