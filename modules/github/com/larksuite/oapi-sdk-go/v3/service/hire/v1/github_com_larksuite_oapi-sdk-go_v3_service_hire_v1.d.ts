...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/hire/v1'{
	...
	// @ts-ignore
	import type {Alias,Nothing,Ref,Struct,int,error,bool,float64} from 'go'
	...
	export interface P2ApplicationStageChangedV1 extends larkevent.EventHandlerModel,Struct<P2ApplicationStageChangedV1>{
	...
	export function emptyTargetMajorInfoBuilder():TargetMajorInfoBuilder
	export function emptyRefTargetMajorInfoBuilder():Ref<TargetMajorInfoBuilder>
	export function refOfTargetMajorInfoBuilder(x:TargetMajorInfoBuilder,v:Ref<TargetMajorInfoBuilder>)
	export function unRefTargetMajorInfoBuilder(v:Ref<TargetMajorInfoBuilder>):TargetMajorInfoBuilder
	export function emptyUpdateResultEcoExamReqBuilder():UpdateResultEcoExamReqBuilder
	export function emptyRefUpdateResultEcoExamReqBuilder():Ref<UpdateResultEcoExamReqBuilder>
	export function refOfUpdateResultEcoExamReqBuilder(x:UpdateResultEcoExamReqBuilder,v:Ref<UpdateResultEcoExamReqBuilder>)
	export function unRefUpdateResultEcoExamReqBuilder(v:Ref<UpdateResultEcoExamReqBuilder>):UpdateResultEcoExamReqBuilder
	...
	export function emptyRoleDetailBuilder():RoleDetailBuilder
	export function emptyRefRoleDetailBuilder():Ref<RoleDetailBuilder>
	export function refOfRoleDetailBuilder(x:RoleDetailBuilder,v:Ref<RoleDetailBuilder>)
	export function unRefRoleDetailBuilder(v:Ref<RoleDetailBuilder>):RoleDetailBuilder
	...
	export function emptyAttachmentV2Builder():AttachmentV2Builder
	export function emptyRefAttachmentV2Builder():Ref<AttachmentV2Builder>
	export function refOfAttachmentV2Builder(x:AttachmentV2Builder,v:Ref<AttachmentV2Builder>)
	export function unRefAttachmentV2Builder(v:Ref<AttachmentV2Builder>):AttachmentV2Builder
	...
	export function emptyP2EhrImportTaskForInternshipOfferImportedV1Handler():P2EhrImportTaskForInternshipOfferImportedV1Handler
	export function emptyRefP2EhrImportTaskForInternshipOfferImportedV1Handler():Ref<P2EhrImportTaskForInternshipOfferImportedV1Handler>
	export function refOfP2EhrImportTaskForInternshipOfferImportedV1Handler(x:P2EhrImportTaskForInternshipOfferImportedV1Handler,v:Ref<P2EhrImportTaskForInternshipOfferImportedV1Handler>)
	export function unRefP2EhrImportTaskForInternshipOfferImportedV1Handler(v:Ref<P2EhrImportTaskForInternshipOfferImportedV1Handler>):P2EhrImportTaskForInternshipOfferImportedV1Handler
	export function emptyTalentCombinedProjectInfoBuilder():TalentCombinedProjectInfoBuilder
	export function emptyRefTalentCombinedProjectInfoBuilder():Ref<TalentCombinedProjectInfoBuilder>
	export function refOfTalentCombinedProjectInfoBuilder(x:TalentCombinedProjectInfoBuilder,v:Ref<TalentCombinedProjectInfoBuilder>)
	export function unRefTalentCombinedProjectInfoBuilder(v:Ref<TalentCombinedProjectInfoBuilder>):TalentCombinedProjectInfoBuilder
	...
	export function emptyWebsiteDeliverySelfEvaluationBuilder():WebsiteDeliverySelfEvaluationBuilder
	export function emptyRefWebsiteDeliverySelfEvaluationBuilder():Ref<WebsiteDeliverySelfEvaluationBuilder>
	export function refOfWebsiteDeliverySelfEvaluationBuilder(x:WebsiteDeliverySelfEvaluationBuilder,v:Ref<WebsiteDeliverySelfEvaluationBuilder>)
	export function unRefWebsiteDeliverySelfEvaluationBuilder(v:Ref<WebsiteDeliverySelfEvaluationBuilder>):WebsiteDeliverySelfEvaluationBuilder
	export function emptyInterviewFeedbackFormBuilder():InterviewFeedbackFormBuilder
	export function emptyRefInterviewFeedbackFormBuilder():Ref<InterviewFeedbackFormBuilder>
	export function refOfInterviewFeedbackFormBuilder(x:InterviewFeedbackFormBuilder,v:Ref<InterviewFeedbackFormBuilder>)
	export function unRefInterviewFeedbackFormBuilder(v:Ref<InterviewFeedbackFormBuilder>):InterviewFeedbackFormBuilder
	export function emptyOfferApplyFormSchemaBuilder():OfferApplyFormSchemaBuilder
	export function emptyRefOfferApplyFormSchemaBuilder():Ref<OfferApplyFormSchemaBuilder>
	export function refOfOfferApplyFormSchemaBuilder(x:OfferApplyFormSchemaBuilder,v:Ref<OfferApplyFormSchemaBuilder>)
	export function unRefOfferApplyFormSchemaBuilder(v:Ref<OfferApplyFormSchemaBuilder>):OfferApplyFormSchemaBuilder
	export function emptyOfferSchemaNameBuilder():OfferSchemaNameBuilder
	export function emptyRefOfferSchemaNameBuilder():Ref<OfferSchemaNameBuilder>
	export function refOfOfferSchemaNameBuilder(x:OfferSchemaNameBuilder,v:Ref<OfferSchemaNameBuilder>)
	export function unRefOfferSchemaNameBuilder(v:Ref<OfferSchemaNameBuilder>):OfferSchemaNameBuilder
	...
	export function emptyTalentCityInfoBuilder():TalentCityInfoBuilder
	export function emptyRefTalentCityInfoBuilder():Ref<TalentCityInfoBuilder>
	export function refOfTalentCityInfoBuilder(x:TalentCityInfoBuilder,v:Ref<TalentCityInfoBuilder>)
	export function unRefTalentCityInfoBuilder(v:Ref<TalentCityInfoBuilder>):TalentCityInfoBuilder
	export function emptyTalentCombinedCareerInfoBuilder():TalentCombinedCareerInfoBuilder
	export function emptyRefTalentCombinedCareerInfoBuilder():Ref<TalentCombinedCareerInfoBuilder>
	export function refOfTalentCombinedCareerInfoBuilder(x:TalentCombinedCareerInfoBuilder,v:Ref<TalentCombinedCareerInfoBuilder>)
	export function unRefTalentCombinedCareerInfoBuilder(v:Ref<TalentCombinedCareerInfoBuilder>):TalentCombinedCareerInfoBuilder
	...
	export function emptyWebsiteJobPostCustomizedDataBuilder():WebsiteJobPostCustomizedDataBuilder
	export function emptyRefWebsiteJobPostCustomizedDataBuilder():Ref<WebsiteJobPostCustomizedDataBuilder>
	export function refOfWebsiteJobPostCustomizedDataBuilder(x:WebsiteJobPostCustomizedDataBuilder,v:Ref<WebsiteJobPostCustomizedDataBuilder>)
	export function unRefWebsiteJobPostCustomizedDataBuilder(v:Ref<WebsiteJobPostCustomizedDataBuilder>):WebsiteJobPostCustomizedDataBuilder
	...
	export function emptyApplicationBasicInfoBuilder():ApplicationBasicInfoBuilder
	export function emptyRefApplicationBasicInfoBuilder():Ref<ApplicationBasicInfoBuilder>
	export function refOfApplicationBasicInfoBuilder(x:ApplicationBasicInfoBuilder,v:Ref<ApplicationBasicInfoBuilder>)
	export function unRefApplicationBasicInfoBuilder(v:Ref<ApplicationBasicInfoBuilder>):ApplicationBasicInfoBuilder
	export function emptyApplicationOfferAttachmentBuilder():ApplicationOfferAttachmentBuilder
	export function emptyRefApplicationOfferAttachmentBuilder():Ref<ApplicationOfferAttachmentBuilder>
	export function refOfApplicationOfferAttachmentBuilder(x:ApplicationOfferAttachmentBuilder,v:Ref<ApplicationOfferAttachmentBuilder>)
	export function unRefApplicationOfferAttachmentBuilder(v:Ref<ApplicationOfferAttachmentBuilder>):ApplicationOfferAttachmentBuilder
	...
	export function emptyJobProcessesBuilder():JobProcessesBuilder
	export function emptyRefJobProcessesBuilder():Ref<JobProcessesBuilder>
	export function refOfJobProcessesBuilder(x:JobProcessesBuilder,v:Ref<JobProcessesBuilder>)
	export function unRefJobProcessesBuilder(v:Ref<JobProcessesBuilder>):JobProcessesBuilder
	...
	export function emptyPatchEhrImportTaskReqBuilder():PatchEhrImportTaskReqBuilder
	export function emptyRefPatchEhrImportTaskReqBuilder():Ref<PatchEhrImportTaskReqBuilder>
	export function refOfPatchEhrImportTaskReqBuilder(x:PatchEhrImportTaskReqBuilder,v:Ref<PatchEhrImportTaskReqBuilder>)
	export function unRefPatchEhrImportTaskReqBuilder(v:Ref<PatchEhrImportTaskReqBuilder>):PatchEhrImportTaskReqBuilder
	...
	export function emptyUpdateProgressEcoBackgroundCheckReqBodyBuilder():UpdateProgressEcoBackgroundCheckReqBodyBuilder
	export function emptyRefUpdateProgressEcoBackgroundCheckReqBodyBuilder():Ref<UpdateProgressEcoBackgroundCheckReqBodyBuilder>
	export function refOfUpdateProgressEcoBackgroundCheckReqBodyBuilder(x:UpdateProgressEcoBackgroundCheckReqBodyBuilder,v:Ref<UpdateProgressEcoBackgroundCheckReqBodyBuilder>)
	export function unRefUpdateProgressEcoBackgroundCheckReqBodyBuilder(v:Ref<UpdateProgressEcoBackgroundCheckReqBodyBuilder>):UpdateProgressEcoBackgroundCheckReqBodyBuilder
	...
	export function emptySnsInfoBuilder():SnsInfoBuilder
	export function emptyRefSnsInfoBuilder():Ref<SnsInfoBuilder>
	export function refOfSnsInfoBuilder(x:SnsInfoBuilder,v:Ref<SnsInfoBuilder>)
	export function unRefSnsInfoBuilder(v:Ref<SnsInfoBuilder>):SnsInfoBuilder
	...
	export function emptyListApplicationReqBuilder():ListApplicationReqBuilder
	export function emptyRefListApplicationReqBuilder():Ref<ListApplicationReqBuilder>
	export function refOfListApplicationReqBuilder(x:ListApplicationReqBuilder,v:Ref<ListApplicationReqBuilder>)
	export function unRefListApplicationReqBuilder(v:Ref<ListApplicationReqBuilder>):ListApplicationReqBuilder
	...
	export function emptySiteJobCityBuilder():SiteJobCityBuilder
	export function emptyRefSiteJobCityBuilder():Ref<SiteJobCityBuilder>
	export function refOfSiteJobCityBuilder(x:SiteJobCityBuilder,v:Ref<SiteJobCityBuilder>)
	export function unRefSiteJobCityBuilder(v:Ref<SiteJobCityBuilder>):SiteJobCityBuilder
	...
	export function emptyJobRecruiterBuilder():JobRecruiterBuilder
	export function emptyRefJobRecruiterBuilder():Ref<JobRecruiterBuilder>
	export function refOfJobRecruiterBuilder(x:JobRecruiterBuilder,v:Ref<JobRecruiterBuilder>)
	export function unRefJobRecruiterBuilder(v:Ref<JobRecruiterBuilder>):JobRecruiterBuilder
	export function emptyP2ApplicationDeletedV1Handler():P2ApplicationDeletedV1Handler
	export function emptyRefP2ApplicationDeletedV1Handler():Ref<P2ApplicationDeletedV1Handler>
	export function refOfP2ApplicationDeletedV1Handler(x:P2ApplicationDeletedV1Handler,v:Ref<P2ApplicationDeletedV1Handler>)
	export function unRefP2ApplicationDeletedV1Handler(v:Ref<P2ApplicationDeletedV1Handler>):P2ApplicationDeletedV1Handler
	...
	export function emptyTalentEducationInfoBuilder():TalentEducationInfoBuilder
	export function emptyRefTalentEducationInfoBuilder():Ref<TalentEducationInfoBuilder>
	export function refOfTalentEducationInfoBuilder(x:TalentEducationInfoBuilder,v:Ref<TalentEducationInfoBuilder>)
	export function unRefTalentEducationInfoBuilder(v:Ref<TalentEducationInfoBuilder>):TalentEducationInfoBuilder
	export function emptyPermissionCollectionBuilder():PermissionCollectionBuilder
	export function emptyRefPermissionCollectionBuilder():Ref<PermissionCollectionBuilder>
	export function refOfPermissionCollectionBuilder(x:PermissionCollectionBuilder,v:Ref<PermissionCollectionBuilder>)
	export function unRefPermissionCollectionBuilder(v:Ref<PermissionCollectionBuilder>):PermissionCollectionBuilder
	...
	export function emptyBatchDeleteEcoExamPaperReqBodyBuilder():BatchDeleteEcoExamPaperReqBodyBuilder
	export function emptyRefBatchDeleteEcoExamPaperReqBodyBuilder():Ref<BatchDeleteEcoExamPaperReqBodyBuilder>
	export function refOfBatchDeleteEcoExamPaperReqBodyBuilder(x:BatchDeleteEcoExamPaperReqBodyBuilder,v:Ref<BatchDeleteEcoExamPaperReqBodyBuilder>)
	export function unRefBatchDeleteEcoExamPaperReqBodyBuilder(v:Ref<BatchDeleteEcoExamPaperReqBodyBuilder>):BatchDeleteEcoExamPaperReqBodyBuilder
	...
	export function emptyInterviewDimensionScoreBuilder():InterviewDimensionScoreBuilder
	export function emptyRefInterviewDimensionScoreBuilder():Ref<InterviewDimensionScoreBuilder>
	export function refOfInterviewDimensionScoreBuilder(x:InterviewDimensionScoreBuilder,v:Ref<InterviewDimensionScoreBuilder>)
	export function unRefInterviewDimensionScoreBuilder(v:Ref<InterviewDimensionScoreBuilder>):InterviewDimensionScoreBuilder
	export function emptyInterviewRoundTypeAssessmentTemplateBuilder():InterviewRoundTypeAssessmentTemplateBuilder
	export function emptyRefInterviewRoundTypeAssessmentTemplateBuilder():Ref<InterviewRoundTypeAssessmentTemplateBuilder>
	export function refOfInterviewRoundTypeAssessmentTemplateBuilder(x:InterviewRoundTypeAssessmentTemplateBuilder,v:Ref<InterviewRoundTypeAssessmentTemplateBuilder>)
	export function unRefInterviewRoundTypeAssessmentTemplateBuilder(v:Ref<InterviewRoundTypeAssessmentTemplateBuilder>):InterviewRoundTypeAssessmentTemplateBuilder
	...
	export function emptyDiDataBuilder():DiDataBuilder
	export function emptyRefDiDataBuilder():Ref<DiDataBuilder>
	export function refOfDiDataBuilder(x:DiDataBuilder,v:Ref<DiDataBuilder>)
	export function unRefDiDataBuilder(v:Ref<DiDataBuilder>):DiDataBuilder
	export function emptyEcoAccountCustomFieldEventDataBuilder():EcoAccountCustomFieldEventDataBuilder
	export function emptyRefEcoAccountCustomFieldEventDataBuilder():Ref<EcoAccountCustomFieldEventDataBuilder>
	export function refOfEcoAccountCustomFieldEventDataBuilder(x:EcoAccountCustomFieldEventDataBuilder,v:Ref<EcoAccountCustomFieldEventDataBuilder>)
	export function unRefEcoAccountCustomFieldEventDataBuilder(v:Ref<EcoAccountCustomFieldEventDataBuilder>):EcoAccountCustomFieldEventDataBuilder
	...
	export function emptyTalentNationalityBuilder():TalentNationalityBuilder
	export function emptyRefTalentNationalityBuilder():Ref<TalentNationalityBuilder>
	export function refOfTalentNationalityBuilder(x:TalentNationalityBuilder,v:Ref<TalentNationalityBuilder>)
	export function unRefTalentNationalityBuilder(v:Ref<TalentNationalityBuilder>):TalentNationalityBuilder
	...
	export function emptyBaseDistrictBuilder():BaseDistrictBuilder
	export function emptyRefBaseDistrictBuilder():Ref<BaseDistrictBuilder>
	export function refOfBaseDistrictBuilder(x:BaseDistrictBuilder,v:Ref<BaseDistrictBuilder>)
	export function unRefBaseDistrictBuilder(v:Ref<BaseDistrictBuilder>):BaseDistrictBuilder
	export function emptyBatchDeleteEcoBackgroundCheckCustomFieldReqBuilder():BatchDeleteEcoBackgroundCheckCustomFieldReqBuilder
	export function emptyRefBatchDeleteEcoBackgroundCheckCustomFieldReqBuilder():Ref<BatchDeleteEcoBackgroundCheckCustomFieldReqBuilder>
	export function refOfBatchDeleteEcoBackgroundCheckCustomFieldReqBuilder(x:BatchDeleteEcoBackgroundCheckCustomFieldReqBuilder,v:Ref<BatchDeleteEcoBackgroundCheckCustomFieldReqBuilder>)
	export function unRefBatchDeleteEcoBackgroundCheckCustomFieldReqBuilder(v:Ref<BatchDeleteEcoBackgroundCheckCustomFieldReqBuilder>):BatchDeleteEcoBackgroundCheckCustomFieldReqBuilder
	...
	export function emptyUserContactInfoBuilder():UserContactInfoBuilder
	export function emptyRefUserContactInfoBuilder():Ref<UserContactInfoBuilder>
	export function refOfUserContactInfoBuilder(x:UserContactInfoBuilder,v:Ref<UserContactInfoBuilder>)
	export function unRefUserContactInfoBuilder(v:Ref<UserContactInfoBuilder>):UserContactInfoBuilder
	export function emptyApplicationTalentAwardInfoBuilder():ApplicationTalentAwardInfoBuilder
	export function emptyRefApplicationTalentAwardInfoBuilder():Ref<ApplicationTalentAwardInfoBuilder>
	export function refOfApplicationTalentAwardInfoBuilder(x:ApplicationTalentAwardInfoBuilder,v:Ref<ApplicationTalentAwardInfoBuilder>)
	export function unRefApplicationTalentAwardInfoBuilder(v:Ref<ApplicationTalentAwardInfoBuilder>):ApplicationTalentAwardInfoBuilder
	export function emptyBatchUpdateEcoExamPaperReqBuilder():BatchUpdateEcoExamPaperReqBuilder
	export function emptyRefBatchUpdateEcoExamPaperReqBuilder():Ref<BatchUpdateEcoExamPaperReqBuilder>
	export function refOfBatchUpdateEcoExamPaperReqBuilder(x:BatchUpdateEcoExamPaperReqBuilder,v:Ref<BatchUpdateEcoExamPaperReqBuilder>)
	export function unRefBatchUpdateEcoExamPaperReqBuilder(v:Ref<BatchUpdateEcoExamPaperReqBuilder>):BatchUpdateEcoExamPaperReqBuilder
	export function emptyApplicationStageBuilder():ApplicationStageBuilder
	export function emptyRefApplicationStageBuilder():Ref<ApplicationStageBuilder>
	export function refOfApplicationStageBuilder(x:ApplicationStageBuilder,v:Ref<ApplicationStageBuilder>)
	export function unRefApplicationStageBuilder(v:Ref<ApplicationStageBuilder>):ApplicationStageBuilder
	...
	export function emptyBonusAmountBuilder():BonusAmountBuilder
	export function emptyRefBonusAmountBuilder():Ref<BonusAmountBuilder>
	export function refOfBonusAmountBuilder(x:BonusAmountBuilder,v:Ref<BonusAmountBuilder>)
	export function unRefBonusAmountBuilder(v:Ref<BonusAmountBuilder>):BonusAmountBuilder
	export function emptyJobHighlightBuilder():JobHighlightBuilder
	export function emptyRefJobHighlightBuilder():Ref<JobHighlightBuilder>
	export function refOfJobHighlightBuilder(x:JobHighlightBuilder,v:Ref<JobHighlightBuilder>)
	export function unRefJobHighlightBuilder(v:Ref<JobHighlightBuilder>):JobHighlightBuilder
	...
	export function emptyTalentCustomizedDataObjectValueBuilder():TalentCustomizedDataObjectValueBuilder
	export function emptyRefTalentCustomizedDataObjectValueBuilder():Ref<TalentCustomizedDataObjectValueBuilder>
	export function refOfTalentCustomizedDataObjectValueBuilder(x:TalentCustomizedDataObjectValueBuilder,v:Ref<TalentCustomizedDataObjectValueBuilder>)
	export function unRefTalentCustomizedDataObjectValueBuilder(v:Ref<TalentCustomizedDataObjectValueBuilder>):TalentCustomizedDataObjectValueBuilder
	export function emptyTalentSnsInfoBuilder():TalentSnsInfoBuilder
	export function emptyRefTalentSnsInfoBuilder():Ref<TalentSnsInfoBuilder>
	export function refOfTalentSnsInfoBuilder(x:TalentSnsInfoBuilder,v:Ref<TalentSnsInfoBuilder>)
	export function unRefTalentSnsInfoBuilder(v:Ref<TalentSnsInfoBuilder>):TalentSnsInfoBuilder
	export function emptyWebsiteDeliveryEducationBuilder():WebsiteDeliveryEducationBuilder
	export function emptyRefWebsiteDeliveryEducationBuilder():Ref<WebsiteDeliveryEducationBuilder>
	export function refOfWebsiteDeliveryEducationBuilder(x:WebsiteDeliveryEducationBuilder,v:Ref<WebsiteDeliveryEducationBuilder>)
	export function unRefWebsiteDeliveryEducationBuilder(v:Ref<WebsiteDeliveryEducationBuilder>):WebsiteDeliveryEducationBuilder
	...
	export function emptyOfferSelectionObjectBuilder():OfferSelectionObjectBuilder
	export function emptyRefOfferSelectionObjectBuilder():Ref<OfferSelectionObjectBuilder>
	export function refOfOfferSelectionObjectBuilder(x:OfferSelectionObjectBuilder,v:Ref<OfferSelectionObjectBuilder>)
	export function unRefOfferSelectionObjectBuilder(v:Ref<OfferSelectionObjectBuilder>):OfferSelectionObjectBuilder
	...
	export function emptyBatchGetIdTalentReqBodyBuilder():BatchGetIdTalentReqBodyBuilder
	export function emptyRefBatchGetIdTalentReqBodyBuilder():Ref<BatchGetIdTalentReqBodyBuilder>
	export function refOfBatchGetIdTalentReqBodyBuilder(x:BatchGetIdTalentReqBodyBuilder,v:Ref<BatchGetIdTalentReqBodyBuilder>)
	export function unRefBatchGetIdTalentReqBodyBuilder(v:Ref<BatchGetIdTalentReqBodyBuilder>):BatchGetIdTalentReqBodyBuilder
	...
	export function emptyGetEmployeeReqBuilder():GetEmployeeReqBuilder
	export function emptyRefGetEmployeeReqBuilder():Ref<GetEmployeeReqBuilder>
	export function refOfGetEmployeeReqBuilder(x:GetEmployeeReqBuilder,v:Ref<GetEmployeeReqBuilder>)
	export function unRefGetEmployeeReqBuilder(v:Ref<GetEmployeeReqBuilder>):GetEmployeeReqBuilder
	...
	export function emptySequenceBuilder():SequenceBuilder
	export function emptyRefSequenceBuilder():Ref<SequenceBuilder>
	export function refOfSequenceBuilder(x:SequenceBuilder,v:Ref<SequenceBuilder>)
	export function unRefSequenceBuilder(v:Ref<SequenceBuilder>):SequenceBuilder
	export function emptyTalentCareerInfoBuilder():TalentCareerInfoBuilder
	export function emptyRefTalentCareerInfoBuilder():Ref<TalentCareerInfoBuilder>
	export function refOfTalentCareerInfoBuilder(x:TalentCareerInfoBuilder,v:Ref<TalentCareerInfoBuilder>)
	export function unRefTalentCareerInfoBuilder(v:Ref<TalentCareerInfoBuilder>):TalentCareerInfoBuilder
	export function emptyApplicationTalentAttachmentResumeInfoBuilder():ApplicationTalentAttachmentResumeInfoBuilder
	export function emptyRefApplicationTalentAttachmentResumeInfoBuilder():Ref<ApplicationTalentAttachmentResumeInfoBuilder>
	export function refOfApplicationTalentAttachmentResumeInfoBuilder(x:ApplicationTalentAttachmentResumeInfoBuilder,v:Ref<ApplicationTalentAttachmentResumeInfoBuilder>)
	export function unRefApplicationTalentAttachmentResumeInfoBuilder(v:Ref<ApplicationTalentAttachmentResumeInfoBuilder>):ApplicationTalentAttachmentResumeInfoBuilder
	export function emptyCommonSchemaOptionBuilder():CommonSchemaOptionBuilder
	export function emptyRefCommonSchemaOptionBuilder():Ref<CommonSchemaOptionBuilder>
	export function refOfCommonSchemaOptionBuilder(x:CommonSchemaOptionBuilder,v:Ref<CommonSchemaOptionBuilder>)
	export function unRefCommonSchemaOptionBuilder(v:Ref<CommonSchemaOptionBuilder>):CommonSchemaOptionBuilder
	export function emptyCreateNoteReqBuilder():CreateNoteReqBuilder
	export function emptyRefCreateNoteReqBuilder():Ref<CreateNoteReqBuilder>
	export function refOfCreateNoteReqBuilder(x:CreateNoteReqBuilder,v:Ref<CreateNoteReqBuilder>)
	export function unRefCreateNoteReqBuilder(v:Ref<CreateNoteReqBuilder>):CreateNoteReqBuilder
	export function emptyTalentCombinedEducationInfoBuilder():TalentCombinedEducationInfoBuilder
	export function emptyRefTalentCombinedEducationInfoBuilder():Ref<TalentCombinedEducationInfoBuilder>
	export function refOfTalentCombinedEducationInfoBuilder(x:TalentCombinedEducationInfoBuilder,v:Ref<TalentCombinedEducationInfoBuilder>)
	export function unRefTalentCombinedEducationInfoBuilder(v:Ref<TalentCombinedEducationInfoBuilder>):TalentCombinedEducationInfoBuilder
	...
	export function emptyEcoBackgroundCheckCreateEventContactInfoBuilder():EcoBackgroundCheckCreateEventContactInfoBuilder
	export function emptyRefEcoBackgroundCheckCreateEventContactInfoBuilder():Ref<EcoBackgroundCheckCreateEventContactInfoBuilder>
	export function refOfEcoBackgroundCheckCreateEventContactInfoBuilder(x:EcoBackgroundCheckCreateEventContactInfoBuilder,v:Ref<EcoBackgroundCheckCreateEventContactInfoBuilder>)
	export function unRefEcoBackgroundCheckCreateEventContactInfoBuilder(v:Ref<EcoBackgroundCheckCreateEventContactInfoBuilder>):EcoBackgroundCheckCreateEventContactInfoBuilder
	...
	export function emptyTestBuilder():TestBuilder
	export function emptyRefTestBuilder():Ref<TestBuilder>
	export function refOfTestBuilder(x:TestBuilder,v:Ref<TestBuilder>)
	export function unRefTestBuilder(v:Ref<TestBuilder>):TestBuilder
	export function emptyBackgroundCheckFeedbackInfoBuilder():BackgroundCheckFeedbackInfoBuilder
	export function emptyRefBackgroundCheckFeedbackInfoBuilder():Ref<BackgroundCheckFeedbackInfoBuilder>
	export function refOfBackgroundCheckFeedbackInfoBuilder(x:BackgroundCheckFeedbackInfoBuilder,v:Ref<BackgroundCheckFeedbackInfoBuilder>)
	export function unRefBackgroundCheckFeedbackInfoBuilder(v:Ref<BackgroundCheckFeedbackInfoBuilder>):BackgroundCheckFeedbackInfoBuilder
	...
	export function emptyObjectAttributeBuilder():ObjectAttributeBuilder
	export function emptyRefObjectAttributeBuilder():Ref<ObjectAttributeBuilder>
	export function refOfObjectAttributeBuilder(x:ObjectAttributeBuilder,v:Ref<ObjectAttributeBuilder>)
	export function unRefObjectAttributeBuilder(v:Ref<ObjectAttributeBuilder>):ObjectAttributeBuilder
	export function emptyApplicationPrehireOfferBasicBuilder():ApplicationPrehireOfferBasicBuilder
	export function emptyRefApplicationPrehireOfferBasicBuilder():Ref<ApplicationPrehireOfferBasicBuilder>
	export function refOfApplicationPrehireOfferBasicBuilder(x:ApplicationPrehireOfferBasicBuilder,v:Ref<ApplicationPrehireOfferBasicBuilder>)
	export function unRefApplicationPrehireOfferBasicBuilder(v:Ref<ApplicationPrehireOfferBasicBuilder>):ApplicationPrehireOfferBasicBuilder
	...
	export function emptyLocationBaseInfoBuilder():LocationBaseInfoBuilder
	export function emptyRefLocationBaseInfoBuilder():Ref<LocationBaseInfoBuilder>
	export function refOfLocationBaseInfoBuilder(x:LocationBaseInfoBuilder,v:Ref<LocationBaseInfoBuilder>)
	export function unRefLocationBaseInfoBuilder(v:Ref<LocationBaseInfoBuilder>):LocationBaseInfoBuilder
	export function emptyOfferCustomFieldConfigOptionBuilder():OfferCustomFieldConfigOptionBuilder
	export function emptyRefOfferCustomFieldConfigOptionBuilder():Ref<OfferCustomFieldConfigOptionBuilder>
	export function refOfOfferCustomFieldConfigOptionBuilder(x:OfferCustomFieldConfigOptionBuilder,v:Ref<OfferCustomFieldConfigOptionBuilder>)
	export function unRefOfferCustomFieldConfigOptionBuilder(v:Ref<OfferCustomFieldConfigOptionBuilder>):OfferCustomFieldConfigOptionBuilder
	...
	export function emptyWebsiteDeliveryResumeBuilder():WebsiteDeliveryResumeBuilder
	export function emptyRefWebsiteDeliveryResumeBuilder():Ref<WebsiteDeliveryResumeBuilder>
	export function refOfWebsiteDeliveryResumeBuilder(x:WebsiteDeliveryResumeBuilder,v:Ref<WebsiteDeliveryResumeBuilder>)
	export function unRefWebsiteDeliveryResumeBuilder(v:Ref<WebsiteDeliveryResumeBuilder>):WebsiteDeliveryResumeBuilder
	...
	export function emptyEcoExamResultDetailBuilder():EcoExamResultDetailBuilder
	export function emptyRefEcoExamResultDetailBuilder():Ref<EcoExamResultDetailBuilder>
	export function refOfEcoExamResultDetailBuilder(x:EcoExamResultDetailBuilder,v:Ref<EcoExamResultDetailBuilder>)
	export function unRefEcoExamResultDetailBuilder(v:Ref<EcoExamResultDetailBuilder>):EcoExamResultDetailBuilder
	...
	export function emptyApplicationResumeSourceBuilder():ApplicationResumeSourceBuilder
	export function emptyRefApplicationResumeSourceBuilder():Ref<ApplicationResumeSourceBuilder>
	export function refOfApplicationResumeSourceBuilder(x:ApplicationResumeSourceBuilder,v:Ref<ApplicationResumeSourceBuilder>)
	export function unRefApplicationResumeSourceBuilder(v:Ref<ApplicationResumeSourceBuilder>):ApplicationResumeSourceBuilder
	export function emptyApplicationTalentCompetitionInfoBuilder():ApplicationTalentCompetitionInfoBuilder
	export function emptyRefApplicationTalentCompetitionInfoBuilder():Ref<ApplicationTalentCompetitionInfoBuilder>
	export function refOfApplicationTalentCompetitionInfoBuilder(x:ApplicationTalentCompetitionInfoBuilder,v:Ref<ApplicationTalentCompetitionInfoBuilder>)
	export function unRefApplicationTalentCompetitionInfoBuilder(v:Ref<ApplicationTalentCompetitionInfoBuilder>):ApplicationTalentCompetitionInfoBuilder
	export function emptyPatchEmployeeReqBuilder():PatchEmployeeReqBuilder
	export function emptyRefPatchEmployeeReqBuilder():Ref<PatchEmployeeReqBuilder>
	export function refOfPatchEmployeeReqBuilder(x:PatchEmployeeReqBuilder,v:Ref<PatchEmployeeReqBuilder>)
	export function unRefPatchEmployeeReqBuilder(v:Ref<PatchEmployeeReqBuilder>):PatchEmployeeReqBuilder
	export function emptyTransferOnboardApplicationReqBodyBuilder():TransferOnboardApplicationReqBodyBuilder
	export function emptyRefTransferOnboardApplicationReqBodyBuilder():Ref<TransferOnboardApplicationReqBodyBuilder>
	export function refOfTransferOnboardApplicationReqBodyBuilder(x:TransferOnboardApplicationReqBodyBuilder,v:Ref<TransferOnboardApplicationReqBodyBuilder>)
	export function unRefTransferOnboardApplicationReqBodyBuilder(v:Ref<TransferOnboardApplicationReqBodyBuilder>):TransferOnboardApplicationReqBodyBuilder
	...
	export function emptyOfferApplyFormModuleInfoBuilder():OfferApplyFormModuleInfoBuilder
	export function emptyRefOfferApplyFormModuleInfoBuilder():Ref<OfferApplyFormModuleInfoBuilder>
	export function refOfOfferApplyFormModuleInfoBuilder(x:OfferApplyFormModuleInfoBuilder,v:Ref<OfferApplyFormModuleInfoBuilder>)
	export function unRefOfferApplyFormModuleInfoBuilder(v:Ref<OfferApplyFormModuleInfoBuilder>):OfferApplyFormModuleInfoBuilder
	...
	export function emptyCreateReferralAccountReqBuilder():CreateReferralAccountReqBuilder
	export function emptyRefCreateReferralAccountReqBuilder():Ref<CreateReferralAccountReqBuilder>
	export function refOfCreateReferralAccountReqBuilder(x:CreateReferralAccountReqBuilder,v:Ref<CreateReferralAccountReqBuilder>)
	export function unRefCreateReferralAccountReqBuilder(v:Ref<CreateReferralAccountReqBuilder>):CreateReferralAccountReqBuilder
	export function emptyDataPermissionBuilder():DataPermissionBuilder
	export function emptyRefDataPermissionBuilder():Ref<DataPermissionBuilder>
	export function refOfDataPermissionBuilder(x:DataPermissionBuilder,v:Ref<DataPermissionBuilder>)
	export function unRefDataPermissionBuilder(v:Ref<DataPermissionBuilder>):DataPermissionBuilder
	...
	export function emptyEcoBackgroundCheckPackageBuilder():EcoBackgroundCheckPackageBuilder
	export function emptyRefEcoBackgroundCheckPackageBuilder():Ref<EcoBackgroundCheckPackageBuilder>
	export function refOfEcoBackgroundCheckPackageBuilder(x:EcoBackgroundCheckPackageBuilder,v:Ref<EcoBackgroundCheckPackageBuilder>)
	export function unRefEcoBackgroundCheckPackageBuilder(v:Ref<EcoBackgroundCheckPackageBuilder>):EcoBackgroundCheckPackageBuilder
	...
	export function emptyWebsiteChannelInfoBuilder():WebsiteChannelInfoBuilder
	export function emptyRefWebsiteChannelInfoBuilder():Ref<WebsiteChannelInfoBuilder>
	export function refOfWebsiteChannelInfoBuilder(x:WebsiteChannelInfoBuilder,v:Ref<WebsiteChannelInfoBuilder>)
	export function unRefWebsiteChannelInfoBuilder(v:Ref<WebsiteChannelInfoBuilder>):WebsiteChannelInfoBuilder
	...
	export function emptyWebsiteDeliveryDtoBuilder():WebsiteDeliveryDtoBuilder
	export function emptyRefWebsiteDeliveryDtoBuilder():Ref<WebsiteDeliveryDtoBuilder>
	export function refOfWebsiteDeliveryDtoBuilder(x:WebsiteDeliveryDtoBuilder,v:Ref<WebsiteDeliveryDtoBuilder>)
	export function unRefWebsiteDeliveryDtoBuilder(v:Ref<WebsiteDeliveryDtoBuilder>):WebsiteDeliveryDtoBuilder
	export function emptyJobCustomizedValueBuilder():JobCustomizedValueBuilder
	export function emptyRefJobCustomizedValueBuilder():Ref<JobCustomizedValueBuilder>
	export function refOfJobCustomizedValueBuilder(x:JobCustomizedValueBuilder,v:Ref<JobCustomizedValueBuilder>)
	export function unRefJobCustomizedValueBuilder(v:Ref<JobCustomizedValueBuilder>):JobCustomizedValueBuilder
	export function emptyListApplicationInterviewReqBuilder():ListApplicationInterviewReqBuilder
	export function emptyRefListApplicationInterviewReqBuilder():Ref<ListApplicationInterviewReqBuilder>
	export function refOfListApplicationInterviewReqBuilder(x:ListApplicationInterviewReqBuilder,v:Ref<ListApplicationInterviewReqBuilder>)
	export function unRefListApplicationInterviewReqBuilder(v:Ref<ListApplicationInterviewReqBuilder>):ListApplicationInterviewReqBuilder
	...
	export function emptyApplicationTalentLanguageInfoBuilder():ApplicationTalentLanguageInfoBuilder
	export function emptyRefApplicationTalentLanguageInfoBuilder():Ref<ApplicationTalentLanguageInfoBuilder>
	export function refOfApplicationTalentLanguageInfoBuilder(x:ApplicationTalentLanguageInfoBuilder,v:Ref<ApplicationTalentLanguageInfoBuilder>)
	export function unRefApplicationTalentLanguageInfoBuilder(v:Ref<ApplicationTalentLanguageInfoBuilder>):ApplicationTalentLanguageInfoBuilder
	...
	export function emptyBatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder():BatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder
	export function emptyRefBatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder():Ref<BatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder>
	export function refOfBatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder(x:BatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder,v:Ref<BatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder>)
	export function unRefBatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder(v:Ref<BatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder>):BatchDeleteEcoBackgroundCheckPackagePathReqBodyBuilder
	export function emptyDeactivateReferralAccountReqBuilder():DeactivateReferralAccountReqBuilder
	export function emptyRefDeactivateReferralAccountReqBuilder():Ref<DeactivateReferralAccountReqBuilder>
	export function refOfDeactivateReferralAccountReqBuilder(x:DeactivateReferralAccountReqBuilder,v:Ref<DeactivateReferralAccountReqBuilder>)
	export function unRefDeactivateReferralAccountReqBuilder(v:Ref<DeactivateReferralAccountReqBuilder>):DeactivateReferralAccountReqBuilder
	export function emptyOfferSalaryInfoBuilder():OfferSalaryInfoBuilder
	export function emptyRefOfferSalaryInfoBuilder():Ref<OfferSalaryInfoBuilder>
	export function refOfOfferSalaryInfoBuilder(x:OfferSalaryInfoBuilder,v:Ref<OfferSalaryInfoBuilder>)
	export function unRefOfferSalaryInfoBuilder(v:Ref<OfferSalaryInfoBuilder>):OfferSalaryInfoBuilder
	...
	export function emptyJobRequirementCustomizedDataBuilder():JobRequirementCustomizedDataBuilder
	export function emptyRefJobRequirementCustomizedDataBuilder():Ref<JobRequirementCustomizedDataBuilder>
	export function refOfJobRequirementCustomizedDataBuilder(x:JobRequirementCustomizedDataBuilder,v:Ref<JobRequirementCustomizedDataBuilder>)
	export function unRefJobRequirementCustomizedDataBuilder(v:Ref<JobRequirementCustomizedDataBuilder>):JobRequirementCustomizedDataBuilder
	...
	export function emptyEcoBackgroundCheckCustomFieldDataOptionBuilder():EcoBackgroundCheckCustomFieldDataOptionBuilder
	export function emptyRefEcoBackgroundCheckCustomFieldDataOptionBuilder():Ref<EcoBackgroundCheckCustomFieldDataOptionBuilder>
	export function refOfEcoBackgroundCheckCustomFieldDataOptionBuilder(x:EcoBackgroundCheckCustomFieldDataOptionBuilder,v:Ref<EcoBackgroundCheckCustomFieldDataOptionBuilder>)
	export function unRefEcoBackgroundCheckCustomFieldDataOptionBuilder(v:Ref<EcoBackgroundCheckCustomFieldDataOptionBuilder>):EcoBackgroundCheckCustomFieldDataOptionBuilder
	export function emptyEcoExamPaperBuilder():EcoExamPaperBuilder
	export function emptyRefEcoExamPaperBuilder():Ref<EcoExamPaperBuilder>
	export function refOfEcoExamPaperBuilder(x:EcoExamPaperBuilder,v:Ref<EcoExamPaperBuilder>)
	export function unRefEcoExamPaperBuilder(v:Ref<EcoExamPaperBuilder>):EcoExamPaperBuilder
	...
	export function emptyTalentBatchInfoBuilder():TalentBatchInfoBuilder
	export function emptyRefTalentBatchInfoBuilder():Ref<TalentBatchInfoBuilder>
	export function refOfTalentBatchInfoBuilder(x:TalentBatchInfoBuilder,v:Ref<TalentBatchInfoBuilder>)
	export function unRefTalentBatchInfoBuilder(v:Ref<TalentBatchInfoBuilder>):TalentBatchInfoBuilder
	...
	export function emptyWebsiteDeliveryCompetitionBuilder():WebsiteDeliveryCompetitionBuilder
	export function emptyRefWebsiteDeliveryCompetitionBuilder():Ref<WebsiteDeliveryCompetitionBuilder>
	export function refOfWebsiteDeliveryCompetitionBuilder(x:WebsiteDeliveryCompetitionBuilder,v:Ref<WebsiteDeliveryCompetitionBuilder>)
	export function unRefWebsiteDeliveryCompetitionBuilder(v:Ref<WebsiteDeliveryCompetitionBuilder>):WebsiteDeliveryCompetitionBuilder
	export function emptyApplicationJobAddressBuilder():ApplicationJobAddressBuilder
	export function emptyRefApplicationJobAddressBuilder():Ref<ApplicationJobAddressBuilder>
	export function refOfApplicationJobAddressBuilder(x:ApplicationJobAddressBuilder,v:Ref<ApplicationJobAddressBuilder>)
	export function unRefApplicationJobAddressBuilder(v:Ref<ApplicationJobAddressBuilder>):ApplicationJobAddressBuilder
	...
	export function emptyBatchDeleteEcoExamPaperReqBuilder():BatchDeleteEcoExamPaperReqBuilder
	export function emptyRefBatchDeleteEcoExamPaperReqBuilder():Ref<BatchDeleteEcoExamPaperReqBuilder>
	export function refOfBatchDeleteEcoExamPaperReqBuilder(x:BatchDeleteEcoExamPaperReqBuilder,v:Ref<BatchDeleteEcoExamPaperReqBuilder>)
	export function unRefBatchDeleteEcoExamPaperReqBuilder(v:Ref<BatchDeleteEcoExamPaperReqBuilder>):BatchDeleteEcoExamPaperReqBuilder
	...
	export function emptyDeleteExternalApplicationReqBuilder():DeleteExternalApplicationReqBuilder
	export function emptyRefDeleteExternalApplicationReqBuilder():Ref<DeleteExternalApplicationReqBuilder>
	export function refOfDeleteExternalApplicationReqBuilder(x:DeleteExternalApplicationReqBuilder,v:Ref<DeleteExternalApplicationReqBuilder>)
	export function unRefDeleteExternalApplicationReqBuilder(v:Ref<DeleteExternalApplicationReqBuilder>):DeleteExternalApplicationReqBuilder
	...
	export function emptyInternshipInfoBuilder():InternshipInfoBuilder
	export function emptyRefInternshipInfoBuilder():Ref<InternshipInfoBuilder>
	export function refOfInternshipInfoBuilder(x:InternshipInfoBuilder,v:Ref<InternshipInfoBuilder>)
	export function unRefInternshipInfoBuilder(v:Ref<InternshipInfoBuilder>):InternshipInfoBuilder
	...
	export function emptyExternalInterviewAssessmentDimensionBuilder():ExternalInterviewAssessmentDimensionBuilder
	export function emptyRefExternalInterviewAssessmentDimensionBuilder():Ref<ExternalInterviewAssessmentDimensionBuilder>
	export function refOfExternalInterviewAssessmentDimensionBuilder(x:ExternalInterviewAssessmentDimensionBuilder,v:Ref<ExternalInterviewAssessmentDimensionBuilder>)
	export function unRefExternalInterviewAssessmentDimensionBuilder(v:Ref<ExternalInterviewAssessmentDimensionBuilder>):ExternalInterviewAssessmentDimensionBuilder
	...
	export function emptyBaseBilingualWithIdBuilder():BaseBilingualWithIdBuilder
	export function emptyRefBaseBilingualWithIdBuilder():Ref<BaseBilingualWithIdBuilder>
	export function refOfBaseBilingualWithIdBuilder(x:BaseBilingualWithIdBuilder,v:Ref<BaseBilingualWithIdBuilder>)
	export function unRefBaseBilingualWithIdBuilder(v:Ref<BaseBilingualWithIdBuilder>):BaseBilingualWithIdBuilder
	export function emptyJobCityBuilder():JobCityBuilder
	export function emptyRefJobCityBuilder():Ref<JobCityBuilder>
	export function refOfJobCityBuilder(x:JobCityBuilder,v:Ref<JobCityBuilder>)
	export function unRefJobCityBuilder(v:Ref<JobCityBuilder>):JobCityBuilder
	export function emptyListReferralWebsiteJobPostReqBuilder():ListReferralWebsiteJobPostReqBuilder
	export function emptyRefListReferralWebsiteJobPostReqBuilder():Ref<ListReferralWebsiteJobPostReqBuilder>
	export function refOfListReferralWebsiteJobPostReqBuilder(x:ListReferralWebsiteJobPostReqBuilder,v:Ref<ListReferralWebsiteJobPostReqBuilder>)
	export function unRefListReferralWebsiteJobPostReqBuilder(v:Ref<ListReferralWebsiteJobPostReqBuilder>):ListReferralWebsiteJobPostReqBuilder
	export function emptyP2EcoExamCreatedV1Handler():P2EcoExamCreatedV1Handler
	export function emptyRefP2EcoExamCreatedV1Handler():Ref<P2EcoExamCreatedV1Handler>
	export function refOfP2EcoExamCreatedV1Handler(x:P2EcoExamCreatedV1Handler,v:Ref<P2EcoExamCreatedV1Handler>)
	export function unRefP2EcoExamCreatedV1Handler(v:Ref<P2EcoExamCreatedV1Handler>):P2EcoExamCreatedV1Handler
	...
	export function emptyTalentCompetitionInfoBuilder():TalentCompetitionInfoBuilder
	export function emptyRefTalentCompetitionInfoBuilder():Ref<TalentCompetitionInfoBuilder>
	export function refOfTalentCompetitionInfoBuilder(x:TalentCompetitionInfoBuilder,v:Ref<TalentCompetitionInfoBuilder>)
	export function unRefTalentCompetitionInfoBuilder(v:Ref<TalentCompetitionInfoBuilder>):TalentCompetitionInfoBuilder
	export function emptyTalentCustomizedDataBuilder():TalentCustomizedDataBuilder
	export function emptyRefTalentCustomizedDataBuilder():Ref<TalentCustomizedDataBuilder>
	export function refOfTalentCustomizedDataBuilder(x:TalentCustomizedDataBuilder,v:Ref<TalentCustomizedDataBuilder>)
	export function unRefTalentCustomizedDataBuilder(v:Ref<TalentCustomizedDataBuilder>):TalentCustomizedDataBuilder
	...
	export function emptyCertificateInfoBuilder():CertificateInfoBuilder
	export function emptyRefCertificateInfoBuilder():Ref<CertificateInfoBuilder>
	export function refOfCertificateInfoBuilder(x:CertificateInfoBuilder,v:Ref<CertificateInfoBuilder>)
	export function unRefCertificateInfoBuilder(v:Ref<CertificateInfoBuilder>):CertificateInfoBuilder
	export function emptyCreateApplicationReqBuilder():CreateApplicationReqBuilder
	export function emptyRefCreateApplicationReqBuilder():Ref<CreateApplicationReqBuilder>
	export function refOfCreateApplicationReqBuilder(x:CreateApplicationReqBuilder,v:Ref<CreateApplicationReqBuilder>)
	export function unRefCreateApplicationReqBuilder(v:Ref<CreateApplicationReqBuilder>):CreateApplicationReqBuilder
	...
	export function emptyJobRecruitmentTypeBuilder():JobRecruitmentTypeBuilder
	export function emptyRefJobRecruitmentTypeBuilder():Ref<JobRecruitmentTypeBuilder>
	export function refOfJobRecruitmentTypeBuilder(x:JobRecruitmentTypeBuilder,v:Ref<JobRecruitmentTypeBuilder>)
	export function unRefJobRecruitmentTypeBuilder(v:Ref<JobRecruitmentTypeBuilder>):JobRecruitmentTypeBuilder
	export function emptyAgencyProtectionBuilder():AgencyProtectionBuilder
	export function emptyRefAgencyProtectionBuilder():Ref<AgencyProtectionBuilder>
	export function refOfAgencyProtectionBuilder(x:AgencyProtectionBuilder,v:Ref<AgencyProtectionBuilder>)
	export function unRefAgencyProtectionBuilder(v:Ref<AgencyProtectionBuilder>):AgencyProtectionBuilder
	...
	export function emptyInterviewDimensionAssessmentBuilder():InterviewDimensionAssessmentBuilder
	export function emptyRefInterviewDimensionAssessmentBuilder():Ref<InterviewDimensionAssessmentBuilder>
	export function refOfInterviewDimensionAssessmentBuilder(x:InterviewDimensionAssessmentBuilder,v:Ref<InterviewDimensionAssessmentBuilder>)
	export function unRefInterviewDimensionAssessmentBuilder(v:Ref<InterviewDimensionAssessmentBuilder>):InterviewDimensionAssessmentBuilder
	...
	export function emptyReconciliationReferralAccountReqBuilder():ReconciliationReferralAccountReqBuilder
	export function emptyRefReconciliationReferralAccountReqBuilder():Ref<ReconciliationReferralAccountReqBuilder>
	export function refOfReconciliationReferralAccountReqBuilder(x:ReconciliationReferralAccountReqBuilder,v:Ref<ReconciliationReferralAccountReqBuilder>)
	export function unRefReconciliationReferralAccountReqBuilder(v:Ref<ReconciliationReferralAccountReqBuilder>):ReconciliationReferralAccountReqBuilder
	...
	export function emptyFiveStartScoringResultBuilder():FiveStartScoringResultBuilder
	export function emptyRefFiveStartScoringResultBuilder():Ref<FiveStartScoringResultBuilder>
	export function refOfFiveStartScoringResultBuilder(x:FiveStartScoringResultBuilder,v:Ref<FiveStartScoringResultBuilder>)
	export function unRefFiveStartScoringResultBuilder(v:Ref<FiveStartScoringResultBuilder>):FiveStartScoringResultBuilder
	...
	export function emptyApplicationWebsiteResumeSourceBuilder():ApplicationWebsiteResumeSourceBuilder
	export function emptyRefApplicationWebsiteResumeSourceBuilder():Ref<ApplicationWebsiteResumeSourceBuilder>
	export function refOfApplicationWebsiteResumeSourceBuilder(x:ApplicationWebsiteResumeSourceBuilder,v:Ref<ApplicationWebsiteResumeSourceBuilder>)
	export function unRefApplicationWebsiteResumeSourceBuilder(v:Ref<ApplicationWebsiteResumeSourceBuilder>):ApplicationWebsiteResumeSourceBuilder
	...
	export function emptyInterviewAppointmentConfigContentBuilder():InterviewAppointmentConfigContentBuilder
	export function emptyRefInterviewAppointmentConfigContentBuilder():Ref<InterviewAppointmentConfigContentBuilder>
	export function refOfInterviewAppointmentConfigContentBuilder(x:InterviewAppointmentConfigContentBuilder,v:Ref<InterviewAppointmentConfigContentBuilder>)
	export function unRefInterviewAppointmentConfigContentBuilder(v:Ref<InterviewAppointmentConfigContentBuilder>):InterviewAppointmentConfigContentBuilder
	export function emptyListTalentFolderReqBuilder():ListTalentFolderReqBuilder
	export function emptyRefListTalentFolderReqBuilder():Ref<ListTalentFolderReqBuilder>
	export function refOfListTalentFolderReqBuilder(x:ListTalentFolderReqBuilder,v:Ref<ListTalentFolderReqBuilder>)
	export function unRefListTalentFolderReqBuilder(v:Ref<ListTalentFolderReqBuilder>):ListTalentFolderReqBuilder
	export function emptyTalentInterviewRegistrationSimpleBuilder():TalentInterviewRegistrationSimpleBuilder
	export function emptyRefTalentInterviewRegistrationSimpleBuilder():Ref<TalentInterviewRegistrationSimpleBuilder>
	export function refOfTalentInterviewRegistrationSimpleBuilder(x:TalentInterviewRegistrationSimpleBuilder,v:Ref<TalentInterviewRegistrationSimpleBuilder>)
	export function unRefTalentInterviewRegistrationSimpleBuilder(v:Ref<TalentInterviewRegistrationSimpleBuilder>):TalentInterviewRegistrationSimpleBuilder
	...
	export function emptyAppliTalentCompetitionInfoBuilder():AppliTalentCompetitionInfoBuilder
	export function emptyRefAppliTalentCompetitionInfoBuilder():Ref<AppliTalentCompetitionInfoBuilder>
	export function refOfAppliTalentCompetitionInfoBuilder(x:AppliTalentCompetitionInfoBuilder,v:Ref<AppliTalentCompetitionInfoBuilder>)
	export function unRefAppliTalentCompetitionInfoBuilder(v:Ref<AppliTalentCompetitionInfoBuilder>):AppliTalentCompetitionInfoBuilder
	...
	export function emptyInterviewFeedbackFormDimensionBuilder():InterviewFeedbackFormDimensionBuilder
	export function emptyRefInterviewFeedbackFormDimensionBuilder():Ref<InterviewFeedbackFormDimensionBuilder>
	export function refOfInterviewFeedbackFormDimensionBuilder(x:InterviewFeedbackFormDimensionBuilder,v:Ref<InterviewFeedbackFormDimensionBuilder>)
	export function unRefInterviewFeedbackFormDimensionBuilder(v:Ref<InterviewFeedbackFormDimensionBuilder>):InterviewFeedbackFormDimensionBuilder
	...
	export function emptyJobFunctionBuilder():JobFunctionBuilder
	export function emptyRefJobFunctionBuilder():Ref<JobFunctionBuilder>
	export function refOfJobFunctionBuilder(x:JobFunctionBuilder,v:Ref<JobFunctionBuilder>)
	export function unRefJobFunctionBuilder(v:Ref<JobFunctionBuilder>):JobFunctionBuilder
	...
	export function emptyRegistrationSchemaInfoBuilder():RegistrationSchemaInfoBuilder
	export function emptyRefRegistrationSchemaInfoBuilder():Ref<RegistrationSchemaInfoBuilder>
	export function refOfRegistrationSchemaInfoBuilder(x:RegistrationSchemaInfoBuilder,v:Ref<RegistrationSchemaInfoBuilder>)
	export function unRefRegistrationSchemaInfoBuilder(v:Ref<RegistrationSchemaInfoBuilder>):RegistrationSchemaInfoBuilder
	export function emptySiteResumeSnsBuilder():SiteResumeSnsBuilder
	export function emptyRefSiteResumeSnsBuilder():Ref<SiteResumeSnsBuilder>
	export function refOfSiteResumeSnsBuilder(x:SiteResumeSnsBuilder,v:Ref<SiteResumeSnsBuilder>)
	export function unRefSiteResumeSnsBuilder(v:Ref<SiteResumeSnsBuilder>):SiteResumeSnsBuilder
	export function emptyTerminateApplicationPathReqBodyBuilder():TerminateApplicationPathReqBodyBuilder
	export function emptyRefTerminateApplicationPathReqBodyBuilder():Ref<TerminateApplicationPathReqBodyBuilder>
	export function refOfTerminateApplicationPathReqBodyBuilder(x:TerminateApplicationPathReqBodyBuilder,v:Ref<TerminateApplicationPathReqBodyBuilder>)
	export function unRefTerminateApplicationPathReqBodyBuilder(v:Ref<TerminateApplicationPathReqBodyBuilder>):TerminateApplicationPathReqBodyBuilder
	...
	export function emptyCommonSchemaConfigBuilder():CommonSchemaConfigBuilder
	export function emptyRefCommonSchemaConfigBuilder():Ref<CommonSchemaConfigBuilder>
	export function refOfCommonSchemaConfigBuilder(x:CommonSchemaConfigBuilder,v:Ref<CommonSchemaConfigBuilder>)
	export function unRefCommonSchemaConfigBuilder(v:Ref<CommonSchemaConfigBuilder>):CommonSchemaConfigBuilder
	...
	export function emptyTransferOnboardApplicationReqBuilder():TransferOnboardApplicationReqBuilder
	export function emptyRefTransferOnboardApplicationReqBuilder():Ref<TransferOnboardApplicationReqBuilder>
	export function refOfTransferOnboardApplicationReqBuilder(x:TransferOnboardApplicationReqBuilder,v:Ref<TransferOnboardApplicationReqBuilder>)
	export function unRefTransferOnboardApplicationReqBuilder(v:Ref<TransferOnboardApplicationReqBuilder>):TransferOnboardApplicationReqBuilder
	export function emptyBaseRespBuilder():BaseRespBuilder
	export function emptyRefBaseRespBuilder():Ref<BaseRespBuilder>
	export function refOfBaseRespBuilder(x:BaseRespBuilder,v:Ref<BaseRespBuilder>)
	export function unRefBaseRespBuilder(v:Ref<BaseRespBuilder>):BaseRespBuilder
	export function emptyInterviewFeedbackFormModuleBuilder():InterviewFeedbackFormModuleBuilder
	export function emptyRefInterviewFeedbackFormModuleBuilder():Ref<InterviewFeedbackFormModuleBuilder>
	export function refOfInterviewFeedbackFormModuleBuilder(x:InterviewFeedbackFormModuleBuilder,v:Ref<InterviewFeedbackFormModuleBuilder>)
	export function unRefInterviewFeedbackFormModuleBuilder(v:Ref<InterviewFeedbackFormModuleBuilder>):InterviewFeedbackFormModuleBuilder
	...
	export function emptyTestResultDetailBuilder():TestResultDetailBuilder
	export function emptyRefTestResultDetailBuilder():Ref<TestResultDetailBuilder>
	export function refOfTestResultDetailBuilder(x:TestResultDetailBuilder,v:Ref<TestResultDetailBuilder>)
	export function unRefTestResultDetailBuilder(v:Ref<TestResultDetailBuilder>):TestResultDetailBuilder
	...
	export function emptySiteResumeProjectBuilder():SiteResumeProjectBuilder
	export function emptyRefSiteResumeProjectBuilder():Ref<SiteResumeProjectBuilder>
	export function refOfSiteResumeProjectBuilder(x:SiteResumeProjectBuilder,v:Ref<SiteResumeProjectBuilder>)
	export function unRefSiteResumeProjectBuilder(v:Ref<SiteResumeProjectBuilder>):SiteResumeProjectBuilder
	export function emptyWebsiteDeliveryIdentificationBuilder():WebsiteDeliveryIdentificationBuilder
	export function emptyRefWebsiteDeliveryIdentificationBuilder():Ref<WebsiteDeliveryIdentificationBuilder>
	export function refOfWebsiteDeliveryIdentificationBuilder(x:WebsiteDeliveryIdentificationBuilder,v:Ref<WebsiteDeliveryIdentificationBuilder>)
	export function unRefWebsiteDeliveryIdentificationBuilder(v:Ref<WebsiteDeliveryIdentificationBuilder>):WebsiteDeliveryIdentificationBuilder
	export function emptyBatchDeleteEcoAccountCustomFieldReqBodyBuilder():BatchDeleteEcoAccountCustomFieldReqBodyBuilder
	export function emptyRefBatchDeleteEcoAccountCustomFieldReqBodyBuilder():Ref<BatchDeleteEcoAccountCustomFieldReqBodyBuilder>
	export function refOfBatchDeleteEcoAccountCustomFieldReqBodyBuilder(x:BatchDeleteEcoAccountCustomFieldReqBodyBuilder,v:Ref<BatchDeleteEcoAccountCustomFieldReqBodyBuilder>)
	export function unRefBatchDeleteEcoAccountCustomFieldReqBodyBuilder(v:Ref<BatchDeleteEcoAccountCustomFieldReqBodyBuilder>):BatchDeleteEcoAccountCustomFieldReqBodyBuilder
	...
	export function emptyApplicationTalentEducationInfoBuilder():ApplicationTalentEducationInfoBuilder
	export function emptyRefApplicationTalentEducationInfoBuilder():Ref<ApplicationTalentEducationInfoBuilder>
	export function refOfApplicationTalentEducationInfoBuilder(x:ApplicationTalentEducationInfoBuilder,v:Ref<ApplicationTalentEducationInfoBuilder>)
	export function unRefApplicationTalentEducationInfoBuilder(v:Ref<ApplicationTalentEducationInfoBuilder>):ApplicationTalentEducationInfoBuilder
	...
	export function emptyExternalInterviewBuilder():ExternalInterviewBuilder
	export function emptyRefExternalInterviewBuilder():Ref<ExternalInterviewBuilder>
	export function refOfExternalInterviewBuilder(x:ExternalInterviewBuilder,v:Ref<ExternalInterviewBuilder>)
	export function unRefExternalInterviewBuilder(v:Ref<ExternalInterviewBuilder>):ExternalInterviewBuilder
	...
	export function emptyEcoExamCreateEventCandidateInfoBuilder():EcoExamCreateEventCandidateInfoBuilder
	export function emptyRefEcoExamCreateEventCandidateInfoBuilder():Ref<EcoExamCreateEventCandidateInfoBuilder>
	export function refOfEcoExamCreateEventCandidateInfoBuilder(x:EcoExamCreateEventCandidateInfoBuilder,v:Ref<EcoExamCreateEventCandidateInfoBuilder>)
	export function unRefEcoExamCreateEventCandidateInfoBuilder(v:Ref<EcoExamCreateEventCandidateInfoBuilder>):EcoExamCreateEventCandidateInfoBuilder
	export function emptyOfferApplyFormInfoBuilder():OfferApplyFormInfoBuilder
	export function emptyRefOfferApplyFormInfoBuilder():Ref<OfferApplyFormInfoBuilder>
	export function refOfOfferApplyFormInfoBuilder(x:OfferApplyFormInfoBuilder,v:Ref<OfferApplyFormInfoBuilder>)
	export function unRefOfferApplyFormInfoBuilder(v:Ref<OfferApplyFormInfoBuilder>):OfferApplyFormInfoBuilder
	...
	export function emptyQuestionBuilder():QuestionBuilder
	export function emptyRefQuestionBuilder():Ref<QuestionBuilder>
	export function refOfQuestionBuilder(x:QuestionBuilder,v:Ref<QuestionBuilder>)
	export function unRefQuestionBuilder(v:Ref<QuestionBuilder>):QuestionBuilder
	...
	export function emptyEmployeeConversionInfoBuilder():EmployeeConversionInfoBuilder
	export function emptyRefEmployeeConversionInfoBuilder():Ref<EmployeeConversionInfoBuilder>
	export function refOfEmployeeConversionInfoBuilder(x:EmployeeConversionInfoBuilder,v:Ref<EmployeeConversionInfoBuilder>)
	export function unRefEmployeeConversionInfoBuilder(v:Ref<EmployeeConversionInfoBuilder>):EmployeeConversionInfoBuilder
	export function emptyPatchNoteReqBodyBuilder():PatchNoteReqBodyBuilder
	export function emptyRefPatchNoteReqBodyBuilder():Ref<PatchNoteReqBodyBuilder>
	export function refOfPatchNoteReqBodyBuilder(x:PatchNoteReqBodyBuilder,v:Ref<PatchNoteReqBodyBuilder>)
	export function unRefPatchNoteReqBodyBuilder(v:Ref<PatchNoteReqBodyBuilder>):PatchNoteReqBodyBuilder
	...
	export function emptyWithdrawReferralAccountReqBuilder():WithdrawReferralAccountReqBuilder
	export function emptyRefWithdrawReferralAccountReqBuilder():Ref<WithdrawReferralAccountReqBuilder>
	export function refOfWithdrawReferralAccountReqBuilder(x:WithdrawReferralAccountReqBuilder,v:Ref<WithdrawReferralAccountReqBuilder>)
	export function unRefWithdrawReferralAccountReqBuilder(v:Ref<WithdrawReferralAccountReqBuilder>):WithdrawReferralAccountReqBuilder
	export function emptyApplicationOfferBuilder():ApplicationOfferBuilder
	export function emptyRefApplicationOfferBuilder():Ref<ApplicationOfferBuilder>
	export function refOfApplicationOfferBuilder(x:ApplicationOfferBuilder,v:Ref<ApplicationOfferBuilder>)
	export function unRefApplicationOfferBuilder(v:Ref<ApplicationOfferBuilder>):ApplicationOfferBuilder
	export function emptyCompetitionInfoBuilder():CompetitionInfoBuilder
	export function emptyRefCompetitionInfoBuilder():Ref<CompetitionInfoBuilder>
	export function refOfCompetitionInfoBuilder(x:CompetitionInfoBuilder,v:Ref<CompetitionInfoBuilder>)
	export function unRefCompetitionInfoBuilder(v:Ref<CompetitionInfoBuilder>):CompetitionInfoBuilder
	...
	export function emptyProviderIdNameObjectBuilder():ProviderIdNameObjectBuilder
	export function emptyRefProviderIdNameObjectBuilder():Ref<ProviderIdNameObjectBuilder>
	export function refOfProviderIdNameObjectBuilder(x:ProviderIdNameObjectBuilder,v:Ref<ProviderIdNameObjectBuilder>)
	export function unRefProviderIdNameObjectBuilder(v:Ref<ProviderIdNameObjectBuilder>):ProviderIdNameObjectBuilder
	...
	export function emptyInterviewRecordTemplateBuilder():InterviewRecordTemplateBuilder
	export function emptyRefInterviewRecordTemplateBuilder():Ref<InterviewRecordTemplateBuilder>
	export function refOfInterviewRecordTemplateBuilder(x:InterviewRecordTemplateBuilder,v:Ref<InterviewRecordTemplateBuilder>)
	export function unRefInterviewRecordTemplateBuilder(v:Ref<InterviewRecordTemplateBuilder>):InterviewRecordTemplateBuilder
	...
	export function emptyOfferApplyFormObjectDisplayConfigInfoBuilder():OfferApplyFormObjectDisplayConfigInfoBuilder
	export function emptyRefOfferApplyFormObjectDisplayConfigInfoBuilder():Ref<OfferApplyFormObjectDisplayConfigInfoBuilder>
	export function refOfOfferApplyFormObjectDisplayConfigInfoBuilder(x:OfferApplyFormObjectDisplayConfigInfoBuilder,v:Ref<OfferApplyFormObjectDisplayConfigInfoBuilder>)
	export function unRefOfferApplyFormObjectDisplayConfigInfoBuilder(v:Ref<OfferApplyFormObjectDisplayConfigInfoBuilder>):OfferApplyFormObjectDisplayConfigInfoBuilder
	...
	export function emptyEcoBackgroundCheckCreateEventCustomKvBuilder():EcoBackgroundCheckCreateEventCustomKvBuilder
	export function emptyRefEcoBackgroundCheckCreateEventCustomKvBuilder():Ref<EcoBackgroundCheckCreateEventCustomKvBuilder>
	export function refOfEcoBackgroundCheckCreateEventCustomKvBuilder(x:EcoBackgroundCheckCreateEventCustomKvBuilder,v:Ref<EcoBackgroundCheckCreateEventCustomKvBuilder>)
	export function unRefEcoBackgroundCheckCreateEventCustomKvBuilder(v:Ref<EcoBackgroundCheckCreateEventCustomKvBuilder>):EcoBackgroundCheckCreateEventCustomKvBuilder
	...
	export function emptyJobCustomizedDataBuilder():JobCustomizedDataBuilder
	export function emptyRefJobCustomizedDataBuilder():Ref<JobCustomizedDataBuilder>
	export function refOfJobCustomizedDataBuilder(x:JobCustomizedDataBuilder,v:Ref<JobCustomizedDataBuilder>)
	export function unRefJobCustomizedDataBuilder(v:Ref<JobCustomizedDataBuilder>):JobCustomizedDataBuilder
	export function emptyOfferBasicInfoBuilder():OfferBasicInfoBuilder
	export function emptyRefOfferBasicInfoBuilder():Ref<OfferBasicInfoBuilder>
	export function refOfOfferBasicInfoBuilder(x:OfferBasicInfoBuilder,v:Ref<OfferBasicInfoBuilder>)
	export function unRefOfferBasicInfoBuilder(v:Ref<OfferBasicInfoBuilder>):OfferBasicInfoBuilder
	export function emptyTradeDetailBuilder():TradeDetailBuilder
	export function emptyRefTradeDetailBuilder():Ref<TradeDetailBuilder>
	export function refOfTradeDetailBuilder(x:TradeDetailBuilder,v:Ref<TradeDetailBuilder>)
	export function unRefTradeDetailBuilder(v:Ref<TradeDetailBuilder>):TradeDetailBuilder
	...
	export function emptyEvaluationTaskBuilder():EvaluationTaskBuilder
	export function emptyRefEvaluationTaskBuilder():Ref<EvaluationTaskBuilder>
	export function refOfEvaluationTaskBuilder(x:EvaluationTaskBuilder,v:Ref<EvaluationTaskBuilder>)
	export function unRefEvaluationTaskBuilder(v:Ref<EvaluationTaskBuilder>):EvaluationTaskBuilder
	...
	export function emptyEcoAccountCustomFieldDataBuilder():EcoAccountCustomFieldDataBuilder
	export function emptyRefEcoAccountCustomFieldDataBuilder():Ref<EcoAccountCustomFieldDataBuilder>
	export function refOfEcoAccountCustomFieldDataBuilder(x:EcoAccountCustomFieldDataBuilder,v:Ref<EcoAccountCustomFieldDataBuilder>)
	export function unRefEcoAccountCustomFieldDataBuilder(v:Ref<EcoAccountCustomFieldDataBuilder>):EcoAccountCustomFieldDataBuilder
	...
	export function emptyOfferApplyFormBuilder():OfferApplyFormBuilder
	export function emptyRefOfferApplyFormBuilder():Ref<OfferApplyFormBuilder>
	export function refOfOfferApplyFormBuilder(x:OfferApplyFormBuilder,v:Ref<OfferApplyFormBuilder>)
	export function unRefOfferApplyFormBuilder(v:Ref<OfferApplyFormBuilder>):OfferApplyFormBuilder
	export function emptyWebsiteBuilder():WebsiteBuilder
	export function emptyRefWebsiteBuilder():Ref<WebsiteBuilder>
	export function refOfWebsiteBuilder(x:WebsiteBuilder,v:Ref<WebsiteBuilder>)
	export function unRefWebsiteBuilder(v:Ref<WebsiteBuilder>):WebsiteBuilder
	...
	export function emptyExternalApplicationBuilder():ExternalApplicationBuilder
	export function emptyRefExternalApplicationBuilder():Ref<ExternalApplicationBuilder>
	export function refOfExternalApplicationBuilder(x:ExternalApplicationBuilder,v:Ref<ExternalApplicationBuilder>)
	export function unRefExternalApplicationBuilder(v:Ref<ExternalApplicationBuilder>):ExternalApplicationBuilder
	...
	export function emptyTalentExternalInfoBuilder():TalentExternalInfoBuilder
	export function emptyRefTalentExternalInfoBuilder():Ref<TalentExternalInfoBuilder>
	export function refOfTalentExternalInfoBuilder(x:TalentExternalInfoBuilder,v:Ref<TalentExternalInfoBuilder>)
	export function unRefTalentExternalInfoBuilder(v:Ref<TalentExternalInfoBuilder>):TalentExternalInfoBuilder
	...
	export function emptyWebsiteDeliverySnsBuilder():WebsiteDeliverySnsBuilder
	export function emptyRefWebsiteDeliverySnsBuilder():Ref<WebsiteDeliverySnsBuilder>
	export function refOfWebsiteDeliverySnsBuilder(x:WebsiteDeliverySnsBuilder,v:Ref<WebsiteDeliverySnsBuilder>)
	export function unRefWebsiteDeliverySnsBuilder(v:Ref<WebsiteDeliverySnsBuilder>):WebsiteDeliverySnsBuilder
	...
	export function emptyGetNoteReqBuilder():GetNoteReqBuilder
	export function emptyRefGetNoteReqBuilder():Ref<GetNoteReqBuilder>
	export function refOfGetNoteReqBuilder(x:GetNoteReqBuilder,v:Ref<GetNoteReqBuilder>)
	export function unRefGetNoteReqBuilder(v:Ref<GetNoteReqBuilder>):GetNoteReqBuilder
	export function emptyListOfferReqBuilder():ListOfferReqBuilder
	export function emptyRefListOfferReqBuilder():Ref<ListOfferReqBuilder>
	export function refOfListOfferReqBuilder(x:ListOfferReqBuilder,v:Ref<ListOfferReqBuilder>)
	export function unRefListOfferReqBuilder(v:Ref<ListOfferReqBuilder>):ListOfferReqBuilder
	...
	export function emptyJobProcessBuilder():JobProcessBuilder
	export function emptyRefJobProcessBuilder():Ref<JobProcessBuilder>
	export function refOfJobProcessBuilder(x:JobProcessBuilder,v:Ref<JobProcessBuilder>)
	export function unRefJobProcessBuilder(v:Ref<JobProcessBuilder>):JobProcessBuilder
	export function emptySiteResumeCompetitionBuilder():SiteResumeCompetitionBuilder
	export function emptyRefSiteResumeCompetitionBuilder():Ref<SiteResumeCompetitionBuilder>
	export function refOfSiteResumeCompetitionBuilder(x:SiteResumeCompetitionBuilder,v:Ref<SiteResumeCompetitionBuilder>)
	export function unRefSiteResumeCompetitionBuilder(v:Ref<SiteResumeCompetitionBuilder>):SiteResumeCompetitionBuilder
	...
	export function emptyTalentLanguageInfoBuilder():TalentLanguageInfoBuilder
	export function emptyRefTalentLanguageInfoBuilder():Ref<TalentLanguageInfoBuilder>
	export function refOfTalentLanguageInfoBuilder(x:TalentLanguageInfoBuilder,v:Ref<TalentLanguageInfoBuilder>)
	export function unRefTalentLanguageInfoBuilder(v:Ref<TalentLanguageInfoBuilder>):TalentLanguageInfoBuilder
	...
	export function emptyBackgroundCheckCustomFieldDataValueBuilder():BackgroundCheckCustomFieldDataValueBuilder
	export function emptyRefBackgroundCheckCustomFieldDataValueBuilder():Ref<BackgroundCheckCustomFieldDataValueBuilder>
	export function refOfBackgroundCheckCustomFieldDataValueBuilder(x:BackgroundCheckCustomFieldDataValueBuilder,v:Ref<BackgroundCheckCustomFieldDataValueBuilder>)
	export function unRefBackgroundCheckCustomFieldDataValueBuilder(v:Ref<BackgroundCheckCustomFieldDataValueBuilder>):BackgroundCheckCustomFieldDataValueBuilder
	export function emptyContractPeriodInfoBuilder():ContractPeriodInfoBuilder
	export function emptyRefContractPeriodInfoBuilder():Ref<ContractPeriodInfoBuilder>
	export function refOfContractPeriodInfoBuilder(x:ContractPeriodInfoBuilder,v:Ref<ContractPeriodInfoBuilder>)
	export function unRefContractPeriodInfoBuilder(v:Ref<ContractPeriodInfoBuilder>):ContractPeriodInfoBuilder
	export function emptyApplicationOfferCustomValueBuilder():ApplicationOfferCustomValueBuilder
	export function emptyRefApplicationOfferCustomValueBuilder():Ref<ApplicationOfferCustomValueBuilder>
	export function refOfApplicationOfferCustomValueBuilder(x:ApplicationOfferCustomValueBuilder,v:Ref<ApplicationOfferCustomValueBuilder>)
	export function unRefApplicationOfferCustomValueBuilder(v:Ref<ApplicationOfferCustomValueBuilder>):ApplicationOfferCustomValueBuilder
	...
	export function emptyApplicationTalentCertificateInfoBuilder():ApplicationTalentCertificateInfoBuilder
	export function emptyRefApplicationTalentCertificateInfoBuilder():Ref<ApplicationTalentCertificateInfoBuilder>
	export function refOfApplicationTalentCertificateInfoBuilder(x:ApplicationTalentCertificateInfoBuilder,v:Ref<ApplicationTalentCertificateInfoBuilder>)
	export function unRefApplicationTalentCertificateInfoBuilder(v:Ref<ApplicationTalentCertificateInfoBuilder>):ApplicationTalentCertificateInfoBuilder
	...
	export function emptyTalentSchemaObjectBuilder():TalentSchemaObjectBuilder
	export function emptyRefTalentSchemaObjectBuilder():Ref<TalentSchemaObjectBuilder>
	export function refOfTalentSchemaObjectBuilder(x:TalentSchemaObjectBuilder,v:Ref<TalentSchemaObjectBuilder>)
	export function unRefTalentSchemaObjectBuilder(v:Ref<TalentSchemaObjectBuilder>):TalentSchemaObjectBuilder
	export function emptyAbilityBuilder():AbilityBuilder
	export function emptyRefAbilityBuilder():Ref<AbilityBuilder>
	export function refOfAbilityBuilder(x:AbilityBuilder,v:Ref<AbilityBuilder>)
	export function unRefAbilityBuilder(v:Ref<AbilityBuilder>):AbilityBuilder
	...
	export function emptyInterviewAssessmentTemplateBuilder():InterviewAssessmentTemplateBuilder
	export function emptyRefInterviewAssessmentTemplateBuilder():Ref<InterviewAssessmentTemplateBuilder>
	export function refOfInterviewAssessmentTemplateBuilder(x:InterviewAssessmentTemplateBuilder,v:Ref<InterviewAssessmentTemplateBuilder>)
	export function unRefInterviewAssessmentTemplateBuilder(v:Ref<InterviewAssessmentTemplateBuilder>):InterviewAssessmentTemplateBuilder
	export function emptyOfferListInfoBuilder():OfferListInfoBuilder
	export function emptyRefOfferListInfoBuilder():Ref<OfferListInfoBuilder>
	export function refOfOfferListInfoBuilder(x:OfferListInfoBuilder,v:Ref<OfferListInfoBuilder>)
	export function unRefOfferListInfoBuilder(v:Ref<OfferListInfoBuilder>):OfferListInfoBuilder
	...
	export function emptyCommonAddressBuilder():CommonAddressBuilder
	export function emptyRefCommonAddressBuilder():Ref<CommonAddressBuilder>
	export function refOfCommonAddressBuilder(x:CommonAddressBuilder,v:Ref<CommonAddressBuilder>)
	export function unRefCommonAddressBuilder(v:Ref<CommonAddressBuilder>):CommonAddressBuilder
	export function emptyDeleteJobRequirementReqBuilder():DeleteJobRequirementReqBuilder
	export function emptyRefDeleteJobRequirementReqBuilder():Ref<DeleteJobRequirementReqBuilder>
	export function refOfDeleteJobRequirementReqBuilder(x:DeleteJobRequirementReqBuilder,v:Ref<DeleteJobRequirementReqBuilder>)
	export function unRefDeleteJobRequirementReqBuilder(v:Ref<DeleteJobRequirementReqBuilder>):DeleteJobRequirementReqBuilder
	...
	export function emptyListTalentReqBuilder():ListTalentReqBuilder
	export function emptyRefListTalentReqBuilder():Ref<ListTalentReqBuilder>
	export function refOfListTalentReqBuilder(x:ListTalentReqBuilder,v:Ref<ListTalentReqBuilder>)
	export function unRefListTalentReqBuilder(v:Ref<ListTalentReqBuilder>):ListTalentReqBuilder
	...
	export function emptyCareerInfoBuilder():CareerInfoBuilder
	export function emptyRefCareerInfoBuilder():Ref<CareerInfoBuilder>
	export function refOfCareerInfoBuilder(x:CareerInfoBuilder,v:Ref<CareerInfoBuilder>)
	export function unRefCareerInfoBuilder(v:Ref<CareerInfoBuilder>):CareerInfoBuilder
	...
	export function emptyP2ReferralAccountAssetsUpdateV1Handler():P2ReferralAccountAssetsUpdateV1Handler
	export function emptyRefP2ReferralAccountAssetsUpdateV1Handler():Ref<P2ReferralAccountAssetsUpdateV1Handler>
	export function refOfP2ReferralAccountAssetsUpdateV1Handler(x:P2ReferralAccountAssetsUpdateV1Handler,v:Ref<P2ReferralAccountAssetsUpdateV1Handler>)
	export function unRefP2ReferralAccountAssetsUpdateV1Handler(v:Ref<P2ReferralAccountAssetsUpdateV1Handler>):P2ReferralAccountAssetsUpdateV1Handler
	...
	export function emptyTalentCertificateInfoBuilder():TalentCertificateInfoBuilder
	export function emptyRefTalentCertificateInfoBuilder():Ref<TalentCertificateInfoBuilder>
	export function refOfTalentCertificateInfoBuilder(x:TalentCertificateInfoBuilder,v:Ref<TalentCertificateInfoBuilder>)
	export function unRefTalentCertificateInfoBuilder(v:Ref<TalentCertificateInfoBuilder>):TalentCertificateInfoBuilder
	export function emptyTalentCustomizedDataObjectValueChildBuilder():TalentCustomizedDataObjectValueChildBuilder
	export function emptyRefTalentCustomizedDataObjectValueChildBuilder():Ref<TalentCustomizedDataObjectValueChildBuilder>
	export function refOfTalentCustomizedDataObjectValueChildBuilder(x:TalentCustomizedDataObjectValueChildBuilder,v:Ref<TalentCustomizedDataObjectValueChildBuilder>)
	export function unRefTalentCustomizedDataObjectValueChildBuilder(v:Ref<TalentCustomizedDataObjectValueChildBuilder>):TalentCustomizedDataObjectValueChildBuilder
	...
	export function emptyApplicationOfferOnboardProfileCityBuilder():ApplicationOfferOnboardProfileCityBuilder
	export function emptyRefApplicationOfferOnboardProfileCityBuilder():Ref<ApplicationOfferOnboardProfileCityBuilder>
	export function refOfApplicationOfferOnboardProfileCityBuilder(x:ApplicationOfferOnboardProfileCityBuilder,v:Ref<ApplicationOfferOnboardProfileCityBuilder>)
	export function unRefApplicationOfferOnboardProfileCityBuilder(v:Ref<ApplicationOfferOnboardProfileCityBuilder>):ApplicationOfferOnboardProfileCityBuilder
	export function emptyEcoExamLoginInfoBuilder():EcoExamLoginInfoBuilder
	export function emptyRefEcoExamLoginInfoBuilder():Ref<EcoExamLoginInfoBuilder>
	export function refOfEcoExamLoginInfoBuilder(x:EcoExamLoginInfoBuilder,v:Ref<EcoExamLoginInfoBuilder>)
	export function unRefEcoExamLoginInfoBuilder(v:Ref<EcoExamLoginInfoBuilder>):EcoExamLoginInfoBuilder
	...
	export function emptyBatchGetIdTalentReqBuilder():BatchGetIdTalentReqBuilder
	export function emptyRefBatchGetIdTalentReqBuilder():Ref<BatchGetIdTalentReqBuilder>
	export function refOfBatchGetIdTalentReqBuilder(x:BatchGetIdTalentReqBuilder,v:Ref<BatchGetIdTalentReqBuilder>)
	export function unRefBatchGetIdTalentReqBuilder(v:Ref<BatchGetIdTalentReqBuilder>):BatchGetIdTalentReqBuilder
	export function emptyInterviewMeetingRoomBuilder():InterviewMeetingRoomBuilder
	export function emptyRefInterviewMeetingRoomBuilder():Ref<InterviewMeetingRoomBuilder>
	export function refOfInterviewMeetingRoomBuilder(x:InterviewMeetingRoomBuilder,v:Ref<InterviewMeetingRoomBuilder>)
	export function unRefInterviewMeetingRoomBuilder(v:Ref<InterviewMeetingRoomBuilder>):InterviewMeetingRoomBuilder
	...
	export function emptyCreateEcoExamPaperReqBuilder():CreateEcoExamPaperReqBuilder
	export function emptyRefCreateEcoExamPaperReqBuilder():Ref<CreateEcoExamPaperReqBuilder>
	export function refOfCreateEcoExamPaperReqBuilder(x:CreateEcoExamPaperReqBuilder,v:Ref<CreateEcoExamPaperReqBuilder>)
	export function unRefCreateEcoExamPaperReqBuilder(v:Ref<CreateEcoExamPaperReqBuilder>):CreateEcoExamPaperReqBuilder
	...
	export function emptyListJobRequirementReqBuilder():ListJobRequirementReqBuilder
	export function emptyRefListJobRequirementReqBuilder():Ref<ListJobRequirementReqBuilder>
	export function refOfListJobRequirementReqBuilder(x:ListJobRequirementReqBuilder,v:Ref<ListJobRequirementReqBuilder>)
	export function unRefListJobRequirementReqBuilder(v:Ref<ListJobRequirementReqBuilder>):ListJobRequirementReqBuilder
	...
	export function emptyWebsiteDeliveryLanguageBuilder():WebsiteDeliveryLanguageBuilder
	export function emptyRefWebsiteDeliveryLanguageBuilder():Ref<WebsiteDeliveryLanguageBuilder>
	export function refOfWebsiteDeliveryLanguageBuilder(x:WebsiteDeliveryLanguageBuilder,v:Ref<WebsiteDeliveryLanguageBuilder>)
	export function unRefWebsiteDeliveryLanguageBuilder(v:Ref<WebsiteDeliveryLanguageBuilder>):WebsiteDeliveryLanguageBuilder
	export function emptyWorksInfoBuilder():WorksInfoBuilder
	export function emptyRefWorksInfoBuilder():Ref<WorksInfoBuilder>
	export function refOfWorksInfoBuilder(x:WorksInfoBuilder,v:Ref<WorksInfoBuilder>)
	export function unRefWorksInfoBuilder(v:Ref<WorksInfoBuilder>):WorksInfoBuilder
	...
	export function emptyRegistrationInfoBuilder():RegistrationInfoBuilder
	export function emptyRefRegistrationInfoBuilder():Ref<RegistrationInfoBuilder>
	export function refOfRegistrationInfoBuilder(x:RegistrationInfoBuilder,v:Ref<RegistrationInfoBuilder>)
	export function unRefRegistrationInfoBuilder(v:Ref<RegistrationInfoBuilder>):RegistrationInfoBuilder
	export function emptySiteNameBuilder():SiteNameBuilder
	export function emptyRefSiteNameBuilder():Ref<SiteNameBuilder>
	export function refOfSiteNameBuilder(x:SiteNameBuilder,v:Ref<SiteNameBuilder>)
	export function unRefSiteNameBuilder(v:Ref<SiteNameBuilder>):SiteNameBuilder
	...
	export function emptyListQuestionnaireReqBuilder():ListQuestionnaireReqBuilder
	export function emptyRefListQuestionnaireReqBuilder():Ref<ListQuestionnaireReqBuilder>
	export function refOfListQuestionnaireReqBuilder(x:ListQuestionnaireReqBuilder,v:Ref<ListQuestionnaireReqBuilder>)
	export function unRefListQuestionnaireReqBuilder(v:Ref<ListQuestionnaireReqBuilder>):ListQuestionnaireReqBuilder
	export function emptyRecruiterJobReqBuilder():RecruiterJobReqBuilder
	export function emptyRefRecruiterJobReqBuilder():Ref<RecruiterJobReqBuilder>
	export function refOfRecruiterJobReqBuilder(x:RecruiterJobReqBuilder,v:Ref<RecruiterJobReqBuilder>)
	export function unRefRecruiterJobReqBuilder(v:Ref<RecruiterJobReqBuilder>):RecruiterJobReqBuilder
	...
	export function emptyWebsiteJobPostCustomizedTimeRangeBuilder():WebsiteJobPostCustomizedTimeRangeBuilder
	export function emptyRefWebsiteJobPostCustomizedTimeRangeBuilder():Ref<WebsiteJobPostCustomizedTimeRangeBuilder>
	export function refOfWebsiteJobPostCustomizedTimeRangeBuilder(x:WebsiteJobPostCustomizedTimeRangeBuilder,v:Ref<WebsiteJobPostCustomizedTimeRangeBuilder>)
	export function unRefWebsiteJobPostCustomizedTimeRangeBuilder(v:Ref<WebsiteJobPostCustomizedTimeRangeBuilder>):WebsiteJobPostCustomizedTimeRangeBuilder
	export function emptyEcoAccountCustomFieldBuilder():EcoAccountCustomFieldBuilder
	export function emptyRefEcoAccountCustomFieldBuilder():Ref<EcoAccountCustomFieldBuilder>
	export function refOfEcoAccountCustomFieldBuilder(x:EcoAccountCustomFieldBuilder,v:Ref<EcoAccountCustomFieldBuilder>)
	export function unRefEcoAccountCustomFieldBuilder(v:Ref<EcoAccountCustomFieldBuilder>):EcoAccountCustomFieldBuilder
	...
	export function emptyInterviewDimensionOptionBuilder():InterviewDimensionOptionBuilder
	export function emptyRefInterviewDimensionOptionBuilder():Ref<InterviewDimensionOptionBuilder>
	export function refOfInterviewDimensionOptionBuilder(x:InterviewDimensionOptionBuilder,v:Ref<InterviewDimensionOptionBuilder>)
	export function unRefInterviewDimensionOptionBuilder(v:Ref<InterviewDimensionOptionBuilder>):InterviewDimensionOptionBuilder
	...
	export function emptyTalentWorksInfoBuilder():TalentWorksInfoBuilder
	export function emptyRefTalentWorksInfoBuilder():Ref<TalentWorksInfoBuilder>
	export function refOfTalentWorksInfoBuilder(x:TalentWorksInfoBuilder,v:Ref<TalentWorksInfoBuilder>)
	export function unRefTalentWorksInfoBuilder(v:Ref<TalentWorksInfoBuilder>):TalentWorksInfoBuilder
	...
	export function emptyBatchDeleteEcoBackgroundCheckPackageReqBodyBuilder():BatchDeleteEcoBackgroundCheckPackageReqBodyBuilder
	export function emptyRefBatchDeleteEcoBackgroundCheckPackageReqBodyBuilder():Ref<BatchDeleteEcoBackgroundCheckPackageReqBodyBuilder>
	export function refOfBatchDeleteEcoBackgroundCheckPackageReqBodyBuilder(x:BatchDeleteEcoBackgroundCheckPackageReqBodyBuilder,v:Ref<BatchDeleteEcoBackgroundCheckPackageReqBodyBuilder>)
	export function unRefBatchDeleteEcoBackgroundCheckPackageReqBodyBuilder(v:Ref<BatchDeleteEcoBackgroundCheckPackageReqBodyBuilder>):BatchDeleteEcoBackgroundCheckPackageReqBodyBuilder
	export function emptyBatchGetIdTalentPathReqBodyBuilder():BatchGetIdTalentPathReqBodyBuilder
	export function emptyRefBatchGetIdTalentPathReqBodyBuilder():Ref<BatchGetIdTalentPathReqBodyBuilder>
	export function refOfBatchGetIdTalentPathReqBodyBuilder(x:BatchGetIdTalentPathReqBodyBuilder,v:Ref<BatchGetIdTalentPathReqBodyBuilder>)
	export function unRefBatchGetIdTalentPathReqBodyBuilder(v:Ref<BatchGetIdTalentPathReqBodyBuilder>):BatchGetIdTalentPathReqBodyBuilder
	...
	export function emptyJobConfigBuilder():JobConfigBuilder
	export function emptyRefJobConfigBuilder():Ref<JobConfigBuilder>
	export function refOfJobConfigBuilder(x:JobConfigBuilder,v:Ref<JobConfigBuilder>)
	export function unRefJobConfigBuilder(v:Ref<JobConfigBuilder>):JobConfigBuilder
	...
	export function emptyWebsiteDeliveryCustomizedDataBuilder():WebsiteDeliveryCustomizedDataBuilder
	export function emptyRefWebsiteDeliveryCustomizedDataBuilder():Ref<WebsiteDeliveryCustomizedDataBuilder>
	export function refOfWebsiteDeliveryCustomizedDataBuilder(x:WebsiteDeliveryCustomizedDataBuilder,v:Ref<WebsiteDeliveryCustomizedDataBuilder>)
	export function unRefWebsiteDeliveryCustomizedDataBuilder(v:Ref<WebsiteDeliveryCustomizedDataBuilder>):WebsiteDeliveryCustomizedDataBuilder
	...
	export function emptyExternalBackgroundCheckBuilder():ExternalBackgroundCheckBuilder
	export function emptyRefExternalBackgroundCheckBuilder():Ref<ExternalBackgroundCheckBuilder>
	export function refOfExternalBackgroundCheckBuilder(x:ExternalBackgroundCheckBuilder,v:Ref<ExternalBackgroundCheckBuilder>)
	export function unRefExternalBackgroundCheckBuilder(v:Ref<ExternalBackgroundCheckBuilder>):ExternalBackgroundCheckBuilder
	...
	export function emptyJobTypeInfoBuilder():JobTypeInfoBuilder
	export function emptyRefJobTypeInfoBuilder():Ref<JobTypeInfoBuilder>
	export function refOfJobTypeInfoBuilder(x:JobTypeInfoBuilder,v:Ref<JobTypeInfoBuilder>)
	export function unRefJobTypeInfoBuilder(v:Ref<JobTypeInfoBuilder>):JobTypeInfoBuilder
	...
	export function emptyApplicationPrehireBuilder():ApplicationPrehireBuilder
	export function emptyRefApplicationPrehireBuilder():Ref<ApplicationPrehireBuilder>
	export function refOfApplicationPrehireBuilder(x:ApplicationPrehireBuilder,v:Ref<ApplicationPrehireBuilder>)
	export function unRefApplicationPrehireBuilder(v:Ref<ApplicationPrehireBuilder>):ApplicationPrehireBuilder
	...
	export function emptyPermissionScopeRuleBuilder():PermissionScopeRuleBuilder
	export function emptyRefPermissionScopeRuleBuilder():Ref<PermissionScopeRuleBuilder>
	export function refOfPermissionScopeRuleBuilder(x:PermissionScopeRuleBuilder,v:Ref<PermissionScopeRuleBuilder>)
	export function unRefPermissionScopeRuleBuilder(v:Ref<PermissionScopeRuleBuilder>):PermissionScopeRuleBuilder
	...
	export function emptyUpdateProgressEcoBackgroundCheckPathReqBodyBuilder():UpdateProgressEcoBackgroundCheckPathReqBodyBuilder
	export function emptyRefUpdateProgressEcoBackgroundCheckPathReqBodyBuilder():Ref<UpdateProgressEcoBackgroundCheckPathReqBodyBuilder>
	export function refOfUpdateProgressEcoBackgroundCheckPathReqBodyBuilder(x:UpdateProgressEcoBackgroundCheckPathReqBodyBuilder,v:Ref<UpdateProgressEcoBackgroundCheckPathReqBodyBuilder>)
	export function unRefUpdateProgressEcoBackgroundCheckPathReqBodyBuilder(v:Ref<UpdateProgressEcoBackgroundCheckPathReqBodyBuilder>):UpdateProgressEcoBackgroundCheckPathReqBodyBuilder
	...
	export function emptyExternalGrantRoleInfoBuilder():ExternalGrantRoleInfoBuilder
	export function emptyRefExternalGrantRoleInfoBuilder():Ref<ExternalGrantRoleInfoBuilder>
	export function refOfExternalGrantRoleInfoBuilder(x:ExternalGrantRoleInfoBuilder,v:Ref<ExternalGrantRoleInfoBuilder>)
	export function unRefExternalGrantRoleInfoBuilder(v:Ref<ExternalGrantRoleInfoBuilder>):ExternalGrantRoleInfoBuilder
	export function emptyExternalRewardBuilder():ExternalRewardBuilder
	export function emptyRefExternalRewardBuilder():Ref<ExternalRewardBuilder>
	export function refOfExternalRewardBuilder(x:ExternalRewardBuilder,v:Ref<ExternalRewardBuilder>)
	export function unRefExternalRewardBuilder(v:Ref<ExternalRewardBuilder>):ExternalRewardBuilder
	export function emptyJobConfigRoundTypeResultBuilder():JobConfigRoundTypeResultBuilder
	export function emptyRefJobConfigRoundTypeResultBuilder():Ref<JobConfigRoundTypeResultBuilder>
	export function refOfJobConfigRoundTypeResultBuilder(x:JobConfigRoundTypeResultBuilder,v:Ref<JobConfigRoundTypeResultBuilder>)
	export function unRefJobConfigRoundTypeResultBuilder(v:Ref<JobConfigRoundTypeResultBuilder>):JobConfigRoundTypeResultBuilder
	...
	export function emptyTalentInternshipInfoBuilder():TalentInternshipInfoBuilder
	export function emptyRefTalentInternshipInfoBuilder():Ref<TalentInternshipInfoBuilder>
	export function refOfTalentInternshipInfoBuilder(x:TalentInternshipInfoBuilder,v:Ref<TalentInternshipInfoBuilder>)
	export function unRefTalentInternshipInfoBuilder(v:Ref<TalentInternshipInfoBuilder>):TalentInternshipInfoBuilder
	...
	export function emptyIdNameObjectBuilder():IdNameObjectBuilder
	export function emptyRefIdNameObjectBuilder():Ref<IdNameObjectBuilder>
	export function refOfIdNameObjectBuilder(x:IdNameObjectBuilder,v:Ref<IdNameObjectBuilder>)
	export function unRefIdNameObjectBuilder(v:Ref<IdNameObjectBuilder>):IdNameObjectBuilder
	export function emptyTalentCustomizedTimeRangeBuilder():TalentCustomizedTimeRangeBuilder
	export function emptyRefTalentCustomizedTimeRangeBuilder():Ref<TalentCustomizedTimeRangeBuilder>
	export function refOfTalentCustomizedTimeRangeBuilder(x:TalentCustomizedTimeRangeBuilder,v:Ref<TalentCustomizedTimeRangeBuilder>)
	export function unRefTalentCustomizedTimeRangeBuilder(v:Ref<TalentCustomizedTimeRangeBuilder>):TalentCustomizedTimeRangeBuilder
	...
	export function emptyApplicationTalentBuilder():ApplicationTalentBuilder
	export function emptyRefApplicationTalentBuilder():Ref<ApplicationTalentBuilder>
	export function refOfApplicationTalentBuilder(x:ApplicationTalentBuilder,v:Ref<ApplicationTalentBuilder>)
	export function unRefApplicationTalentBuilder(v:Ref<ApplicationTalentBuilder>):ApplicationTalentBuilder
	export function emptyInternOfferOnboardingInfoBuilder():InternOfferOnboardingInfoBuilder
	export function emptyRefInternOfferOnboardingInfoBuilder():Ref<InternOfferOnboardingInfoBuilder>
	export function refOfInternOfferOnboardingInfoBuilder(x:InternOfferOnboardingInfoBuilder,v:Ref<InternOfferOnboardingInfoBuilder>)
	export function unRefInternOfferOnboardingInfoBuilder(v:Ref<InternOfferOnboardingInfoBuilder>):InternOfferOnboardingInfoBuilder
	...
	export function emptyStoreBuilder():StoreBuilder
	export function emptyRefStoreBuilder():Ref<StoreBuilder>
	export function refOfStoreBuilder(x:StoreBuilder,v:Ref<StoreBuilder>)
	export function unRefStoreBuilder(v:Ref<StoreBuilder>):StoreBuilder
	...
	export function emptyApplicationJobBuilder():ApplicationJobBuilder
	export function emptyRefApplicationJobBuilder():Ref<ApplicationJobBuilder>
	export function refOfApplicationJobBuilder(x:ApplicationJobBuilder,v:Ref<ApplicationJobBuilder>)
	export function unRefApplicationJobBuilder(v:Ref<ApplicationJobBuilder>):ApplicationJobBuilder
	...
	export function emptyEcoExamResultBuilder():EcoExamResultBuilder
	export function emptyRefEcoExamResultBuilder():Ref<EcoExamResultBuilder>
	export function refOfEcoExamResultBuilder(x:EcoExamResultBuilder,v:Ref<EcoExamResultBuilder>)
	export function unRefEcoExamResultBuilder(v:Ref<EcoExamResultBuilder>):EcoExamResultBuilder
	export function emptyGetOfferReqBuilder():GetOfferReqBuilder
	export function emptyRefGetOfferReqBuilder():Ref<GetOfferReqBuilder>
	export function refOfGetOfferReqBuilder(x:GetOfferReqBuilder,v:Ref<GetOfferReqBuilder>)
	export function unRefGetOfferReqBuilder(v:Ref<GetOfferReqBuilder>):GetOfferReqBuilder
	...
	export function emptyInternOfferOffboardingInfoBuilder():InternOfferOffboardingInfoBuilder
	export function emptyRefInternOfferOffboardingInfoBuilder():Ref<InternOfferOffboardingInfoBuilder>
	export function refOfInternOfferOffboardingInfoBuilder(x:InternOfferOffboardingInfoBuilder,v:Ref<InternOfferOffboardingInfoBuilder>)
	export function unRefInternOfferOffboardingInfoBuilder(v:Ref<InternOfferOffboardingInfoBuilder>):InternOfferOffboardingInfoBuilder
	export function emptyUpdateOfferReqBuilder():UpdateOfferReqBuilder
	export function emptyRefUpdateOfferReqBuilder():Ref<UpdateOfferReqBuilder>
	export function refOfUpdateOfferReqBuilder(x:UpdateOfferReqBuilder,v:Ref<UpdateOfferReqBuilder>)
	export function unRefUpdateOfferReqBuilder(v:Ref<UpdateOfferReqBuilder>):UpdateOfferReqBuilder
	export function emptyAppliOfferBasicInfoUserBuilder():AppliOfferBasicInfoUserBuilder
	export function emptyRefAppliOfferBasicInfoUserBuilder():Ref<AppliOfferBasicInfoUserBuilder>
	export function refOfAppliOfferBasicInfoUserBuilder(x:AppliOfferBasicInfoUserBuilder,v:Ref<AppliOfferBasicInfoUserBuilder>)
	export function unRefAppliOfferBasicInfoUserBuilder(v:Ref<AppliOfferBasicInfoUserBuilder>):AppliOfferBasicInfoUserBuilder
	...
	export function emptyListResumeSourceReqBuilder():ListResumeSourceReqBuilder
	export function emptyRefListResumeSourceReqBuilder():Ref<ListResumeSourceReqBuilder>
	export function refOfListResumeSourceReqBuilder(x:ListResumeSourceReqBuilder,v:Ref<ListResumeSourceReqBuilder>)
	export function unRefListResumeSourceReqBuilder(v:Ref<ListResumeSourceReqBuilder>):ListResumeSourceReqBuilder
	...
	export function emptySiteJobTypeBuilder():SiteJobTypeBuilder
	export function emptyRefSiteJobTypeBuilder():Ref<SiteJobTypeBuilder>
	export function refOfSiteJobTypeBuilder(x:SiteJobTypeBuilder,v:Ref<SiteJobTypeBuilder>)
	export function unRefSiteJobTypeBuilder(v:Ref<SiteJobTypeBuilder>):SiteJobTypeBuilder
	export function emptyAddToFolderTalentPathReqBodyBuilder():AddToFolderTalentPathReqBodyBuilder
	export function emptyRefAddToFolderTalentPathReqBodyBuilder():Ref<AddToFolderTalentPathReqBodyBuilder>
	export function refOfAddToFolderTalentPathReqBodyBuilder(x:AddToFolderTalentPathReqBodyBuilder,v:Ref<AddToFolderTalentPathReqBodyBuilder>)
	export function unRefAddToFolderTalentPathReqBodyBuilder(v:Ref<AddToFolderTalentPathReqBodyBuilder>):AddToFolderTalentPathReqBodyBuilder
	...
	export function emptyUpdateResultEcoBackgroundCheckReqBodyBuilder():UpdateResultEcoBackgroundCheckReqBodyBuilder
	export function emptyRefUpdateResultEcoBackgroundCheckReqBodyBuilder():Ref<UpdateResultEcoBackgroundCheckReqBodyBuilder>
	export function refOfUpdateResultEcoBackgroundCheckReqBodyBuilder(x:UpdateResultEcoBackgroundCheckReqBodyBuilder,v:Ref<UpdateResultEcoBackgroundCheckReqBodyBuilder>)
	export function unRefUpdateResultEcoBackgroundCheckReqBodyBuilder(v:Ref<UpdateResultEcoBackgroundCheckReqBodyBuilder>):UpdateResultEcoBackgroundCheckReqBodyBuilder
	...
	export function emptyAuthBuilder():AuthBuilder
	export function emptyRefAuthBuilder():Ref<AuthBuilder>
	export function refOfAuthBuilder(x:AuthBuilder,v:Ref<AuthBuilder>)
	export function unRefAuthBuilder(v:Ref<AuthBuilder>):AuthBuilder
	...
	export function emptyJobCategoryBuilder():JobCategoryBuilder
	export function emptyRefJobCategoryBuilder():Ref<JobCategoryBuilder>
	export function refOfJobCategoryBuilder(x:JobCategoryBuilder,v:Ref<JobCategoryBuilder>)
	export function unRefJobCategoryBuilder(v:Ref<JobCategoryBuilder>):JobCategoryBuilder
	...
	export function emptyWebsiteDeliveryAwardBuilder():WebsiteDeliveryAwardBuilder
	export function emptyRefWebsiteDeliveryAwardBuilder():Ref<WebsiteDeliveryAwardBuilder>
	export function refOfWebsiteDeliveryAwardBuilder(x:WebsiteDeliveryAwardBuilder,v:Ref<WebsiteDeliveryAwardBuilder>)
	export function unRefWebsiteDeliveryAwardBuilder(v:Ref<WebsiteDeliveryAwardBuilder>):WebsiteDeliveryAwardBuilder
	export function emptyInterviewAppointmentConfigBuilder():InterviewAppointmentConfigBuilder
	export function emptyRefInterviewAppointmentConfigBuilder():Ref<InterviewAppointmentConfigBuilder>
	export function refOfInterviewAppointmentConfigBuilder(x:InterviewAppointmentConfigBuilder,v:Ref<InterviewAppointmentConfigBuilder>)
	export function unRefInterviewAppointmentConfigBuilder(v:Ref<InterviewAppointmentConfigBuilder>):InterviewAppointmentConfigBuilder
	...
	export function emptyApplicationOfferCustomModuleBuilder():ApplicationOfferCustomModuleBuilder
	export function emptyRefApplicationOfferCustomModuleBuilder():Ref<ApplicationOfferCustomModuleBuilder>
	export function refOfApplicationOfferCustomModuleBuilder(x:ApplicationOfferCustomModuleBuilder,v:Ref<ApplicationOfferCustomModuleBuilder>)
	export function unRefApplicationOfferCustomModuleBuilder(v:Ref<ApplicationOfferCustomModuleBuilder>):ApplicationOfferCustomModuleBuilder
	export function emptyBaseCityBuilder():BaseCityBuilder
	export function emptyRefBaseCityBuilder():Ref<BaseCityBuilder>
	export function refOfBaseCityBuilder(x:BaseCityBuilder,v:Ref<BaseCityBuilder>)
	export function unRefBaseCityBuilder(v:Ref<BaseCityBuilder>):BaseCityBuilder
	export function emptyApplicationTalentSnsInfoBuilder():ApplicationTalentSnsInfoBuilder
	export function emptyRefApplicationTalentSnsInfoBuilder():Ref<ApplicationTalentSnsInfoBuilder>
	export function refOfApplicationTalentSnsInfoBuilder(x:ApplicationTalentSnsInfoBuilder,v:Ref<ApplicationTalentSnsInfoBuilder>)
	export function unRefApplicationTalentSnsInfoBuilder(v:Ref<ApplicationTalentSnsInfoBuilder>):ApplicationTalentSnsInfoBuilder
	export function emptyDimensionAbilityBuilder():DimensionAbilityBuilder
	export function emptyRefDimensionAbilityBuilder():Ref<DimensionAbilityBuilder>
	export function refOfDimensionAbilityBuilder(x:DimensionAbilityBuilder,v:Ref<DimensionAbilityBuilder>)
	export function unRefDimensionAbilityBuilder(v:Ref<DimensionAbilityBuilder>):DimensionAbilityBuilder
	export function emptyEntityInfoBuilder():EntityInfoBuilder
	export function emptyRefEntityInfoBuilder():Ref<EntityInfoBuilder>
	export function refOfEntityInfoBuilder(x:EntityInfoBuilder,v:Ref<EntityInfoBuilder>)
	export function unRefEntityInfoBuilder(v:Ref<EntityInfoBuilder>):EntityInfoBuilder
	...
	export function emptyEcoBackgroundCheckPackageAdditionalItemBuilder():EcoBackgroundCheckPackageAdditionalItemBuilder
	export function emptyRefEcoBackgroundCheckPackageAdditionalItemBuilder():Ref<EcoBackgroundCheckPackageAdditionalItemBuilder>
	export function refOfEcoBackgroundCheckPackageAdditionalItemBuilder(x:EcoBackgroundCheckPackageAdditionalItemBuilder,v:Ref<EcoBackgroundCheckPackageAdditionalItemBuilder>)
	export function unRefEcoBackgroundCheckPackageAdditionalItemBuilder(v:Ref<EcoBackgroundCheckPackageAdditionalItemBuilder>):EcoBackgroundCheckPackageAdditionalItemBuilder
	...
	export function emptyReconciliationReferralAccountReqBodyBuilder():ReconciliationReferralAccountReqBodyBuilder
	export function emptyRefReconciliationReferralAccountReqBodyBuilder():Ref<ReconciliationReferralAccountReqBodyBuilder>
	export function refOfReconciliationReferralAccountReqBodyBuilder(x:ReconciliationReferralAccountReqBodyBuilder,v:Ref<ReconciliationReferralAccountReqBodyBuilder>)
	export function unRefReconciliationReferralAccountReqBodyBuilder(v:Ref<ReconciliationReferralAccountReqBodyBuilder>):ReconciliationReferralAccountReqBodyBuilder
	...
	export function emptyListNoteReqBuilder():ListNoteReqBuilder
	export function emptyRefListNoteReqBuilder():Ref<ListNoteReqBuilder>
	export function refOfListNoteReqBuilder(x:ListNoteReqBuilder,v:Ref<ListNoteReqBuilder>)
	export function unRefListNoteReqBuilder(v:Ref<ListNoteReqBuilder>):ListNoteReqBuilder
	export function emptyOfferSchemaDetailBuilder():OfferSchemaDetailBuilder
	export function emptyRefOfferSchemaDetailBuilder():Ref<OfferSchemaDetailBuilder>
	export function refOfOfferSchemaDetailBuilder(x:OfferSchemaDetailBuilder,v:Ref<OfferSchemaDetailBuilder>)
	export function unRefOfferSchemaDetailBuilder(v:Ref<OfferSchemaDetailBuilder>):OfferSchemaDetailBuilder
	export function emptyReferralBuilder():ReferralBuilder
	export function emptyRefReferralBuilder():Ref<ReferralBuilder>
	export function refOfReferralBuilder(x:ReferralBuilder,v:Ref<ReferralBuilder>)
	export function unRefReferralBuilder(v:Ref<ReferralBuilder>):ReferralBuilder
	export function emptyUpdateExternalApplicationReqBuilder():UpdateExternalApplicationReqBuilder
	export function emptyRefUpdateExternalApplicationReqBuilder():Ref<UpdateExternalApplicationReqBuilder>
	export function refOfUpdateExternalApplicationReqBuilder(x:UpdateExternalApplicationReqBuilder,v:Ref<UpdateExternalApplicationReqBuilder>)
	export function unRefUpdateExternalApplicationReqBuilder(v:Ref<UpdateExternalApplicationReqBuilder>):UpdateExternalApplicationReqBuilder
	export function emptyApplicationPrehireDepartmentBuilder():ApplicationPrehireDepartmentBuilder
	export function emptyRefApplicationPrehireDepartmentBuilder():Ref<ApplicationPrehireDepartmentBuilder>
	export function refOfApplicationPrehireDepartmentBuilder(x:ApplicationPrehireDepartmentBuilder,v:Ref<ApplicationPrehireDepartmentBuilder>)
	export function unRefApplicationPrehireDepartmentBuilder(v:Ref<ApplicationPrehireDepartmentBuilder>):ApplicationPrehireDepartmentBuilder
	...
	export function emptyEcoBackgroundCheckCreateEventMobileBuilder():EcoBackgroundCheckCreateEventMobileBuilder
	export function emptyRefEcoBackgroundCheckCreateEventMobileBuilder():Ref<EcoBackgroundCheckCreateEventMobileBuilder>
	export function refOfEcoBackgroundCheckCreateEventMobileBuilder(x:EcoBackgroundCheckCreateEventMobileBuilder,v:Ref<EcoBackgroundCheckCreateEventMobileBuilder>)
	export function unRefEcoBackgroundCheckCreateEventMobileBuilder(v:Ref<EcoBackgroundCheckCreateEventMobileBuilder>):EcoBackgroundCheckCreateEventMobileBuilder
	export function emptyEcoBackgroundCheckReportFileBuilder():EcoBackgroundCheckReportFileBuilder
	export function emptyRefEcoBackgroundCheckReportFileBuilder():Ref<EcoBackgroundCheckReportFileBuilder>
	export function refOfEcoBackgroundCheckReportFileBuilder(x:EcoBackgroundCheckReportFileBuilder,v:Ref<EcoBackgroundCheckReportFileBuilder>)
	export function unRefEcoBackgroundCheckReportFileBuilder(v:Ref<EcoBackgroundCheckReportFileBuilder>):EcoBackgroundCheckReportFileBuilder
	export function emptyOfferStatusOfferReqBuilder():OfferStatusOfferReqBuilder
	export function emptyRefOfferStatusOfferReqBuilder():Ref<OfferStatusOfferReqBuilder>
	export function refOfOfferStatusOfferReqBuilder(x:OfferStatusOfferReqBuilder,v:Ref<OfferStatusOfferReqBuilder>)
	export function unRefOfferStatusOfferReqBuilder(v:Ref<OfferStatusOfferReqBuilder>):OfferStatusOfferReqBuilder
	...
	export function emptyLanguageInfoBuilder():LanguageInfoBuilder
	export function emptyRefLanguageInfoBuilder():Ref<LanguageInfoBuilder>
	export function refOfLanguageInfoBuilder(x:LanguageInfoBuilder,v:Ref<LanguageInfoBuilder>)
	export function unRefLanguageInfoBuilder(v:Ref<LanguageInfoBuilder>):LanguageInfoBuilder
	...
	export function emptyGetOfferSchemaReqBuilder():GetOfferSchemaReqBuilder
	export function emptyRefGetOfferSchemaReqBuilder():Ref<GetOfferSchemaReqBuilder>
	export function refOfGetOfferSchemaReqBuilder(x:GetOfferSchemaReqBuilder,v:Ref<GetOfferSchemaReqBuilder>)
	export function unRefGetOfferSchemaReqBuilder(v:Ref<GetOfferSchemaReqBuilder>):GetOfferSchemaReqBuilder
	...
	export function emptyApplicationOfferSalaryPlanBuilder():ApplicationOfferSalaryPlanBuilder
	export function emptyRefApplicationOfferSalaryPlanBuilder():Ref<ApplicationOfferSalaryPlanBuilder>
	export function refOfApplicationOfferSalaryPlanBuilder(x:ApplicationOfferSalaryPlanBuilder,v:Ref<ApplicationOfferSalaryPlanBuilder>)
	export function unRefApplicationOfferSalaryPlanBuilder(v:Ref<ApplicationOfferSalaryPlanBuilder>):ApplicationOfferSalaryPlanBuilder
	...
	export function emptyInterviewAssessmentDimensionArgsScoreBuilder():InterviewAssessmentDimensionArgsScoreBuilder
	export function emptyRefInterviewAssessmentDimensionArgsScoreBuilder():Ref<InterviewAssessmentDimensionArgsScoreBuilder>
	export function refOfInterviewAssessmentDimensionArgsScoreBuilder(x:InterviewAssessmentDimensionArgsScoreBuilder,v:Ref<InterviewAssessmentDimensionArgsScoreBuilder>)
	export function unRefInterviewAssessmentDimensionArgsScoreBuilder(v:Ref<InterviewAssessmentDimensionArgsScoreBuilder>):InterviewAssessmentDimensionArgsScoreBuilder
	...
	export function emptyWebsiteDeliveryBuilder():WebsiteDeliveryBuilder
	export function emptyRefWebsiteDeliveryBuilder():Ref<WebsiteDeliveryBuilder>
	export function refOfWebsiteDeliveryBuilder(x:WebsiteDeliveryBuilder,v:Ref<WebsiteDeliveryBuilder>)
	export function unRefWebsiteDeliveryBuilder(v:Ref<WebsiteDeliveryBuilder>):WebsiteDeliveryBuilder
	...
	export function emptyP2EcoAccountCreatedV1Handler():P2EcoAccountCreatedV1Handler
	export function emptyRefP2EcoAccountCreatedV1Handler():Ref<P2EcoAccountCreatedV1Handler>
	export function refOfP2EcoAccountCreatedV1Handler(x:P2EcoAccountCreatedV1Handler,v:Ref<P2EcoAccountCreatedV1Handler>)
	export function unRefP2EcoAccountCreatedV1Handler(v:Ref<P2EcoAccountCreatedV1Handler>):P2EcoAccountCreatedV1Handler
	export function emptyRoleBuilder():RoleBuilder
	export function emptyRefRoleBuilder():Ref<RoleBuilder>
	export function refOfRoleBuilder(x:RoleBuilder,v:Ref<RoleBuilder>)
	export function unRefRoleBuilder(v:Ref<RoleBuilder>):RoleBuilder
	...
	export function emptyApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder():ApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder
	export function emptyRefApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder():Ref<ApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder>
	export function refOfApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder(x:ApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder,v:Ref<ApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder>)
	export function unRefApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder(v:Ref<ApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder>):ApplicationOfferBasicInfoCustomizedObjectOptionValueBuilder
	...
	export function emptyTalentSchemaOptionBuilder():TalentSchemaOptionBuilder
	export function emptyRefTalentSchemaOptionBuilder():Ref<TalentSchemaOptionBuilder>
	export function refOfTalentSchemaOptionBuilder(x:TalentSchemaOptionBuilder,v:Ref<TalentSchemaOptionBuilder>)
	export function unRefTalentSchemaOptionBuilder(v:Ref<TalentSchemaOptionBuilder>):TalentSchemaOptionBuilder
	export function emptyTerminationReasonBuilder():TerminationReasonBuilder
	export function emptyRefTerminationReasonBuilder():Ref<TerminationReasonBuilder>
	export function refOfTerminationReasonBuilder(x:TerminationReasonBuilder,v:Ref<TerminationReasonBuilder>)
	export function unRefTerminationReasonBuilder(v:Ref<TerminationReasonBuilder>):TerminationReasonBuilder
	export function emptyInternOfferStatusOfferReqBuilder():InternOfferStatusOfferReqBuilder
	export function emptyRefInternOfferStatusOfferReqBuilder():Ref<InternOfferStatusOfferReqBuilder>
	export function refOfInternOfferStatusOfferReqBuilder(x:InternOfferStatusOfferReqBuilder,v:Ref<InternOfferStatusOfferReqBuilder>)
	export function unRefInternOfferStatusOfferReqBuilder(v:Ref<InternOfferStatusOfferReqBuilder>):InternOfferStatusOfferReqBuilder
	export function emptyJobSchemaBuilder():JobSchemaBuilder
	export function emptyRefJobSchemaBuilder():Ref<JobSchemaBuilder>
	export function refOfJobSchemaBuilder(x:JobSchemaBuilder,v:Ref<JobSchemaBuilder>)
	export function unRefJobSchemaBuilder(v:Ref<JobSchemaBuilder>):JobSchemaBuilder
	...
	export function emptyWebsiteJobPostCustomizedOptionBuilder():WebsiteJobPostCustomizedOptionBuilder
	export function emptyRefWebsiteJobPostCustomizedOptionBuilder():Ref<WebsiteJobPostCustomizedOptionBuilder>
	export function refOfWebsiteJobPostCustomizedOptionBuilder(x:WebsiteJobPostCustomizedOptionBuilder,v:Ref<WebsiteJobPostCustomizedOptionBuilder>)
	export function unRefWebsiteJobPostCustomizedOptionBuilder(v:Ref<WebsiteJobPostCustomizedOptionBuilder>):WebsiteJobPostCustomizedOptionBuilder
	export function emptyBackgroundCheckOrderCreatorBuilder():BackgroundCheckOrderCreatorBuilder
	export function emptyRefBackgroundCheckOrderCreatorBuilder():Ref<BackgroundCheckOrderCreatorBuilder>
	export function refOfBackgroundCheckOrderCreatorBuilder(x:BackgroundCheckOrderCreatorBuilder,v:Ref<BackgroundCheckOrderCreatorBuilder>)
	export function unRefBackgroundCheckOrderCreatorBuilder(v:Ref<BackgroundCheckOrderCreatorBuilder>):BackgroundCheckOrderCreatorBuilder
	...
	export function emptyGetReferralWebsiteJobPostReqBuilder():GetReferralWebsiteJobPostReqBuilder
	export function emptyRefGetReferralWebsiteJobPostReqBuilder():Ref<GetReferralWebsiteJobPostReqBuilder>
	export function refOfGetReferralWebsiteJobPostReqBuilder(x:GetReferralWebsiteJobPostReqBuilder,v:Ref<GetReferralWebsiteJobPostReqBuilder>)
	export function unRefGetReferralWebsiteJobPostReqBuilder(v:Ref<GetReferralWebsiteJobPostReqBuilder>):GetReferralWebsiteJobPostReqBuilder
	export function emptyListRegistrationSchemaReqBuilder():ListRegistrationSchemaReqBuilder
	export function emptyRefListRegistrationSchemaReqBuilder():Ref<ListRegistrationSchemaReqBuilder>
	export function refOfListRegistrationSchemaReqBuilder(x:ListRegistrationSchemaReqBuilder,v:Ref<ListRegistrationSchemaReqBuilder>)
	export function unRefListRegistrationSchemaReqBuilder(v:Ref<ListRegistrationSchemaReqBuilder>):ListRegistrationSchemaReqBuilder
	export function emptyPreviewAttachmentReqBuilder():PreviewAttachmentReqBuilder
	export function emptyRefPreviewAttachmentReqBuilder():Ref<PreviewAttachmentReqBuilder>
	export function refOfPreviewAttachmentReqBuilder(x:PreviewAttachmentReqBuilder,v:Ref<PreviewAttachmentReqBuilder>)
	export function unRefPreviewAttachmentReqBuilder(v:Ref<PreviewAttachmentReqBuilder>):PreviewAttachmentReqBuilder
	...
	export function emptyWithdrawReferralAccountPathReqBodyBuilder():WithdrawReferralAccountPathReqBodyBuilder
	export function emptyRefWithdrawReferralAccountPathReqBodyBuilder():Ref<WithdrawReferralAccountPathReqBodyBuilder>
	export function refOfWithdrawReferralAccountPathReqBodyBuilder(x:WithdrawReferralAccountPathReqBodyBuilder,v:Ref<WithdrawReferralAccountPathReqBodyBuilder>)
	export function unRefWithdrawReferralAccountPathReqBodyBuilder(v:Ref<WithdrawReferralAccountPathReqBodyBuilder>):WithdrawReferralAccountPathReqBodyBuilder
	export function emptyCreateExternalBackgroundCheckReqBuilder():CreateExternalBackgroundCheckReqBuilder
	export function emptyRefCreateExternalBackgroundCheckReqBuilder():Ref<CreateExternalBackgroundCheckReqBuilder>
	export function refOfCreateExternalBackgroundCheckReqBuilder(x:CreateExternalBackgroundCheckReqBuilder,v:Ref<CreateExternalBackgroundCheckReqBuilder>)
	export function unRefCreateExternalBackgroundCheckReqBuilder(v:Ref<CreateExternalBackgroundCheckReqBuilder>):CreateExternalBackgroundCheckReqBuilder
	...
	export function emptyAddToFolderTalentReqBodyBuilder():AddToFolderTalentReqBodyBuilder
	export function emptyRefAddToFolderTalentReqBodyBuilder():Ref<AddToFolderTalentReqBodyBuilder>
	export function refOfAddToFolderTalentReqBodyBuilder(x:AddToFolderTalentReqBodyBuilder,v:Ref<AddToFolderTalentReqBodyBuilder>)
	export function unRefAddToFolderTalentReqBodyBuilder(v:Ref<AddToFolderTalentReqBodyBuilder>):AddToFolderTalentReqBodyBuilder
	export function emptyAssessmentScoreInfoBuilder():AssessmentScoreInfoBuilder
	export function emptyRefAssessmentScoreInfoBuilder():Ref<AssessmentScoreInfoBuilder>
	export function refOfAssessmentScoreInfoBuilder(x:AssessmentScoreInfoBuilder,v:Ref<AssessmentScoreInfoBuilder>)
	export function unRefAssessmentScoreInfoBuilder(v:Ref<AssessmentScoreInfoBuilder>):AssessmentScoreInfoBuilder
	export function emptyJobRequirementCustomizedDataDtoBuilder():JobRequirementCustomizedDataDtoBuilder
	export function emptyRefJobRequirementCustomizedDataDtoBuilder():Ref<JobRequirementCustomizedDataDtoBuilder>
	export function refOfJobRequirementCustomizedDataDtoBuilder(x:JobRequirementCustomizedDataDtoBuilder,v:Ref<JobRequirementCustomizedDataDtoBuilder>)
	export function unRefJobRequirementCustomizedDataDtoBuilder(v:Ref<JobRequirementCustomizedDataDtoBuilder>):JobRequirementCustomizedDataDtoBuilder
	export function emptyJobRequirementCustomizedTimeRangeBuilder():JobRequirementCustomizedTimeRangeBuilder
	export function emptyRefJobRequirementCustomizedTimeRangeBuilder():Ref<JobRequirementCustomizedTimeRangeBuilder>
	export function refOfJobRequirementCustomizedTimeRangeBuilder(x:JobRequirementCustomizedTimeRangeBuilder,v:Ref<JobRequirementCustomizedTimeRangeBuilder>)
	export function unRefJobRequirementCustomizedTimeRangeBuilder(v:Ref<JobRequirementCustomizedTimeRangeBuilder>):JobRequirementCustomizedTimeRangeBuilder
	export function emptySelectOptionResultBuilder():SelectOptionResultBuilder
	export function emptyRefSelectOptionResultBuilder():Ref<SelectOptionResultBuilder>
	export function refOfSelectOptionResultBuilder(x:SelectOptionResultBuilder,v:Ref<SelectOptionResultBuilder>)
	export function unRefSelectOptionResultBuilder(v:Ref<SelectOptionResultBuilder>):SelectOptionResultBuilder
	export function emptySiteResumeAwardBuilder():SiteResumeAwardBuilder
	export function emptyRefSiteResumeAwardBuilder():Ref<SiteResumeAwardBuilder>
	export function refOfSiteResumeAwardBuilder(x:SiteResumeAwardBuilder,v:Ref<SiteResumeAwardBuilder>)
	export function unRefSiteResumeAwardBuilder(v:Ref<SiteResumeAwardBuilder>):SiteResumeAwardBuilder
	...
	export function emptyApplicationOfferOnboardProfileAddressBuilder():ApplicationOfferOnboardProfileAddressBuilder
	export function emptyRefApplicationOfferOnboardProfileAddressBuilder():Ref<ApplicationOfferOnboardProfileAddressBuilder>
	export function refOfApplicationOfferOnboardProfileAddressBuilder(x:ApplicationOfferOnboardProfileAddressBuilder,v:Ref<ApplicationOfferOnboardProfileAddressBuilder>)
	export function unRefApplicationOfferOnboardProfileAddressBuilder(v:Ref<ApplicationOfferOnboardProfileAddressBuilder>):ApplicationOfferOnboardProfileAddressBuilder
	...
	export function emptyInterviewQuestionBuilder():InterviewQuestionBuilder
	export function emptyRefInterviewQuestionBuilder():Ref<InterviewQuestionBuilder>
	export function refOfInterviewQuestionBuilder(x:InterviewQuestionBuilder,v:Ref<InterviewQuestionBuilder>)
	export function unRefInterviewQuestionBuilder(v:Ref<InterviewQuestionBuilder>):InterviewQuestionBuilder
	export function emptyJobConfigResultBuilder():JobConfigResultBuilder
	export function emptyRefJobConfigResultBuilder():Ref<JobConfigResultBuilder>
	export function refOfJobConfigResultBuilder(x:JobConfigResultBuilder,v:Ref<JobConfigResultBuilder>)
	export function unRefJobConfigResultBuilder(v:Ref<JobConfigResultBuilder>):JobConfigResultBuilder
	export function emptyWebsiteDeliveryAttachmentIndentificationBuilder():WebsiteDeliveryAttachmentIndentificationBuilder
	export function emptyRefWebsiteDeliveryAttachmentIndentificationBuilder():Ref<WebsiteDeliveryAttachmentIndentificationBuilder>
	export function refOfWebsiteDeliveryAttachmentIndentificationBuilder(x:WebsiteDeliveryAttachmentIndentificationBuilder,v:Ref<WebsiteDeliveryAttachmentIndentificationBuilder>)
	export function unRefWebsiteDeliveryAttachmentIndentificationBuilder(v:Ref<WebsiteDeliveryAttachmentIndentificationBuilder>):WebsiteDeliveryAttachmentIndentificationBuilder
	export function emptyRecruitmentTypeBuilder():RecruitmentTypeBuilder
	export function emptyRefRecruitmentTypeBuilder():Ref<RecruitmentTypeBuilder>
	export function refOfRecruitmentTypeBuilder(x:RecruitmentTypeBuilder,v:Ref<RecruitmentTypeBuilder>)
	export function unRefRecruitmentTypeBuilder(v:Ref<RecruitmentTypeBuilder>):RecruitmentTypeBuilder
	export function emptySiteResumeInternshipBuilder():SiteResumeInternshipBuilder
	export function emptyRefSiteResumeInternshipBuilder():Ref<SiteResumeInternshipBuilder>
	export function refOfSiteResumeInternshipBuilder(x:SiteResumeInternshipBuilder,v:Ref<SiteResumeInternshipBuilder>)
	export function unRefSiteResumeInternshipBuilder(v:Ref<SiteResumeInternshipBuilder>):SiteResumeInternshipBuilder
	...
	export function emptyBackgroundCheckProcessInfoBuilder():BackgroundCheckProcessInfoBuilder
	export function emptyRefBackgroundCheckProcessInfoBuilder():Ref<BackgroundCheckProcessInfoBuilder>
	export function refOfBackgroundCheckProcessInfoBuilder(x:BackgroundCheckProcessInfoBuilder,v:Ref<BackgroundCheckProcessInfoBuilder>)
	export function unRefBackgroundCheckProcessInfoBuilder(v:Ref<BackgroundCheckProcessInfoBuilder>):BackgroundCheckProcessInfoBuilder
	...
	export function emptyOfferApplyFormObjectConfigInfoBuilder():OfferApplyFormObjectConfigInfoBuilder
	export function emptyRefOfferApplyFormObjectConfigInfoBuilder():Ref<OfferApplyFormObjectConfigInfoBuilder>
	export function refOfOfferApplyFormObjectConfigInfoBuilder(x:OfferApplyFormObjectConfigInfoBuilder,v:Ref<OfferApplyFormObjectConfigInfoBuilder>)
	export function unRefOfferApplyFormObjectConfigInfoBuilder(v:Ref<OfferApplyFormObjectConfigInfoBuilder>):OfferApplyFormObjectConfigInfoBuilder
	export function emptyScoreCalculationConfigBuilder():ScoreCalculationConfigBuilder
	export function emptyRefScoreCalculationConfigBuilder():Ref<ScoreCalculationConfigBuilder>
	export function refOfScoreCalculationConfigBuilder(x:ScoreCalculationConfigBuilder,v:Ref<ScoreCalculationConfigBuilder>)
	export function unRefScoreCalculationConfigBuilder(v:Ref<ScoreCalculationConfigBuilder>):ScoreCalculationConfigBuilder
	export function emptyWebsiteDeliveryInternshipBuilder():WebsiteDeliveryInternshipBuilder
	export function emptyRefWebsiteDeliveryInternshipBuilder():Ref<WebsiteDeliveryInternshipBuilder>
	export function refOfWebsiteDeliveryInternshipBuilder(x:WebsiteDeliveryInternshipBuilder,v:Ref<WebsiteDeliveryInternshipBuilder>)
	export function unRefWebsiteDeliveryInternshipBuilder(v:Ref<WebsiteDeliveryInternshipBuilder>):WebsiteDeliveryInternshipBuilder
	...
	export function emptyQuestionnaireBuilder():QuestionnaireBuilder
	export function emptyRefQuestionnaireBuilder():Ref<QuestionnaireBuilder>
	export function refOfQuestionnaireBuilder(x:QuestionnaireBuilder,v:Ref<QuestionnaireBuilder>)
	export function unRefQuestionnaireBuilder(v:Ref<QuestionnaireBuilder>):QuestionnaireBuilder
	...
	export function emptyAppliOfferBasicCustObjOpVBuilder():AppliOfferBasicCustObjOpVBuilder
	export function emptyRefAppliOfferBasicCustObjOpVBuilder():Ref<AppliOfferBasicCustObjOpVBuilder>
	export function refOfAppliOfferBasicCustObjOpVBuilder(x:AppliOfferBasicCustObjOpVBuilder,v:Ref<AppliOfferBasicCustObjOpVBuilder>)
	export function unRefAppliOfferBasicCustObjOpVBuilder(v:Ref<AppliOfferBasicCustObjOpVBuilder>):AppliOfferBasicCustObjOpVBuilder
	export function emptyCombinedJobResultBuilder():CombinedJobResultBuilder
	export function emptyRefCombinedJobResultBuilder():Ref<CombinedJobResultBuilder>
	export function refOfCombinedJobResultBuilder(x:CombinedJobResultBuilder,v:Ref<CombinedJobResultBuilder>)
	export function unRefCombinedJobResultBuilder(v:Ref<CombinedJobResultBuilder>):CombinedJobResultBuilder
	export function emptyEcoBackgroundCheckCustomFieldDataBuilder():EcoBackgroundCheckCustomFieldDataBuilder
	export function emptyRefEcoBackgroundCheckCustomFieldDataBuilder():Ref<EcoBackgroundCheckCustomFieldDataBuilder>
	export function refOfEcoBackgroundCheckCustomFieldDataBuilder(x:EcoBackgroundCheckCustomFieldDataBuilder,v:Ref<EcoBackgroundCheckCustomFieldDataBuilder>)
	export function unRefEcoBackgroundCheckCustomFieldDataBuilder(v:Ref<EcoBackgroundCheckCustomFieldDataBuilder>):EcoBackgroundCheckCustomFieldDataBuilder
	...
	export function emptyLoginInfoEcoExamPathReqBodyBuilder():LoginInfoEcoExamPathReqBodyBuilder
	export function emptyRefLoginInfoEcoExamPathReqBodyBuilder():Ref<LoginInfoEcoExamPathReqBodyBuilder>
	export function refOfLoginInfoEcoExamPathReqBodyBuilder(x:LoginInfoEcoExamPathReqBodyBuilder,v:Ref<LoginInfoEcoExamPathReqBodyBuilder>)
	export function unRefLoginInfoEcoExamPathReqBodyBuilder(v:Ref<LoginInfoEcoExamPathReqBodyBuilder>):LoginInfoEcoExamPathReqBodyBuilder
	export function emptyAppliTalentAttachResumeInfoBuilder():AppliTalentAttachResumeInfoBuilder
	export function emptyRefAppliTalentAttachResumeInfoBuilder():Ref<AppliTalentAttachResumeInfoBuilder>
	export function refOfAppliTalentAttachResumeInfoBuilder(x:AppliTalentAttachResumeInfoBuilder,v:Ref<AppliTalentAttachResumeInfoBuilder>)
	export function unRefAppliTalentAttachResumeInfoBuilder(v:Ref<AppliTalentAttachResumeInfoBuilder>):AppliTalentAttachResumeInfoBuilder
	export function emptyAppliTalentEducationInfoBuilder():AppliTalentEducationInfoBuilder
	export function emptyRefAppliTalentEducationInfoBuilder():Ref<AppliTalentEducationInfoBuilder>
	export function refOfAppliTalentEducationInfoBuilder(x:AppliTalentEducationInfoBuilder,v:Ref<AppliTalentEducationInfoBuilder>)
	export function unRefAppliTalentEducationInfoBuilder(v:Ref<AppliTalentEducationInfoBuilder>):AppliTalentEducationInfoBuilder
	export function emptyEcoBackgroundCheckPackageDataBuilder():EcoBackgroundCheckPackageDataBuilder
	export function emptyRefEcoBackgroundCheckPackageDataBuilder():Ref<EcoBackgroundCheckPackageDataBuilder>
	export function refOfEcoBackgroundCheckPackageDataBuilder(x:EcoBackgroundCheckPackageDataBuilder,v:Ref<EcoBackgroundCheckPackageDataBuilder>)
	export function unRefEcoBackgroundCheckPackageDataBuilder(v:Ref<EcoBackgroundCheckPackageDataBuilder>):EcoBackgroundCheckPackageDataBuilder
	export function emptySiteJobPostSearchInfoBuilder():SiteJobPostSearchInfoBuilder
	export function emptyRefSiteJobPostSearchInfoBuilder():Ref<SiteJobPostSearchInfoBuilder>
	export function refOfSiteJobPostSearchInfoBuilder(x:SiteJobPostSearchInfoBuilder,v:Ref<SiteJobPostSearchInfoBuilder>)
	export function unRefSiteJobPostSearchInfoBuilder(v:Ref<SiteJobPostSearchInfoBuilder>):SiteJobPostSearchInfoBuilder
	export function emptyApplicationOfferBasicInfoCustomizedObjectBuilder():ApplicationOfferBasicInfoCustomizedObjectBuilder
	export function emptyRefApplicationOfferBasicInfoCustomizedObjectBuilder():Ref<ApplicationOfferBasicInfoCustomizedObjectBuilder>
	export function refOfApplicationOfferBasicInfoCustomizedObjectBuilder(x:ApplicationOfferBasicInfoCustomizedObjectBuilder,v:Ref<ApplicationOfferBasicInfoCustomizedObjectBuilder>)
	export function unRefApplicationOfferBasicInfoCustomizedObjectBuilder(v:Ref<ApplicationOfferBasicInfoCustomizedObjectBuilder>):ApplicationOfferBasicInfoCustomizedObjectBuilder
	...
	export function emptyWebsiteJobPostBuilder():WebsiteJobPostBuilder
	export function emptyRefWebsiteJobPostBuilder():Ref<WebsiteJobPostBuilder>
	export function refOfWebsiteJobPostBuilder(x:WebsiteJobPostBuilder,v:Ref<WebsiteJobPostBuilder>)
	export function unRefWebsiteJobPostBuilder(v:Ref<WebsiteJobPostBuilder>):WebsiteJobPostBuilder
	...
	export function emptyTalentResumeSourceBuilder():TalentResumeSourceBuilder
	export function emptyRefTalentResumeSourceBuilder():Ref<TalentResumeSourceBuilder>
	export function refOfTalentResumeSourceBuilder(x:TalentResumeSourceBuilder,v:Ref<TalentResumeSourceBuilder>)
	export function unRefTalentResumeSourceBuilder(v:Ref<TalentResumeSourceBuilder>):TalentResumeSourceBuilder
	export function emptyUpdateResultEcoBackgroundCheckPathReqBodyBuilder():UpdateResultEcoBackgroundCheckPathReqBodyBuilder
	export function emptyRefUpdateResultEcoBackgroundCheckPathReqBodyBuilder():Ref<UpdateResultEcoBackgroundCheckPathReqBodyBuilder>
	export function refOfUpdateResultEcoBackgroundCheckPathReqBodyBuilder(x:UpdateResultEcoBackgroundCheckPathReqBodyBuilder,v:Ref<UpdateResultEcoBackgroundCheckPathReqBodyBuilder>)
	export function unRefUpdateResultEcoBackgroundCheckPathReqBodyBuilder(v:Ref<UpdateResultEcoBackgroundCheckPathReqBodyBuilder>):UpdateResultEcoBackgroundCheckPathReqBodyBuilder
	...
	export function emptyCreateReferralAccountPathReqBodyBuilder():CreateReferralAccountPathReqBodyBuilder
	export function emptyRefCreateReferralAccountPathReqBodyBuilder():Ref<CreateReferralAccountPathReqBodyBuilder>
	export function refOfCreateReferralAccountPathReqBodyBuilder(x:CreateReferralAccountPathReqBodyBuilder,v:Ref<CreateReferralAccountPathReqBodyBuilder>)
	export function unRefCreateReferralAccountPathReqBodyBuilder(v:Ref<CreateReferralAccountPathReqBodyBuilder>):CreateReferralAccountPathReqBodyBuilder
	...
	export function emptyInterviewScoreBuilder():InterviewScoreBuilder
	export function emptyRefInterviewScoreBuilder():Ref<InterviewScoreBuilder>
	export function refOfInterviewScoreBuilder(x:InterviewScoreBuilder,v:Ref<InterviewScoreBuilder>)
	export function unRefInterviewScoreBuilder(v:Ref<InterviewScoreBuilder>):InterviewScoreBuilder
	...
	export function emptyTalentCombinedSnsInfoBuilder():TalentCombinedSnsInfoBuilder
	export function emptyRefTalentCombinedSnsInfoBuilder():Ref<TalentCombinedSnsInfoBuilder>
	export function refOfTalentCombinedSnsInfoBuilder(x:TalentCombinedSnsInfoBuilder,v:Ref<TalentCombinedSnsInfoBuilder>)
	export function unRefTalentCombinedSnsInfoBuilder(v:Ref<TalentCombinedSnsInfoBuilder>):TalentCombinedSnsInfoBuilder
	export function emptyAppliOfferSalaryPlanTemplateBuilder():AppliOfferSalaryPlanTemplateBuilder
	export function emptyRefAppliOfferSalaryPlanTemplateBuilder():Ref<AppliOfferSalaryPlanTemplateBuilder>
	export function refOfAppliOfferSalaryPlanTemplateBuilder(x:AppliOfferSalaryPlanTemplateBuilder,v:Ref<AppliOfferSalaryPlanTemplateBuilder>)
	export function unRefAppliOfferSalaryPlanTemplateBuilder(v:Ref<AppliOfferSalaryPlanTemplateBuilder>):AppliOfferSalaryPlanTemplateBuilder
	export function emptyCombinedJobBuilder():CombinedJobBuilder
	export function emptyRefCombinedJobBuilder():Ref<CombinedJobBuilder>
	export function refOfCombinedJobBuilder(x:CombinedJobBuilder,v:Ref<CombinedJobBuilder>)
	export function unRefCombinedJobBuilder(v:Ref<CombinedJobBuilder>):CombinedJobBuilder
	...
	export function emptyPatchNotePathReqBodyBuilder():PatchNotePathReqBodyBuilder
	export function emptyRefPatchNotePathReqBodyBuilder():Ref<PatchNotePathReqBodyBuilder>
	export function refOfPatchNotePathReqBodyBuilder(x:PatchNotePathReqBodyBuilder,v:Ref<PatchNotePathReqBodyBuilder>)
	export function unRefPatchNotePathReqBodyBuilder(v:Ref<PatchNotePathReqBodyBuilder>):PatchNotePathReqBodyBuilder
	...
	export function emptyCombinedJobObjectValueMapBuilder():CombinedJobObjectValueMapBuilder
	export function emptyRefCombinedJobObjectValueMapBuilder():Ref<CombinedJobObjectValueMapBuilder>
	export function refOfCombinedJobObjectValueMapBuilder(x:CombinedJobObjectValueMapBuilder,v:Ref<CombinedJobObjectValueMapBuilder>)
	export function unRefCombinedJobObjectValueMapBuilder(v:Ref<CombinedJobObjectValueMapBuilder>):CombinedJobObjectValueMapBuilder
	...
	export function emptyApplicationTalentProjectInfoBuilder():ApplicationTalentProjectInfoBuilder
	export function emptyRefApplicationTalentProjectInfoBuilder():Ref<ApplicationTalentProjectInfoBuilder>
	export function refOfApplicationTalentProjectInfoBuilder(x:ApplicationTalentProjectInfoBuilder,v:Ref<ApplicationTalentProjectInfoBuilder>)
	export function unRefApplicationTalentProjectInfoBuilder(v:Ref<ApplicationTalentProjectInfoBuilder>):ApplicationTalentProjectInfoBuilder
	...
	export function emptyBaseAddressBuilder():BaseAddressBuilder
	export function emptyRefBaseAddressBuilder():Ref<BaseAddressBuilder>
	export function refOfBaseAddressBuilder(x:BaseAddressBuilder,v:Ref<BaseAddressBuilder>)
	export function unRefBaseAddressBuilder(v:Ref<BaseAddressBuilder>):BaseAddressBuilder
	...
	export function emptyApplicationTalentCareerInfoBuilder():ApplicationTalentCareerInfoBuilder
	export function emptyRefApplicationTalentCareerInfoBuilder():Ref<ApplicationTalentCareerInfoBuilder>
	export function refOfApplicationTalentCareerInfoBuilder(x:ApplicationTalentCareerInfoBuilder,v:Ref<ApplicationTalentCareerInfoBuilder>)
	export function unRefApplicationTalentCareerInfoBuilder(v:Ref<ApplicationTalentCareerInfoBuilder>):ApplicationTalentCareerInfoBuilder
	...
	export function emptyCountryBuilder():CountryBuilder
	export function emptyRefCountryBuilder():Ref<CountryBuilder>
	export function refOfCountryBuilder(x:CountryBuilder,v:Ref<CountryBuilder>)
	export function unRefCountryBuilder(v:Ref<CountryBuilder>):CountryBuilder
	...
	export function emptyAwardInfoBuilder():AwardInfoBuilder
	export function emptyRefAwardInfoBuilder():Ref<AwardInfoBuilder>
	export function refOfAwardInfoBuilder(x:AwardInfoBuilder,v:Ref<AwardInfoBuilder>)
	export function unRefAwardInfoBuilder(v:Ref<AwardInfoBuilder>):AwardInfoBuilder
	export function emptyBackgroundCheckOrderProcessInfoBuilder():BackgroundCheckOrderProcessInfoBuilder
	export function emptyRefBackgroundCheckOrderProcessInfoBuilder():Ref<BackgroundCheckOrderProcessInfoBuilder>
	export function refOfBackgroundCheckOrderProcessInfoBuilder(x:BackgroundCheckOrderProcessInfoBuilder,v:Ref<BackgroundCheckOrderProcessInfoBuilder>)
	export function unRefBackgroundCheckOrderProcessInfoBuilder(v:Ref<BackgroundCheckOrderProcessInfoBuilder>):BackgroundCheckOrderProcessInfoBuilder
	...
	export function emptyCreateExternalInterviewAssessmentReqBuilder():CreateExternalInterviewAssessmentReqBuilder
	export function emptyRefCreateExternalInterviewAssessmentReqBuilder():Ref<CreateExternalInterviewAssessmentReqBuilder>
	export function refOfCreateExternalInterviewAssessmentReqBuilder(x:CreateExternalInterviewAssessmentReqBuilder,v:Ref<CreateExternalInterviewAssessmentReqBuilder>)
	export function unRefCreateExternalInterviewAssessmentReqBuilder(v:Ref<CreateExternalInterviewAssessmentReqBuilder>):CreateExternalInterviewAssessmentReqBuilder
	...
	export function emptyOfferApplyFormConfigFormulaInfoBuilder():OfferApplyFormConfigFormulaInfoBuilder
	export function emptyRefOfferApplyFormConfigFormulaInfoBuilder():Ref<OfferApplyFormConfigFormulaInfoBuilder>
	export function refOfOfferApplyFormConfigFormulaInfoBuilder(x:OfferApplyFormConfigFormulaInfoBuilder,v:Ref<OfferApplyFormConfigFormulaInfoBuilder>)
	export function unRefOfferApplyFormConfigFormulaInfoBuilder(v:Ref<OfferApplyFormConfigFormulaInfoBuilder>):OfferApplyFormConfigFormulaInfoBuilder
	export function emptyOfferApplyFormPreObjectConfigInfoBuilder():OfferApplyFormPreObjectConfigInfoBuilder
	export function emptyRefOfferApplyFormPreObjectConfigInfoBuilder():Ref<OfferApplyFormPreObjectConfigInfoBuilder>
	export function refOfOfferApplyFormPreObjectConfigInfoBuilder(x:OfferApplyFormPreObjectConfigInfoBuilder,v:Ref<OfferApplyFormPreObjectConfigInfoBuilder>)
	export function unRefOfferApplyFormPreObjectConfigInfoBuilder(v:Ref<OfferApplyFormPreObjectConfigInfoBuilder>):OfferApplyFormPreObjectConfigInfoBuilder
	...
	export function emptySiteBuilder():SiteBuilder
	export function emptyRefSiteBuilder():Ref<SiteBuilder>
	export function refOfSiteBuilder(x:SiteBuilder,v:Ref<SiteBuilder>)
	export function unRefSiteBuilder(v:Ref<SiteBuilder>):SiteBuilder
	...
	export function emptyJobRequirementDtoBuilder():JobRequirementDtoBuilder
	export function emptyRefJobRequirementDtoBuilder():Ref<JobRequirementDtoBuilder>
	export function refOfJobRequirementDtoBuilder(x:JobRequirementDtoBuilder,v:Ref<JobRequirementDtoBuilder>)
	export function unRefJobRequirementDtoBuilder(v:Ref<JobRequirementDtoBuilder>):JobRequirementDtoBuilder
	export function emptyTripartiteAgreementInfoBuilder():TripartiteAgreementInfoBuilder
	export function emptyRefTripartiteAgreementInfoBuilder():Ref<TripartiteAgreementInfoBuilder>
	export function refOfTripartiteAgreementInfoBuilder(x:TripartiteAgreementInfoBuilder,v:Ref<TripartiteAgreementInfoBuilder>)
	export function unRefTripartiteAgreementInfoBuilder(v:Ref<TripartiteAgreementInfoBuilder>):TripartiteAgreementInfoBuilder
	...
	export function emptyOfferSchemaDetailOptionBuilder():OfferSchemaDetailOptionBuilder
	export function emptyRefOfferSchemaDetailOptionBuilder():Ref<OfferSchemaDetailOptionBuilder>
	export function refOfOfferSchemaDetailOptionBuilder(x:OfferSchemaDetailOptionBuilder,v:Ref<OfferSchemaDetailOptionBuilder>)
	export function unRefOfferSchemaDetailOptionBuilder(v:Ref<OfferSchemaDetailOptionBuilder>):OfferSchemaDetailOptionBuilder
	...
	export function emptyAddToFolderTalentReqBuilder():AddToFolderTalentReqBuilder
	export function emptyRefAddToFolderTalentReqBuilder():Ref<AddToFolderTalentReqBuilder>
	export function refOfAddToFolderTalentReqBuilder(x:AddToFolderTalentReqBuilder,v:Ref<AddToFolderTalentReqBuilder>)
	export function unRefAddToFolderTalentReqBuilder(v:Ref<AddToFolderTalentReqBuilder>):AddToFolderTalentReqBuilder
	export function emptyApplicationStageInfoBuilder():ApplicationStageInfoBuilder
	export function emptyRefApplicationStageInfoBuilder():Ref<ApplicationStageInfoBuilder>
	export function refOfApplicationStageInfoBuilder(x:ApplicationStageInfoBuilder,v:Ref<ApplicationStageInfoBuilder>)
	export function unRefApplicationStageInfoBuilder(v:Ref<ApplicationStageInfoBuilder>):ApplicationStageInfoBuilder
	...
	export function emptySiteResumeIdentificationBuilder():SiteResumeIdentificationBuilder
	export function emptyRefSiteResumeIdentificationBuilder():Ref<SiteResumeIdentificationBuilder>
	export function refOfSiteResumeIdentificationBuilder(x:SiteResumeIdentificationBuilder,v:Ref<SiteResumeIdentificationBuilder>)
	export function unRefSiteResumeIdentificationBuilder(v:Ref<SiteResumeIdentificationBuilder>):SiteResumeIdentificationBuilder
	export function emptyTalentCombinedAwardInfoBuilder():TalentCombinedAwardInfoBuilder
	export function emptyRefTalentCombinedAwardInfoBuilder():Ref<TalentCombinedAwardInfoBuilder>
	export function refOfTalentCombinedAwardInfoBuilder(x:TalentCombinedAwardInfoBuilder,v:Ref<TalentCombinedAwardInfoBuilder>)
	export function unRefTalentCombinedAwardInfoBuilder(v:Ref<TalentCombinedAwardInfoBuilder>):TalentCombinedAwardInfoBuilder
	...
	export function emptyUpdateProgressEcoBackgroundCheckReqBuilder():UpdateProgressEcoBackgroundCheckReqBuilder
	export function emptyRefUpdateProgressEcoBackgroundCheckReqBuilder():Ref<UpdateProgressEcoBackgroundCheckReqBuilder>
	export function refOfUpdateProgressEcoBackgroundCheckReqBuilder(x:UpdateProgressEcoBackgroundCheckReqBuilder,v:Ref<UpdateProgressEcoBackgroundCheckReqBuilder>)
	export function unRefUpdateProgressEcoBackgroundCheckReqBuilder(v:Ref<UpdateProgressEcoBackgroundCheckReqBuilder>):UpdateProgressEcoBackgroundCheckReqBuilder
	...
	export function emptyInternOfferStatusBuilder():InternOfferStatusBuilder
	export function emptyRefInternOfferStatusBuilder():Ref<InternOfferStatusBuilder>
	export function refOfInternOfferStatusBuilder(x:InternOfferStatusBuilder,v:Ref<InternOfferStatusBuilder>)
	export function unRefInternOfferStatusBuilder(v:Ref<InternOfferStatusBuilder>):InternOfferStatusBuilder
	...
	export function emptySiteJobPostSearchRequestBuilder():SiteJobPostSearchRequestBuilder
	export function emptyRefSiteJobPostSearchRequestBuilder():Ref<SiteJobPostSearchRequestBuilder>
	export function refOfSiteJobPostSearchRequestBuilder(x:SiteJobPostSearchRequestBuilder,v:Ref<SiteJobPostSearchRequestBuilder>)
	export function unRefSiteJobPostSearchRequestBuilder(v:Ref<SiteJobPostSearchRequestBuilder>):SiteJobPostSearchRequestBuilder
	export function emptyCashBuilder():CashBuilder
	export function emptyRefCashBuilder():Ref<CashBuilder>
	export function refOfCashBuilder(x:CashBuilder,v:Ref<CashBuilder>)
	export function unRefCashBuilder(v:Ref<CashBuilder>):CashBuilder
	...
	export function emptyWebsiteDeliveryAttachmentBuilder():WebsiteDeliveryAttachmentBuilder
	export function emptyRefWebsiteDeliveryAttachmentBuilder():Ref<WebsiteDeliveryAttachmentBuilder>
	export function refOfWebsiteDeliveryAttachmentBuilder(x:WebsiteDeliveryAttachmentBuilder,v:Ref<WebsiteDeliveryAttachmentBuilder>)
	export function unRefWebsiteDeliveryAttachmentBuilder(v:Ref<WebsiteDeliveryAttachmentBuilder>):WebsiteDeliveryAttachmentBuilder
	export function emptyExternalBackgroundCheckAttachmentBuilder():ExternalBackgroundCheckAttachmentBuilder
	export function emptyRefExternalBackgroundCheckAttachmentBuilder():Ref<ExternalBackgroundCheckAttachmentBuilder>
	export function refOfExternalBackgroundCheckAttachmentBuilder(x:ExternalBackgroundCheckAttachmentBuilder,v:Ref<ExternalBackgroundCheckAttachmentBuilder>)
	export function unRefExternalBackgroundCheckAttachmentBuilder(v:Ref<ExternalBackgroundCheckAttachmentBuilder>):ExternalBackgroundCheckAttachmentBuilder
	...
	export function emptyCheckFailedAccountInfoBuilder():CheckFailedAccountInfoBuilder
	export function emptyRefCheckFailedAccountInfoBuilder():Ref<CheckFailedAccountInfoBuilder>
	export function refOfCheckFailedAccountInfoBuilder(x:CheckFailedAccountInfoBuilder,v:Ref<CheckFailedAccountInfoBuilder>)
	export function unRefCheckFailedAccountInfoBuilder(v:Ref<CheckFailedAccountInfoBuilder>):CheckFailedAccountInfoBuilder
	...
	export function emptyListJobRequirementSchemaReqBuilder():ListJobRequirementSchemaReqBuilder
	export function emptyRefListJobRequirementSchemaReqBuilder():Ref<ListJobRequirementSchemaReqBuilder>
	export function refOfListJobRequirementSchemaReqBuilder(x:ListJobRequirementSchemaReqBuilder,v:Ref<ListJobRequirementSchemaReqBuilder>)
	export function unRefListJobRequirementSchemaReqBuilder(v:Ref<ListJobRequirementSchemaReqBuilder>):ListJobRequirementSchemaReqBuilder
	...
	export function emptyBaseCountryBuilder():BaseCountryBuilder
	export function emptyRefBaseCountryBuilder():Ref<BaseCountryBuilder>
	export function refOfBaseCountryBuilder(x:BaseCountryBuilder,v:Ref<BaseCountryBuilder>)
	export function unRefBaseCountryBuilder(v:Ref<BaseCountryBuilder>):BaseCountryBuilder
	export function emptyBatchDeleteEcoBackgroundCheckPackageReqBuilder():BatchDeleteEcoBackgroundCheckPackageReqBuilder
	export function emptyRefBatchDeleteEcoBackgroundCheckPackageReqBuilder():Ref<BatchDeleteEcoBackgroundCheckPackageReqBuilder>
	export function refOfBatchDeleteEcoBackgroundCheckPackageReqBuilder(x:BatchDeleteEcoBackgroundCheckPackageReqBuilder,v:Ref<BatchDeleteEcoBackgroundCheckPackageReqBuilder>)
	export function unRefBatchDeleteEcoBackgroundCheckPackageReqBuilder(v:Ref<BatchDeleteEcoBackgroundCheckPackageReqBuilder>):BatchDeleteEcoBackgroundCheckPackageReqBuilder
	...
	export function emptyScoreDimensionConfigBuilder():ScoreDimensionConfigBuilder
	export function emptyRefScoreDimensionConfigBuilder():Ref<ScoreDimensionConfigBuilder>
	export function refOfScoreDimensionConfigBuilder(x:ScoreDimensionConfigBuilder,v:Ref<ScoreDimensionConfigBuilder>)
	export function unRefScoreDimensionConfigBuilder(v:Ref<ScoreDimensionConfigBuilder>):ScoreDimensionConfigBuilder
	export function emptySiteResumeCertificateBuilder():SiteResumeCertificateBuilder
	export function emptyRefSiteResumeCertificateBuilder():Ref<SiteResumeCertificateBuilder>
	export function refOfSiteResumeCertificateBuilder(x:SiteResumeCertificateBuilder,v:Ref<SiteResumeCertificateBuilder>)
	export function unRefSiteResumeCertificateBuilder(v:Ref<SiteResumeCertificateBuilder>):SiteResumeCertificateBuilder
	...
	export function emptyBatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder():BatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder
	export function emptyRefBatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder():Ref<BatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder>
	export function refOfBatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder(x:BatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder,v:Ref<BatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder>)
	export function unRefBatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder(v:Ref<BatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder>):BatchDeleteEcoBackgroundCheckCustomFieldReqBodyBuilder
	...
	export function emptyInterviewRoundTypeBuilder():InterviewRoundTypeBuilder
	export function emptyRefInterviewRoundTypeBuilder():Ref<InterviewRoundTypeBuilder>
	export function refOfInterviewRoundTypeBuilder(x:InterviewRoundTypeBuilder,v:Ref<InterviewRoundTypeBuilder>)
	export function unRefInterviewRoundTypeBuilder(v:Ref<InterviewRoundTypeBuilder>):InterviewRoundTypeBuilder
	...
	export function emptyTalentInterviewBuilder():TalentInterviewBuilder
	export function emptyRefTalentInterviewBuilder():Ref<TalentInterviewBuilder>
	export function refOfTalentInterviewBuilder(x:TalentInterviewBuilder,v:Ref<TalentInterviewBuilder>)
	export function unRefTalentInterviewBuilder(v:Ref<TalentInterviewBuilder>):TalentInterviewBuilder
	export function emptyJobRequirementCustomizedValueBuilder():JobRequirementCustomizedValueBuilder
	export function emptyRefJobRequirementCustomizedValueBuilder():Ref<JobRequirementCustomizedValueBuilder>
	export function refOfJobRequirementCustomizedValueBuilder(x:JobRequirementCustomizedValueBuilder,v:Ref<JobRequirementCustomizedValueBuilder>)
	export function unRefJobRequirementCustomizedValueBuilder(v:Ref<JobRequirementCustomizedValueBuilder>):JobRequirementCustomizedValueBuilder
	...
	export function emptyTestScheduleBuilder():TestScheduleBuilder
	export function emptyRefTestScheduleBuilder():Ref<TestScheduleBuilder>
	export function refOfTestScheduleBuilder(x:TestScheduleBuilder,v:Ref<TestScheduleBuilder>)
	export function unRefTestScheduleBuilder(v:Ref<TestScheduleBuilder>):TestScheduleBuilder
	export function emptyUpdateConfigJobReqBuilder():UpdateConfigJobReqBuilder
	export function emptyRefUpdateConfigJobReqBuilder():Ref<UpdateConfigJobReqBuilder>
	export function refOfUpdateConfigJobReqBuilder(x:UpdateConfigJobReqBuilder,v:Ref<UpdateConfigJobReqBuilder>)
	export function unRefUpdateConfigJobReqBuilder(v:Ref<UpdateConfigJobReqBuilder>):UpdateConfigJobReqBuilder
	export function emptyAgencyBuilder():AgencyBuilder
	export function emptyRefAgencyBuilder():Ref<AgencyBuilder>
	export function refOfAgencyBuilder(x:AgencyBuilder,v:Ref<AgencyBuilder>)
	export function unRefAgencyBuilder(v:Ref<AgencyBuilder>):AgencyBuilder
	...
	export function emptyOfferApplyFormConfigOptionInfoBuilder():OfferApplyFormConfigOptionInfoBuilder
	export function emptyRefOfferApplyFormConfigOptionInfoBuilder():Ref<OfferApplyFormConfigOptionInfoBuilder>
	export function refOfOfferApplyFormConfigOptionInfoBuilder(x:OfferApplyFormConfigOptionInfoBuilder,v:Ref<OfferApplyFormConfigOptionInfoBuilder>)
	export function unRefOfferApplyFormConfigOptionInfoBuilder(v:Ref<OfferApplyFormConfigOptionInfoBuilder>):OfferApplyFormConfigOptionInfoBuilder
	...
	export function emptyJobRequirementBuilder():JobRequirementBuilder
	export function emptyRefJobRequirementBuilder():Ref<JobRequirementBuilder>
	export function refOfJobRequirementBuilder(x:JobRequirementBuilder,v:Ref<JobRequirementBuilder>)
	export function unRefJobRequirementBuilder(v:Ref<JobRequirementBuilder>):JobRequirementBuilder
	...
	export function emptyApplicationOfferBasicInfoUserBuilder():ApplicationOfferBasicInfoUserBuilder
	export function emptyRefApplicationOfferBasicInfoUserBuilder():Ref<ApplicationOfferBasicInfoUserBuilder>
	export function refOfApplicationOfferBasicInfoUserBuilder(x:ApplicationOfferBasicInfoUserBuilder,v:Ref<ApplicationOfferBasicInfoUserBuilder>)
	export function unRefApplicationOfferBasicInfoUserBuilder(v:Ref<ApplicationOfferBasicInfoUserBuilder>):ApplicationOfferBasicInfoUserBuilder
	export function emptyConfigJobReqBuilder():ConfigJobReqBuilder
	export function emptyRefConfigJobReqBuilder():Ref<ConfigJobReqBuilder>
	export function refOfConfigJobReqBuilder(x:ConfigJobReqBuilder,v:Ref<ConfigJobReqBuilder>)
	export function unRefConfigJobReqBuilder(v:Ref<ConfigJobReqBuilder>):ConfigJobReqBuilder
	...
	export function emptyCreateEcoAccountCustomFieldReqBuilder():CreateEcoAccountCustomFieldReqBuilder
	export function emptyRefCreateEcoAccountCustomFieldReqBuilder():Ref<CreateEcoAccountCustomFieldReqBuilder>
	export function refOfCreateEcoAccountCustomFieldReqBuilder(x:CreateEcoAccountCustomFieldReqBuilder,v:Ref<CreateEcoAccountCustomFieldReqBuilder>)
	export function unRefCreateEcoAccountCustomFieldReqBuilder(v:Ref<CreateEcoAccountCustomFieldReqBuilder>):CreateEcoAccountCustomFieldReqBuilder
	...
	export function emptyLoginInfoEcoExamReqBodyBuilder():LoginInfoEcoExamReqBodyBuilder
	export function emptyRefLoginInfoEcoExamReqBodyBuilder():Ref<LoginInfoEcoExamReqBodyBuilder>
	export function refOfLoginInfoEcoExamReqBodyBuilder(x:LoginInfoEcoExamReqBodyBuilder,v:Ref<LoginInfoEcoExamReqBodyBuilder>)
	export function unRefLoginInfoEcoExamReqBodyBuilder(v:Ref<LoginInfoEcoExamReqBodyBuilder>):LoginInfoEcoExamReqBodyBuilder
	...
	export function emptyApplicationOfferBasicInfoBuilder():ApplicationOfferBasicInfoBuilder
	export function emptyRefApplicationOfferBasicInfoBuilder():Ref<ApplicationOfferBasicInfoBuilder>
	export function refOfApplicationOfferBasicInfoBuilder(x:ApplicationOfferBasicInfoBuilder,v:Ref<ApplicationOfferBasicInfoBuilder>)
	export function unRefApplicationOfferBasicInfoBuilder(v:Ref<ApplicationOfferBasicInfoBuilder>):ApplicationOfferBasicInfoBuilder
	export function emptyBatchDeleteEcoAccountCustomFieldPathReqBodyBuilder():BatchDeleteEcoAccountCustomFieldPathReqBodyBuilder
	export function emptyRefBatchDeleteEcoAccountCustomFieldPathReqBodyBuilder():Ref<BatchDeleteEcoAccountCustomFieldPathReqBodyBuilder>
	export function refOfBatchDeleteEcoAccountCustomFieldPathReqBodyBuilder(x:BatchDeleteEcoAccountCustomFieldPathReqBodyBuilder,v:Ref<BatchDeleteEcoAccountCustomFieldPathReqBodyBuilder>)
	export function unRefBatchDeleteEcoAccountCustomFieldPathReqBodyBuilder(v:Ref<BatchDeleteEcoAccountCustomFieldPathReqBodyBuilder>):BatchDeleteEcoAccountCustomFieldPathReqBodyBuilder
	...
	export function emptyCreateEcoBackgroundCheckCustomFieldReqBuilder():CreateEcoBackgroundCheckCustomFieldReqBuilder
	export function emptyRefCreateEcoBackgroundCheckCustomFieldReqBuilder():Ref<CreateEcoBackgroundCheckCustomFieldReqBuilder>
	export function refOfCreateEcoBackgroundCheckCustomFieldReqBuilder(x:CreateEcoBackgroundCheckCustomFieldReqBuilder,v:Ref<CreateEcoBackgroundCheckCustomFieldReqBuilder>)
	export function unRefCreateEcoBackgroundCheckCustomFieldReqBuilder(v:Ref<CreateEcoBackgroundCheckCustomFieldReqBuilder>):CreateEcoBackgroundCheckCustomFieldReqBuilder
	...
	export function emptyP2EhrImportTaskImportedV1Handler():P2EhrImportTaskImportedV1Handler
	export function emptyRefP2EhrImportTaskImportedV1Handler():Ref<P2EhrImportTaskImportedV1Handler>
	export function refOfP2EhrImportTaskImportedV1Handler(x:P2EhrImportTaskImportedV1Handler,v:Ref<P2EhrImportTaskImportedV1Handler>)
	export function unRefP2EhrImportTaskImportedV1Handler(v:Ref<P2EhrImportTaskImportedV1Handler>):P2EhrImportTaskImportedV1Handler
	...
	export function emptyTalentCustomizedDataChildBuilder():TalentCustomizedDataChildBuilder
	export function emptyRefTalentCustomizedDataChildBuilder():Ref<TalentCustomizedDataChildBuilder>
	export function refOfTalentCustomizedDataChildBuilder(x:TalentCustomizedDataChildBuilder,v:Ref<TalentCustomizedDataChildBuilder>)
	export function unRefTalentCustomizedDataChildBuilder(v:Ref<TalentCustomizedDataChildBuilder>):TalentCustomizedDataChildBuilder
	...
	export function emptyWebsiteJobPostCustomizedValueBuilder():WebsiteJobPostCustomizedValueBuilder
	export function emptyRefWebsiteJobPostCustomizedValueBuilder():Ref<WebsiteJobPostCustomizedValueBuilder>
	export function refOfWebsiteJobPostCustomizedValueBuilder(x:WebsiteJobPostCustomizedValueBuilder,v:Ref<WebsiteJobPostCustomizedValueBuilder>)
	export function unRefWebsiteJobPostCustomizedValueBuilder(v:Ref<WebsiteJobPostCustomizedValueBuilder>):WebsiteJobPostCustomizedValueBuilder
	...
	export function emptyTalentProjectInfoBuilder():TalentProjectInfoBuilder
	export function emptyRefTalentProjectInfoBuilder():Ref<TalentProjectInfoBuilder>
	export function refOfTalentProjectInfoBuilder(x:TalentProjectInfoBuilder,v:Ref<TalentProjectInfoBuilder>)
	export function unRefTalentProjectInfoBuilder(v:Ref<TalentProjectInfoBuilder>):TalentProjectInfoBuilder
	export function emptyApplicationTalentBasicInfoBuilder():ApplicationTalentBasicInfoBuilder
	export function emptyRefApplicationTalentBasicInfoBuilder():Ref<ApplicationTalentBasicInfoBuilder>
	export function refOfApplicationTalentBasicInfoBuilder(x:ApplicationTalentBasicInfoBuilder,v:Ref<ApplicationTalentBasicInfoBuilder>)
	export function unRefApplicationTalentBasicInfoBuilder(v:Ref<ApplicationTalentBasicInfoBuilder>):ApplicationTalentBasicInfoBuilder
	...
	export function emptyJobCustomizedOptionBuilder():JobCustomizedOptionBuilder
	export function emptyRefJobCustomizedOptionBuilder():Ref<JobCustomizedOptionBuilder>
	export function refOfJobCustomizedOptionBuilder(x:JobCustomizedOptionBuilder,v:Ref<JobCustomizedOptionBuilder>)
	export function unRefJobCustomizedOptionBuilder(v:Ref<JobCustomizedOptionBuilder>):JobCustomizedOptionBuilder
	export function emptyTalentBuilder():TalentBuilder
	export function emptyRefTalentBuilder():Ref<TalentBuilder>
	export function refOfTalentBuilder(x:TalentBuilder,v:Ref<TalentBuilder>)
	export function unRefTalentBuilder(v:Ref<TalentBuilder>):TalentBuilder
	...
	export function emptyAppliOfferOnboardProfileCityBuilder():AppliOfferOnboardProfileCityBuilder
	export function emptyRefAppliOfferOnboardProfileCityBuilder():Ref<AppliOfferOnboardProfileCityBuilder>
	export function refOfAppliOfferOnboardProfileCityBuilder(x:AppliOfferOnboardProfileCityBuilder,v:Ref<AppliOfferOnboardProfileCityBuilder>)
	export function unRefAppliOfferOnboardProfileCityBuilder(v:Ref<AppliOfferOnboardProfileCityBuilder>):AppliOfferOnboardProfileCityBuilder
	...
	export function emptyBackgroundCheckOrderBuilder():BackgroundCheckOrderBuilder
	export function emptyRefBackgroundCheckOrderBuilder():Ref<BackgroundCheckOrderBuilder>
	export function refOfBackgroundCheckOrderBuilder(x:BackgroundCheckOrderBuilder,v:Ref<BackgroundCheckOrderBuilder>)
	export function unRefBackgroundCheckOrderBuilder(v:Ref<BackgroundCheckOrderBuilder>):BackgroundCheckOrderBuilder
	export function emptyBatchDeleteEcoAccountCustomFieldReqBuilder():BatchDeleteEcoAccountCustomFieldReqBuilder
	export function emptyRefBatchDeleteEcoAccountCustomFieldReqBuilder():Ref<BatchDeleteEcoAccountCustomFieldReqBuilder>
	export function refOfBatchDeleteEcoAccountCustomFieldReqBuilder(x:BatchDeleteEcoAccountCustomFieldReqBuilder,v:Ref<BatchDeleteEcoAccountCustomFieldReqBuilder>)
	export function unRefBatchDeleteEcoAccountCustomFieldReqBuilder(v:Ref<BatchDeleteEcoAccountCustomFieldReqBuilder>):BatchDeleteEcoAccountCustomFieldReqBuilder
	...
	export function emptyTerminateApplicationReqBodyBuilder():TerminateApplicationReqBodyBuilder
	export function emptyRefTerminateApplicationReqBodyBuilder():Ref<TerminateApplicationReqBodyBuilder>
	export function refOfTerminateApplicationReqBodyBuilder(x:TerminateApplicationReqBodyBuilder,v:Ref<TerminateApplicationReqBodyBuilder>)
	export function unRefTerminateApplicationReqBodyBuilder(v:Ref<TerminateApplicationReqBodyBuilder>):TerminateApplicationReqBodyBuilder
	...
	export function emptyOfferSchemaListInfoBuilder():OfferSchemaListInfoBuilder
	export function emptyRefOfferSchemaListInfoBuilder():Ref<OfferSchemaListInfoBuilder>
	export function refOfOfferSchemaListInfoBuilder(x:OfferSchemaListInfoBuilder,v:Ref<OfferSchemaListInfoBuilder>)
	export function unRefOfferSchemaListInfoBuilder(v:Ref<OfferSchemaListInfoBuilder>):OfferSchemaListInfoBuilder
	...
	export function emptyReconciliationReferralAccountPathReqBodyBuilder():ReconciliationReferralAccountPathReqBodyBuilder
	export function emptyRefReconciliationReferralAccountPathReqBodyBuilder():Ref<ReconciliationReferralAccountPathReqBodyBuilder>
	export function refOfReconciliationReferralAccountPathReqBodyBuilder(x:ReconciliationReferralAccountPathReqBodyBuilder,v:Ref<ReconciliationReferralAccountPathReqBodyBuilder>)
	export function unRefReconciliationReferralAccountPathReqBodyBuilder(v:Ref<ReconciliationReferralAccountPathReqBodyBuilder>):ReconciliationReferralAccountPathReqBodyBuilder
	...
	export function emptyCombinedJobResultDefaultJobPostBuilder():CombinedJobResultDefaultJobPostBuilder
	export function emptyRefCombinedJobResultDefaultJobPostBuilder():Ref<CombinedJobResultDefaultJobPostBuilder>
	export function refOfCombinedJobResultDefaultJobPostBuilder(x:CombinedJobResultDefaultJobPostBuilder,v:Ref<CombinedJobResultDefaultJobPostBuilder>)
	export function unRefCombinedJobResultDefaultJobPostBuilder(v:Ref<CombinedJobResultDefaultJobPostBuilder>):CombinedJobResultDefaultJobPostBuilder
	...
	export function emptyJobConfigInterviewRoundConfBuilder():JobConfigInterviewRoundConfBuilder
	export function emptyRefJobConfigInterviewRoundConfBuilder():Ref<JobConfigInterviewRoundConfBuilder>
	export function refOfJobConfigInterviewRoundConfBuilder(x:JobConfigInterviewRoundConfBuilder,v:Ref<JobConfigInterviewRoundConfBuilder>)
	export function unRefJobConfigInterviewRoundConfBuilder(v:Ref<JobConfigInterviewRoundConfBuilder>):JobConfigInterviewRoundConfBuilder
	export function emptySiteResumeEducationBuilder():SiteResumeEducationBuilder
	export function emptyRefSiteResumeEducationBuilder():Ref<SiteResumeEducationBuilder>
	export function refOfSiteResumeEducationBuilder(x:SiteResumeEducationBuilder,v:Ref<SiteResumeEducationBuilder>)
	export function unRefSiteResumeEducationBuilder(v:Ref<SiteResumeEducationBuilder>):SiteResumeEducationBuilder
	export function emptyCombinedUpdateJobReqBuilder():CombinedUpdateJobReqBuilder
	export function emptyRefCombinedUpdateJobReqBuilder():Ref<CombinedUpdateJobReqBuilder>
	export function refOfCombinedUpdateJobReqBuilder(x:CombinedUpdateJobReqBuilder,v:Ref<CombinedUpdateJobReqBuilder>)
	export function unRefCombinedUpdateJobReqBuilder(v:Ref<CombinedUpdateJobReqBuilder>):CombinedUpdateJobReqBuilder
	...
	export function emptyListByIdJobRequirementReqBodyBuilder():ListByIdJobRequirementReqBodyBuilder
	export function emptyRefListByIdJobRequirementReqBodyBuilder():Ref<ListByIdJobRequirementReqBodyBuilder>
	export function refOfListByIdJobRequirementReqBodyBuilder(x:ListByIdJobRequirementReqBodyBuilder,v:Ref<ListByIdJobRequirementReqBodyBuilder>)
	export function unRefListByIdJobRequirementReqBodyBuilder(v:Ref<ListByIdJobRequirementReqBodyBuilder>):ListByIdJobRequirementReqBodyBuilder
	export function emptyDiInfoBuilder():DiInfoBuilder
	export function emptyRefDiInfoBuilder():Ref<DiInfoBuilder>
	export function refOfDiInfoBuilder(x:DiInfoBuilder,v:Ref<DiInfoBuilder>)
	export function unRefDiInfoBuilder(v:Ref<DiInfoBuilder>):DiInfoBuilder
	...
	export function emptyWebsiteDeliveryWorksAttachmentBuilder():WebsiteDeliveryWorksAttachmentBuilder
	export function emptyRefWebsiteDeliveryWorksAttachmentBuilder():Ref<WebsiteDeliveryWorksAttachmentBuilder>
	export function refOfWebsiteDeliveryWorksAttachmentBuilder(x:WebsiteDeliveryWorksAttachmentBuilder,v:Ref<WebsiteDeliveryWorksAttachmentBuilder>)
	export function unRefWebsiteDeliveryWorksAttachmentBuilder(v:Ref<WebsiteDeliveryWorksAttachmentBuilder>):WebsiteDeliveryWorksAttachmentBuilder
	export function emptyCreateReferralAccountReqBodyBuilder():CreateReferralAccountReqBodyBuilder
	export function emptyRefCreateReferralAccountReqBodyBuilder():Ref<CreateReferralAccountReqBodyBuilder>
	export function refOfCreateReferralAccountReqBodyBuilder(x:CreateReferralAccountReqBodyBuilder,v:Ref<CreateReferralAccountReqBodyBuilder>)
	export function unRefCreateReferralAccountReqBodyBuilder(v:Ref<CreateReferralAccountReqBodyBuilder>):CreateReferralAccountReqBodyBuilder
	export function emptyIdentificationBuilder():IdentificationBuilder
	export function emptyRefIdentificationBuilder():Ref<IdentificationBuilder>
	export function refOfIdentificationBuilder(x:IdentificationBuilder,v:Ref<IdentificationBuilder>)
	export function unRefIdentificationBuilder(v:Ref<IdentificationBuilder>):IdentificationBuilder
	...
	export function emptyTodoCommonBuilder():TodoCommonBuilder
	export function emptyRefTodoCommonBuilder():Ref<TodoCommonBuilder>
	export function refOfTodoCommonBuilder(x:TodoCommonBuilder,v:Ref<TodoCommonBuilder>)
	export function unRefTodoCommonBuilder(v:Ref<TodoCommonBuilder>):TodoCommonBuilder
	...
	export function emptyNoteBuilder():NoteBuilder
	export function emptyRefNoteBuilder():Ref<NoteBuilder>
	export function refOfNoteBuilder(x:NoteBuilder,v:Ref<NoteBuilder>)
	export function unRefNoteBuilder(v:Ref<NoteBuilder>):NoteBuilder
	...
	export function emptyTalentOperationLogBuilder():TalentOperationLogBuilder
	export function emptyRefTalentOperationLogBuilder():Ref<TalentOperationLogBuilder>
	export function refOfTalentOperationLogBuilder(x:TalentOperationLogBuilder,v:Ref<TalentOperationLogBuilder>)
	export function unRefTalentOperationLogBuilder(v:Ref<TalentOperationLogBuilder>):TalentOperationLogBuilder
	export function emptyBackgroundCheckOrderFeedbackInfoBuilder():BackgroundCheckOrderFeedbackInfoBuilder
	export function emptyRefBackgroundCheckOrderFeedbackInfoBuilder():Ref<BackgroundCheckOrderFeedbackInfoBuilder>
	export function refOfBackgroundCheckOrderFeedbackInfoBuilder(x:BackgroundCheckOrderFeedbackInfoBuilder,v:Ref<BackgroundCheckOrderFeedbackInfoBuilder>)
	export function unRefBackgroundCheckOrderFeedbackInfoBuilder(v:Ref<BackgroundCheckOrderFeedbackInfoBuilder>):BackgroundCheckOrderFeedbackInfoBuilder
	export function emptyP2EcoBackgroundCheckCanceledV1Handler():P2EcoBackgroundCheckCanceledV1Handler
	export function emptyRefP2EcoBackgroundCheckCanceledV1Handler():Ref<P2EcoBackgroundCheckCanceledV1Handler>
	export function refOfP2EcoBackgroundCheckCanceledV1Handler(x:P2EcoBackgroundCheckCanceledV1Handler,v:Ref<P2EcoBackgroundCheckCanceledV1Handler>)
	export function unRefP2EcoBackgroundCheckCanceledV1Handler(v:Ref<P2EcoBackgroundCheckCanceledV1Handler>):P2EcoBackgroundCheckCanceledV1Handler
	...
	export function emptyGetByApplicationReferralReqBuilder():GetByApplicationReferralReqBuilder
	export function emptyRefGetByApplicationReferralReqBuilder():Ref<GetByApplicationReferralReqBuilder>
	export function refOfGetByApplicationReferralReqBuilder(x:GetByApplicationReferralReqBuilder,v:Ref<GetByApplicationReferralReqBuilder>)
	export function unRefGetByApplicationReferralReqBuilder(v:Ref<GetByApplicationReferralReqBuilder>):GetByApplicationReferralReqBuilder
	...
	export function emptyAttachmentInfoBuilder():AttachmentInfoBuilder
	export function emptyRefAttachmentInfoBuilder():Ref<AttachmentInfoBuilder>
	export function refOfAttachmentInfoBuilder(x:AttachmentInfoBuilder,v:Ref<AttachmentInfoBuilder>)
	export function unRefAttachmentInfoBuilder(v:Ref<AttachmentInfoBuilder>):AttachmentInfoBuilder
	export function emptyEcoExamResultReportBuilder():EcoExamResultReportBuilder
	export function emptyRefEcoExamResultReportBuilder():Ref<EcoExamResultReportBuilder>
	export function refOfEcoExamResultReportBuilder(x:EcoExamResultReportBuilder,v:Ref<EcoExamResultReportBuilder>)
	export function unRefEcoExamResultReportBuilder(v:Ref<EcoExamResultReportBuilder>):EcoExamResultReportBuilder
	export function emptyListByIdJobRequirementReqBuilder():ListByIdJobRequirementReqBuilder
	export function emptyRefListByIdJobRequirementReqBuilder():Ref<ListByIdJobRequirementReqBuilder>
	export function refOfListByIdJobRequirementReqBuilder(x:ListByIdJobRequirementReqBuilder,v:Ref<ListByIdJobRequirementReqBuilder>)
	export function unRefListByIdJobRequirementReqBuilder(v:Ref<ListByIdJobRequirementReqBuilder>):ListByIdJobRequirementReqBuilder
	...
	export function emptyPatchNoteReqBuilder():PatchNoteReqBuilder
	export function emptyRefPatchNoteReqBuilder():Ref<PatchNoteReqBuilder>
	export function refOfPatchNoteReqBuilder(x:PatchNoteReqBuilder,v:Ref<PatchNoteReqBuilder>)
	export function unRefPatchNoteReqBuilder(v:Ref<PatchNoteReqBuilder>):PatchNoteReqBuilder
	...
	export function emptyCreateApplicationReqBodyBuilder():CreateApplicationReqBodyBuilder
	export function emptyRefCreateApplicationReqBodyBuilder():Ref<CreateApplicationReqBodyBuilder>
	export function refOfCreateApplicationReqBodyBuilder(x:CreateApplicationReqBodyBuilder,v:Ref<CreateApplicationReqBodyBuilder>)
	export function unRefCreateApplicationReqBodyBuilder(v:Ref<CreateApplicationReqBodyBuilder>):CreateApplicationReqBodyBuilder
	...
	export function emptyWebsiteDeliveryBasicInfoBuilder():WebsiteDeliveryBasicInfoBuilder
	export function emptyRefWebsiteDeliveryBasicInfoBuilder():Ref<WebsiteDeliveryBasicInfoBuilder>
	export function refOfWebsiteDeliveryBasicInfoBuilder(x:WebsiteDeliveryBasicInfoBuilder,v:Ref<WebsiteDeliveryBasicInfoBuilder>)
	export function unRefWebsiteDeliveryBasicInfoBuilder(v:Ref<WebsiteDeliveryBasicInfoBuilder>):WebsiteDeliveryBasicInfoBuilder
	...
	export function emptyTalentPoolBuilder():TalentPoolBuilder
	export function emptyRefTalentPoolBuilder():Ref<TalentPoolBuilder>
	export function refOfTalentPoolBuilder(x:TalentPoolBuilder,v:Ref<TalentPoolBuilder>)
	export function unRefTalentPoolBuilder(v:Ref<TalentPoolBuilder>):TalentPoolBuilder
	...
	export function emptyTalentBasicInfoBuilder():TalentBasicInfoBuilder
	export function emptyRefTalentBasicInfoBuilder():Ref<TalentBasicInfoBuilder>
	export function refOfTalentBasicInfoBuilder(x:TalentBasicInfoBuilder,v:Ref<TalentBasicInfoBuilder>)
	export function unRefTalentBasicInfoBuilder(v:Ref<TalentBasicInfoBuilder>):TalentBasicInfoBuilder
	export function emptyTalentSelfEvaluationBuilder():TalentSelfEvaluationBuilder
	export function emptyRefTalentSelfEvaluationBuilder():Ref<TalentSelfEvaluationBuilder>
	export function refOfTalentSelfEvaluationBuilder(x:TalentSelfEvaluationBuilder,v:Ref<TalentSelfEvaluationBuilder>)
	export function unRefTalentSelfEvaluationBuilder(v:Ref<TalentSelfEvaluationBuilder>):TalentSelfEvaluationBuilder
	export function emptyAssetsBuilder():AssetsBuilder
	export function emptyRefAssetsBuilder():Ref<AssetsBuilder>
	export function refOfAssetsBuilder(x:AssetsBuilder,v:Ref<AssetsBuilder>)
	export function unRefAssetsBuilder(v:Ref<AssetsBuilder>):AssetsBuilder
	export function emptyEcoExamPaperDataBuilder():EcoExamPaperDataBuilder
	export function emptyRefEcoExamPaperDataBuilder():Ref<EcoExamPaperDataBuilder>
	export function refOfEcoExamPaperDataBuilder(x:EcoExamPaperDataBuilder,v:Ref<EcoExamPaperDataBuilder>)
	export function unRefEcoExamPaperDataBuilder(v:Ref<EcoExamPaperDataBuilder>):EcoExamPaperDataBuilder
	...
	export function emptyCreateExternalApplicationReqBuilder():CreateExternalApplicationReqBuilder
	export function emptyRefCreateExternalApplicationReqBuilder():Ref<CreateExternalApplicationReqBuilder>
	export function refOfCreateExternalApplicationReqBuilder(x:CreateExternalApplicationReqBuilder,v:Ref<CreateExternalApplicationReqBuilder>)
	export function unRefCreateExternalApplicationReqBuilder(v:Ref<CreateExternalApplicationReqBuilder>):CreateExternalApplicationReqBuilder
	export function emptyEcoExamCreateEventMobileBuilder():EcoExamCreateEventMobileBuilder
	export function emptyRefEcoExamCreateEventMobileBuilder():Ref<EcoExamCreateEventMobileBuilder>
	export function refOfEcoExamCreateEventMobileBuilder(x:EcoExamCreateEventMobileBuilder,v:Ref<EcoExamCreateEventMobileBuilder>)
	export function unRefEcoExamCreateEventMobileBuilder(v:Ref<EcoExamCreateEventMobileBuilder>):EcoExamCreateEventMobileBuilder
	...
	export function emptyJobProcessesStageBuilder():JobProcessesStageBuilder
	export function emptyRefJobProcessesStageBuilder():Ref<JobProcessesStageBuilder>
	export function refOfJobProcessesStageBuilder(x:JobProcessesStageBuilder,v:Ref<JobProcessesStageBuilder>)
	export function unRefJobProcessesStageBuilder(v:Ref<JobProcessesStageBuilder>):JobProcessesStageBuilder
	export function emptyAppliOfferOnboardProfileBuilder():AppliOfferOnboardProfileBuilder
	export function emptyRefAppliOfferOnboardProfileBuilder():Ref<AppliOfferOnboardProfileBuilder>
	export function refOfAppliOfferOnboardProfileBuilder(x:AppliOfferOnboardProfileBuilder,v:Ref<AppliOfferOnboardProfileBuilder>)
	export function unRefAppliOfferOnboardProfileBuilder(v:Ref<AppliOfferOnboardProfileBuilder>):AppliOfferOnboardProfileBuilder
	...
	export function emptyGetJobManagerReqBuilder():GetJobManagerReqBuilder
	export function emptyRefGetJobManagerReqBuilder():Ref<GetJobManagerReqBuilder>
	export function refOfGetJobManagerReqBuilder(x:GetJobManagerReqBuilder,v:Ref<GetJobManagerReqBuilder>)
	export function unRefGetJobManagerReqBuilder(v:Ref<GetJobManagerReqBuilder>):GetJobManagerReqBuilder
	export function emptyOfferApprovalTemplateBuilder():OfferApprovalTemplateBuilder
	export function emptyRefOfferApprovalTemplateBuilder():Ref<OfferApprovalTemplateBuilder>
	export function refOfOfferApprovalTemplateBuilder(x:OfferApprovalTemplateBuilder,v:Ref<OfferApprovalTemplateBuilder>)
	export function unRefOfferApprovalTemplateBuilder(v:Ref<OfferApprovalTemplateBuilder>):OfferApprovalTemplateBuilder
	export function emptyAppliOfferOnboardProfileAddBuilder():AppliOfferOnboardProfileAddBuilder
	export function emptyRefAppliOfferOnboardProfileAddBuilder():Ref<AppliOfferOnboardProfileAddBuilder>
	export function refOfAppliOfferOnboardProfileAddBuilder(x:AppliOfferOnboardProfileAddBuilder,v:Ref<AppliOfferOnboardProfileAddBuilder>)
	export function unRefAppliOfferOnboardProfileAddBuilder(v:Ref<AppliOfferOnboardProfileAddBuilder>):AppliOfferOnboardProfileAddBuilder
	...
	export function emptyP2EcoBackgroundCheckCreatedV1Handler():P2EcoBackgroundCheckCreatedV1Handler
	export function emptyRefP2EcoBackgroundCheckCreatedV1Handler():Ref<P2EcoBackgroundCheckCreatedV1Handler>
	export function refOfP2EcoBackgroundCheckCreatedV1Handler(x:P2EcoBackgroundCheckCreatedV1Handler,v:Ref<P2EcoBackgroundCheckCreatedV1Handler>)
	export function unRefP2EcoBackgroundCheckCreatedV1Handler(v:Ref<P2EcoBackgroundCheckCreatedV1Handler>):P2EcoBackgroundCheckCreatedV1Handler
	export function emptyP2OfferStatusChangedV1Handler():P2OfferStatusChangedV1Handler
	export function emptyRefP2OfferStatusChangedV1Handler():Ref<P2OfferStatusChangedV1Handler>
	export function refOfP2OfferStatusChangedV1Handler(x:P2OfferStatusChangedV1Handler,v:Ref<P2OfferStatusChangedV1Handler>)
	export function unRefP2OfferStatusChangedV1Handler(v:Ref<P2OfferStatusChangedV1Handler>):P2OfferStatusChangedV1Handler
	...
	export function emptyApplicationReferralBuilder():ApplicationReferralBuilder
	export function emptyRefApplicationReferralBuilder():Ref<ApplicationReferralBuilder>
	export function refOfApplicationReferralBuilder(x:ApplicationReferralBuilder,v:Ref<ApplicationReferralBuilder>)
	export function unRefApplicationReferralBuilder(v:Ref<ApplicationReferralBuilder>):ApplicationReferralBuilder
	...
	export function emptyTalentCustomizedOptionBuilder():TalentCustomizedOptionBuilder
	export function emptyRefTalentCustomizedOptionBuilder():Ref<TalentCustomizedOptionBuilder>
	export function refOfTalentCustomizedOptionBuilder(x:TalentCustomizedOptionBuilder,v:Ref<TalentCustomizedOptionBuilder>)
	export function unRefTalentCustomizedOptionBuilder(v:Ref<TalentCustomizedOptionBuilder>):TalentCustomizedOptionBuilder
	...
	export function emptyInterviewRegistrationSchemaBuilder():InterviewRegistrationSchemaBuilder
	export function emptyRefInterviewRegistrationSchemaBuilder():Ref<InterviewRegistrationSchemaBuilder>
	export function refOfInterviewRegistrationSchemaBuilder(x:InterviewRegistrationSchemaBuilder,v:Ref<InterviewRegistrationSchemaBuilder>)
	export function unRefInterviewRegistrationSchemaBuilder(v:Ref<InterviewRegistrationSchemaBuilder>):InterviewRegistrationSchemaBuilder
	...
	export function emptySubjectBuilder():SubjectBuilder
	export function emptyRefSubjectBuilder():Ref<SubjectBuilder>
	export function refOfSubjectBuilder(x:SubjectBuilder,v:Ref<SubjectBuilder>)
	export function unRefSubjectBuilder(v:Ref<SubjectBuilder>):SubjectBuilder
	...
	export function emptyJobRecruiter2Builder():JobRecruiter2Builder
	export function emptyRefJobRecruiter2Builder():Ref<JobRecruiter2Builder>
	export function refOfJobRecruiter2Builder(x:JobRecruiter2Builder,v:Ref<JobRecruiter2Builder>)
	export function unRefJobRecruiter2Builder(v:Ref<JobRecruiter2Builder>):JobRecruiter2Builder
	...
	export function emptyJobRequirementSchemaBuilder():JobRequirementSchemaBuilder
	export function emptyRefJobRequirementSchemaBuilder():Ref<JobRequirementSchemaBuilder>
	export function refOfJobRequirementSchemaBuilder(x:JobRequirementSchemaBuilder,v:Ref<JobRequirementSchemaBuilder>)
	export function unRefJobRequirementSchemaBuilder(v:Ref<JobRequirementSchemaBuilder>):JobRequirementSchemaBuilder
	export function emptyProjectInfoBuilder():ProjectInfoBuilder
	export function emptyRefProjectInfoBuilder():Ref<ProjectInfoBuilder>
	export function refOfProjectInfoBuilder(x:ProjectInfoBuilder,v:Ref<ProjectInfoBuilder>)
	export function unRefProjectInfoBuilder(v:Ref<ProjectInfoBuilder>):ProjectInfoBuilder
	export function emptyBackgroundCheckItemInfoBuilder():BackgroundCheckItemInfoBuilder
	export function emptyRefBackgroundCheckItemInfoBuilder():Ref<BackgroundCheckItemInfoBuilder>
	export function refOfBackgroundCheckItemInfoBuilder(x:BackgroundCheckItemInfoBuilder,v:Ref<BackgroundCheckItemInfoBuilder>)
	export function unRefBackgroundCheckItemInfoBuilder(v:Ref<BackgroundCheckItemInfoBuilder>):BackgroundCheckItemInfoBuilder
	export function emptyInterviewAssessmentDimensionArgsBuilder():InterviewAssessmentDimensionArgsBuilder
	export function emptyRefInterviewAssessmentDimensionArgsBuilder():Ref<InterviewAssessmentDimensionArgsBuilder>
	export function refOfInterviewAssessmentDimensionArgsBuilder(x:InterviewAssessmentDimensionArgsBuilder,v:Ref<InterviewAssessmentDimensionArgsBuilder>)
	export function unRefInterviewAssessmentDimensionArgsBuilder(v:Ref<InterviewAssessmentDimensionArgsBuilder>):InterviewAssessmentDimensionArgsBuilder
	...
	export function emptySiteJobRecruitmentTypeBuilder():SiteJobRecruitmentTypeBuilder
	export function emptyRefSiteJobRecruitmentTypeBuilder():Ref<SiteJobRecruitmentTypeBuilder>
	export function refOfSiteJobRecruitmentTypeBuilder(x:SiteJobRecruitmentTypeBuilder,v:Ref<SiteJobRecruitmentTypeBuilder>)
	export function unRefSiteJobRecruitmentTypeBuilder(v:Ref<SiteJobRecruitmentTypeBuilder>):SiteJobRecruitmentTypeBuilder
	...
	export function emptyInterviewExtendBuilder():InterviewExtendBuilder
	export function emptyRefInterviewExtendBuilder():Ref<InterviewExtendBuilder>
	export function refOfInterviewExtendBuilder(x:InterviewExtendBuilder,v:Ref<InterviewExtendBuilder>)
	export function unRefInterviewExtendBuilder(v:Ref<InterviewExtendBuilder>):InterviewExtendBuilder
	...
	export function emptyOfferApplyFormFormulaExtraMapInfoBuilder():OfferApplyFormFormulaExtraMapInfoBuilder
	export function emptyRefOfferApplyFormFormulaExtraMapInfoBuilder():Ref<OfferApplyFormFormulaExtraMapInfoBuilder>
	export function refOfOfferApplyFormFormulaExtraMapInfoBuilder(x:OfferApplyFormFormulaExtraMapInfoBuilder,v:Ref<OfferApplyFormFormulaExtraMapInfoBuilder>)
	export function unRefOfferApplyFormFormulaExtraMapInfoBuilder(v:Ref<OfferApplyFormFormulaExtraMapInfoBuilder>):OfferApplyFormFormulaExtraMapInfoBuilder
	export function emptySiteResumeCareerBuilder():SiteResumeCareerBuilder
	export function emptyRefSiteResumeCareerBuilder():Ref<SiteResumeCareerBuilder>
	export function refOfSiteResumeCareerBuilder(x:SiteResumeCareerBuilder,v:Ref<SiteResumeCareerBuilder>)
	export function unRefSiteResumeCareerBuilder(v:Ref<SiteResumeCareerBuilder>):SiteResumeCareerBuilder
	export function emptyTalentFolderBuilder():TalentFolderBuilder
	export function emptyRefTalentFolderBuilder():Ref<TalentFolderBuilder>
	export function refOfTalentFolderBuilder(x:TalentFolderBuilder,v:Ref<TalentFolderBuilder>)
	export function unRefTalentFolderBuilder(v:Ref<TalentFolderBuilder>):TalentFolderBuilder
	...
	export function emptyApplicationWebsiteChannelBuilder():ApplicationWebsiteChannelBuilder
	export function emptyRefApplicationWebsiteChannelBuilder():Ref<ApplicationWebsiteChannelBuilder>
	export function refOfApplicationWebsiteChannelBuilder(x:ApplicationWebsiteChannelBuilder,v:Ref<ApplicationWebsiteChannelBuilder>)
	export function unRefApplicationWebsiteChannelBuilder(v:Ref<ApplicationWebsiteChannelBuilder>):ApplicationWebsiteChannelBuilder
	...
	export function emptyJobCustomizedTimeRangeBuilder():JobCustomizedTimeRangeBuilder
	export function emptyRefJobCustomizedTimeRangeBuilder():Ref<JobCustomizedTimeRangeBuilder>
	export function refOfJobCustomizedTimeRangeBuilder(x:JobCustomizedTimeRangeBuilder,v:Ref<JobCustomizedTimeRangeBuilder>)
	export function unRefJobCustomizedTimeRangeBuilder(v:Ref<JobCustomizedTimeRangeBuilder>):JobCustomizedTimeRangeBuilder
	...
	export function emptyTalentCustomizedValueBuilder():TalentCustomizedValueBuilder
	export function emptyRefTalentCustomizedValueBuilder():Ref<TalentCustomizedValueBuilder>
	export function refOfTalentCustomizedValueBuilder(x:TalentCustomizedValueBuilder,v:Ref<TalentCustomizedValueBuilder>)
	export function unRefTalentCustomizedValueBuilder(v:Ref<TalentCustomizedValueBuilder>):TalentCustomizedValueBuilder
	...
	export function emptyWebsiteDeliveryWorksBuilder():WebsiteDeliveryWorksBuilder
	export function emptyRefWebsiteDeliveryWorksBuilder():Ref<WebsiteDeliveryWorksBuilder>
	export function refOfWebsiteDeliveryWorksBuilder(x:WebsiteDeliveryWorksBuilder,v:Ref<WebsiteDeliveryWorksBuilder>)
	export function unRefWebsiteDeliveryWorksBuilder(v:Ref<WebsiteDeliveryWorksBuilder>):WebsiteDeliveryWorksBuilder
	...
	export function emptyJobManagerBuilder():JobManagerBuilder
	export function emptyRefJobManagerBuilder():Ref<JobManagerBuilder>
	export function refOfJobManagerBuilder(x:JobManagerBuilder,v:Ref<JobManagerBuilder>)
	export function unRefJobManagerBuilder(v:Ref<JobManagerBuilder>):JobManagerBuilder
	...
	export function emptyEhrImportTaskBuilder():EhrImportTaskBuilder
	export function emptyRefEhrImportTaskBuilder():Ref<EhrImportTaskBuilder>
	export function refOfEhrImportTaskBuilder(x:EhrImportTaskBuilder,v:Ref<EhrImportTaskBuilder>)
	export function unRefEhrImportTaskBuilder(v:Ref<EhrImportTaskBuilder>):EhrImportTaskBuilder
	...
	export function emptyJobTypeBuilder():JobTypeBuilder
	export function emptyRefJobTypeBuilder():Ref<JobTypeBuilder>
	export function refOfJobTypeBuilder(x:JobTypeBuilder,v:Ref<JobTypeBuilder>)
	export function unRefJobTypeBuilder(v:Ref<JobTypeBuilder>):JobTypeBuilder
	export function emptyMasterLocationInfoBuilder():MasterLocationInfoBuilder
	export function emptyRefMasterLocationInfoBuilder():Ref<MasterLocationInfoBuilder>
	export function refOfMasterLocationInfoBuilder(x:MasterLocationInfoBuilder,v:Ref<MasterLocationInfoBuilder>)
	export function unRefMasterLocationInfoBuilder(v:Ref<MasterLocationInfoBuilder>):MasterLocationInfoBuilder
	...
	export function emptySiteJobPostBuilder():SiteJobPostBuilder
	export function emptyRefSiteJobPostBuilder():Ref<SiteJobPostBuilder>
	export function refOfSiteJobPostBuilder(x:SiteJobPostBuilder,v:Ref<SiteJobPostBuilder>)
	export function unRefSiteJobPostBuilder(v:Ref<SiteJobPostBuilder>):SiteJobPostBuilder
	...
	export function emptyOfferCustomFieldConfigBuilder():OfferCustomFieldConfigBuilder
	export function emptyRefOfferCustomFieldConfigBuilder():Ref<OfferCustomFieldConfigBuilder>
	export function refOfOfferCustomFieldConfigBuilder(x:OfferCustomFieldConfigBuilder,v:Ref<OfferCustomFieldConfigBuilder>)
	export function unRefOfferCustomFieldConfigBuilder(v:Ref<OfferCustomFieldConfigBuilder>):OfferCustomFieldConfigBuilder
	...
	export function emptyListJobTypeReqBuilder():ListJobTypeReqBuilder
	export function emptyRefListJobTypeReqBuilder():Ref<ListJobTypeReqBuilder>
	export function refOfListJobTypeReqBuilder(x:ListJobTypeReqBuilder,v:Ref<ListJobTypeReqBuilder>)
	export function unRefListJobTypeReqBuilder(v:Ref<ListJobTypeReqBuilder>):ListJobTypeReqBuilder
	...
	export function emptyTalentIdentificationInfoBuilder():TalentIdentificationInfoBuilder
	export function emptyRefTalentIdentificationInfoBuilder():Ref<TalentIdentificationInfoBuilder>
	export function refOfTalentIdentificationInfoBuilder(x:TalentIdentificationInfoBuilder,v:Ref<TalentIdentificationInfoBuilder>)
	export function unRefTalentIdentificationInfoBuilder(v:Ref<TalentIdentificationInfoBuilder>):TalentIdentificationInfoBuilder
	export function emptyCreateOfferReqBuilder():CreateOfferReqBuilder
	export function emptyRefCreateOfferReqBuilder():Ref<CreateOfferReqBuilder>
	export function refOfCreateOfferReqBuilder(x:CreateOfferReqBuilder,v:Ref<CreateOfferReqBuilder>)
	export function unRefCreateOfferReqBuilder(v:Ref<CreateOfferReqBuilder>):CreateOfferReqBuilder
	export function emptyOfferCustomizedInfoBuilder():OfferCustomizedInfoBuilder
	export function emptyRefOfferCustomizedInfoBuilder():Ref<OfferCustomizedInfoBuilder>
	export function refOfOfferCustomizedInfoBuilder(x:OfferCustomizedInfoBuilder,v:Ref<OfferCustomizedInfoBuilder>)
	export function unRefOfferCustomizedInfoBuilder(v:Ref<OfferCustomizedInfoBuilder>):OfferCustomizedInfoBuilder
	...
	export function emptyWebsiteDeliveryCustomizedDataParentBuilder():WebsiteDeliveryCustomizedDataParentBuilder
	export function emptyRefWebsiteDeliveryCustomizedDataParentBuilder():Ref<WebsiteDeliveryCustomizedDataParentBuilder>
	export function refOfWebsiteDeliveryCustomizedDataParentBuilder(x:WebsiteDeliveryCustomizedDataParentBuilder,v:Ref<WebsiteDeliveryCustomizedDataParentBuilder>)
	export function unRefWebsiteDeliveryCustomizedDataParentBuilder(v:Ref<WebsiteDeliveryCustomizedDataParentBuilder>):WebsiteDeliveryCustomizedDataParentBuilder
	export function emptyWithdrawReferralAccountReqBodyBuilder():WithdrawReferralAccountReqBodyBuilder
	export function emptyRefWithdrawReferralAccountReqBodyBuilder():Ref<WithdrawReferralAccountReqBodyBuilder>
	export function refOfWithdrawReferralAccountReqBodyBuilder(x:WithdrawReferralAccountReqBodyBuilder,v:Ref<WithdrawReferralAccountReqBodyBuilder>)
	export function unRefWithdrawReferralAccountReqBodyBuilder(v:Ref<WithdrawReferralAccountReqBodyBuilder>):WithdrawReferralAccountReqBodyBuilder
	...
	export function emptyTalentSchemaChildObjectBuilder():TalentSchemaChildObjectBuilder
	export function emptyRefTalentSchemaChildObjectBuilder():Ref<TalentSchemaChildObjectBuilder>
	export function refOfTalentSchemaChildObjectBuilder(x:TalentSchemaChildObjectBuilder,v:Ref<TalentSchemaChildObjectBuilder>)
	export function unRefTalentSchemaChildObjectBuilder(v:Ref<TalentSchemaChildObjectBuilder>):TalentSchemaChildObjectBuilder
	export function emptyTransferOnboardApplicationPathReqBodyBuilder():TransferOnboardApplicationPathReqBodyBuilder
	export function emptyRefTransferOnboardApplicationPathReqBodyBuilder():Ref<TransferOnboardApplicationPathReqBodyBuilder>
	export function refOfTransferOnboardApplicationPathReqBodyBuilder(x:TransferOnboardApplicationPathReqBodyBuilder,v:Ref<TransferOnboardApplicationPathReqBodyBuilder>)
	export function unRefTransferOnboardApplicationPathReqBodyBuilder(v:Ref<TransferOnboardApplicationPathReqBodyBuilder>):TransferOnboardApplicationPathReqBodyBuilder
	export function emptyBatchUpdateEcoAccountCustomFieldReqBuilder():BatchUpdateEcoAccountCustomFieldReqBuilder
	export function emptyRefBatchUpdateEcoAccountCustomFieldReqBuilder():Ref<BatchUpdateEcoAccountCustomFieldReqBuilder>
	export function refOfBatchUpdateEcoAccountCustomFieldReqBuilder(x:BatchUpdateEcoAccountCustomFieldReqBuilder,v:Ref<BatchUpdateEcoAccountCustomFieldReqBuilder>)
	export function unRefBatchUpdateEcoAccountCustomFieldReqBuilder(v:Ref<BatchUpdateEcoAccountCustomFieldReqBuilder>):BatchUpdateEcoAccountCustomFieldReqBuilder
	...
	export function emptyMobileBuilder():MobileBuilder
	export function emptyRefMobileBuilder():Ref<MobileBuilder>
	export function refOfMobileBuilder(x:MobileBuilder,v:Ref<MobileBuilder>)
	export function unRefMobileBuilder(v:Ref<MobileBuilder>):MobileBuilder
	export function emptyOfferCustomFieldBuilder():OfferCustomFieldBuilder
	export function emptyRefOfferCustomFieldBuilder():Ref<OfferCustomFieldBuilder>
	export function refOfOfferCustomFieldBuilder(x:OfferCustomFieldBuilder,v:Ref<OfferCustomFieldBuilder>)
	export function unRefOfferCustomFieldBuilder(v:Ref<OfferCustomFieldBuilder>):OfferCustomFieldBuilder
	...
	export function emptyApplicationPrehireOfferBuilder():ApplicationPrehireOfferBuilder
	export function emptyRefApplicationPrehireOfferBuilder():Ref<ApplicationPrehireOfferBuilder>
	export function refOfApplicationPrehireOfferBuilder(x:ApplicationPrehireOfferBuilder,v:Ref<ApplicationPrehireOfferBuilder>)
	export function unRefApplicationPrehireOfferBuilder(v:Ref<ApplicationPrehireOfferBuilder>):ApplicationPrehireOfferBuilder
	...
	export function emptyCancelEcoBackgroundCheckPathReqBodyBuilder():CancelEcoBackgroundCheckPathReqBodyBuilder
	export function emptyRefCancelEcoBackgroundCheckPathReqBodyBuilder():Ref<CancelEcoBackgroundCheckPathReqBodyBuilder>
	export function refOfCancelEcoBackgroundCheckPathReqBodyBuilder(x:CancelEcoBackgroundCheckPathReqBodyBuilder,v:Ref<CancelEcoBackgroundCheckPathReqBodyBuilder>)
	export function unRefCancelEcoBackgroundCheckPathReqBodyBuilder(v:Ref<CancelEcoBackgroundCheckPathReqBodyBuilder>):CancelEcoBackgroundCheckPathReqBodyBuilder
	export function emptyInterviewAddressBuilder():InterviewAddressBuilder
	export function emptyRefInterviewAddressBuilder():Ref<InterviewAddressBuilder>
	export function refOfInterviewAddressBuilder(x:InterviewAddressBuilder,v:Ref<InterviewAddressBuilder>)
	export function unRefInterviewAddressBuilder(v:Ref<InterviewAddressBuilder>):InterviewAddressBuilder
	...
	export function emptyCancelEcoBackgroundCheckReqBuilder():CancelEcoBackgroundCheckReqBuilder
	export function emptyRefCancelEcoBackgroundCheckReqBuilder():Ref<CancelEcoBackgroundCheckReqBuilder>
	export function refOfCancelEcoBackgroundCheckReqBuilder(x:CancelEcoBackgroundCheckReqBuilder,v:Ref<CancelEcoBackgroundCheckReqBuilder>)
	export function unRefCancelEcoBackgroundCheckReqBuilder(v:Ref<CancelEcoBackgroundCheckReqBuilder>):CancelEcoBackgroundCheckReqBuilder
	export function emptyCombinedCreateJobReqBuilder():CombinedCreateJobReqBuilder
	export function emptyRefCombinedCreateJobReqBuilder():Ref<CombinedCreateJobReqBuilder>
	export function refOfCombinedCreateJobReqBuilder(x:CombinedCreateJobReqBuilder,v:Ref<CombinedCreateJobReqBuilder>)
	export function unRefCombinedCreateJobReqBuilder(v:Ref<CombinedCreateJobReqBuilder>):CombinedCreateJobReqBuilder
	export function emptyMasterLocationAddressInfoBuilder():MasterLocationAddressInfoBuilder
	export function emptyRefMasterLocationAddressInfoBuilder():Ref<MasterLocationAddressInfoBuilder>
	export function refOfMasterLocationAddressInfoBuilder(x:MasterLocationAddressInfoBuilder,v:Ref<MasterLocationAddressInfoBuilder>)
	export function unRefMasterLocationAddressInfoBuilder(v:Ref<MasterLocationAddressInfoBuilder>):MasterLocationAddressInfoBuilder
	export function emptyBatchUpdateEcoBackgroundCheckPackageReqBuilder():BatchUpdateEcoBackgroundCheckPackageReqBuilder
	export function emptyRefBatchUpdateEcoBackgroundCheckPackageReqBuilder():Ref<BatchUpdateEcoBackgroundCheckPackageReqBuilder>
	export function refOfBatchUpdateEcoBackgroundCheckPackageReqBuilder(x:BatchUpdateEcoBackgroundCheckPackageReqBuilder,v:Ref<BatchUpdateEcoBackgroundCheckPackageReqBuilder>)
	export function unRefBatchUpdateEcoBackgroundCheckPackageReqBuilder(v:Ref<BatchUpdateEcoBackgroundCheckPackageReqBuilder>):BatchUpdateEcoBackgroundCheckPackageReqBuilder
	...
	export function emptyBatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder():BatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder
	export function emptyRefBatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder():Ref<BatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder>
	export function refOfBatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder(x:BatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder,v:Ref<BatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder>)
	export function unRefBatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder(v:Ref<BatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder>):BatchDeleteEcoBackgroundCheckCustomFieldPathReqBodyBuilder
	...
	export function emptyOfferApplyFormObjectInfoBuilder():OfferApplyFormObjectInfoBuilder
	export function emptyRefOfferApplyFormObjectInfoBuilder():Ref<OfferApplyFormObjectInfoBuilder>
	export function refOfOfferApplyFormObjectInfoBuilder(x:OfferApplyFormObjectInfoBuilder,v:Ref<OfferApplyFormObjectInfoBuilder>)
	export function unRefOfferApplyFormObjectInfoBuilder(v:Ref<OfferApplyFormObjectInfoBuilder>):OfferApplyFormObjectInfoBuilder
	...
	export function emptyBatchDeleteEcoExamPaperPathReqBodyBuilder():BatchDeleteEcoExamPaperPathReqBodyBuilder
	export function emptyRefBatchDeleteEcoExamPaperPathReqBodyBuilder():Ref<BatchDeleteEcoExamPaperPathReqBodyBuilder>
	export function refOfBatchDeleteEcoExamPaperPathReqBodyBuilder(x:BatchDeleteEcoExamPaperPathReqBodyBuilder,v:Ref<BatchDeleteEcoExamPaperPathReqBodyBuilder>)
	export function unRefBatchDeleteEcoExamPaperPathReqBodyBuilder(v:Ref<BatchDeleteEcoExamPaperPathReqBodyBuilder>):BatchDeleteEcoExamPaperPathReqBodyBuilder
	export function emptyChangeEmployeeStageBuilder():ChangeEmployeeStageBuilder
	export function emptyRefChangeEmployeeStageBuilder():Ref<ChangeEmployeeStageBuilder>
	export function refOfChangeEmployeeStageBuilder(x:ChangeEmployeeStageBuilder,v:Ref<ChangeEmployeeStageBuilder>)
	export function unRefChangeEmployeeStageBuilder(v:Ref<ChangeEmployeeStageBuilder>):ChangeEmployeeStageBuilder
	export function emptyResumeSourceBuilder():ResumeSourceBuilder
	export function emptyRefResumeSourceBuilder():Ref<ResumeSourceBuilder>
	export function refOfResumeSourceBuilder(x:ResumeSourceBuilder,v:Ref<ResumeSourceBuilder>)
	export function unRefResumeSourceBuilder(v:Ref<ResumeSourceBuilder>):ResumeSourceBuilder
	export function emptyUserRoleBuilder():UserRoleBuilder
	export function emptyRefUserRoleBuilder():Ref<UserRoleBuilder>
	export function refOfUserRoleBuilder(x:UserRoleBuilder,v:Ref<UserRoleBuilder>)
	export function unRefUserRoleBuilder(v:Ref<UserRoleBuilder>):UserRoleBuilder
	export function emptyReferralInfoBuilder():ReferralInfoBuilder
	export function emptyRefReferralInfoBuilder():Ref<ReferralInfoBuilder>
	export function refOfReferralInfoBuilder(x:ReferralInfoBuilder,v:Ref<ReferralInfoBuilder>)
	export function unRefReferralInfoBuilder(v:Ref<ReferralInfoBuilder>):ReferralInfoBuilder
	export function emptyJobDepartmentBuilder():JobDepartmentBuilder
	export function emptyRefJobDepartmentBuilder():Ref<JobDepartmentBuilder>
	export function refOfJobDepartmentBuilder(x:JobDepartmentBuilder,v:Ref<JobDepartmentBuilder>)
	export function unRefJobDepartmentBuilder(v:Ref<JobDepartmentBuilder>):JobDepartmentBuilder
	...
	export function emptyWebsiteDeliveryCareerBuilder():WebsiteDeliveryCareerBuilder
	export function emptyRefWebsiteDeliveryCareerBuilder():Ref<WebsiteDeliveryCareerBuilder>
	export function refOfWebsiteDeliveryCareerBuilder(x:WebsiteDeliveryCareerBuilder,v:Ref<WebsiteDeliveryCareerBuilder>)
	export function unRefWebsiteDeliveryCareerBuilder(v:Ref<WebsiteDeliveryCareerBuilder>):WebsiteDeliveryCareerBuilder
	export function emptyWebsiteDeliveryProjectBuilder():WebsiteDeliveryProjectBuilder
	export function emptyRefWebsiteDeliveryProjectBuilder():Ref<WebsiteDeliveryProjectBuilder>
	export function refOfWebsiteDeliveryProjectBuilder(x:WebsiteDeliveryProjectBuilder,v:Ref<WebsiteDeliveryProjectBuilder>)
	export function unRefWebsiteDeliveryProjectBuilder(v:Ref<WebsiteDeliveryProjectBuilder>):WebsiteDeliveryProjectBuilder
	export function emptyUpdateResultEcoBackgroundCheckReqBuilder():UpdateResultEcoBackgroundCheckReqBuilder
	export function emptyRefUpdateResultEcoBackgroundCheckReqBuilder():Ref<UpdateResultEcoBackgroundCheckReqBuilder>
	export function refOfUpdateResultEcoBackgroundCheckReqBuilder(x:UpdateResultEcoBackgroundCheckReqBuilder,v:Ref<UpdateResultEcoBackgroundCheckReqBuilder>)
	export function unRefUpdateResultEcoBackgroundCheckReqBuilder(v:Ref<UpdateResultEcoBackgroundCheckReqBuilder>):UpdateResultEcoBackgroundCheckReqBuilder
	...
	export function emptyTalentCombinedLanguageInfoBuilder():TalentCombinedLanguageInfoBuilder
	export function emptyRefTalentCombinedLanguageInfoBuilder():Ref<TalentCombinedLanguageInfoBuilder>
	export function refOfTalentCombinedLanguageInfoBuilder(x:TalentCombinedLanguageInfoBuilder,v:Ref<TalentCombinedLanguageInfoBuilder>)
	export function unRefTalentCombinedLanguageInfoBuilder(v:Ref<TalentCombinedLanguageInfoBuilder>):TalentCombinedLanguageInfoBuilder
	...
	export function emptySalaryBuilder():SalaryBuilder
	export function emptyRefSalaryBuilder():Ref<SalaryBuilder>
	export function refOfSalaryBuilder(x:SalaryBuilder,v:Ref<SalaryBuilder>)
	export function unRefSalaryBuilder(v:Ref<SalaryBuilder>):SalaryBuilder
	...
	export function emptyCreateApplicationPathReqBodyBuilder():CreateApplicationPathReqBodyBuilder
	export function emptyRefCreateApplicationPathReqBodyBuilder():Ref<CreateApplicationPathReqBodyBuilder>
	export function refOfCreateApplicationPathReqBodyBuilder(x:CreateApplicationPathReqBodyBuilder,v:Ref<CreateApplicationPathReqBodyBuilder>)
	export function unRefCreateApplicationPathReqBodyBuilder(v:Ref<CreateApplicationPathReqBodyBuilder>):CreateApplicationPathReqBodyBuilder
	export function emptyJobConfigInterviewRoundBuilder():JobConfigInterviewRoundBuilder
	export function emptyRefJobConfigInterviewRoundBuilder():Ref<JobConfigInterviewRoundBuilder>
	export function refOfJobConfigInterviewRoundBuilder(x:JobConfigInterviewRoundBuilder,v:Ref<JobConfigInterviewRoundBuilder>)
	export function unRefJobConfigInterviewRoundBuilder(v:Ref<JobConfigInterviewRoundBuilder>):JobConfigInterviewRoundBuilder
	export function emptySiteApplicationBuilder():SiteApplicationBuilder
	export function emptyRefSiteApplicationBuilder():Ref<SiteApplicationBuilder>
	export function refOfSiteApplicationBuilder(x:SiteApplicationBuilder,v:Ref<SiteApplicationBuilder>)
	export function unRefSiteApplicationBuilder(v:Ref<SiteApplicationBuilder>):SiteApplicationBuilder
	export function emptyCommonSchemaSettingBuilder():CommonSchemaSettingBuilder
	export function emptyRefCommonSchemaSettingBuilder():Ref<CommonSchemaSettingBuilder>
	export function refOfCommonSchemaSettingBuilder(x:CommonSchemaSettingBuilder,v:Ref<CommonSchemaSettingBuilder>)
	export function unRefCommonSchemaSettingBuilder(v:Ref<CommonSchemaSettingBuilder>):CommonSchemaSettingBuilder
	export function emptyExamMarkingTaskBuilder():ExamMarkingTaskBuilder
	export function emptyRefExamMarkingTaskBuilder():Ref<ExamMarkingTaskBuilder>
	export function refOfExamMarkingTaskBuilder(x:ExamMarkingTaskBuilder,v:Ref<ExamMarkingTaskBuilder>)
	export function unRefExamMarkingTaskBuilder(v:Ref<ExamMarkingTaskBuilder>):ExamMarkingTaskBuilder
	...
	export function emptyAppliOfferBasicCustObjBuilder():AppliOfferBasicCustObjBuilder
	export function emptyRefAppliOfferBasicCustObjBuilder():Ref<AppliOfferBasicCustObjBuilder>
	export function refOfAppliOfferBasicCustObjBuilder(x:AppliOfferBasicCustObjBuilder,v:Ref<AppliOfferBasicCustObjBuilder>)
	export function unRefAppliOfferBasicCustObjBuilder(v:Ref<AppliOfferBasicCustObjBuilder>):AppliOfferBasicCustObjBuilder
	...
	export function emptyOfferApplicationReqBuilder():OfferApplicationReqBuilder
	export function emptyRefOfferApplicationReqBuilder():Ref<OfferApplicationReqBuilder>
	export function refOfOfferApplicationReqBuilder(x:OfferApplicationReqBuilder,v:Ref<OfferApplicationReqBuilder>)
	export function unRefOfferApplicationReqBuilder(v:Ref<OfferApplicationReqBuilder>):OfferApplicationReqBuilder
	export function emptyTalentCombinedBasicInfoBuilder():TalentCombinedBasicInfoBuilder
	export function emptyRefTalentCombinedBasicInfoBuilder():Ref<TalentCombinedBasicInfoBuilder>
	export function refOfTalentCombinedBasicInfoBuilder(x:TalentCombinedBasicInfoBuilder,v:Ref<TalentCombinedBasicInfoBuilder>)
	export function unRefTalentCombinedBasicInfoBuilder(v:Ref<TalentCombinedBasicInfoBuilder>):TalentCombinedBasicInfoBuilder
	...
	export function emptySiteResumeWorkBuilder():SiteResumeWorkBuilder
	export function emptyRefSiteResumeWorkBuilder():Ref<SiteResumeWorkBuilder>
	export function refOfSiteResumeWorkBuilder(x:SiteResumeWorkBuilder,v:Ref<SiteResumeWorkBuilder>)
	export function unRefSiteResumeWorkBuilder(v:Ref<SiteResumeWorkBuilder>):SiteResumeWorkBuilder
	export function emptyApplicationTalentWorksInfoBuilder():ApplicationTalentWorksInfoBuilder
	export function emptyRefApplicationTalentWorksInfoBuilder():Ref<ApplicationTalentWorksInfoBuilder>
	export function refOfApplicationTalentWorksInfoBuilder(x:ApplicationTalentWorksInfoBuilder,v:Ref<ApplicationTalentWorksInfoBuilder>)
	export function unRefApplicationTalentWorksInfoBuilder(v:Ref<ApplicationTalentWorksInfoBuilder>):ApplicationTalentWorksInfoBuilder
	export function emptyCancelEcoBackgroundCheckReqBodyBuilder():CancelEcoBackgroundCheckReqBodyBuilder
	export function emptyRefCancelEcoBackgroundCheckReqBodyBuilder():Ref<CancelEcoBackgroundCheckReqBodyBuilder>
	export function refOfCancelEcoBackgroundCheckReqBodyBuilder(x:CancelEcoBackgroundCheckReqBodyBuilder,v:Ref<CancelEcoBackgroundCheckReqBodyBuilder>)
	export function unRefCancelEcoBackgroundCheckReqBodyBuilder(v:Ref<CancelEcoBackgroundCheckReqBodyBuilder>):CancelEcoBackgroundCheckReqBodyBuilder
	...
	export function emptyJobConfigRoundTypeBuilder():JobConfigRoundTypeBuilder
	export function emptyRefJobConfigRoundTypeBuilder():Ref<JobConfigRoundTypeBuilder>
	export function refOfJobConfigRoundTypeBuilder(x:JobConfigRoundTypeBuilder,v:Ref<JobConfigRoundTypeBuilder>)
	export function unRefJobConfigRoundTypeBuilder(v:Ref<JobConfigRoundTypeBuilder>):JobConfigRoundTypeBuilder
	...
	export function emptyListByIdJobRequirementPathReqBodyBuilder():ListByIdJobRequirementPathReqBodyBuilder
	export function emptyRefListByIdJobRequirementPathReqBodyBuilder():Ref<ListByIdJobRequirementPathReqBodyBuilder>
	export function refOfListByIdJobRequirementPathReqBodyBuilder(x:ListByIdJobRequirementPathReqBodyBuilder,v:Ref<ListByIdJobRequirementPathReqBodyBuilder>)
	export function unRefListByIdJobRequirementPathReqBodyBuilder(v:Ref<ListByIdJobRequirementPathReqBodyBuilder>):ListByIdJobRequirementPathReqBodyBuilder
	...
	export function emptyLoginInfoEcoExamReqBuilder():LoginInfoEcoExamReqBuilder
	export function emptyRefLoginInfoEcoExamReqBuilder():Ref<LoginInfoEcoExamReqBuilder>
	export function refOfLoginInfoEcoExamReqBuilder(x:LoginInfoEcoExamReqBuilder,v:Ref<LoginInfoEcoExamReqBuilder>)
	export function unRefLoginInfoEcoExamReqBuilder(v:Ref<LoginInfoEcoExamReqBuilder>):LoginInfoEcoExamReqBuilder
	export function emptySiteResumeLanguageSkillBuilder():SiteResumeLanguageSkillBuilder
	export function emptyRefSiteResumeLanguageSkillBuilder():Ref<SiteResumeLanguageSkillBuilder>
	export function refOfSiteResumeLanguageSkillBuilder(x:SiteResumeLanguageSkillBuilder,v:Ref<SiteResumeLanguageSkillBuilder>)
	export function unRefSiteResumeLanguageSkillBuilder(v:Ref<SiteResumeLanguageSkillBuilder>):SiteResumeLanguageSkillBuilder
	export function emptyTalentCombinedWorkInfoBuilder():TalentCombinedWorkInfoBuilder
	export function emptyRefTalentCombinedWorkInfoBuilder():Ref<TalentCombinedWorkInfoBuilder>
	export function refOfTalentCombinedWorkInfoBuilder(x:TalentCombinedWorkInfoBuilder,v:Ref<TalentCombinedWorkInfoBuilder>)
	export function unRefTalentCombinedWorkInfoBuilder(v:Ref<TalentCombinedWorkInfoBuilder>):TalentCombinedWorkInfoBuilder
	...
	export function emptyEmployeeOverboardInfoBuilder():EmployeeOverboardInfoBuilder
	export function emptyRefEmployeeOverboardInfoBuilder():Ref<EmployeeOverboardInfoBuilder>
	export function refOfEmployeeOverboardInfoBuilder(x:EmployeeOverboardInfoBuilder,v:Ref<EmployeeOverboardInfoBuilder>)
	export function unRefEmployeeOverboardInfoBuilder(v:Ref<EmployeeOverboardInfoBuilder>):EmployeeOverboardInfoBuilder
	export function emptyInterviewRecordBuilder():InterviewRecordBuilder
	export function emptyRefInterviewRecordBuilder():Ref<InterviewRecordBuilder>
	export function refOfInterviewRecordBuilder(x:InterviewRecordBuilder,v:Ref<InterviewRecordBuilder>)
	export function unRefInterviewRecordBuilder(v:Ref<InterviewRecordBuilder>):InterviewRecordBuilder
	...
	export function emptyOfferJobInfoBuilder():OfferJobInfoBuilder
	export function emptyRefOfferJobInfoBuilder():Ref<OfferJobInfoBuilder>
	export function refOfOfferJobInfoBuilder(x:OfferJobInfoBuilder,v:Ref<OfferJobInfoBuilder>)
	export function unRefOfferJobInfoBuilder(v:Ref<OfferJobInfoBuilder>):OfferJobInfoBuilder
	export function emptyTalentAwardInfoBuilder():TalentAwardInfoBuilder
	export function emptyRefTalentAwardInfoBuilder():Ref<TalentAwardInfoBuilder>
	export function refOfTalentAwardInfoBuilder(x:TalentAwardInfoBuilder,v:Ref<TalentAwardInfoBuilder>)
	export function unRefTalentAwardInfoBuilder(v:Ref<TalentAwardInfoBuilder>):TalentAwardInfoBuilder
	export function emptyApplicationOfferSalaryPlanSalaryTemplateBuilder():ApplicationOfferSalaryPlanSalaryTemplateBuilder
	export function emptyRefApplicationOfferSalaryPlanSalaryTemplateBuilder():Ref<ApplicationOfferSalaryPlanSalaryTemplateBuilder>
	export function refOfApplicationOfferSalaryPlanSalaryTemplateBuilder(x:ApplicationOfferSalaryPlanSalaryTemplateBuilder,v:Ref<ApplicationOfferSalaryPlanSalaryTemplateBuilder>)
	export function unRefApplicationOfferSalaryPlanSalaryTemplateBuilder(v:Ref<ApplicationOfferSalaryPlanSalaryTemplateBuilder>):ApplicationOfferSalaryPlanSalaryTemplateBuilder
	...
	export function emptyInterviewAssessmentDimensionBuilder():InterviewAssessmentDimensionBuilder
	export function emptyRefInterviewAssessmentDimensionBuilder():Ref<InterviewAssessmentDimensionBuilder>
	export function refOfInterviewAssessmentDimensionBuilder(x:InterviewAssessmentDimensionBuilder,v:Ref<InterviewAssessmentDimensionBuilder>)
	export function unRefInterviewAssessmentDimensionBuilder(v:Ref<InterviewAssessmentDimensionBuilder>):InterviewAssessmentDimensionBuilder
	export function emptyOfferSchemaChildBuilder():OfferSchemaChildBuilder
	export function emptyRefOfferSchemaChildBuilder():Ref<OfferSchemaChildBuilder>
	export function refOfOfferSchemaChildBuilder(x:OfferSchemaChildBuilder,v:Ref<OfferSchemaChildBuilder>)
	export function unRefOfferSchemaChildBuilder(v:Ref<OfferSchemaChildBuilder>):OfferSchemaChildBuilder
	export function emptyRegistrationSchemaBuilder():RegistrationSchemaBuilder
	export function emptyRefRegistrationSchemaBuilder():Ref<RegistrationSchemaBuilder>
	export function refOfRegistrationSchemaBuilder(x:RegistrationSchemaBuilder,v:Ref<RegistrationSchemaBuilder>)
	export function unRefRegistrationSchemaBuilder(v:Ref<RegistrationSchemaBuilder>):RegistrationSchemaBuilder
	export function emptyUserBusinessManagementScopeBuilder():UserBusinessManagementScopeBuilder
	export function emptyRefUserBusinessManagementScopeBuilder():Ref<UserBusinessManagementScopeBuilder>
	export function refOfUserBusinessManagementScopeBuilder(x:UserBusinessManagementScopeBuilder,v:Ref<UserBusinessManagementScopeBuilder>)
	export function unRefUserBusinessManagementScopeBuilder(v:Ref<UserBusinessManagementScopeBuilder>):UserBusinessManagementScopeBuilder
	...
	export function emptyAppliTalentCertificateInfoBuilder():AppliTalentCertificateInfoBuilder
	export function emptyRefAppliTalentCertificateInfoBuilder():Ref<AppliTalentCertificateInfoBuilder>
	export function refOfAppliTalentCertificateInfoBuilder(x:AppliTalentCertificateInfoBuilder,v:Ref<AppliTalentCertificateInfoBuilder>)
	export function unRefAppliTalentCertificateInfoBuilder(v:Ref<AppliTalentCertificateInfoBuilder>):AppliTalentCertificateInfoBuilder
	export function emptyApplicationPrehireOptionalBuilder():ApplicationPrehireOptionalBuilder
	export function emptyRefApplicationPrehireOptionalBuilder():Ref<ApplicationPrehireOptionalBuilder>
	export function refOfApplicationPrehireOptionalBuilder(x:ApplicationPrehireOptionalBuilder,v:Ref<ApplicationPrehireOptionalBuilder>)
	export function unRefApplicationPrehireOptionalBuilder(v:Ref<ApplicationPrehireOptionalBuilder>):ApplicationPrehireOptionalBuilder
	export function emptyBusinessManagementScopeBuilder():BusinessManagementScopeBuilder
	export function emptyRefBusinessManagementScopeBuilder():Ref<BusinessManagementScopeBuilder>
	export function refOfBusinessManagementScopeBuilder(x:BusinessManagementScopeBuilder,v:Ref<BusinessManagementScopeBuilder>)
	export function unRefBusinessManagementScopeBuilder(v:Ref<BusinessManagementScopeBuilder>):BusinessManagementScopeBuilder
	...
	export function emptyEcoBackgroundCheckCreateEventCandidateInfoBuilder():EcoBackgroundCheckCreateEventCandidateInfoBuilder
	export function emptyRefEcoBackgroundCheckCreateEventCandidateInfoBuilder():Ref<EcoBackgroundCheckCreateEventCandidateInfoBuilder>
	export function refOfEcoBackgroundCheckCreateEventCandidateInfoBuilder(x:EcoBackgroundCheckCreateEventCandidateInfoBuilder,v:Ref<EcoBackgroundCheckCreateEventCandidateInfoBuilder>)
	export function unRefEcoBackgroundCheckCreateEventCandidateInfoBuilder(v:Ref<EcoBackgroundCheckCreateEventCandidateInfoBuilder>):EcoBackgroundCheckCreateEventCandidateInfoBuilder
	export function emptyInterviewAssessmentTemplateArgsBuilder():InterviewAssessmentTemplateArgsBuilder
	export function emptyRefInterviewAssessmentTemplateArgsBuilder():Ref<InterviewAssessmentTemplateArgsBuilder>
	export function refOfInterviewAssessmentTemplateArgsBuilder(x:InterviewAssessmentTemplateArgsBuilder,v:Ref<InterviewAssessmentTemplateArgsBuilder>)
	export function unRefInterviewAssessmentTemplateArgsBuilder(v:Ref<InterviewAssessmentTemplateArgsBuilder>):InterviewAssessmentTemplateArgsBuilder
	...
	export function emptyOfferStatusOfferPathReqBodyBuilder():OfferStatusOfferPathReqBodyBuilder
	export function emptyRefOfferStatusOfferPathReqBodyBuilder():Ref<OfferStatusOfferPathReqBodyBuilder>
	export function refOfOfferStatusOfferPathReqBodyBuilder(x:OfferStatusOfferPathReqBodyBuilder,v:Ref<OfferStatusOfferPathReqBodyBuilder>)
	export function unRefOfferStatusOfferPathReqBodyBuilder(v:Ref<OfferStatusOfferPathReqBodyBuilder>):OfferStatusOfferPathReqBodyBuilder
	export function emptyP2ApplicationStageChangedV1Handler():P2ApplicationStageChangedV1Handler
	export function emptyRefP2ApplicationStageChangedV1Handler():Ref<P2ApplicationStageChangedV1Handler>
	export function refOfP2ApplicationStageChangedV1Handler(x:P2ApplicationStageChangedV1Handler,v:Ref<P2ApplicationStageChangedV1Handler>)
	export function unRefP2ApplicationStageChangedV1Handler(v:Ref<P2ApplicationStageChangedV1Handler>):P2ApplicationStageChangedV1Handler
	export function emptySiteApplicationResumeBuilder():SiteApplicationResumeBuilder
	export function emptyRefSiteApplicationResumeBuilder():Ref<SiteApplicationResumeBuilder>
	export function refOfSiteApplicationResumeBuilder(x:SiteApplicationResumeBuilder,v:Ref<SiteApplicationResumeBuilder>)
	export function unRefSiteApplicationResumeBuilder(v:Ref<SiteApplicationResumeBuilder>):SiteApplicationResumeBuilder
	export function emptyWebsiteDeliveryCertificateBuilder():WebsiteDeliveryCertificateBuilder
	export function emptyRefWebsiteDeliveryCertificateBuilder():Ref<WebsiteDeliveryCertificateBuilder>
	export function refOfWebsiteDeliveryCertificateBuilder(x:WebsiteDeliveryCertificateBuilder,v:Ref<WebsiteDeliveryCertificateBuilder>)
	export function unRefWebsiteDeliveryCertificateBuilder(v:Ref<WebsiteDeliveryCertificateBuilder>):WebsiteDeliveryCertificateBuilder
	export function emptyCreateExternalInterviewReqBuilder():CreateExternalInterviewReqBuilder
	export function emptyRefCreateExternalInterviewReqBuilder():Ref<CreateExternalInterviewReqBuilder>
	export function refOfCreateExternalInterviewReqBuilder(x:CreateExternalInterviewReqBuilder,v:Ref<CreateExternalInterviewReqBuilder>)
	export function unRefCreateExternalInterviewReqBuilder(v:Ref<CreateExternalInterviewReqBuilder>):CreateExternalInterviewReqBuilder
	export function emptyInterviewTaskBuilder():InterviewTaskBuilder
	export function emptyRefInterviewTaskBuilder():Ref<InterviewTaskBuilder>
	export function refOfInterviewTaskBuilder(x:InterviewTaskBuilder,v:Ref<InterviewTaskBuilder>)
	export function unRefInterviewTaskBuilder(v:Ref<InterviewTaskBuilder>):InterviewTaskBuilder
	export function emptyListEvaluationReqBuilder():ListEvaluationReqBuilder
	export function emptyRefListEvaluationReqBuilder():Ref<ListEvaluationReqBuilder>
	export function refOfListEvaluationReqBuilder(x:ListEvaluationReqBuilder,v:Ref<ListEvaluationReqBuilder>)
	export function unRefListEvaluationReqBuilder(v:Ref<ListEvaluationReqBuilder>):ListEvaluationReqBuilder
	export function emptyRegistrationBasicInfoBuilder():RegistrationBasicInfoBuilder
	export function emptyRefRegistrationBasicInfoBuilder():Ref<RegistrationBasicInfoBuilder>
	export function refOfRegistrationBasicInfoBuilder(x:RegistrationBasicInfoBuilder,v:Ref<RegistrationBasicInfoBuilder>)
	export function unRefRegistrationBasicInfoBuilder(v:Ref<RegistrationBasicInfoBuilder>):RegistrationBasicInfoBuilder
	export function emptyUpdateJobRequirementReqBuilder():UpdateJobRequirementReqBuilder
	export function emptyRefUpdateJobRequirementReqBuilder():Ref<UpdateJobRequirementReqBuilder>
	export function refOfUpdateJobRequirementReqBuilder(x:UpdateJobRequirementReqBuilder,v:Ref<UpdateJobRequirementReqBuilder>)
	export function unRefUpdateJobRequirementReqBuilder(v:Ref<UpdateJobRequirementReqBuilder>):UpdateJobRequirementReqBuilder
	...
	export function emptyCreateJobRequirementReqBuilder():CreateJobRequirementReqBuilder
	export function emptyRefCreateJobRequirementReqBuilder():Ref<CreateJobRequirementReqBuilder>
	export function refOfCreateJobRequirementReqBuilder(x:CreateJobRequirementReqBuilder,v:Ref<CreateJobRequirementReqBuilder>)
	export function unRefCreateJobRequirementReqBuilder(v:Ref<CreateJobRequirementReqBuilder>):CreateJobRequirementReqBuilder
	...
	export function emptyApplicationStageTimeBuilder():ApplicationStageTimeBuilder
	export function emptyRefApplicationStageTimeBuilder():Ref<ApplicationStageTimeBuilder>
	export function refOfApplicationStageTimeBuilder(x:ApplicationStageTimeBuilder,v:Ref<ApplicationStageTimeBuilder>)
	export function unRefApplicationStageTimeBuilder(v:Ref<ApplicationStageTimeBuilder>):ApplicationStageTimeBuilder
	...
	export function emptyOfferStatusOfferReqBodyBuilder():OfferStatusOfferReqBodyBuilder
	export function emptyRefOfferStatusOfferReqBodyBuilder():Ref<OfferStatusOfferReqBodyBuilder>
	export function refOfOfferStatusOfferReqBodyBuilder(x:OfferStatusOfferReqBodyBuilder,v:Ref<OfferStatusOfferReqBodyBuilder>)
	export function unRefOfferStatusOfferReqBodyBuilder(v:Ref<OfferStatusOfferReqBodyBuilder>):OfferStatusOfferReqBodyBuilder
	...
	export function emptyJobRequirementCustomizedOptionBuilder():JobRequirementCustomizedOptionBuilder
	export function emptyRefJobRequirementCustomizedOptionBuilder():Ref<JobRequirementCustomizedOptionBuilder>
	export function refOfJobRequirementCustomizedOptionBuilder(x:JobRequirementCustomizedOptionBuilder,v:Ref<JobRequirementCustomizedOptionBuilder>)
	export function unRefJobRequirementCustomizedOptionBuilder(v:Ref<JobRequirementCustomizedOptionBuilder>):JobRequirementCustomizedOptionBuilder
	...
	export function emptyTalentCustomizedAttachmentBuilder():TalentCustomizedAttachmentBuilder
	export function emptyRefTalentCustomizedAttachmentBuilder():Ref<TalentCustomizedAttachmentBuilder>
	export function refOfTalentCustomizedAttachmentBuilder(x:TalentCustomizedAttachmentBuilder,v:Ref<TalentCustomizedAttachmentBuilder>)
	export function unRefTalentCustomizedAttachmentBuilder(v:Ref<TalentCustomizedAttachmentBuilder>):TalentCustomizedAttachmentBuilder
	...
	export function emptyListJobProcessReqBuilder():ListJobProcessReqBuilder
	export function emptyRefListJobProcessReqBuilder():Ref<ListJobProcessReqBuilder>
	export function refOfListJobProcessReqBuilder(x:ListJobProcessReqBuilder,v:Ref<ListJobProcessReqBuilder>)
	export function unRefListJobProcessReqBuilder(v:Ref<ListJobProcessReqBuilder>):ListJobProcessReqBuilder
	...
	export function emptyCommonSchemaBuilder():CommonSchemaBuilder
	export function emptyRefCommonSchemaBuilder():Ref<CommonSchemaBuilder>
	export function refOfCommonSchemaBuilder(x:CommonSchemaBuilder,v:Ref<CommonSchemaBuilder>)
	export function unRefCommonSchemaBuilder(v:Ref<CommonSchemaBuilder>):CommonSchemaBuilder
	export function emptyCommonSchemaChildBuilder():CommonSchemaChildBuilder
	export function emptyRefCommonSchemaChildBuilder():Ref<CommonSchemaChildBuilder>
	export function refOfCommonSchemaChildBuilder(x:CommonSchemaChildBuilder,v:Ref<CommonSchemaChildBuilder>)
	export function unRefCommonSchemaChildBuilder(v:Ref<CommonSchemaChildBuilder>):CommonSchemaChildBuilder
	...
	export function emptyPermissionGroupInfoBuilder():PermissionGroupInfoBuilder
	export function emptyRefPermissionGroupInfoBuilder():Ref<PermissionGroupInfoBuilder>
	export function refOfPermissionGroupInfoBuilder(x:PermissionGroupInfoBuilder,v:Ref<PermissionGroupInfoBuilder>)
	export function unRefPermissionGroupInfoBuilder(v:Ref<PermissionGroupInfoBuilder>):PermissionGroupInfoBuilder
	...
	export function emptyCodeNameObjectBuilder():CodeNameObjectBuilder
	export function emptyRefCodeNameObjectBuilder():Ref<CodeNameObjectBuilder>
	export function refOfCodeNameObjectBuilder(x:CodeNameObjectBuilder,v:Ref<CodeNameObjectBuilder>)
	export function unRefCodeNameObjectBuilder(v:Ref<CodeNameObjectBuilder>):CodeNameObjectBuilder
	export function emptyCreateEcoBackgroundCheckPackageReqBuilder():CreateEcoBackgroundCheckPackageReqBuilder
	export function emptyRefCreateEcoBackgroundCheckPackageReqBuilder():Ref<CreateEcoBackgroundCheckPackageReqBuilder>
	export function refOfCreateEcoBackgroundCheckPackageReqBuilder(x:CreateEcoBackgroundCheckPackageReqBuilder,v:Ref<CreateEcoBackgroundCheckPackageReqBuilder>)
	export function unRefCreateEcoBackgroundCheckPackageReqBuilder(v:Ref<CreateEcoBackgroundCheckPackageReqBuilder>):CreateEcoBackgroundCheckPackageReqBuilder
	...
	export function emptyTerminateApplicationReqBuilder():TerminateApplicationReqBuilder
	export function emptyRefTerminateApplicationReqBuilder():Ref<TerminateApplicationReqBuilder>
	export function refOfTerminateApplicationReqBuilder(x:TerminateApplicationReqBuilder,v:Ref<TerminateApplicationReqBuilder>)
	export function unRefTerminateApplicationReqBuilder(v:Ref<TerminateApplicationReqBuilder>):TerminateApplicationReqBuilder
	...
	export function emptyTodoBuilder():TodoBuilder
	export function emptyRefTodoBuilder():Ref<TodoBuilder>
	export function refOfTodoBuilder(x:TodoBuilder,v:Ref<TodoBuilder>)
	export function unRefTodoBuilder(v:Ref<TodoBuilder>):TodoBuilder
	export function emptyGetTalentReqBuilder():GetTalentReqBuilder
	export function emptyRefGetTalentReqBuilder():Ref<GetTalentReqBuilder>
	export function refOfGetTalentReqBuilder(x:GetTalentReqBuilder,v:Ref<GetTalentReqBuilder>)
	export function unRefGetTalentReqBuilder(v:Ref<GetTalentReqBuilder>):GetTalentReqBuilder
	export function emptyInterviewBuilder():InterviewBuilder
	export function emptyRefInterviewBuilder():Ref<InterviewBuilder>
	export function refOfInterviewBuilder(x:InterviewBuilder,v:Ref<InterviewBuilder>)
	export function unRefInterviewBuilder(v:Ref<InterviewBuilder>):InterviewBuilder
	...
	export function emptyBatchUpdateEcoBackgroundCheckCustomFieldReqBuilder():BatchUpdateEcoBackgroundCheckCustomFieldReqBuilder
	export function emptyRefBatchUpdateEcoBackgroundCheckCustomFieldReqBuilder():Ref<BatchUpdateEcoBackgroundCheckCustomFieldReqBuilder>
	export function refOfBatchUpdateEcoBackgroundCheckCustomFieldReqBuilder(x:BatchUpdateEcoBackgroundCheckCustomFieldReqBuilder,v:Ref<BatchUpdateEcoBackgroundCheckCustomFieldReqBuilder>)
	export function unRefBatchUpdateEcoBackgroundCheckCustomFieldReqBuilder(v:Ref<BatchUpdateEcoBackgroundCheckCustomFieldReqBuilder>):BatchUpdateEcoBackgroundCheckCustomFieldReqBuilder
	...
	export function emptyListInterviewReqBuilder():ListInterviewReqBuilder
	export function emptyRefListInterviewReqBuilder():Ref<ListInterviewReqBuilder>
	export function refOfListInterviewReqBuilder(x:ListInterviewReqBuilder,v:Ref<ListInterviewReqBuilder>)
	export function unRefListInterviewReqBuilder(v:Ref<ListInterviewReqBuilder>):ListInterviewReqBuilder
	export function emptyPortalJobPostBuilder():PortalJobPostBuilder
	export function emptyRefPortalJobPostBuilder():Ref<PortalJobPostBuilder>
	export function refOfPortalJobPostBuilder(x:PortalJobPostBuilder,v:Ref<PortalJobPostBuilder>)
	export function unRefPortalJobPostBuilder(v:Ref<PortalJobPostBuilder>):PortalJobPostBuilder
	...
	export function emptyOfferSchemaBuilder():OfferSchemaBuilder
	export function emptyRefOfferSchemaBuilder():Ref<OfferSchemaBuilder>
	export function refOfOfferSchemaBuilder(x:OfferSchemaBuilder,v:Ref<OfferSchemaBuilder>)
	export function unRefOfferSchemaBuilder(v:Ref<OfferSchemaBuilder>):OfferSchemaBuilder
	...
	export function emptyAccountBuilder():AccountBuilder
	export function emptyRefAccountBuilder():Ref<AccountBuilder>
	export function refOfAccountBuilder(x:AccountBuilder,v:Ref<AccountBuilder>)
	export function unRefAccountBuilder(v:Ref<AccountBuilder>):AccountBuilder
	export function emptyApplicationOfferOnboardProfileBuilder():ApplicationOfferOnboardProfileBuilder
	export function emptyRefApplicationOfferOnboardProfileBuilder():Ref<ApplicationOfferOnboardProfileBuilder>
	export function refOfApplicationOfferOnboardProfileBuilder(x:ApplicationOfferOnboardProfileBuilder,v:Ref<ApplicationOfferOnboardProfileBuilder>)
	export function unRefApplicationOfferOnboardProfileBuilder(v:Ref<ApplicationOfferOnboardProfileBuilder>):ApplicationOfferOnboardProfileBuilder
	export function emptyEvaluationBuilder():EvaluationBuilder
	export function emptyRefEvaluationBuilder():Ref<EvaluationBuilder>
	export function refOfEvaluationBuilder(x:EvaluationBuilder,v:Ref<EvaluationBuilder>)
	export function unRefEvaluationBuilder(v:Ref<EvaluationBuilder>):EvaluationBuilder
	...
	export function emptyWebsiteUserBuilder():WebsiteUserBuilder
	export function emptyRefWebsiteUserBuilder():Ref<WebsiteUserBuilder>
	export function refOfWebsiteUserBuilder(x:WebsiteUserBuilder,v:Ref<WebsiteUserBuilder>)
	export function unRefWebsiteUserBuilder(v:Ref<WebsiteUserBuilder>):WebsiteUserBuilder
	...
	export function emptyEcoBackgroundCheckCustomFieldBuilder():EcoBackgroundCheckCustomFieldBuilder
	export function emptyRefEcoBackgroundCheckCustomFieldBuilder():Ref<EcoBackgroundCheckCustomFieldBuilder>
	export function refOfEcoBackgroundCheckCustomFieldBuilder(x:EcoBackgroundCheckCustomFieldBuilder,v:Ref<EcoBackgroundCheckCustomFieldBuilder>)
	export function unRefEcoBackgroundCheckCustomFieldBuilder(v:Ref<EcoBackgroundCheckCustomFieldBuilder>):EcoBackgroundCheckCustomFieldBuilder
	export function emptyExternalInterviewAssessmentBuilder():ExternalInterviewAssessmentBuilder
	export function emptyRefExternalInterviewAssessmentBuilder():Ref<ExternalInterviewAssessmentBuilder>
	export function refOfExternalInterviewAssessmentBuilder(x:ExternalInterviewAssessmentBuilder,v:Ref<ExternalInterviewAssessmentBuilder>)
	export function unRefExternalInterviewAssessmentBuilder(v:Ref<ExternalInterviewAssessmentBuilder>):ExternalInterviewAssessmentBuilder
	export function emptyGetByApplicationEmployeeReqBuilder():GetByApplicationEmployeeReqBuilder
	export function emptyRefGetByApplicationEmployeeReqBuilder():Ref<GetByApplicationEmployeeReqBuilder>
	export function refOfGetByApplicationEmployeeReqBuilder(x:GetByApplicationEmployeeReqBuilder,v:Ref<GetByApplicationEmployeeReqBuilder>)
	export function unRefGetByApplicationEmployeeReqBuilder(v:Ref<GetByApplicationEmployeeReqBuilder>):GetByApplicationEmployeeReqBuilder
	...
	export function emptyOfferBuilder():OfferBuilder
	export function emptyRefOfferBuilder():Ref<OfferBuilder>
	export function refOfOfferBuilder(x:OfferBuilder,v:Ref<OfferBuilder>)
	export function unRefOfferBuilder(v:Ref<OfferBuilder>):OfferBuilder
	...
	export function emptyTalentFolderForListBuilder():TalentFolderForListBuilder
	export function emptyRefTalentFolderForListBuilder():Ref<TalentFolderForListBuilder>
	export function refOfTalentFolderForListBuilder(x:TalentFolderForListBuilder,v:Ref<TalentFolderForListBuilder>)
	export function unRefTalentFolderForListBuilder(v:Ref<TalentFolderForListBuilder>):TalentFolderForListBuilder
}