...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/lingo/v1'{
	...
	export function emptyDocLinkBuilder():DocLinkBuilder
	export function emptyRefDocLinkBuilder():Ref<DocLinkBuilder>
	export function refOfDocLinkBuilder(x:DocLinkBuilder,v:Ref<DocLinkBuilder>)
	export function unRefDocLinkBuilder(v:Ref<DocLinkBuilder>):DocLinkBuilder
	...
	export function emptyDocHeadingBuilder():DocHeadingBuilder
	export function emptyRefDocHeadingBuilder():Ref<DocHeadingBuilder>
	export function refOfDocHeadingBuilder(x:DocHeadingBuilder,v:Ref<DocHeadingBuilder>)
	export function unRefDocHeadingBuilder(v:Ref<DocHeadingBuilder>):DocHeadingBuilder
	...
	export function emptyDocBulletBuilder():DocBulletBuilder
	export function emptyRefDocBulletBuilder():Ref<DocBulletBuilder>
	export function refOfDocBulletBuilder(x:DocBulletBuilder,v:Ref<DocBulletBuilder>)
	export function unRefDocBulletBuilder(v:Ref<DocBulletBuilder>):DocBulletBuilder
	...
	export function emptyDeleteEntityReqBuilder():DeleteEntityReqBuilder
	export function emptyRefDeleteEntityReqBuilder():Ref<DeleteEntityReqBuilder>
	export function refOfDeleteEntityReqBuilder(x:DeleteEntityReqBuilder,v:Ref<DeleteEntityReqBuilder>)
	export function unRefDeleteEntityReqBuilder(v:Ref<DeleteEntityReqBuilder>):DeleteEntityReqBuilder
	...
	export function emptyDocDataBuilder():DocDataBuilder
	export function emptyRefDocDataBuilder():Ref<DocDataBuilder>
	export function refOfDocDataBuilder(x:DocDataBuilder,v:Ref<DocDataBuilder>)
	export function unRefDocDataBuilder(v:Ref<DocDataBuilder>):DocDataBuilder
	export function emptyI18nEntryDescBuilder():I18nEntryDescBuilder
	export function emptyRefI18nEntryDescBuilder():Ref<I18nEntryDescBuilder>
	export function refOfI18nEntryDescBuilder(x:I18nEntryDescBuilder,v:Ref<I18nEntryDescBuilder>)
	export function unRefI18nEntryDescBuilder(v:Ref<I18nEntryDescBuilder>):I18nEntryDescBuilder
	...
	export function emptyAigcConfigBuilder():AigcConfigBuilder
	export function emptyRefAigcConfigBuilder():Ref<AigcConfigBuilder>
	export function refOfAigcConfigBuilder(x:AigcConfigBuilder,v:Ref<AigcConfigBuilder>)
	export function unRefAigcConfigBuilder(v:Ref<AigcConfigBuilder>):AigcConfigBuilder
	...
	export function emptyDocTextBuilder():DocTextBuilder
	export function emptyRefDocTextBuilder():Ref<DocTextBuilder>
	export function refOfDocTextBuilder(x:DocTextBuilder,v:Ref<DocTextBuilder>)
	export function unRefDocTextBuilder(v:Ref<DocTextBuilder>):DocTextBuilder
	...
	export function emptyDocRoderedBuilder():DocRoderedBuilder
	export function emptyRefDocRoderedBuilder():Ref<DocRoderedBuilder>
	export function refOfDocRoderedBuilder(x:DocRoderedBuilder,v:Ref<DocRoderedBuilder>)
	export function unRefDocRoderedBuilder(v:Ref<DocRoderedBuilder>):DocRoderedBuilder
	...
	export function emptyRepoBuilder():RepoBuilder
	export function emptyRefRepoBuilder():Ref<RepoBuilder>
	export function refOfRepoBuilder(x:RepoBuilder,v:Ref<RepoBuilder>)
	export function unRefRepoBuilder(v:Ref<RepoBuilder>):RepoBuilder
	...
	export function emptyDocContentBuilder():DocContentBuilder
	export function emptyRefDocContentBuilder():Ref<DocContentBuilder>
	export function refOfDocContentBuilder(x:DocContentBuilder,v:Ref<DocContentBuilder>)
	export function unRefDocContentBuilder(v:Ref<DocContentBuilder>):DocContentBuilder
	...
	export function emptyDocCodeBuilder():DocCodeBuilder
	export function emptyRefDocCodeBuilder():Ref<DocCodeBuilder>
	export function refOfDocCodeBuilder(x:DocCodeBuilder,v:Ref<DocCodeBuilder>)
	export function unRefDocCodeBuilder(v:Ref<DocCodeBuilder>):DocCodeBuilder
	export function emptyDocUserBuilder():DocUserBuilder
	export function emptyRefDocUserBuilder():Ref<DocUserBuilder>
	export function refOfDocUserBuilder(x:DocUserBuilder,v:Ref<DocUserBuilder>)
	export function unRefDocUserBuilder(v:Ref<DocUserBuilder>):DocUserBuilder
	...
	export function emptyDocImageBuilder():DocImageBuilder
	export function emptyRefDocImageBuilder():Ref<DocImageBuilder>
	export function refOfDocImageBuilder(x:DocImageBuilder,v:Ref<DocImageBuilder>)
	export function unRefDocImageBuilder(v:Ref<DocImageBuilder>):DocImageBuilder
	...
	export function emptyEntityCardDataBuilder():EntityCardDataBuilder
	export function emptyRefEntityCardDataBuilder():Ref<EntityCardDataBuilder>
	export function refOfEntityCardDataBuilder(x:EntityCardDataBuilder,v:Ref<EntityCardDataBuilder>)
	export function unRefEntityCardDataBuilder(v:Ref<EntityCardDataBuilder>):EntityCardDataBuilder
	export function emptyI18nClsNameBuilder():I18nClsNameBuilder
	export function emptyRefI18nClsNameBuilder():Ref<I18nClsNameBuilder>
	export function refOfI18nClsNameBuilder(x:I18nClsNameBuilder,v:Ref<I18nClsNameBuilder>)
	export function unRefI18nClsNameBuilder(v:Ref<I18nClsNameBuilder>):I18nClsNameBuilder
