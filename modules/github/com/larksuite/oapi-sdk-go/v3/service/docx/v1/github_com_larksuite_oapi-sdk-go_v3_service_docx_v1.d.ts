...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/docx/v1'{
	...
	// @ts-ignore
	import type {bool,float64,Ref,Struct,Alias,Nothing,int,error} from 'go'
	...
	export function emptyBatchUpdateDocumentBlockReqBuilder():BatchUpdateDocumentBlockReqBuilder
	export function emptyRefBatchUpdateDocumentBlockReqBuilder():Ref<BatchUpdateDocumentBlockReqBuilder>
	export function refOfBatchUpdateDocumentBlockReqBuilder(x:BatchUpdateDocumentBlockReqBuilder,v:Ref<BatchUpdateDocumentBlockReqBuilder>)
	export function unRefBatchUpdateDocumentBlockReqBuilder(v:Ref<BatchUpdateDocumentBlockReqBuilder>):BatchUpdateDocumentBlockReqBuilder
	export function emptyCalloutBuilder():CalloutBuilder
	export function emptyRefCalloutBuilder():Ref<CalloutBuilder>
	export function refOfCalloutBuilder(x:CalloutBuilder,v:Ref<CalloutBuilder>)
	export function unRefCalloutBuilder(v:Ref<CalloutBuilder>):CalloutBuilder
	export function emptyCreateDocumentBlockChildrenReqBuilder():CreateDocumentBlockChildrenReqBuilder
	export function emptyRefCreateDocumentBlockChildrenReqBuilder():Ref<CreateDocumentBlockChildrenReqBuilder>
	export function refOfCreateDocumentBlockChildrenReqBuilder(x:CreateDocumentBlockChildrenReqBuilder,v:Ref<CreateDocumentBlockChildrenReqBuilder>)
	export function unRefCreateDocumentBlockChildrenReqBuilder(v:Ref<CreateDocumentBlockChildrenReqBuilder>):CreateDocumentBlockChildrenReqBuilder
	...
	export function emptyGetDocumentBlockReqBuilder():GetDocumentBlockReqBuilder
	export function emptyRefGetDocumentBlockReqBuilder():Ref<GetDocumentBlockReqBuilder>
	export function refOfGetDocumentBlockReqBuilder(x:GetDocumentBlockReqBuilder,v:Ref<GetDocumentBlockReqBuilder>)
	export function unRefGetDocumentBlockReqBuilder(v:Ref<GetDocumentBlockReqBuilder>):GetDocumentBlockReqBuilder
	...
	export function emptyUpdateTablePropertyRequestBuilder():UpdateTablePropertyRequestBuilder
	export function emptyRefUpdateTablePropertyRequestBuilder():Ref<UpdateTablePropertyRequestBuilder>
	export function refOfUpdateTablePropertyRequestBuilder(x:UpdateTablePropertyRequestBuilder,v:Ref<UpdateTablePropertyRequestBuilder>)
	export function unRefUpdateTablePropertyRequestBuilder(v:Ref<UpdateTablePropertyRequestBuilder>):UpdateTablePropertyRequestBuilder
	...
	export function emptyUpdateCoverRequestBuilder():UpdateCoverRequestBuilder
	export function emptyRefUpdateCoverRequestBuilder():Ref<UpdateCoverRequestBuilder>
	export function refOfUpdateCoverRequestBuilder(x:UpdateCoverRequestBuilder,v:Ref<UpdateCoverRequestBuilder>)
	export function unRefUpdateCoverRequestBuilder(v:Ref<UpdateCoverRequestBuilder>):UpdateCoverRequestBuilder
	export function emptyCreateDocumentBlockChildrenPathReqBodyBuilder():CreateDocumentBlockChildrenPathReqBodyBuilder
	export function emptyRefCreateDocumentBlockChildrenPathReqBodyBuilder():Ref<CreateDocumentBlockChildrenPathReqBodyBuilder>
	export function refOfCreateDocumentBlockChildrenPathReqBodyBuilder(x:CreateDocumentBlockChildrenPathReqBodyBuilder,v:Ref<CreateDocumentBlockChildrenPathReqBodyBuilder>)
	export function unRefCreateDocumentBlockChildrenPathReqBodyBuilder(v:Ref<CreateDocumentBlockChildrenPathReqBodyBuilder>):CreateDocumentBlockChildrenPathReqBodyBuilder
	...
	export function emptyGridColumnBuilder():GridColumnBuilder
	export function emptyRefGridColumnBuilder():Ref<GridColumnBuilder>
	export function refOfGridColumnBuilder(x:GridColumnBuilder,v:Ref<GridColumnBuilder>)
	export function unRefGridColumnBuilder(v:Ref<GridColumnBuilder>):GridColumnBuilder
	export function emptyLinkPreviewBuilder():LinkPreviewBuilder
	export function emptyRefLinkPreviewBuilder():Ref<LinkPreviewBuilder>
	export function refOfLinkPreviewBuilder(x:LinkPreviewBuilder,v:Ref<LinkPreviewBuilder>)
	export function unRefLinkPreviewBuilder(v:Ref<LinkPreviewBuilder>):LinkPreviewBuilder
	...
	export function emptyBatchUpdateDocumentBlockReqBodyBuilder():BatchUpdateDocumentBlockReqBodyBuilder
	export function emptyRefBatchUpdateDocumentBlockReqBodyBuilder():Ref<BatchUpdateDocumentBlockReqBodyBuilder>
	export function refOfBatchUpdateDocumentBlockReqBodyBuilder(x:BatchUpdateDocumentBlockReqBodyBuilder,v:Ref<BatchUpdateDocumentBlockReqBodyBuilder>)
	export function unRefBatchUpdateDocumentBlockReqBodyBuilder(v:Ref<BatchUpdateDocumentBlockReqBodyBuilder>):BatchUpdateDocumentBlockReqBodyBuilder
	export function emptyCreateDocumentReqBodyBuilder():CreateDocumentReqBodyBuilder
	export function emptyRefCreateDocumentReqBodyBuilder():Ref<CreateDocumentReqBodyBuilder>
	export function refOfCreateDocumentReqBodyBuilder(x:CreateDocumentReqBodyBuilder,v:Ref<CreateDocumentReqBodyBuilder>)
	export function unRefCreateDocumentReqBodyBuilder(v:Ref<CreateDocumentReqBodyBuilder>):CreateDocumentReqBodyBuilder
	...
	export function emptyReplaceImageRequestBuilder():ReplaceImageRequestBuilder
	export function emptyRefReplaceImageRequestBuilder():Ref<ReplaceImageRequestBuilder>
	export function refOfReplaceImageRequestBuilder(x:ReplaceImageRequestBuilder,v:Ref<ReplaceImageRequestBuilder>)
	export function unRefReplaceImageRequestBuilder(v:Ref<ReplaceImageRequestBuilder>):ReplaceImageRequestBuilder
	...
	export function emptyUpdateTextElementsRequestBuilder():UpdateTextElementsRequestBuilder
	export function emptyRefUpdateTextElementsRequestBuilder():Ref<UpdateTextElementsRequestBuilder>
	export function refOfUpdateTextElementsRequestBuilder(x:UpdateTextElementsRequestBuilder,v:Ref<UpdateTextElementsRequestBuilder>)
	export function unRefUpdateTextElementsRequestBuilder(v:Ref<UpdateTextElementsRequestBuilder>):UpdateTextElementsRequestBuilder
	...
	export function emptyUpdateTextStyleRequestBuilder():UpdateTextStyleRequestBuilder
	export function emptyRefUpdateTextStyleRequestBuilder():Ref<UpdateTextStyleRequestBuilder>
	export function refOfUpdateTextStyleRequestBuilder(x:UpdateTextStyleRequestBuilder,v:Ref<UpdateTextStyleRequestBuilder>)
	export function unRefUpdateTextStyleRequestBuilder(v:Ref<UpdateTextStyleRequestBuilder>):UpdateTextStyleRequestBuilder
	...
	export function emptyUnmergeTableCellsRequestBuilder():UnmergeTableCellsRequestBuilder
	export function emptyRefUnmergeTableCellsRequestBuilder():Ref<UnmergeTableCellsRequestBuilder>
	export function refOfUnmergeTableCellsRequestBuilder(x:UnmergeTableCellsRequestBuilder,v:Ref<UnmergeTableCellsRequestBuilder>)
	export function unRefUnmergeTableCellsRequestBuilder(v:Ref<UnmergeTableCellsRequestBuilder>):UnmergeTableCellsRequestBuilder
	...
	export function emptyAgendaTitleElementBuilder():AgendaTitleElementBuilder
	export function emptyRefAgendaTitleElementBuilder():Ref<AgendaTitleElementBuilder>
	export function refOfAgendaTitleElementBuilder(x:AgendaTitleElementBuilder,v:Ref<AgendaTitleElementBuilder>)
	export function unRefAgendaTitleElementBuilder(v:Ref<AgendaTitleElementBuilder>):AgendaTitleElementBuilder
	export function emptyBatchDeleteDocumentBlockChildrenPathReqBodyBuilder():BatchDeleteDocumentBlockChildrenPathReqBodyBuilder
	export function emptyRefBatchDeleteDocumentBlockChildrenPathReqBodyBuilder():Ref<BatchDeleteDocumentBlockChildrenPathReqBodyBuilder>
	export function refOfBatchDeleteDocumentBlockChildrenPathReqBodyBuilder(x:BatchDeleteDocumentBlockChildrenPathReqBodyBuilder,v:Ref<BatchDeleteDocumentBlockChildrenPathReqBodyBuilder>)
	export function unRefBatchDeleteDocumentBlockChildrenPathReqBodyBuilder(v:Ref<BatchDeleteDocumentBlockChildrenPathReqBodyBuilder>):BatchDeleteDocumentBlockChildrenPathReqBodyBuilder
	...
	export function emptyInsertTableRowRequestBuilder():InsertTableRowRequestBuilder
	export function emptyRefInsertTableRowRequestBuilder():Ref<InsertTableRowRequestBuilder>
	export function refOfInsertTableRowRequestBuilder(x:InsertTableRowRequestBuilder,v:Ref<InsertTableRowRequestBuilder>)
	export function unRefInsertTableRowRequestBuilder(v:Ref<InsertTableRowRequestBuilder>):InsertTableRowRequestBuilder
	export function emptyTextElementStyleBuilder():TextElementStyleBuilder
	export function emptyRefTextElementStyleBuilder():Ref<TextElementStyleBuilder>
	export function refOfTextElementStyleBuilder(x:TextElementStyleBuilder,v:Ref<TextElementStyleBuilder>)
	export function unRefTextElementStyleBuilder(v:Ref<TextElementStyleBuilder>):TextElementStyleBuilder
	...
	export function emptyDeleteTableRowsRequestBuilder():DeleteTableRowsRequestBuilder
	export function emptyRefDeleteTableRowsRequestBuilder():Ref<DeleteTableRowsRequestBuilder>
	export function refOfDeleteTableRowsRequestBuilder(x:DeleteTableRowsRequestBuilder,v:Ref<DeleteTableRowsRequestBuilder>)
	export function unRefDeleteTableRowsRequestBuilder(v:Ref<DeleteTableRowsRequestBuilder>):DeleteTableRowsRequestBuilder
	...
	export function emptyGetDocumentReqBuilder():GetDocumentReqBuilder
	export function emptyRefGetDocumentReqBuilder():Ref<GetDocumentReqBuilder>
	export function refOfGetDocumentReqBuilder(x:GetDocumentReqBuilder,v:Ref<GetDocumentReqBuilder>)
	export function unRefGetDocumentReqBuilder(v:Ref<GetDocumentReqBuilder>):GetDocumentReqBuilder
	...
	export function emptyMindnoteBuilder():MindnoteBuilder
	export function emptyRefMindnoteBuilder():Ref<MindnoteBuilder>
	export function refOfMindnoteBuilder(x:MindnoteBuilder,v:Ref<MindnoteBuilder>)
	export function unRefMindnoteBuilder(v:Ref<MindnoteBuilder>):MindnoteBuilder
	...
	export function emptyDocumentCoverBuilder():DocumentCoverBuilder
	export function emptyRefDocumentCoverBuilder():Ref<DocumentCoverBuilder>
	export function refOfDocumentCoverBuilder(x:DocumentCoverBuilder,v:Ref<DocumentCoverBuilder>)
	export function unRefDocumentCoverBuilder(v:Ref<DocumentCoverBuilder>):DocumentCoverBuilder
	export function emptyGetDocumentBlockChildrenReqBuilder():GetDocumentBlockChildrenReqBuilder
	export function emptyRefGetDocumentBlockChildrenReqBuilder():Ref<GetDocumentBlockChildrenReqBuilder>
	export function refOfGetDocumentBlockChildrenReqBuilder(x:GetDocumentBlockChildrenReqBuilder,v:Ref<GetDocumentBlockChildrenReqBuilder>)
	export function unRefGetDocumentBlockChildrenReqBuilder(v:Ref<GetDocumentBlockChildrenReqBuilder>):GetDocumentBlockChildrenReqBuilder
	...
	export function emptyJiraIssueBuilder():JiraIssueBuilder
	export function emptyRefJiraIssueBuilder():Ref<JiraIssueBuilder>
	export function refOfJiraIssueBuilder(x:JiraIssueBuilder,v:Ref<JiraIssueBuilder>)
	export function unRefJiraIssueBuilder(v:Ref<JiraIssueBuilder>):JiraIssueBuilder
	...
	export function emptyOkrProgressRateBuilder():OkrProgressRateBuilder
	export function emptyRefOkrProgressRateBuilder():Ref<OkrProgressRateBuilder>
	export function refOfOkrProgressRateBuilder(x:OkrProgressRateBuilder,v:Ref<OkrProgressRateBuilder>)
	export function unRefOkrProgressRateBuilder(v:Ref<OkrProgressRateBuilder>):OkrProgressRateBuilder
	...
	export function emptyUpdateGridColumnWidthRatioRequestBuilder():UpdateGridColumnWidthRatioRequestBuilder
	export function emptyRefUpdateGridColumnWidthRatioRequestBuilder():Ref<UpdateGridColumnWidthRatioRequestBuilder>
	export function refOfUpdateGridColumnWidthRatioRequestBuilder(x:UpdateGridColumnWidthRatioRequestBuilder,v:Ref<UpdateGridColumnWidthRatioRequestBuilder>)
	export function unRefUpdateGridColumnWidthRatioRequestBuilder(v:Ref<UpdateGridColumnWidthRatioRequestBuilder>):UpdateGridColumnWidthRatioRequestBuilder
	export function emptyViewBuilder():ViewBuilder
	export function emptyRefViewBuilder():Ref<ViewBuilder>
	export function refOfViewBuilder(x:ViewBuilder,v:Ref<ViewBuilder>)
	export function unRefViewBuilder(v:Ref<ViewBuilder>):ViewBuilder
	...
	export function emptyUpdateTaskRequestBuilder():UpdateTaskRequestBuilder
	export function emptyRefUpdateTaskRequestBuilder():Ref<UpdateTaskRequestBuilder>
	export function refOfUpdateTaskRequestBuilder(x:UpdateTaskRequestBuilder,v:Ref<UpdateTaskRequestBuilder>)
	export function unRefUpdateTaskRequestBuilder(v:Ref<UpdateTaskRequestBuilder>):UpdateTaskRequestBuilder
	...
	export function emptyDeleteTableColumnsRequestBuilder():DeleteTableColumnsRequestBuilder
	export function emptyRefDeleteTableColumnsRequestBuilder():Ref<DeleteTableColumnsRequestBuilder>
	export function refOfDeleteTableColumnsRequestBuilder(x:DeleteTableColumnsRequestBuilder,v:Ref<DeleteTableColumnsRequestBuilder>)
	export function unRefDeleteTableColumnsRequestBuilder(v:Ref<DeleteTableColumnsRequestBuilder>):DeleteTableColumnsRequestBuilder
	...
	export function emptyReplaceFileRequestBuilder():ReplaceFileRequestBuilder
	export function emptyRefReplaceFileRequestBuilder():Ref<ReplaceFileRequestBuilder>
	export function refOfReplaceFileRequestBuilder(x:ReplaceFileRequestBuilder,v:Ref<ReplaceFileRequestBuilder>)
	export function unRefReplaceFileRequestBuilder(v:Ref<ReplaceFileRequestBuilder>):ReplaceFileRequestBuilder
	export function emptyBoardBuilder():BoardBuilder
	export function emptyRefBoardBuilder():Ref<BoardBuilder>
	export function refOfBoardBuilder(x:BoardBuilder,v:Ref<BoardBuilder>)
	export function unRefBoardBuilder(v:Ref<BoardBuilder>):BoardBuilder
	...
	export function emptyCreateDocumentPathReqBodyBuilder():CreateDocumentPathReqBodyBuilder
	export function emptyRefCreateDocumentPathReqBodyBuilder():Ref<CreateDocumentPathReqBodyBuilder>
	export function refOfCreateDocumentPathReqBodyBuilder(x:CreateDocumentPathReqBodyBuilder,v:Ref<CreateDocumentPathReqBodyBuilder>)
	export function unRefCreateDocumentPathReqBodyBuilder(v:Ref<CreateDocumentPathReqBodyBuilder>):CreateDocumentPathReqBodyBuilder
	...
	export function emptyIframeComponentBuilder():IframeComponentBuilder
	export function emptyRefIframeComponentBuilder():Ref<IframeComponentBuilder>
	export function refOfIframeComponentBuilder(x:IframeComponentBuilder,v:Ref<IframeComponentBuilder>)
	export function unRefIframeComponentBuilder(v:Ref<IframeComponentBuilder>):IframeComponentBuilder
	...
	export function emptyWikiCatalogBuilder():WikiCatalogBuilder
	export function emptyRefWikiCatalogBuilder():Ref<WikiCatalogBuilder>
	export function refOfWikiCatalogBuilder(x:WikiCatalogBuilder,v:Ref<WikiCatalogBuilder>)
	export function unRefWikiCatalogBuilder(v:Ref<WikiCatalogBuilder>):WikiCatalogBuilder
	export function emptyBitableBuilder():BitableBuilder
	export function emptyRefBitableBuilder():Ref<BitableBuilder>
	export function refOfBitableBuilder(x:BitableBuilder,v:Ref<BitableBuilder>)
	export function unRefBitableBuilder(v:Ref<BitableBuilder>):BitableBuilder
	export function emptyBlockIdRelationBuilder():BlockIdRelationBuilder
	export function emptyRefBlockIdRelationBuilder():Ref<BlockIdRelationBuilder>
	export function refOfBlockIdRelationBuilder(x:BlockIdRelationBuilder,v:Ref<BlockIdRelationBuilder>)
	export function unRefBlockIdRelationBuilder(v:Ref<BlockIdRelationBuilder>):BlockIdRelationBuilder
	export function emptyChatCardBuilder():ChatCardBuilder
	export function emptyRefChatCardBuilder():Ref<ChatCardBuilder>
	export function refOfChatCardBuilder(x:ChatCardBuilder,v:Ref<ChatCardBuilder>)
	export function unRefChatCardBuilder(v:Ref<ChatCardBuilder>):ChatCardBuilder
	export function emptyCreateDocumentBlockChildrenReqBodyBuilder():CreateDocumentBlockChildrenReqBodyBuilder
	export function emptyRefCreateDocumentBlockChildrenReqBodyBuilder():Ref<CreateDocumentBlockChildrenReqBodyBuilder>
	export function refOfCreateDocumentBlockChildrenReqBodyBuilder(x:CreateDocumentBlockChildrenReqBodyBuilder,v:Ref<CreateDocumentBlockChildrenReqBodyBuilder>)
	export function unRefCreateDocumentBlockChildrenReqBodyBuilder(v:Ref<CreateDocumentBlockChildrenReqBodyBuilder>):CreateDocumentBlockChildrenReqBodyBuilder
	...
	export function emptyTableMergeInfoBuilder():TableMergeInfoBuilder
	export function emptyRefTableMergeInfoBuilder():Ref<TableMergeInfoBuilder>
	export function refOfTableMergeInfoBuilder(x:TableMergeInfoBuilder,v:Ref<TableMergeInfoBuilder>)
	export function unRefTableMergeInfoBuilder(v:Ref<TableMergeInfoBuilder>):TableMergeInfoBuilder
	export function emptyTablePropertyBuilder():TablePropertyBuilder
	export function emptyRefTablePropertyBuilder():Ref<TablePropertyBuilder>
	export function refOfTablePropertyBuilder(x:TablePropertyBuilder,v:Ref<TablePropertyBuilder>)
	export function unRefTablePropertyBuilder(v:Ref<TablePropertyBuilder>):TablePropertyBuilder
	...
	export function emptyObjectiveIdWithKrIdBuilder():ObjectiveIdWithKrIdBuilder
	export function emptyRefObjectiveIdWithKrIdBuilder():Ref<ObjectiveIdWithKrIdBuilder>
	export function refOfObjectiveIdWithKrIdBuilder(x:ObjectiveIdWithKrIdBuilder,v:Ref<ObjectiveIdWithKrIdBuilder>)
	export function unRefObjectiveIdWithKrIdBuilder(v:Ref<ObjectiveIdWithKrIdBuilder>):ObjectiveIdWithKrIdBuilder
	...
	export function emptyAgendaItemTitleBuilder():AgendaItemTitleBuilder
	export function emptyRefAgendaItemTitleBuilder():Ref<AgendaItemTitleBuilder>
	export function refOfAgendaItemTitleBuilder(x:AgendaItemTitleBuilder,v:Ref<AgendaItemTitleBuilder>)
	export function unRefAgendaItemTitleBuilder(v:Ref<AgendaItemTitleBuilder>):AgendaItemTitleBuilder
	export function emptyBatchDeleteDocumentBlockChildrenReqBodyBuilder():BatchDeleteDocumentBlockChildrenReqBodyBuilder
	export function emptyRefBatchDeleteDocumentBlockChildrenReqBodyBuilder():Ref<BatchDeleteDocumentBlockChildrenReqBodyBuilder>
	export function refOfBatchDeleteDocumentBlockChildrenReqBodyBuilder(x:BatchDeleteDocumentBlockChildrenReqBodyBuilder,v:Ref<BatchDeleteDocumentBlockChildrenReqBodyBuilder>)
	export function unRefBatchDeleteDocumentBlockChildrenReqBodyBuilder(v:Ref<BatchDeleteDocumentBlockChildrenReqBodyBuilder>):BatchDeleteDocumentBlockChildrenReqBodyBuilder
	...
	export function emptyListDocumentBlockReqBuilder():ListDocumentBlockReqBuilder
	export function emptyRefListDocumentBlockReqBuilder():Ref<ListDocumentBlockReqBuilder>
	export function refOfListDocumentBlockReqBuilder(x:ListDocumentBlockReqBuilder,v:Ref<ListDocumentBlockReqBuilder>)
	export function unRefListDocumentBlockReqBuilder(v:Ref<ListDocumentBlockReqBuilder>):ListDocumentBlockReqBuilder
	...
	export function emptyUpdateTextRequestBuilder():UpdateTextRequestBuilder
	export function emptyRefUpdateTextRequestBuilder():Ref<UpdateTextRequestBuilder>
	export function refOfUpdateTextRequestBuilder(x:UpdateTextRequestBuilder,v:Ref<UpdateTextRequestBuilder>)
	export function unRefUpdateTextRequestBuilder(v:Ref<UpdateTextRequestBuilder>):UpdateTextRequestBuilder
	export function emptyBatchDeleteDocumentBlockChildrenReqBuilder():BatchDeleteDocumentBlockChildrenReqBuilder
	export function emptyRefBatchDeleteDocumentBlockChildrenReqBuilder():Ref<BatchDeleteDocumentBlockChildrenReqBuilder>
	export function refOfBatchDeleteDocumentBlockChildrenReqBuilder(x:BatchDeleteDocumentBlockChildrenReqBuilder,v:Ref<BatchDeleteDocumentBlockChildrenReqBuilder>)
	export function unRefBatchDeleteDocumentBlockChildrenReqBuilder(v:Ref<BatchDeleteDocumentBlockChildrenReqBuilder>):BatchDeleteDocumentBlockChildrenReqBuilder
	...
	export function emptyIframeBuilder():IframeBuilder
	export function emptyRefIframeBuilder():Ref<IframeBuilder>
	export function refOfIframeBuilder(x:IframeBuilder,v:Ref<IframeBuilder>)
	export function unRefIframeBuilder(v:Ref<IframeBuilder>):IframeBuilder
	export function emptyOkrVisibleSettingBuilder():OkrVisibleSettingBuilder
	export function emptyRefOkrVisibleSettingBuilder():Ref<OkrVisibleSettingBuilder>
	export function refOfOkrVisibleSettingBuilder(x:OkrVisibleSettingBuilder,v:Ref<OkrVisibleSettingBuilder>)
	export function unRefOkrVisibleSettingBuilder(v:Ref<OkrVisibleSettingBuilder>):OkrVisibleSettingBuilder
	...
	export function emptyUpdateBlockRequestBuilder():UpdateBlockRequestBuilder
	export function emptyRefUpdateBlockRequestBuilder():Ref<UpdateBlockRequestBuilder>
	export function refOfUpdateBlockRequestBuilder(x:UpdateBlockRequestBuilder,v:Ref<UpdateBlockRequestBuilder>)
	export function unRefUpdateBlockRequestBuilder(v:Ref<UpdateBlockRequestBuilder>):UpdateBlockRequestBuilder
	export function emptyDiagramBuilder():DiagramBuilder
	export function emptyRefDiagramBuilder():Ref<DiagramBuilder>
	export function refOfDiagramBuilder(x:DiagramBuilder,v:Ref<DiagramBuilder>)
	export function unRefDiagramBuilder(v:Ref<DiagramBuilder>):DiagramBuilder
	export function emptyIsvBuilder():IsvBuilder
	export function emptyRefIsvBuilder():Ref<IsvBuilder>
	export function refOfIsvBuilder(x:IsvBuilder,v:Ref<IsvBuilder>)
	export function unRefIsvBuilder(v:Ref<IsvBuilder>):IsvBuilder
	...
	export function emptyRawContentDocumentReqBuilder():RawContentDocumentReqBuilder
	export function emptyRefRawContentDocumentReqBuilder():Ref<RawContentDocumentReqBuilder>
	export function refOfRawContentDocumentReqBuilder(x:RawContentDocumentReqBuilder,v:Ref<RawContentDocumentReqBuilder>)
	export function unRefRawContentDocumentReqBuilder(v:Ref<RawContentDocumentReqBuilder>):RawContentDocumentReqBuilder
	...
	export function emptyUpdateDocumentRequestBuilder():UpdateDocumentRequestBuilder
	export function emptyRefUpdateDocumentRequestBuilder():Ref<UpdateDocumentRequestBuilder>
	export function refOfUpdateDocumentRequestBuilder(x:UpdateDocumentRequestBuilder,v:Ref<UpdateDocumentRequestBuilder>)
	export function unRefUpdateDocumentRequestBuilder(v:Ref<UpdateDocumentRequestBuilder>):UpdateDocumentRequestBuilder
	export function emptyAddOnsBuilder():AddOnsBuilder
	export function emptyRefAddOnsBuilder():Ref<AddOnsBuilder>
	export function refOfAddOnsBuilder(x:AddOnsBuilder,v:Ref<AddOnsBuilder>)
	export function unRefAddOnsBuilder(v:Ref<AddOnsBuilder>):AddOnsBuilder
	...
	export function emptyInsertGridColumnRequestBuilder():InsertGridColumnRequestBuilder
	export function emptyRefInsertGridColumnRequestBuilder():Ref<InsertGridColumnRequestBuilder>
	export function refOfInsertGridColumnRequestBuilder(x:InsertGridColumnRequestBuilder,v:Ref<InsertGridColumnRequestBuilder>)
	export function unRefInsertGridColumnRequestBuilder(v:Ref<InsertGridColumnRequestBuilder>):InsertGridColumnRequestBuilder
	...
	export function emptyDeleteGridColumnRequestBuilder():DeleteGridColumnRequestBuilder
	export function emptyRefDeleteGridColumnRequestBuilder():Ref<DeleteGridColumnRequestBuilder>
	export function refOfDeleteGridColumnRequestBuilder(x:DeleteGridColumnRequestBuilder,v:Ref<DeleteGridColumnRequestBuilder>)
	export function unRefDeleteGridColumnRequestBuilder(v:Ref<DeleteGridColumnRequestBuilder>):DeleteGridColumnRequestBuilder
	export function emptyDocumentDisplaySettingBuilder():DocumentDisplaySettingBuilder
	export function emptyRefDocumentDisplaySettingBuilder():Ref<DocumentDisplaySettingBuilder>
	export function refOfDocumentDisplaySettingBuilder(x:DocumentDisplaySettingBuilder,v:Ref<DocumentDisplaySettingBuilder>)
	export function unRefDocumentDisplaySettingBuilder(v:Ref<DocumentDisplaySettingBuilder>):DocumentDisplaySettingBuilder
	...
	export function emptyGridBuilder():GridBuilder
	export function emptyRefGridBuilder():Ref<GridBuilder>
	export function refOfGridBuilder(x:GridBuilder,v:Ref<GridBuilder>)
	export function unRefGridBuilder(v:Ref<GridBuilder>):GridBuilder
	export function emptyPatchDocumentBlockReqBuilder():PatchDocumentBlockReqBuilder
	export function emptyRefPatchDocumentBlockReqBuilder():Ref<PatchDocumentBlockReqBuilder>
	export function refOfPatchDocumentBlockReqBuilder(x:PatchDocumentBlockReqBuilder,v:Ref<PatchDocumentBlockReqBuilder>)
	export function unRefPatchDocumentBlockReqBuilder(v:Ref<PatchDocumentBlockReqBuilder>):PatchDocumentBlockReqBuilder
	export function emptyTextStyleBuilder():TextStyleBuilder
	export function emptyRefTextStyleBuilder():Ref<TextStyleBuilder>
	export function refOfTextStyleBuilder(x:TextStyleBuilder,v:Ref<TextStyleBuilder>)
	export function unRefTextStyleBuilder(v:Ref<TextStyleBuilder>):TextStyleBuilder
	...
	export function emptyInsertTableColumnRequestBuilder():InsertTableColumnRequestBuilder
	export function emptyRefInsertTableColumnRequestBuilder():Ref<InsertTableColumnRequestBuilder>
	export function refOfInsertTableColumnRequestBuilder(x:InsertTableColumnRequestBuilder,v:Ref<InsertTableColumnRequestBuilder>)
	export function unRefInsertTableColumnRequestBuilder(v:Ref<InsertTableColumnRequestBuilder>):InsertTableColumnRequestBuilder
	...
	export function emptyTextElementBuilder():TextElementBuilder
	export function emptyRefTextElementBuilder():Ref<TextElementBuilder>
	export function refOfTextElementBuilder(x:TextElementBuilder,v:Ref<TextElementBuilder>)
	export function unRefTextElementBuilder(v:Ref<TextElementBuilder>):TextElementBuilder
	...
	export function emptyBatchUpdateDocumentBlockPathReqBodyBuilder():BatchUpdateDocumentBlockPathReqBodyBuilder
	export function emptyRefBatchUpdateDocumentBlockPathReqBodyBuilder():Ref<BatchUpdateDocumentBlockPathReqBodyBuilder>
	export function refOfBatchUpdateDocumentBlockPathReqBodyBuilder(x:BatchUpdateDocumentBlockPathReqBodyBuilder,v:Ref<BatchUpdateDocumentBlockPathReqBodyBuilder>)
	export function unRefBatchUpdateDocumentBlockPathReqBodyBuilder(v:Ref<BatchUpdateDocumentBlockPathReqBodyBuilder>):BatchUpdateDocumentBlockPathReqBodyBuilder
	export function emptyCreateDocumentReqBuilder():CreateDocumentReqBuilder
	export function emptyRefCreateDocumentReqBuilder():Ref<CreateDocumentReqBuilder>
	export function refOfCreateDocumentReqBuilder(x:CreateDocumentReqBuilder,v:Ref<CreateDocumentReqBuilder>)
	export function unRefCreateDocumentReqBuilder(v:Ref<CreateDocumentReqBuilder>):CreateDocumentReqBuilder
	...
	export function emptyEquationBuilder():EquationBuilder
	export function emptyRefEquationBuilder():Ref<EquationBuilder>
	export function refOfEquationBuilder(x:EquationBuilder,v:Ref<EquationBuilder>)
	export function unRefEquationBuilder(v:Ref<EquationBuilder>):EquationBuilder
	export function emptyInlineFileBuilder():InlineFileBuilder
	export function emptyRefInlineFileBuilder():Ref<InlineFileBuilder>
	export function refOfInlineFileBuilder(x:InlineFileBuilder,v:Ref<InlineFileBuilder>)
	export function unRefInlineFileBuilder(v:Ref<InlineFileBuilder>):InlineFileBuilder
	...
	export function emptyMentionDocBuilder():MentionDocBuilder
	export function emptyRefMentionDocBuilder():Ref<MentionDocBuilder>
	export function refOfMentionDocBuilder(x:MentionDocBuilder,v:Ref<MentionDocBuilder>)
	export function unRefMentionDocBuilder(v:Ref<MentionDocBuilder>):MentionDocBuilder
	...
	export function emptyOkrKeyResultBuilder():OkrKeyResultBuilder
	export function emptyRefOkrKeyResultBuilder():Ref<OkrKeyResultBuilder>
	export function refOfOkrKeyResultBuilder(x:OkrKeyResultBuilder,v:Ref<OkrKeyResultBuilder>)
	export function unRefOkrKeyResultBuilder(v:Ref<OkrKeyResultBuilder>):OkrKeyResultBuilder
	...
	export function emptyInlineBlockBuilder():InlineBlockBuilder
	export function emptyRefInlineBlockBuilder():Ref<InlineBlockBuilder>
	export function refOfInlineBlockBuilder(x:InlineBlockBuilder,v:Ref<InlineBlockBuilder>)
	export function unRefInlineBlockBuilder(v:Ref<InlineBlockBuilder>):InlineBlockBuilder
	export function emptyMergeTableCellsRequestBuilder():MergeTableCellsRequestBuilder
	export function emptyRefMergeTableCellsRequestBuilder():Ref<MergeTableCellsRequestBuilder>
	export function refOfMergeTableCellsRequestBuilder(x:MergeTableCellsRequestBuilder,v:Ref<MergeTableCellsRequestBuilder>)
	export function unRefMergeTableCellsRequestBuilder(v:Ref<MergeTableCellsRequestBuilder>):MergeTableCellsRequestBuilder
