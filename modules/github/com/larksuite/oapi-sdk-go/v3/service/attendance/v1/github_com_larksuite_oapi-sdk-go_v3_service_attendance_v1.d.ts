...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/attendance/v1'{
	...
	// @ts-ignore
	import type {float64,map,Ref,int,Struct,error,bool} from 'go'
	...
	export function emptyScheduleBuilder():ScheduleBuilder
	export function emptyRefScheduleBuilder():Ref<ScheduleBuilder>
	export function refOfScheduleBuilder(x:ScheduleBuilder,v:Ref<ScheduleBuilder>)
	export function unRefScheduleBuilder(v:Ref<ScheduleBuilder>):ScheduleBuilder
	...
	export function emptyPatchLeaveAccrualRecordPathReqBodyBuilder():PatchLeaveAccrualRecordPathReqBodyBuilder
	export function emptyRefPatchLeaveAccrualRecordPathReqBodyBuilder():Ref<PatchLeaveAccrualRecordPathReqBodyBuilder>
	export function refOfPatchLeaveAccrualRecordPathReqBodyBuilder(x:PatchLeaveAccrualRecordPathReqBodyBuilder,v:Ref<PatchLeaveAccrualRecordPathReqBodyBuilder>)
	export function unRefPatchLeaveAccrualRecordPathReqBodyBuilder(v:Ref<PatchLeaveAccrualRecordPathReqBodyBuilder>):PatchLeaveAccrualRecordPathReqBodyBuilder
	...
	export function emptyUserOutBuilder():UserOutBuilder
	export function emptyRefUserOutBuilder():Ref<UserOutBuilder>
	export function refOfUserOutBuilder(x:UserOutBuilder,v:Ref<UserOutBuilder>)
	export function unRefUserOutBuilder(v:Ref<UserOutBuilder>):UserOutBuilder
	export function emptyScopeGroupBuilder():ScopeGroupBuilder
	export function emptyRefScopeGroupBuilder():Ref<ScopeGroupBuilder>
	export function refOfScopeGroupBuilder(x:ScopeGroupBuilder,v:Ref<ScopeGroupBuilder>)
	export function unRefScopeGroupBuilder(v:Ref<ScopeGroupBuilder>):ScopeGroupBuilder
	...
	export function emptyQueryUserStatsViewReqBuilder():QueryUserStatsViewReqBuilder
	export function emptyRefQueryUserStatsViewReqBuilder():Ref<QueryUserStatsViewReqBuilder>
	export function refOfQueryUserStatsViewReqBuilder(x:QueryUserStatsViewReqBuilder,v:Ref<QueryUserStatsViewReqBuilder>)
	export function unRefQueryUserStatsViewReqBuilder(v:Ref<QueryUserStatsViewReqBuilder>):QueryUserStatsViewReqBuilder
	...
	export function emptyLocationInfoEventBuilder():LocationInfoEventBuilder
	export function emptyRefLocationInfoEventBuilder():Ref<LocationInfoEventBuilder>
	export function refOfLocationInfoEventBuilder(x:LocationInfoEventBuilder,v:Ref<LocationInfoEventBuilder>)
	export function unRefLocationInfoEventBuilder(v:Ref<LocationInfoEventBuilder>):LocationInfoEventBuilder
	export function emptyOvertimeRuleBuilder():OvertimeRuleBuilder
	export function emptyRefOvertimeRuleBuilder():Ref<OvertimeRuleBuilder>
	export function refOfOvertimeRuleBuilder(x:OvertimeRuleBuilder,v:Ref<OvertimeRuleBuilder>)
	export function unRefOvertimeRuleBuilder(v:Ref<OvertimeRuleBuilder>):OvertimeRuleBuilder
	export function emptyQueryUserStatsFieldPathReqBodyBuilder():QueryUserStatsFieldPathReqBodyBuilder
	export function emptyRefQueryUserStatsFieldPathReqBodyBuilder():Ref<QueryUserStatsFieldPathReqBodyBuilder>
	export function refOfQueryUserStatsFieldPathReqBodyBuilder(x:QueryUserStatsFieldPathReqBodyBuilder,v:Ref<QueryUserStatsFieldPathReqBodyBuilder>)
	export function unRefQueryUserStatsFieldPathReqBodyBuilder(v:Ref<QueryUserStatsFieldPathReqBodyBuilder>):QueryUserStatsFieldPathReqBodyBuilder
	...
	export function emptyCreateUserApprovalReqBodyBuilder():CreateUserApprovalReqBodyBuilder
	export function emptyRefCreateUserApprovalReqBodyBuilder():Ref<CreateUserApprovalReqBodyBuilder>
	export function refOfCreateUserApprovalReqBodyBuilder(x:CreateUserApprovalReqBodyBuilder,v:Ref<CreateUserApprovalReqBodyBuilder>)
	export function unRefCreateUserApprovalReqBodyBuilder(v:Ref<CreateUserApprovalReqBodyBuilder>):CreateUserApprovalReqBodyBuilder
	...
	export function emptyRestRuleBuilder():RestRuleBuilder
	export function emptyRefRestRuleBuilder():Ref<RestRuleBuilder>
	export function refOfRestRuleBuilder(x:RestRuleBuilder,v:Ref<RestRuleBuilder>)
	export function unRefRestRuleBuilder(v:Ref<RestRuleBuilder>):RestRuleBuilder
	...
	export function emptyShiftGroupUserBuilder():ShiftGroupUserBuilder
	export function emptyRefShiftGroupUserBuilder():Ref<ShiftGroupUserBuilder>
	export function refOfShiftGroupUserBuilder(x:ShiftGroupUserBuilder,v:Ref<ShiftGroupUserBuilder>)
	export function unRefShiftGroupUserBuilder(v:Ref<ShiftGroupUserBuilder>):ShiftGroupUserBuilder
	export function emptyUserSettingBuilder():UserSettingBuilder
	export function emptyRefUserSettingBuilder():Ref<UserSettingBuilder>
	export function refOfUserSettingBuilder(x:UserSettingBuilder,v:Ref<UserSettingBuilder>)
	export function unRefUserSettingBuilder(v:Ref<UserSettingBuilder>):UserSettingBuilder
	...
	export function emptyFlexibleRuleBuilder():FlexibleRuleBuilder
	export function emptyRefFlexibleRuleBuilder():Ref<FlexibleRuleBuilder>
	export function refOfFlexibleRuleBuilder(x:FlexibleRuleBuilder,v:Ref<FlexibleRuleBuilder>)
	export function unRefFlexibleRuleBuilder(v:Ref<FlexibleRuleBuilder>):FlexibleRuleBuilder
	...
	export function emptyUserLeaveBuilder():UserLeaveBuilder
	export function emptyRefUserLeaveBuilder():Ref<UserLeaveBuilder>
	export function refOfUserLeaveBuilder(x:UserLeaveBuilder,v:Ref<UserLeaveBuilder>)
	export function unRefUserLeaveBuilder(v:Ref<UserLeaveBuilder>):UserLeaveBuilder
	...
	export function emptyQueryUserApprovalPathReqBodyBuilder():QueryUserApprovalPathReqBodyBuilder
	export function emptyRefQueryUserApprovalPathReqBodyBuilder():Ref<QueryUserApprovalPathReqBodyBuilder>
	export function refOfQueryUserApprovalPathReqBodyBuilder(x:QueryUserApprovalPathReqBodyBuilder,v:Ref<QueryUserApprovalPathReqBodyBuilder>)
	export function unRefQueryUserApprovalPathReqBodyBuilder(v:Ref<QueryUserApprovalPathReqBodyBuilder>):QueryUserApprovalPathReqBodyBuilder
	...
	export function emptyShiftBuilder():ShiftBuilder
	export function emptyRefShiftBuilder():Ref<ShiftBuilder>
	export function refOfShiftBuilder(x:ShiftBuilder,v:Ref<ShiftBuilder>)
	export function unRefShiftBuilder(v:Ref<ShiftBuilder>):ShiftBuilder
	...
	export function emptyLocationSettingBuilder():LocationSettingBuilder
	export function emptyRefLocationSettingBuilder():Ref<LocationSettingBuilder>
	export function refOfLocationSettingBuilder(x:LocationSettingBuilder,v:Ref<LocationSettingBuilder>)
	export function unRefLocationSettingBuilder(v:Ref<LocationSettingBuilder>):LocationSettingBuilder
	...
	export function emptyQueryUserFlowReqBodyBuilder():QueryUserFlowReqBodyBuilder
	export function emptyRefQueryUserFlowReqBodyBuilder():Ref<QueryUserFlowReqBodyBuilder>
	export function refOfQueryUserFlowReqBodyBuilder(x:QueryUserFlowReqBodyBuilder,v:Ref<QueryUserFlowReqBodyBuilder>)
	export function unRefQueryUserFlowReqBodyBuilder(v:Ref<QueryUserFlowReqBodyBuilder>):QueryUserFlowReqBodyBuilder
	...
	export function emptyWifiInfoEventBuilder():WifiInfoEventBuilder
	export function emptyRefWifiInfoEventBuilder():Ref<WifiInfoEventBuilder>
	export function refOfWifiInfoEventBuilder(x:WifiInfoEventBuilder,v:Ref<WifiInfoEventBuilder>)
	export function unRefWifiInfoEventBuilder(v:Ref<WifiInfoEventBuilder>):WifiInfoEventBuilder
	export function emptyGetLeaveEmployExpireRecordPathReqBodyBuilder():GetLeaveEmployExpireRecordPathReqBodyBuilder
	export function emptyRefGetLeaveEmployExpireRecordPathReqBodyBuilder():Ref<GetLeaveEmployExpireRecordPathReqBodyBuilder>
	export function refOfGetLeaveEmployExpireRecordPathReqBodyBuilder(x:GetLeaveEmployExpireRecordPathReqBodyBuilder,v:Ref<GetLeaveEmployExpireRecordPathReqBodyBuilder>)
	export function unRefGetLeaveEmployExpireRecordPathReqBodyBuilder(v:Ref<GetLeaveEmployExpireRecordPathReqBodyBuilder>):GetLeaveEmployExpireRecordPathReqBodyBuilder
	export function emptyMemberStatusChangeBuilder():MemberStatusChangeBuilder
	export function emptyRefMemberStatusChangeBuilder():Ref<MemberStatusChangeBuilder>
	export function refOfMemberStatusChangeBuilder(x:MemberStatusChangeBuilder,v:Ref<MemberStatusChangeBuilder>)
	export function unRefMemberStatusChangeBuilder(v:Ref<MemberStatusChangeBuilder>):MemberStatusChangeBuilder
	...
	export function emptyFilterItemBuilder():FilterItemBuilder
	export function emptyRefFilterItemBuilder():Ref<FilterItemBuilder>
	export function refOfFilterItemBuilder(x:FilterItemBuilder,v:Ref<FilterItemBuilder>)
	export function unRefFilterItemBuilder(v:Ref<FilterItemBuilder>):FilterItemBuilder
	export function emptyOvertimeApplyDetailBuilder():OvertimeApplyDetailBuilder
	export function emptyRefOvertimeApplyDetailBuilder():Ref<OvertimeApplyDetailBuilder>
	export function refOfOvertimeApplyDetailBuilder(x:OvertimeApplyDetailBuilder,v:Ref<OvertimeApplyDetailBuilder>)
	export function unRefOvertimeApplyDetailBuilder(v:Ref<OvertimeApplyDetailBuilder>):OvertimeApplyDetailBuilder
	export function emptyQueryUserDailyShiftReqBodyBuilder():QueryUserDailyShiftReqBodyBuilder
	export function emptyRefQueryUserDailyShiftReqBodyBuilder():Ref<QueryUserDailyShiftReqBodyBuilder>
	export function refOfQueryUserDailyShiftReqBodyBuilder(x:QueryUserDailyShiftReqBodyBuilder,v:Ref<QueryUserDailyShiftReqBodyBuilder>)
	export function unRefQueryUserDailyShiftReqBodyBuilder(v:Ref<QueryUserDailyShiftReqBodyBuilder>):QueryUserDailyShiftReqBodyBuilder
	export function emptySearchGroupReqBodyBuilder():SearchGroupReqBodyBuilder
	export function emptyRefSearchGroupReqBodyBuilder():Ref<SearchGroupReqBodyBuilder>
	export function refOfSearchGroupReqBodyBuilder(x:SearchGroupReqBodyBuilder,v:Ref<SearchGroupReqBodyBuilder>)
	export function unRefSearchGroupReqBodyBuilder(v:Ref<SearchGroupReqBodyBuilder>):SearchGroupReqBodyBuilder
	...
	export function emptyUserArrangeShiftGroupBuilder():UserArrangeShiftGroupBuilder
	export function emptyRefUserArrangeShiftGroupBuilder():Ref<UserArrangeShiftGroupBuilder>
	export function refOfUserArrangeShiftGroupBuilder(x:UserArrangeShiftGroupBuilder,v:Ref<UserArrangeShiftGroupBuilder>)
	export function unRefUserArrangeShiftGroupBuilder(v:Ref<UserArrangeShiftGroupBuilder>):UserArrangeShiftGroupBuilder
	...
	export function emptyCreateUserTaskRemedyReqBuilder():CreateUserTaskRemedyReqBuilder
	export function emptyRefCreateUserTaskRemedyReqBuilder():Ref<CreateUserTaskRemedyReqBuilder>
	export function refOfCreateUserTaskRemedyReqBuilder(x:CreateUserTaskRemedyReqBuilder,v:Ref<CreateUserTaskRemedyReqBuilder>)
	export function unRefCreateUserTaskRemedyReqBuilder(v:Ref<CreateUserTaskRemedyReqBuilder>):CreateUserTaskRemedyReqBuilder
	...
	export function emptyScanWifiInfoBuilder():ScanWifiInfoBuilder
	export function emptyRefScanWifiInfoBuilder():Ref<ScanWifiInfoBuilder>
	export function refOfScanWifiInfoBuilder(x:ScanWifiInfoBuilder,v:Ref<ScanWifiInfoBuilder>)
	export function unRefScanWifiInfoBuilder(v:Ref<ScanWifiInfoBuilder>):ScanWifiInfoBuilder
	...
	export function emptyArchiveReportMetaBuilder():ArchiveReportMetaBuilder
	export function emptyRefArchiveReportMetaBuilder():Ref<ArchiveReportMetaBuilder>
	export function refOfArchiveReportMetaBuilder(x:ArchiveReportMetaBuilder,v:Ref<ArchiveReportMetaBuilder>)
	export function unRefArchiveReportMetaBuilder(v:Ref<ArchiveReportMetaBuilder>):ArchiveReportMetaBuilder
	export function emptyProcessApprovalInfoReqBuilder():ProcessApprovalInfoReqBuilder
	export function emptyRefProcessApprovalInfoReqBuilder():Ref<ProcessApprovalInfoReqBuilder>
	export function refOfProcessApprovalInfoReqBuilder(x:ProcessApprovalInfoReqBuilder,v:Ref<ProcessApprovalInfoReqBuilder>)
	export function unRefProcessApprovalInfoReqBuilder(v:Ref<ProcessApprovalInfoReqBuilder>):ProcessApprovalInfoReqBuilder
	export function emptyQueryUserStatsDataReqBuilder():QueryUserStatsDataReqBuilder
	export function emptyRefQueryUserStatsDataReqBuilder():Ref<QueryUserStatsDataReqBuilder>
	export function refOfQueryUserStatsDataReqBuilder(x:QueryUserStatsDataReqBuilder,v:Ref<QueryUserStatsDataReqBuilder>)
	export function unRefQueryUserStatsDataReqBuilder(v:Ref<QueryUserStatsDataReqBuilder>):QueryUserStatsDataReqBuilder
	export function emptyUpdateUserStatsViewReqBodyBuilder():UpdateUserStatsViewReqBodyBuilder
	export function emptyRefUpdateUserStatsViewReqBodyBuilder():Ref<UpdateUserStatsViewReqBodyBuilder>
	export function refOfUpdateUserStatsViewReqBodyBuilder(x:UpdateUserStatsViewReqBodyBuilder,v:Ref<UpdateUserStatsViewReqBodyBuilder>)
	export function unRefUpdateUserStatsViewReqBodyBuilder(v:Ref<UpdateUserStatsViewReqBodyBuilder>):UpdateUserStatsViewReqBodyBuilder
	export function emptyUserTaskRemedyBuilder():UserTaskRemedyBuilder
	export function emptyRefUserTaskRemedyBuilder():Ref<UserTaskRemedyBuilder>
	export function refOfUserTaskRemedyBuilder(x:UserTaskRemedyBuilder,v:Ref<UserTaskRemedyBuilder>)
	export function unRefUserTaskRemedyBuilder(v:Ref<UserTaskRemedyBuilder>):UserTaskRemedyBuilder
	...
	export function emptyGetLeaveEmployExpireRecordReqBuilder():GetLeaveEmployExpireRecordReqBuilder
	export function emptyRefGetLeaveEmployExpireRecordReqBuilder():Ref<GetLeaveEmployExpireRecordReqBuilder>
	export function refOfGetLeaveEmployExpireRecordReqBuilder(x:GetLeaveEmployExpireRecordReqBuilder,v:Ref<GetLeaveEmployExpireRecordReqBuilder>)
	export function unRefGetLeaveEmployExpireRecordReqBuilder(v:Ref<GetLeaveEmployExpireRecordReqBuilder>):GetLeaveEmployExpireRecordReqBuilder
	...
	export function emptyLocationRecordBuilder():LocationRecordBuilder
	export function emptyRefLocationRecordBuilder():Ref<LocationRecordBuilder>
	export function refOfLocationRecordBuilder(x:LocationRecordBuilder,v:Ref<LocationRecordBuilder>)
	export function unRefLocationRecordBuilder(v:Ref<LocationRecordBuilder>):LocationRecordBuilder
	export function emptyQueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder():QueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder
	export function emptyRefQueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder():Ref<QueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder>
	export function refOfQueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder(x:QueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder,v:Ref<QueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder>)
	export function unRefQueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder(v:Ref<QueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder>):QueryUserAllowedRemedysUserTaskRemedyPathReqBodyBuilder
	...
	export function emptyUserApprovalBuilder():UserApprovalBuilder
	export function emptyRefUserApprovalBuilder():Ref<UserApprovalBuilder>
	export function refOfUserApprovalBuilder(x:UserApprovalBuilder,v:Ref<UserApprovalBuilder>)
	export function unRefUserApprovalBuilder(v:Ref<UserApprovalBuilder>):UserApprovalBuilder
	...
	export function emptyCreateShiftReqBuilder():CreateShiftReqBuilder
	export function emptyRefCreateShiftReqBuilder():Ref<CreateShiftReqBuilder>
	export function refOfCreateShiftReqBuilder(x:CreateShiftReqBuilder,v:Ref<CreateShiftReqBuilder>)
	export function unRefCreateShiftReqBuilder(v:Ref<CreateShiftReqBuilder>):CreateShiftReqBuilder
	export function emptyQueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder():QueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder
	export function emptyRefQueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder():Ref<QueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder>
	export function refOfQueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder(x:QueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder,v:Ref<QueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder>)
	export function unRefQueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder(v:Ref<QueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder>):QueryUserAllowedRemedysUserTaskRemedyReqBodyBuilder
	export function emptyReportValueBuilder():ReportValueBuilder
	export function emptyRefReportValueBuilder():Ref<ReportValueBuilder>
	export function refOfReportValueBuilder(x:ReportValueBuilder,v:Ref<ReportValueBuilder>)
	export function unRefReportValueBuilder(v:Ref<ReportValueBuilder>):ReportValueBuilder
	export function emptyUploadFileReqBodyBuilder():UploadFileReqBodyBuilder
	export function emptyRefUploadFileReqBodyBuilder():Ref<UploadFileReqBodyBuilder>
	export function refOfUploadFileReqBodyBuilder(x:UploadFileReqBodyBuilder,v:Ref<UploadFileReqBodyBuilder>)
	export function unRefUploadFileReqBodyBuilder(v:Ref<UploadFileReqBodyBuilder>):UploadFileReqBodyBuilder
	...
	export function emptyQueryUserStatsViewPathReqBodyBuilder():QueryUserStatsViewPathReqBodyBuilder
	export function emptyRefQueryUserStatsViewPathReqBodyBuilder():Ref<QueryUserStatsViewPathReqBodyBuilder>
	export function refOfQueryUserStatsViewPathReqBodyBuilder(x:QueryUserStatsViewPathReqBodyBuilder,v:Ref<QueryUserStatsViewPathReqBodyBuilder>)
	export function unRefQueryUserStatsViewPathReqBodyBuilder(v:Ref<QueryUserStatsViewPathReqBodyBuilder>):QueryUserStatsViewPathReqBodyBuilder
	...
	export function emptyQueryUserApprovalReqBodyBuilder():QueryUserApprovalReqBodyBuilder
	export function emptyRefQueryUserApprovalReqBodyBuilder():Ref<QueryUserApprovalReqBodyBuilder>
	export function refOfQueryUserApprovalReqBodyBuilder(x:QueryUserApprovalReqBodyBuilder,v:Ref<QueryUserApprovalReqBodyBuilder>)
	export function unRefQueryUserApprovalReqBodyBuilder(v:Ref<QueryUserApprovalReqBodyBuilder>):QueryUserApprovalReqBodyBuilder
	export function emptyGroupMetaBuilder():GroupMetaBuilder
	export function emptyRefGroupMetaBuilder():Ref<GroupMetaBuilder>
	export function refOfGroupMetaBuilder(x:GroupMetaBuilder,v:Ref<GroupMetaBuilder>)
	export function unRefGroupMetaBuilder(v:Ref<GroupMetaBuilder>):GroupMetaBuilder
	export function emptyOpenApplyTimeRangeBuilder():OpenApplyTimeRangeBuilder
	export function emptyRefOpenApplyTimeRangeBuilder():Ref<OpenApplyTimeRangeBuilder>
	export function refOfOpenApplyTimeRangeBuilder(x:OpenApplyTimeRangeBuilder,v:Ref<OpenApplyTimeRangeBuilder>)
	export function unRefOpenApplyTimeRangeBuilder(v:Ref<OpenApplyTimeRangeBuilder>):OpenApplyTimeRangeBuilder
	export function emptyQueryUserTaskReqBodyBuilder():QueryUserTaskReqBodyBuilder
	export function emptyRefQueryUserTaskReqBodyBuilder():Ref<QueryUserTaskReqBodyBuilder>
	export function refOfQueryUserTaskReqBodyBuilder(x:QueryUserTaskReqBodyBuilder,v:Ref<QueryUserTaskReqBodyBuilder>)
	export function unRefQueryUserTaskReqBodyBuilder(v:Ref<QueryUserTaskReqBodyBuilder>):QueryUserTaskReqBodyBuilder
	export function emptyStatisticsFieldBuilder():StatisticsFieldBuilder
	export function emptyRefStatisticsFieldBuilder():Ref<StatisticsFieldBuilder>
	export function refOfStatisticsFieldBuilder(x:StatisticsFieldBuilder,v:Ref<StatisticsFieldBuilder>)
	export function unRefStatisticsFieldBuilder(v:Ref<StatisticsFieldBuilder>):StatisticsFieldBuilder
	export function emptyChildItemBuilder():ChildItemBuilder
	export function emptyRefChildItemBuilder():Ref<ChildItemBuilder>
	export function refOfChildItemBuilder(x:ChildItemBuilder,v:Ref<ChildItemBuilder>)
	export function unRefChildItemBuilder(v:Ref<ChildItemBuilder>):ChildItemBuilder
	...
	export function emptyUserShiftGroupsListBuilder():UserShiftGroupsListBuilder
	export function emptyRefUserShiftGroupsListBuilder():Ref<UserShiftGroupsListBuilder>
	export function refOfUserShiftGroupsListBuilder(x:UserShiftGroupsListBuilder,v:Ref<UserShiftGroupsListBuilder>)
	export function unRefUserShiftGroupsListBuilder(v:Ref<UserShiftGroupsListBuilder>):UserShiftGroupsListBuilder
	...
	export function emptyListShiftReqBuilder():ListShiftReqBuilder
	export function emptyRefListShiftReqBuilder():Ref<ListShiftReqBuilder>
	export function refOfListShiftReqBuilder(x:ListShiftReqBuilder,v:Ref<ListShiftReqBuilder>)
	export function unRefListShiftReqBuilder(v:Ref<ListShiftReqBuilder>):ListShiftReqBuilder
	export function emptyReportDataBuilder():ReportDataBuilder
	export function emptyRefReportDataBuilder():Ref<ReportDataBuilder>
	export function refOfReportDataBuilder(x:ReportDataBuilder,v:Ref<ReportDataBuilder>)
	export function unRefReportDataBuilder(v:Ref<ReportDataBuilder>):ReportDataBuilder
	...
	export function emptyApprovalInfoBuilder():ApprovalInfoBuilder
	export function emptyRefApprovalInfoBuilder():Ref<ApprovalInfoBuilder>
	export function refOfApprovalInfoBuilder(x:ApprovalInfoBuilder,v:Ref<ApprovalInfoBuilder>)
	export function unRefApprovalInfoBuilder(v:Ref<ApprovalInfoBuilder>):ApprovalInfoBuilder
	...
	export function emptyUserStatsViewBuilder():UserStatsViewBuilder
	export function emptyRefUserStatsViewBuilder():Ref<UserStatsViewBuilder>
	export function refOfUserStatsViewBuilder(x:UserStatsViewBuilder,v:Ref<UserStatsViewBuilder>)
	export function unRefUserStatsViewBuilder(v:Ref<UserStatsViewBuilder>):UserStatsViewBuilder
	export function emptyLocationInfoBuilder():LocationInfoBuilder
	export function emptyRefLocationInfoBuilder():Ref<LocationInfoBuilder>
	export function refOfLocationInfoBuilder(x:LocationInfoBuilder,v:Ref<LocationInfoBuilder>)
	export function unRefLocationInfoBuilder(v:Ref<LocationInfoBuilder>):LocationInfoBuilder
	...
	export function emptyUserStatsDataFeatureBuilder():UserStatsDataFeatureBuilder
	export function emptyRefUserStatsDataFeatureBuilder():Ref<UserStatsDataFeatureBuilder>
	export function refOfUserStatsDataFeatureBuilder(x:UserStatsDataFeatureBuilder,v:Ref<UserStatsDataFeatureBuilder>)
	export function unRefUserStatsDataFeatureBuilder(v:Ref<UserStatsDataFeatureBuilder>):UserStatsDataFeatureBuilder
	...
	export function emptyBatchCreateUserFlowPathReqBodyBuilder():BatchCreateUserFlowPathReqBodyBuilder
	export function emptyRefBatchCreateUserFlowPathReqBodyBuilder():Ref<BatchCreateUserFlowPathReqBodyBuilder>
	export function refOfBatchCreateUserFlowPathReqBodyBuilder(x:BatchCreateUserFlowPathReqBodyBuilder,v:Ref<BatchCreateUserFlowPathReqBodyBuilder>)
	export function unRefBatchCreateUserFlowPathReqBodyBuilder(v:Ref<BatchCreateUserFlowPathReqBodyBuilder>):BatchCreateUserFlowPathReqBodyBuilder
	...
	export function emptyDurationItemBuilder():DurationItemBuilder
	export function emptyRefDurationItemBuilder():Ref<DurationItemBuilder>
	export function refOfDurationItemBuilder(x:DurationItemBuilder,v:Ref<DurationItemBuilder>)
	export function unRefDurationItemBuilder(v:Ref<DurationItemBuilder>):DurationItemBuilder
	export function emptyPunchTimeRuleBuilder():PunchTimeRuleBuilder
	export function emptyRefPunchTimeRuleBuilder():Ref<PunchTimeRuleBuilder>
	export function refOfPunchTimeRuleBuilder(x:PunchTimeRuleBuilder,v:Ref<PunchTimeRuleBuilder>)
	export function unRefPunchTimeRuleBuilder(v:Ref<PunchTimeRuleBuilder>):PunchTimeRuleBuilder
	export function emptyQueryUserAllowedRemedysUserTaskRemedyReqBuilder():QueryUserAllowedRemedysUserTaskRemedyReqBuilder
	export function emptyRefQueryUserAllowedRemedysUserTaskRemedyReqBuilder():Ref<QueryUserAllowedRemedysUserTaskRemedyReqBuilder>
	export function refOfQueryUserAllowedRemedysUserTaskRemedyReqBuilder(x:QueryUserAllowedRemedysUserTaskRemedyReqBuilder,v:Ref<QueryUserAllowedRemedysUserTaskRemedyReqBuilder>)
	export function unRefQueryUserAllowedRemedysUserTaskRemedyReqBuilder(v:Ref<QueryUserAllowedRemedysUserTaskRemedyReqBuilder>):QueryUserAllowedRemedysUserTaskRemedyReqBuilder
	export function emptyQueryUserStatsDataReqBodyBuilder():QueryUserStatsDataReqBodyBuilder
	export function emptyRefQueryUserStatsDataReqBodyBuilder():Ref<QueryUserStatsDataReqBodyBuilder>
	export function refOfQueryUserStatsDataReqBodyBuilder(x:QueryUserStatsDataReqBodyBuilder,v:Ref<QueryUserStatsDataReqBodyBuilder>)
	export function unRefQueryUserStatsDataReqBodyBuilder(v:Ref<QueryUserStatsDataReqBodyBuilder>):QueryUserStatsDataReqBodyBuilder
	...
	export function emptyUpdateUserStatsViewReqBuilder():UpdateUserStatsViewReqBuilder
	export function emptyRefUpdateUserStatsViewReqBuilder():Ref<UpdateUserStatsViewReqBuilder>
	export function refOfUpdateUserStatsViewReqBuilder(x:UpdateUserStatsViewReqBuilder,v:Ref<UpdateUserStatsViewReqBuilder>)
	export function unRefUpdateUserStatsViewReqBuilder(v:Ref<UpdateUserStatsViewReqBuilder>):UpdateUserStatsViewReqBuilder
	...
	export function emptyGetUserFlowReqBuilder():GetUserFlowReqBuilder
	export function emptyRefGetUserFlowReqBuilder():Ref<GetUserFlowReqBuilder>
	export function refOfGetUserFlowReqBuilder(x:GetUserFlowReqBuilder,v:Ref<GetUserFlowReqBuilder>)
	export function unRefGetUserFlowReqBuilder(v:Ref<GetUserFlowReqBuilder>):GetUserFlowReqBuilder
	export function emptyProcessApprovalInfoPathReqBodyBuilder():ProcessApprovalInfoPathReqBodyBuilder
	export function emptyRefProcessApprovalInfoPathReqBodyBuilder():Ref<ProcessApprovalInfoPathReqBodyBuilder>
	export function refOfProcessApprovalInfoPathReqBodyBuilder(x:ProcessApprovalInfoPathReqBodyBuilder,v:Ref<ProcessApprovalInfoPathReqBodyBuilder>)
	export function unRefProcessApprovalInfoPathReqBodyBuilder(v:Ref<ProcessApprovalInfoPathReqBodyBuilder>):ProcessApprovalInfoPathReqBodyBuilder
	export function emptyScopeValueBuilder():ScopeValueBuilder
	export function emptyRefScopeValueBuilder():Ref<ScopeValueBuilder>
	export function refOfScopeValueBuilder(x:ScopeValueBuilder,v:Ref<ScopeValueBuilder>)
	export function unRefScopeValueBuilder(v:Ref<ScopeValueBuilder>):ScopeValueBuilder
	export function emptyUserTmpDailyShiftBuilder():UserTmpDailyShiftBuilder
	export function emptyRefUserTmpDailyShiftBuilder():Ref<UserTmpDailyShiftBuilder>
	export function refOfUserTmpDailyShiftBuilder(x:UserTmpDailyShiftBuilder,v:Ref<UserTmpDailyShiftBuilder>)
	export function unRefUserTmpDailyShiftBuilder(v:Ref<UserTmpDailyShiftBuilder>):UserTmpDailyShiftBuilder
	...
	export function emptyOvertimeDetailBuilder():OvertimeDetailBuilder
	export function emptyRefOvertimeDetailBuilder():Ref<OvertimeDetailBuilder>
	export function refOfOvertimeDetailBuilder(x:OvertimeDetailBuilder,v:Ref<OvertimeDetailBuilder>)
	export function unRefOvertimeDetailBuilder(v:Ref<OvertimeDetailBuilder>):OvertimeDetailBuilder
	export function emptyPunchTimeSimpleRuleBuilder():PunchTimeSimpleRuleBuilder
	export function emptyRefPunchTimeSimpleRuleBuilder():Ref<PunchTimeSimpleRuleBuilder>
	export function refOfPunchTimeSimpleRuleBuilder(x:PunchTimeSimpleRuleBuilder,v:Ref<PunchTimeSimpleRuleBuilder>)
	export function unRefPunchTimeSimpleRuleBuilder(v:Ref<PunchTimeSimpleRuleBuilder>):PunchTimeSimpleRuleBuilder
	...
	export function emptyModifyUserSettingReqBodyBuilder():ModifyUserSettingReqBodyBuilder
	export function emptyRefModifyUserSettingReqBodyBuilder():Ref<ModifyUserSettingReqBodyBuilder>
	export function refOfModifyUserSettingReqBodyBuilder(x:ModifyUserSettingReqBodyBuilder,v:Ref<ModifyUserSettingReqBodyBuilder>)
	export function unRefModifyUserSettingReqBodyBuilder(v:Ref<ModifyUserSettingReqBodyBuilder>):ModifyUserSettingReqBodyBuilder
	...
	export function emptyGetLeaveEmployExpireRecordReqBodyBuilder():GetLeaveEmployExpireRecordReqBodyBuilder
	export function emptyRefGetLeaveEmployExpireRecordReqBodyBuilder():Ref<GetLeaveEmployExpireRecordReqBodyBuilder>
	export function refOfGetLeaveEmployExpireRecordReqBodyBuilder(x:GetLeaveEmployExpireRecordReqBodyBuilder,v:Ref<GetLeaveEmployExpireRecordReqBodyBuilder>)
	export function unRefGetLeaveEmployExpireRecordReqBodyBuilder(v:Ref<GetLeaveEmployExpireRecordReqBodyBuilder>):GetLeaveEmployExpireRecordReqBodyBuilder
	...
	export function emptyUserOvertimeWorkBuilder():UserOvertimeWorkBuilder
	export function emptyRefUserOvertimeWorkBuilder():Ref<UserOvertimeWorkBuilder>
	export function refOfUserOvertimeWorkBuilder(x:UserOvertimeWorkBuilder,v:Ref<UserOvertimeWorkBuilder>)
	export function unRefUserOvertimeWorkBuilder(v:Ref<UserOvertimeWorkBuilder>):UserOvertimeWorkBuilder
	...
	export function emptySearchGroupReqBuilder():SearchGroupReqBuilder
	export function emptyRefSearchGroupReqBuilder():Ref<SearchGroupReqBuilder>
	export function refOfSearchGroupReqBuilder(x:SearchGroupReqBuilder,v:Ref<SearchGroupReqBuilder>)
	export function unRefSearchGroupReqBuilder(v:Ref<SearchGroupReqBuilder>):SearchGroupReqBuilder
	export function emptyUserStatsDataCellBuilder():UserStatsDataCellBuilder
	export function emptyRefUserStatsDataCellBuilder():Ref<UserStatsDataCellBuilder>
	export function refOfUserStatsDataCellBuilder(x:UserStatsDataCellBuilder,v:Ref<UserStatsDataCellBuilder>)
	export function unRefUserStatsDataCellBuilder(v:Ref<UserStatsDataCellBuilder>):UserStatsDataCellBuilder
	...
	export function emptyArchiveFieldBuilder():ArchiveFieldBuilder
	export function emptyRefArchiveFieldBuilder():Ref<ArchiveFieldBuilder>
	export function refOfArchiveFieldBuilder(x:ArchiveFieldBuilder,v:Ref<ArchiveFieldBuilder>)
	export function unRefArchiveFieldBuilder(v:Ref<ArchiveFieldBuilder>):ArchiveFieldBuilder
	...
	export function emptyPunchMemberBuilder():PunchMemberBuilder
	export function emptyRefPunchMemberBuilder():Ref<PunchMemberBuilder>
	export function refOfPunchMemberBuilder(x:PunchMemberBuilder,v:Ref<PunchMemberBuilder>)
	export function unRefPunchMemberBuilder(v:Ref<PunchMemberBuilder>):PunchMemberBuilder
	export function emptyStatusChangeBuilder():StatusChangeBuilder
	export function emptyRefStatusChangeBuilder():Ref<StatusChangeBuilder>
	export function refOfStatusChangeBuilder(x:StatusChangeBuilder,v:Ref<StatusChangeBuilder>)
	export function unRefStatusChangeBuilder(v:Ref<StatusChangeBuilder>):StatusChangeBuilder
	...
	export function emptyUserDailyShiftBuilder():UserDailyShiftBuilder
	export function emptyRefUserDailyShiftBuilder():Ref<UserDailyShiftBuilder>
	export function refOfUserDailyShiftBuilder(x:UserDailyShiftBuilder,v:Ref<UserDailyShiftBuilder>)
	export function unRefUserDailyShiftBuilder(v:Ref<UserDailyShiftBuilder>):UserDailyShiftBuilder
	...
	export function emptyQueryUserStatsDataPathReqBodyBuilder():QueryUserStatsDataPathReqBodyBuilder
	export function emptyRefQueryUserStatsDataPathReqBodyBuilder():Ref<QueryUserStatsDataPathReqBodyBuilder>
	export function refOfQueryUserStatsDataPathReqBodyBuilder(x:QueryUserStatsDataPathReqBodyBuilder,v:Ref<QueryUserStatsDataPathReqBodyBuilder>)
	export function unRefQueryUserStatsDataPathReqBodyBuilder(v:Ref<QueryUserStatsDataPathReqBodyBuilder>):QueryUserStatsDataPathReqBodyBuilder
	...
	export function emptyUploadFilePathReqBodyBuilder():UploadFilePathReqBodyBuilder
	export function emptyRefUploadFilePathReqBodyBuilder():Ref<UploadFilePathReqBodyBuilder>
	export function refOfUploadFilePathReqBodyBuilder(x:UploadFilePathReqBodyBuilder,v:Ref<UploadFilePathReqBodyBuilder>)
	export function unRefUploadFilePathReqBodyBuilder(v:Ref<UploadFilePathReqBodyBuilder>):UploadFilePathReqBodyBuilder
	...
	export function emptyListGroupReqBuilder():ListGroupReqBuilder
	export function emptyRefListGroupReqBuilder():Ref<ListGroupReqBuilder>
	export function refOfListGroupReqBuilder(x:ListGroupReqBuilder,v:Ref<ListGroupReqBuilder>)
	export function unRefListGroupReqBuilder(v:Ref<ListGroupReqBuilder>):ListGroupReqBuilder
	...
	export function emptyQueryUserSettingPathReqBodyBuilder():QueryUserSettingPathReqBodyBuilder
	export function emptyRefQueryUserSettingPathReqBodyBuilder():Ref<QueryUserSettingPathReqBodyBuilder>
	export function refOfQueryUserSettingPathReqBodyBuilder(x:QueryUserSettingPathReqBodyBuilder,v:Ref<QueryUserSettingPathReqBodyBuilder>)
	export function unRefQueryUserSettingPathReqBodyBuilder(v:Ref<QueryUserSettingPathReqBodyBuilder>):QueryUserSettingPathReqBodyBuilder
	...
	export function emptyCreateGroupPathReqBodyBuilder():CreateGroupPathReqBodyBuilder
	export function emptyRefCreateGroupPathReqBodyBuilder():Ref<CreateGroupPathReqBodyBuilder>
	export function refOfCreateGroupPathReqBodyBuilder(x:CreateGroupPathReqBodyBuilder,v:Ref<CreateGroupPathReqBodyBuilder>)
	export function unRefCreateGroupPathReqBodyBuilder(v:Ref<CreateGroupPathReqBodyBuilder>):CreateGroupPathReqBodyBuilder
	...
	export function emptySearchGroupPathReqBodyBuilder():SearchGroupPathReqBodyBuilder
	export function emptyRefSearchGroupPathReqBodyBuilder():Ref<SearchGroupPathReqBodyBuilder>
	export function refOfSearchGroupPathReqBodyBuilder(x:SearchGroupPathReqBodyBuilder,v:Ref<SearchGroupPathReqBodyBuilder>)
	export function unRefSearchGroupPathReqBodyBuilder(v:Ref<SearchGroupPathReqBodyBuilder>):SearchGroupPathReqBodyBuilder
	...
	export function emptyWifiInfoBuilder():WifiInfoBuilder
	export function emptyRefWifiInfoBuilder():Ref<WifiInfoBuilder>
	export function refOfWifiInfoBuilder(x:WifiInfoBuilder,v:Ref<WifiInfoBuilder>)
	export function unRefWifiInfoBuilder(v:Ref<WifiInfoBuilder>):WifiInfoBuilder
	export function emptyBatchCreateUserFlowReqBuilder():BatchCreateUserFlowReqBuilder
	export function emptyRefBatchCreateUserFlowReqBuilder():Ref<BatchCreateUserFlowReqBuilder>
	export function refOfBatchCreateUserFlowReqBuilder(x:BatchCreateUserFlowReqBuilder,v:Ref<BatchCreateUserFlowReqBuilder>)
	export function unRefBatchCreateUserFlowReqBuilder(v:Ref<BatchCreateUserFlowReqBuilder>):BatchCreateUserFlowReqBuilder
	...
	export function emptyOvertimeTimeRangeBuilder():OvertimeTimeRangeBuilder
	export function emptyRefOvertimeTimeRangeBuilder():Ref<OvertimeTimeRangeBuilder>
	export function refOfOvertimeTimeRangeBuilder(x:OvertimeTimeRangeBuilder,v:Ref<OvertimeTimeRangeBuilder>)
	export function unRefOvertimeTimeRangeBuilder(v:Ref<OvertimeTimeRangeBuilder>):OvertimeTimeRangeBuilder
	...
	export function emptyQueryUserTaskRemedyReqBuilder():QueryUserTaskRemedyReqBuilder
	export function emptyRefQueryUserTaskRemedyReqBuilder():Ref<QueryUserTaskRemedyReqBuilder>
	export function refOfQueryUserTaskRemedyReqBuilder(x:QueryUserTaskRemedyReqBuilder,v:Ref<QueryUserTaskRemedyReqBuilder>)
	export function unRefQueryUserTaskRemedyReqBuilder(v:Ref<QueryUserTaskRemedyReqBuilder>):QueryUserTaskRemedyReqBuilder
	...
	export function emptyQueryUserTaskReqBuilder():QueryUserTaskReqBuilder
	export function emptyRefQueryUserTaskReqBuilder():Ref<QueryUserTaskReqBuilder>
	export function refOfQueryUserTaskReqBuilder(x:QueryUserTaskReqBuilder,v:Ref<QueryUserTaskReqBuilder>)
	export function unRefQueryUserTaskReqBuilder(v:Ref<QueryUserTaskReqBuilder>):QueryUserTaskReqBuilder
	export function emptyBatchCreateUserDailyShiftReqBodyBuilder():BatchCreateUserDailyShiftReqBodyBuilder
	export function emptyRefBatchCreateUserDailyShiftReqBodyBuilder():Ref<BatchCreateUserDailyShiftReqBodyBuilder>
	export function refOfBatchCreateUserDailyShiftReqBodyBuilder(x:BatchCreateUserDailyShiftReqBodyBuilder,v:Ref<BatchCreateUserDailyShiftReqBodyBuilder>)
	export function unRefBatchCreateUserDailyShiftReqBodyBuilder(v:Ref<BatchCreateUserDailyShiftReqBodyBuilder>):BatchCreateUserDailyShiftReqBodyBuilder
	export function emptyUpdateUserStatsViewPathReqBodyBuilder():UpdateUserStatsViewPathReqBodyBuilder
	export function emptyRefUpdateUserStatsViewPathReqBodyBuilder():Ref<UpdateUserStatsViewPathReqBodyBuilder>
	export function refOfUpdateUserStatsViewPathReqBodyBuilder(x:UpdateUserStatsViewPathReqBodyBuilder,v:Ref<UpdateUserStatsViewPathReqBodyBuilder>)
	export function unRefUpdateUserStatsViewPathReqBodyBuilder(v:Ref<UpdateUserStatsViewPathReqBodyBuilder>):UpdateUserStatsViewPathReqBodyBuilder
	export function emptyQueryUserSettingReqBuilder():QueryUserSettingReqBuilder
	export function emptyRefQueryUserSettingReqBuilder():Ref<QueryUserSettingReqBuilder>
	export function refOfQueryUserSettingReqBuilder(x:QueryUserSettingReqBuilder,v:Ref<QueryUserSettingReqBuilder>)
	export function unRefQueryUserSettingReqBuilder(v:Ref<QueryUserSettingReqBuilder>):QueryUserSettingReqBuilder
	...
	export function emptyQueryUserTaskPathReqBodyBuilder():QueryUserTaskPathReqBodyBuilder
	export function emptyRefQueryUserTaskPathReqBodyBuilder():Ref<QueryUserTaskPathReqBodyBuilder>
	export function refOfQueryUserTaskPathReqBodyBuilder(x:QueryUserTaskPathReqBodyBuilder,v:Ref<QueryUserTaskPathReqBodyBuilder>)
	export function unRefQueryUserTaskPathReqBodyBuilder(v:Ref<QueryUserTaskPathReqBodyBuilder>):QueryUserTaskPathReqBodyBuilder
	...
	export function emptyProcessApprovalInfoReqBodyBuilder():ProcessApprovalInfoReqBodyBuilder
	export function emptyRefProcessApprovalInfoReqBodyBuilder():Ref<ProcessApprovalInfoReqBodyBuilder>
	export function refOfProcessApprovalInfoReqBodyBuilder(x:ProcessApprovalInfoReqBodyBuilder,v:Ref<ProcessApprovalInfoReqBodyBuilder>)
	export function unRefProcessApprovalInfoReqBodyBuilder(v:Ref<ProcessApprovalInfoReqBodyBuilder>):ProcessApprovalInfoReqBodyBuilder
	export function emptyUserFlowBuilder():UserFlowBuilder
	export function emptyRefUserFlowBuilder():Ref<UserFlowBuilder>
	export function refOfUserFlowBuilder(x:UserFlowBuilder,v:Ref<UserFlowBuilder>)
	export function unRefUserFlowBuilder(v:Ref<UserFlowBuilder>):UserFlowBuilder
	...
	export function emptyLateOffLateOnRuleBuilder():LateOffLateOnRuleBuilder
	export function emptyRefLateOffLateOnRuleBuilder():Ref<LateOffLateOnRuleBuilder>
	export function refOfLateOffLateOnRuleBuilder(x:LateOffLateOnRuleBuilder,v:Ref<LateOffLateOnRuleBuilder>)
	export function unRefLateOffLateOnRuleBuilder(v:Ref<LateOffLateOnRuleBuilder>):LateOffLateOnRuleBuilder
	...
	export function emptyQueryUserStatsFieldReqBodyBuilder():QueryUserStatsFieldReqBodyBuilder
	export function emptyRefQueryUserStatsFieldReqBodyBuilder():Ref<QueryUserStatsFieldReqBodyBuilder>
	export function refOfQueryUserStatsFieldReqBodyBuilder(x:QueryUserStatsFieldReqBodyBuilder,v:Ref<QueryUserStatsFieldReqBodyBuilder>)
	export function unRefQueryUserStatsFieldReqBodyBuilder(v:Ref<QueryUserStatsFieldReqBodyBuilder>):QueryUserStatsFieldReqBodyBuilder
	export function emptyI18nMapBuilder():I18nMapBuilder
	export function emptyRefI18nMapBuilder():Ref<I18nMapBuilder>
	export function refOfI18nMapBuilder(x:I18nMapBuilder,v:Ref<I18nMapBuilder>)
	export function unRefI18nMapBuilder(v:Ref<I18nMapBuilder>):I18nMapBuilder
	...
	export function emptyUserStatsDataBuilder():UserStatsDataBuilder
	export function emptyRefUserStatsDataBuilder():Ref<UserStatsDataBuilder>
	export function refOfUserStatsDataBuilder(x:UserStatsDataBuilder,v:Ref<UserStatsDataBuilder>)
	export function unRefUserStatsDataBuilder(v:Ref<UserStatsDataBuilder>):UserStatsDataBuilder
	...
	export function emptyPunchSpecialDateShiftBuilder():PunchSpecialDateShiftBuilder
	export function emptyRefPunchSpecialDateShiftBuilder():Ref<PunchSpecialDateShiftBuilder>
	export function refOfPunchSpecialDateShiftBuilder(x:PunchSpecialDateShiftBuilder,v:Ref<PunchSpecialDateShiftBuilder>)
	export function unRefPunchSpecialDateShiftBuilder(v:Ref<PunchSpecialDateShiftBuilder>):PunchSpecialDateShiftBuilder
	export function emptyFieldBuilder():FieldBuilder
	export function emptyRefFieldBuilder():Ref<FieldBuilder>
	export function refOfFieldBuilder(x:FieldBuilder,v:Ref<FieldBuilder>)
	export function unRefFieldBuilder(v:Ref<FieldBuilder>):FieldBuilder
	...
	export function emptyQueryUserApprovalReqBuilder():QueryUserApprovalReqBuilder
	export function emptyRefQueryUserApprovalReqBuilder():Ref<QueryUserApprovalReqBuilder>
	export function refOfQueryUserApprovalReqBuilder(x:QueryUserApprovalReqBuilder,v:Ref<QueryUserApprovalReqBuilder>)
	export function unRefQueryUserApprovalReqBuilder(v:Ref<QueryUserApprovalReqBuilder>):QueryUserApprovalReqBuilder
	export function emptyQueryUserTaskRemedyPathReqBodyBuilder():QueryUserTaskRemedyPathReqBodyBuilder
	export function emptyRefQueryUserTaskRemedyPathReqBodyBuilder():Ref<QueryUserTaskRemedyPathReqBodyBuilder>
	export function refOfQueryUserTaskRemedyPathReqBodyBuilder(x:QueryUserTaskRemedyPathReqBodyBuilder,v:Ref<QueryUserTaskRemedyPathReqBodyBuilder>)
	export function unRefQueryUserTaskRemedyPathReqBodyBuilder(v:Ref<QueryUserTaskRemedyPathReqBodyBuilder>):QueryUserTaskRemedyPathReqBodyBuilder
	export function emptyArchiveFieldDataBuilder():ArchiveFieldDataBuilder
	export function emptyRefArchiveFieldDataBuilder():Ref<ArchiveFieldDataBuilder>
	export function refOfArchiveFieldDataBuilder(x:ArchiveFieldDataBuilder,v:Ref<ArchiveFieldDataBuilder>)
	export function unRefArchiveFieldDataBuilder(v:Ref<ArchiveFieldDataBuilder>):ArchiveFieldDataBuilder
	...
	export function emptyFreePunchCfgBuilder():FreePunchCfgBuilder
	export function emptyRefFreePunchCfgBuilder():Ref<FreePunchCfgBuilder>
	export function refOfFreePunchCfgBuilder(x:FreePunchCfgBuilder,v:Ref<FreePunchCfgBuilder>)
	export function unRefFreePunchCfgBuilder(v:Ref<FreePunchCfgBuilder>):FreePunchCfgBuilder
	export function emptyArrangeShiftGroupBuilder():ArrangeShiftGroupBuilder
	export function emptyRefArrangeShiftGroupBuilder():Ref<ArrangeShiftGroupBuilder>
	export function refOfArrangeShiftGroupBuilder(x:ArrangeShiftGroupBuilder,v:Ref<ArrangeShiftGroupBuilder>)
	export function unRefArrangeShiftGroupBuilder(v:Ref<ArrangeShiftGroupBuilder>):ArrangeShiftGroupBuilder
	...
	export function emptyPatchLeaveAccrualRecordReqBodyBuilder():PatchLeaveAccrualRecordReqBodyBuilder
	export function emptyRefPatchLeaveAccrualRecordReqBodyBuilder():Ref<PatchLeaveAccrualRecordReqBodyBuilder>
	export function refOfPatchLeaveAccrualRecordReqBodyBuilder(x:PatchLeaveAccrualRecordReqBodyBuilder,v:Ref<PatchLeaveAccrualRecordReqBodyBuilder>)
	export function unRefPatchLeaveAccrualRecordReqBodyBuilder(v:Ref<PatchLeaveAccrualRecordReqBodyBuilder>):PatchLeaveAccrualRecordReqBodyBuilder
	...
	export function emptyQueryUserDailyShiftReqBuilder():QueryUserDailyShiftReqBuilder
	export function emptyRefQueryUserDailyShiftReqBuilder():Ref<QueryUserDailyShiftReqBuilder>
	export function refOfQueryUserDailyShiftReqBuilder(x:QueryUserDailyShiftReqBuilder,v:Ref<QueryUserDailyShiftReqBuilder>)
	export function unRefQueryUserDailyShiftReqBuilder(v:Ref<QueryUserDailyShiftReqBuilder>):QueryUserDailyShiftReqBuilder
	...
	export function emptyAreaBuilder():AreaBuilder
	export function emptyRefAreaBuilder():Ref<AreaBuilder>
	export function refOfAreaBuilder(x:AreaBuilder,v:Ref<AreaBuilder>)
	export function unRefAreaBuilder(v:Ref<AreaBuilder>):AreaBuilder
	export function emptyCreateUserApprovalReqBuilder():CreateUserApprovalReqBuilder
	export function emptyRefCreateUserApprovalReqBuilder():Ref<CreateUserApprovalReqBuilder>
	export function refOfCreateUserApprovalReqBuilder(x:CreateUserApprovalReqBuilder,v:Ref<CreateUserApprovalReqBuilder>)
	export function unRefCreateUserApprovalReqBuilder(v:Ref<CreateUserApprovalReqBuilder>):CreateUserApprovalReqBuilder
	...
	export function emptyQueryUserDailyShiftPathReqBodyBuilder():QueryUserDailyShiftPathReqBodyBuilder
	export function emptyRefQueryUserDailyShiftPathReqBodyBuilder():Ref<QueryUserDailyShiftPathReqBodyBuilder>
	export function refOfQueryUserDailyShiftPathReqBodyBuilder(x:QueryUserDailyShiftPathReqBodyBuilder,v:Ref<QueryUserDailyShiftPathReqBodyBuilder>)
	export function unRefQueryUserDailyShiftPathReqBodyBuilder(v:Ref<QueryUserDailyShiftPathReqBodyBuilder>):QueryUserDailyShiftPathReqBodyBuilder
	export function emptyArchiveReportDataBuilder():ArchiveReportDataBuilder
	export function emptyRefArchiveReportDataBuilder():Ref<ArchiveReportDataBuilder>
	export function refOfArchiveReportDataBuilder(x:ArchiveReportDataBuilder,v:Ref<ArchiveReportDataBuilder>)
	export function unRefArchiveReportDataBuilder(v:Ref<ArchiveReportDataBuilder>):ArchiveReportDataBuilder
	export function emptyCoordinateBuilder():CoordinateBuilder
	export function emptyRefCoordinateBuilder():Ref<CoordinateBuilder>
	export function refOfCoordinateBuilder(x:CoordinateBuilder,v:Ref<CoordinateBuilder>)
	export function unRefCoordinateBuilder(v:Ref<CoordinateBuilder>):CoordinateBuilder
	...
	export function emptyQueryUserFlowReqBuilder():QueryUserFlowReqBuilder
	export function emptyRefQueryUserFlowReqBuilder():Ref<QueryUserFlowReqBuilder>
	export function refOfQueryUserFlowReqBuilder(x:QueryUserFlowReqBuilder,v:Ref<QueryUserFlowReqBuilder>)
	export function unRefQueryUserFlowReqBuilder(v:Ref<QueryUserFlowReqBuilder>):QueryUserFlowReqBuilder
	export function emptyBatchCreateUserFlowReqBodyBuilder():BatchCreateUserFlowReqBodyBuilder
	export function emptyRefBatchCreateUserFlowReqBodyBuilder():Ref<BatchCreateUserFlowReqBodyBuilder>
	export function refOfBatchCreateUserFlowReqBodyBuilder(x:BatchCreateUserFlowReqBodyBuilder,v:Ref<BatchCreateUserFlowReqBodyBuilder>)
	export function unRefBatchCreateUserFlowReqBodyBuilder(v:Ref<BatchCreateUserFlowReqBodyBuilder>):BatchCreateUserFlowReqBodyBuilder
	export function emptyBatchCreateUserDailyShiftReqBuilder():BatchCreateUserDailyShiftReqBuilder
	export function emptyRefBatchCreateUserDailyShiftReqBuilder():Ref<BatchCreateUserDailyShiftReqBuilder>
	export function refOfBatchCreateUserDailyShiftReqBuilder(x:BatchCreateUserDailyShiftReqBuilder,v:Ref<BatchCreateUserDailyShiftReqBuilder>)
	export function unRefBatchCreateUserDailyShiftReqBuilder(v:Ref<BatchCreateUserDailyShiftReqBuilder>):BatchCreateUserDailyShiftReqBuilder
	...
	export function emptyBatchCreateUserDailyShiftPathReqBodyBuilder():BatchCreateUserDailyShiftPathReqBodyBuilder
	export function emptyRefBatchCreateUserDailyShiftPathReqBodyBuilder():Ref<BatchCreateUserDailyShiftPathReqBodyBuilder>
	export function refOfBatchCreateUserDailyShiftPathReqBodyBuilder(x:BatchCreateUserDailyShiftPathReqBodyBuilder,v:Ref<BatchCreateUserDailyShiftPathReqBodyBuilder>)
	export function unRefBatchCreateUserDailyShiftPathReqBodyBuilder(v:Ref<BatchCreateUserDailyShiftPathReqBodyBuilder>):BatchCreateUserDailyShiftPathReqBodyBuilder
	...
	export function emptyQueryUserTaskRemedyReqBodyBuilder():QueryUserTaskRemedyReqBodyBuilder
	export function emptyRefQueryUserTaskRemedyReqBodyBuilder():Ref<QueryUserTaskRemedyReqBodyBuilder>
	export function refOfQueryUserTaskRemedyReqBodyBuilder(x:QueryUserTaskRemedyReqBodyBuilder,v:Ref<QueryUserTaskRemedyReqBodyBuilder>)
	export function unRefQueryUserTaskRemedyReqBodyBuilder(v:Ref<QueryUserTaskRemedyReqBodyBuilder>):QueryUserTaskRemedyReqBodyBuilder
	export function emptyTaskResultBuilder():TaskResultBuilder
	export function emptyRefTaskResultBuilder():Ref<TaskResultBuilder>
	export function refOfTaskResultBuilder(x:TaskResultBuilder,v:Ref<TaskResultBuilder>)
	export function unRefTaskResultBuilder(v:Ref<TaskResultBuilder>):TaskResultBuilder
	...
	export function emptyChildFieldBuilder():ChildFieldBuilder
	export function emptyRefChildFieldBuilder():Ref<ChildFieldBuilder>
	export function refOfChildFieldBuilder(x:ChildFieldBuilder,v:Ref<ChildFieldBuilder>)
	export function unRefChildFieldBuilder(v:Ref<ChildFieldBuilder>):ChildFieldBuilder
	...
	export function emptyQueryShiftReqBuilder():QueryShiftReqBuilder
	export function emptyRefQueryShiftReqBuilder():Ref<QueryShiftReqBuilder>
	export function refOfQueryShiftReqBuilder(x:QueryShiftReqBuilder,v:Ref<QueryShiftReqBuilder>)
	export function unRefQueryShiftReqBuilder(v:Ref<QueryShiftReqBuilder>):QueryShiftReqBuilder
	...
	export function emptyDeleteShiftReqBuilder():DeleteShiftReqBuilder
	export function emptyRefDeleteShiftReqBuilder():Ref<DeleteShiftReqBuilder>
	export function refOfDeleteShiftReqBuilder(x:DeleteShiftReqBuilder,v:Ref<DeleteShiftReqBuilder>)
	export function unRefDeleteShiftReqBuilder(v:Ref<DeleteShiftReqBuilder>):DeleteShiftReqBuilder
	export function emptyLeaveNeedPunchCfgBuilder():LeaveNeedPunchCfgBuilder
	export function emptyRefLeaveNeedPunchCfgBuilder():Ref<LeaveNeedPunchCfgBuilder>
	export function refOfLeaveNeedPunchCfgBuilder(x:LeaveNeedPunchCfgBuilder,v:Ref<LeaveNeedPunchCfgBuilder>)
	export function unRefLeaveNeedPunchCfgBuilder(v:Ref<LeaveNeedPunchCfgBuilder>):LeaveNeedPunchCfgBuilder
	export function emptyQueryUserFlowPathReqBodyBuilder():QueryUserFlowPathReqBodyBuilder
	export function emptyRefQueryUserFlowPathReqBodyBuilder():Ref<QueryUserFlowPathReqBodyBuilder>
	export function refOfQueryUserFlowPathReqBodyBuilder(x:QueryUserFlowPathReqBodyBuilder,v:Ref<QueryUserFlowPathReqBodyBuilder>)
	export function unRefQueryUserFlowPathReqBodyBuilder(v:Ref<QueryUserFlowPathReqBodyBuilder>):QueryUserFlowPathReqBodyBuilder
	...
	export function emptyModifyUserSettingPathReqBodyBuilder():ModifyUserSettingPathReqBodyBuilder
	export function emptyRefModifyUserSettingPathReqBodyBuilder():Ref<ModifyUserSettingPathReqBodyBuilder>
	export function refOfModifyUserSettingPathReqBodyBuilder(x:ModifyUserSettingPathReqBodyBuilder,v:Ref<ModifyUserSettingPathReqBodyBuilder>)
	export function unRefModifyUserSettingPathReqBodyBuilder(v:Ref<ModifyUserSettingPathReqBodyBuilder>):ModifyUserSettingPathReqBodyBuilder
	...
	export function emptyPatchLeaveAccrualRecordReqBuilder():PatchLeaveAccrualRecordReqBuilder
	export function emptyRefPatchLeaveAccrualRecordReqBuilder():Ref<PatchLeaveAccrualRecordReqBuilder>
	export function refOfPatchLeaveAccrualRecordReqBuilder(x:PatchLeaveAccrualRecordReqBuilder,v:Ref<PatchLeaveAccrualRecordReqBuilder>)
	export function unRefPatchLeaveAccrualRecordReqBuilder(v:Ref<PatchLeaveAccrualRecordReqBuilder>):PatchLeaveAccrualRecordReqBuilder
	...
	export function emptyOvertimeClockCfgBuilder():OvertimeClockCfgBuilder
	export function emptyRefOvertimeClockCfgBuilder():Ref<OvertimeClockCfgBuilder>
	export function refOfOvertimeClockCfgBuilder(x:OvertimeClockCfgBuilder,v:Ref<OvertimeClockCfgBuilder>)
	export function unRefOvertimeClockCfgBuilder(v:Ref<OvertimeClockCfgBuilder>):OvertimeClockCfgBuilder
	...
	export function emptyCreateGroupReqBodyBuilder():CreateGroupReqBodyBuilder
	export function emptyRefCreateGroupReqBodyBuilder():Ref<CreateGroupReqBodyBuilder>
	export function refOfCreateGroupReqBodyBuilder(x:CreateGroupReqBodyBuilder,v:Ref<CreateGroupReqBodyBuilder>)
	export function unRefCreateGroupReqBodyBuilder(v:Ref<CreateGroupReqBodyBuilder>):CreateGroupReqBodyBuilder
	...
	export function emptyModifyUserSettingReqBuilder():ModifyUserSettingReqBuilder
	export function emptyRefModifyUserSettingReqBuilder():Ref<ModifyUserSettingReqBuilder>
	export function refOfModifyUserSettingReqBuilder(x:ModifyUserSettingReqBuilder,v:Ref<ModifyUserSettingReqBuilder>)
	export function unRefModifyUserSettingReqBuilder(v:Ref<ModifyUserSettingReqBuilder>):ModifyUserSettingReqBuilder
	...
	export function emptyQueryUserSettingReqBodyBuilder():QueryUserSettingReqBodyBuilder
	export function emptyRefQueryUserSettingReqBodyBuilder():Ref<QueryUserSettingReqBodyBuilder>
	export function refOfQueryUserSettingReqBodyBuilder(x:QueryUserSettingReqBodyBuilder,v:Ref<QueryUserSettingReqBodyBuilder>)
	export function unRefQueryUserSettingReqBodyBuilder(v:Ref<QueryUserSettingReqBodyBuilder>):QueryUserSettingReqBodyBuilder
	export function emptyQueryUserStatsViewReqBodyBuilder():QueryUserStatsViewReqBodyBuilder
	export function emptyRefQueryUserStatsViewReqBodyBuilder():Ref<QueryUserStatsViewReqBodyBuilder>
	export function refOfQueryUserStatsViewReqBodyBuilder(x:QueryUserStatsViewReqBodyBuilder,v:Ref<QueryUserStatsViewReqBodyBuilder>)
	export function unRefQueryUserStatsViewReqBodyBuilder(v:Ref<QueryUserStatsViewReqBodyBuilder>):QueryUserStatsViewReqBodyBuilder
	export function emptyUserTripBuilder():UserTripBuilder
	export function emptyRefUserTripBuilder():Ref<UserTripBuilder>
	export function refOfUserTripBuilder(x:UserTripBuilder,v:Ref<UserTripBuilder>)
	export function unRefUserTripBuilder(v:Ref<UserTripBuilder>):UserTripBuilder
	...
	export function emptyGetShiftReqBuilder():GetShiftReqBuilder
	export function emptyRefGetShiftReqBuilder():Ref<GetShiftReqBuilder>
	export function refOfGetShiftReqBuilder(x:GetShiftReqBuilder,v:Ref<GetShiftReqBuilder>)
	export function unRefGetShiftReqBuilder(v:Ref<GetShiftReqBuilder>):GetShiftReqBuilder
	...
	export function emptyUserStatsFieldBuilder():UserStatsFieldBuilder
	export function emptyRefUserStatsFieldBuilder():Ref<UserStatsFieldBuilder>
	export function refOfUserStatsFieldBuilder(x:UserStatsFieldBuilder,v:Ref<UserStatsFieldBuilder>)
	export function unRefUserStatsFieldBuilder(v:Ref<UserStatsFieldBuilder>):UserStatsFieldBuilder
	export function emptyUserTaskBuilder():UserTaskBuilder
	export function emptyRefUserTaskBuilder():Ref<UserTaskBuilder>
	export function refOfUserTaskBuilder(x:UserTaskBuilder,v:Ref<UserTaskBuilder>)
	export function unRefUserTaskBuilder(v:Ref<UserTaskBuilder>):UserTaskBuilder
	...
	export function emptyCreateUserApprovalPathReqBodyBuilder():CreateUserApprovalPathReqBodyBuilder
	export function emptyRefCreateUserApprovalPathReqBodyBuilder():Ref<CreateUserApprovalPathReqBodyBuilder>
	export function refOfCreateUserApprovalPathReqBodyBuilder(x:CreateUserApprovalPathReqBodyBuilder,v:Ref<CreateUserApprovalPathReqBodyBuilder>)
	export function unRefCreateUserApprovalPathReqBodyBuilder(v:Ref<CreateUserApprovalPathReqBodyBuilder>):CreateUserApprovalPathReqBodyBuilder
	...
	export function emptyMachineBuilder():MachineBuilder
	export function emptyRefMachineBuilder():Ref<MachineBuilder>
	export function refOfMachineBuilder(x:MachineBuilder,v:Ref<MachineBuilder>)
	export function unRefMachineBuilder(v:Ref<MachineBuilder>):MachineBuilder
	...
	export function emptyQueryUserStatsFieldReqBuilder():QueryUserStatsFieldReqBuilder
	export function emptyRefQueryUserStatsFieldReqBuilder():Ref<QueryUserStatsFieldReqBuilder>
	export function refOfQueryUserStatsFieldReqBuilder(x:QueryUserStatsFieldReqBuilder,v:Ref<QueryUserStatsFieldReqBuilder>)
	export function unRefQueryUserStatsFieldReqBuilder(v:Ref<QueryUserStatsFieldReqBuilder>):QueryUserStatsFieldReqBuilder
	...
	export function emptyUserAllowedRemedyBuilder():UserAllowedRemedyBuilder
	export function emptyRefUserAllowedRemedyBuilder():Ref<UserAllowedRemedyBuilder>
	export function refOfUserAllowedRemedyBuilder(x:UserAllowedRemedyBuilder,v:Ref<UserAllowedRemedyBuilder>)
	export function unRefUserAllowedRemedyBuilder(v:Ref<UserAllowedRemedyBuilder>):UserAllowedRemedyBuilder
