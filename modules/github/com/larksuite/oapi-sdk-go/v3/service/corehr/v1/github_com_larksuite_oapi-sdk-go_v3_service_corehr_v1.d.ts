...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/corehr/v1'{
	...
	// @ts-ignore
	import type {Alias,Nothing,float64,Ref,bool,Struct,int,error} from 'go'
	...
	export interface P2JobCreatedV1 extends larkevent.EventHandlerModel,Struct<P2JobCreatedV1>{
	...
	export interface P2PersonUpdatedV1 extends larkevent.EventHandlerModel,Struct<P2PersonUpdatedV1>{
	...
	export function emptyGetJobFamilyReqBuilder():GetJobFamilyReqBuilder
	export function emptyRefGetJobFamilyReqBuilder():Ref<GetJobFamilyReqBuilder>
	export function refOfGetJobFamilyReqBuilder(x:GetJobFamilyReqBuilder,v:Ref<GetJobFamilyReqBuilder>)
	export function unRefGetJobFamilyReqBuilder(v:Ref<GetJobFamilyReqBuilder>):GetJobFamilyReqBuilder
	...
	export function emptyCreateEmploymentReqBuilder():CreateEmploymentReqBuilder
	export function emptyRefCreateEmploymentReqBuilder():Ref<CreateEmploymentReqBuilder>
	export function refOfCreateEmploymentReqBuilder(x:CreateEmploymentReqBuilder,v:Ref<CreateEmploymentReqBuilder>)
	export function unRefCreateEmploymentReqBuilder(v:Ref<CreateEmploymentReqBuilder>):CreateEmploymentReqBuilder
	...
	export function emptyCreateContractReqBuilder():CreateContractReqBuilder
	export function emptyRefCreateContractReqBuilder():Ref<CreateContractReqBuilder>
	export function refOfCreateContractReqBuilder(x:CreateContractReqBuilder,v:Ref<CreateContractReqBuilder>)
	export function unRefCreateContractReqBuilder(v:Ref<CreateContractReqBuilder>):CreateContractReqBuilder
	...
	export function emptyManageRelationBuilder():ManageRelationBuilder
	export function emptyRefManageRelationBuilder():Ref<ManageRelationBuilder>
	export function refOfManageRelationBuilder(x:ManageRelationBuilder,v:Ref<ManageRelationBuilder>)
	export function unRefManageRelationBuilder(v:Ref<ManageRelationBuilder>):ManageRelationBuilder
	...
	export function emptySubdivisionBuilder():SubdivisionBuilder
	export function emptyRefSubdivisionBuilder():Ref<SubdivisionBuilder>
	export function refOfSubdivisionBuilder(x:SubdivisionBuilder,v:Ref<SubdivisionBuilder>)
	export function unRefSubdivisionBuilder(v:Ref<SubdivisionBuilder>):SubdivisionBuilder
	export function emptyApplicationInfoBuilder():ApplicationInfoBuilder
	export function emptyRefApplicationInfoBuilder():Ref<ApplicationInfoBuilder>
	export function refOfApplicationInfoBuilder(x:ApplicationInfoBuilder,v:Ref<ApplicationInfoBuilder>)
	export function unRefApplicationInfoBuilder(v:Ref<ApplicationInfoBuilder>):ApplicationInfoBuilder
	export function emptyGetCurrencyReqBuilder():GetCurrencyReqBuilder
	export function emptyRefGetCurrencyReqBuilder():Ref<GetCurrencyReqBuilder>
	export function refOfGetCurrencyReqBuilder(x:GetCurrencyReqBuilder,v:Ref<GetCurrencyReqBuilder>)
	export function unRefGetCurrencyReqBuilder(v:Ref<GetCurrencyReqBuilder>):GetCurrencyReqBuilder
	...
	export function emptyGetJobLevelReqBuilder():GetJobLevelReqBuilder
	export function emptyRefGetJobLevelReqBuilder():Ref<GetJobLevelReqBuilder>
	export function refOfGetJobLevelReqBuilder(x:GetJobLevelReqBuilder,v:Ref<GetJobLevelReqBuilder>)
	export function unRefGetJobLevelReqBuilder(v:Ref<GetJobLevelReqBuilder>):GetJobLevelReqBuilder
	...
	export function emptyProcessBuilder():ProcessBuilder
	export function emptyRefProcessBuilder():Ref<ProcessBuilder>
	export function refOfProcessBuilder(x:ProcessBuilder,v:Ref<ProcessBuilder>)
	export function unRefProcessBuilder(v:Ref<ProcessBuilder>):ProcessBuilder
	export function emptyQueryOffboardingReqBuilder():QueryOffboardingReqBuilder
	export function emptyRefQueryOffboardingReqBuilder():Ref<QueryOffboardingReqBuilder>
	export function refOfQueryOffboardingReqBuilder(x:QueryOffboardingReqBuilder,v:Ref<QueryOffboardingReqBuilder>)
	export function unRefQueryOffboardingReqBuilder(v:Ref<QueryOffboardingReqBuilder>):QueryOffboardingReqBuilder
	...
	export function emptyWorkingHoursTypeBuilder():WorkingHoursTypeBuilder
	export function emptyRefWorkingHoursTypeBuilder():Ref<WorkingHoursTypeBuilder>
	export function refOfWorkingHoursTypeBuilder(x:WorkingHoursTypeBuilder,v:Ref<WorkingHoursTypeBuilder>)
	export function unRefWorkingHoursTypeBuilder(v:Ref<WorkingHoursTypeBuilder>):WorkingHoursTypeBuilder
	...
	export function emptyLeaveRequestHistoryLeaveReqBuilder():LeaveRequestHistoryLeaveReqBuilder
	export function emptyRefLeaveRequestHistoryLeaveReqBuilder():Ref<LeaveRequestHistoryLeaveReqBuilder>
	export function refOfLeaveRequestHistoryLeaveReqBuilder(x:LeaveRequestHistoryLeaveReqBuilder,v:Ref<LeaveRequestHistoryLeaveReqBuilder>)
	export function unRefLeaveRequestHistoryLeaveReqBuilder(v:Ref<LeaveRequestHistoryLeaveReqBuilder>):LeaveRequestHistoryLeaveReqBuilder
	...
	export function emptyEmploymentCostCenterBuilder():EmploymentCostCenterBuilder
	export function emptyRefEmploymentCostCenterBuilder():Ref<EmploymentCostCenterBuilder>
	export function refOfEmploymentCostCenterBuilder(x:EmploymentCostCenterBuilder,v:Ref<EmploymentCostCenterBuilder>)
	export function unRefEmploymentCostCenterBuilder(v:Ref<EmploymentCostCenterBuilder>):EmploymentCostCenterBuilder
	...
	export function emptyP2DepartmentDeletedV1Handler():P2DepartmentDeletedV1Handler
	export function emptyRefP2DepartmentDeletedV1Handler():Ref<P2DepartmentDeletedV1Handler>
	export function refOfP2DepartmentDeletedV1Handler(x:P2DepartmentDeletedV1Handler,v:Ref<P2DepartmentDeletedV1Handler>)
	export function unRefP2DepartmentDeletedV1Handler(v:Ref<P2DepartmentDeletedV1Handler>):P2DepartmentDeletedV1Handler
	...
	export function emptyListEmployeeTypeReqBuilder():ListEmployeeTypeReqBuilder
	export function emptyRefListEmployeeTypeReqBuilder():Ref<ListEmployeeTypeReqBuilder>
	export function refOfListEmployeeTypeReqBuilder(x:ListEmployeeTypeReqBuilder,v:Ref<ListEmployeeTypeReqBuilder>)
	export function unRefListEmployeeTypeReqBuilder(v:Ref<ListEmployeeTypeReqBuilder>):ListEmployeeTypeReqBuilder
	...
	export function emptyTransferReasonBuilder():TransferReasonBuilder
	export function emptyRefTransferReasonBuilder():Ref<TransferReasonBuilder>
	export function refOfTransferReasonBuilder(x:TransferReasonBuilder,v:Ref<TransferReasonBuilder>)
	export function unRefTransferReasonBuilder(v:Ref<TransferReasonBuilder>):TransferReasonBuilder
	...
	export function emptyUploadPersonReqBodyBuilder():UploadPersonReqBodyBuilder
	export function emptyRefUploadPersonReqBodyBuilder():Ref<UploadPersonReqBodyBuilder>
	export function refOfUploadPersonReqBodyBuilder(x:UploadPersonReqBodyBuilder,v:Ref<UploadPersonReqBodyBuilder>)
	export function unRefUploadPersonReqBodyBuilder(v:Ref<UploadPersonReqBodyBuilder>):UploadPersonReqBodyBuilder
	...
	export function emptyPatchContractReqBuilder():PatchContractReqBuilder
	export function emptyRefPatchContractReqBuilder():Ref<PatchContractReqBuilder>
	export function refOfPatchContractReqBuilder(x:PatchContractReqBuilder,v:Ref<PatchContractReqBuilder>)
	export function unRefPatchContractReqBuilder(v:Ref<PatchContractReqBuilder>):PatchContractReqBuilder
	...
	export function emptyPatchWorkingHoursTypeReqBuilder():PatchWorkingHoursTypeReqBuilder
	export function emptyRefPatchWorkingHoursTypeReqBuilder():Ref<PatchWorkingHoursTypeReqBuilder>
	export function refOfPatchWorkingHoursTypeReqBuilder(x:PatchWorkingHoursTypeReqBuilder,v:Ref<PatchWorkingHoursTypeReqBuilder>)
	export function unRefPatchWorkingHoursTypeReqBuilder(v:Ref<PatchWorkingHoursTypeReqBuilder>):PatchWorkingHoursTypeReqBuilder
	...
	export function emptyDeleteNationalIdTypeReqBuilder():DeleteNationalIdTypeReqBuilder
	export function emptyRefDeleteNationalIdTypeReqBuilder():Ref<DeleteNationalIdTypeReqBuilder>
	export function refOfDeleteNationalIdTypeReqBuilder(x:DeleteNationalIdTypeReqBuilder,v:Ref<DeleteNationalIdTypeReqBuilder>)
	export function unRefDeleteNationalIdTypeReqBuilder(v:Ref<DeleteNationalIdTypeReqBuilder>):DeleteNationalIdTypeReqBuilder
	...
	export function emptyP2EmploymentUpdatedV1Handler():P2EmploymentUpdatedV1Handler
	export function emptyRefP2EmploymentUpdatedV1Handler():Ref<P2EmploymentUpdatedV1Handler>
	export function refOfP2EmploymentUpdatedV1Handler(x:P2EmploymentUpdatedV1Handler,v:Ref<P2EmploymentUpdatedV1Handler>)
	export function unRefP2EmploymentUpdatedV1Handler(v:Ref<P2EmploymentUpdatedV1Handler>):P2EmploymentUpdatedV1Handler
	...
	export function emptyUploadPersonPathReqBodyBuilder():UploadPersonPathReqBodyBuilder
	export function emptyRefUploadPersonPathReqBodyBuilder():Ref<UploadPersonPathReqBodyBuilder>
	export function refOfUploadPersonPathReqBodyBuilder(x:UploadPersonPathReqBodyBuilder,v:Ref<UploadPersonPathReqBodyBuilder>)
	export function unRefUploadPersonPathReqBodyBuilder(v:Ref<UploadPersonPathReqBodyBuilder>):UploadPersonPathReqBodyBuilder
	export function emptyListJobDataReqBuilder():ListJobDataReqBuilder
	export function emptyRefListJobDataReqBuilder():Ref<ListJobDataReqBuilder>
	export function refOfListJobDataReqBuilder(x:ListJobDataReqBuilder,v:Ref<ListJobDataReqBuilder>)
	export function unRefListJobDataReqBuilder(v:Ref<ListJobDataReqBuilder>):ListJobDataReqBuilder
	...
	export function emptyCreateJobChangeReqBuilder():CreateJobChangeReqBuilder
	export function emptyRefCreateJobChangeReqBuilder():Ref<CreateJobChangeReqBuilder>
	export function refOfCreateJobChangeReqBuilder(x:CreateJobChangeReqBuilder,v:Ref<CreateJobChangeReqBuilder>)
	export function unRefCreateJobChangeReqBuilder(v:Ref<CreateJobChangeReqBuilder>):CreateJobChangeReqBuilder
	...
	export function emptyGetNationalIdTypeReqBuilder():GetNationalIdTypeReqBuilder
	export function emptyRefGetNationalIdTypeReqBuilder():Ref<GetNationalIdTypeReqBuilder>
	export function refOfGetNationalIdTypeReqBuilder(x:GetNationalIdTypeReqBuilder,v:Ref<GetNationalIdTypeReqBuilder>)
	export function unRefGetNationalIdTypeReqBuilder(v:Ref<GetNationalIdTypeReqBuilder>):GetNationalIdTypeReqBuilder
	...
	export function emptyGetCountryRegionReqBuilder():GetCountryRegionReqBuilder
	export function emptyRefGetCountryRegionReqBuilder():Ref<GetCountryRegionReqBuilder>
	export function refOfGetCountryRegionReqBuilder(x:GetCountryRegionReqBuilder,v:Ref<GetCountryRegionReqBuilder>)
	export function unRefGetCountryRegionReqBuilder(v:Ref<GetCountryRegionReqBuilder>):GetCountryRegionReqBuilder
	...
	export function emptyImageFieldSettingBuilder():ImageFieldSettingBuilder
	export function emptyRefImageFieldSettingBuilder():Ref<ImageFieldSettingBuilder>
	export function refOfImageFieldSettingBuilder(x:ImageFieldSettingBuilder,v:Ref<ImageFieldSettingBuilder>)
	export function unRefImageFieldSettingBuilder(v:Ref<ImageFieldSettingBuilder>):ImageFieldSettingBuilder
	export function emptyLeaveTypesLeaveReqBuilder():LeaveTypesLeaveReqBuilder
	export function emptyRefLeaveTypesLeaveReqBuilder():Ref<LeaveTypesLeaveReqBuilder>
	export function refOfLeaveTypesLeaveReqBuilder(x:LeaveTypesLeaveReqBuilder,v:Ref<LeaveTypesLeaveReqBuilder>)
	export function unRefLeaveTypesLeaveReqBuilder(v:Ref<LeaveTypesLeaveReqBuilder>):LeaveTypesLeaveReqBuilder
	export function emptyPatchJobDataReqBuilder():PatchJobDataReqBuilder
	export function emptyRefPatchJobDataReqBuilder():Ref<PatchJobDataReqBuilder>
	export function refOfPatchJobDataReqBuilder(x:PatchJobDataReqBuilder,v:Ref<PatchJobDataReqBuilder>)
	export function unRefPatchJobDataReqBuilder(v:Ref<PatchJobDataReqBuilder>):PatchJobDataReqBuilder
	...
	export function emptyGetEmployeeTypeReqBuilder():GetEmployeeTypeReqBuilder
	export function emptyRefGetEmployeeTypeReqBuilder():Ref<GetEmployeeTypeReqBuilder>
	export function refOfGetEmployeeTypeReqBuilder(x:GetEmployeeTypeReqBuilder,v:Ref<GetEmployeeTypeReqBuilder>)
	export function unRefGetEmployeeTypeReqBuilder(v:Ref<GetEmployeeTypeReqBuilder>):GetEmployeeTypeReqBuilder
	...
	export function emptyListCurrencyReqBuilder():ListCurrencyReqBuilder
	export function emptyRefListCurrencyReqBuilder():Ref<ListCurrencyReqBuilder>
	export function refOfListCurrencyReqBuilder(x:ListCurrencyReqBuilder,v:Ref<ListCurrencyReqBuilder>)
	export function unRefListCurrencyReqBuilder(v:Ref<ListCurrencyReqBuilder>):ListCurrencyReqBuilder
	...
	export function emptyCreateLeaveGrantingRecordReqBuilder():CreateLeaveGrantingRecordReqBuilder
	export function emptyRefCreateLeaveGrantingRecordReqBuilder():Ref<CreateLeaveGrantingRecordReqBuilder>
	export function refOfCreateLeaveGrantingRecordReqBuilder(x:CreateLeaveGrantingRecordReqBuilder,v:Ref<CreateLeaveGrantingRecordReqBuilder>)
	export function unRefCreateLeaveGrantingRecordReqBuilder(v:Ref<CreateLeaveGrantingRecordReqBuilder>):CreateLeaveGrantingRecordReqBuilder
	export function emptyP2PreHireUpdatedV1Handler():P2PreHireUpdatedV1Handler
	export function emptyRefP2PreHireUpdatedV1Handler():Ref<P2PreHireUpdatedV1Handler>
	export function refOfP2PreHireUpdatedV1Handler(x:P2PreHireUpdatedV1Handler,v:Ref<P2PreHireUpdatedV1Handler>)
	export function unRefP2PreHireUpdatedV1Handler(v:Ref<P2PreHireUpdatedV1Handler>):P2PreHireUpdatedV1Handler
	...
	export function emptyReferenceObjectBuilder():ReferenceObjectBuilder
	export function emptyRefReferenceObjectBuilder():Ref<ReferenceObjectBuilder>
	export function refOfReferenceObjectBuilder(x:ReferenceObjectBuilder,v:Ref<ReferenceObjectBuilder>)
	export function unRefReferenceObjectBuilder(v:Ref<ReferenceObjectBuilder>):ReferenceObjectBuilder
	export function emptyFormFieldVariableListObjectBuilder():FormFieldVariableListObjectBuilder
	export function emptyRefFormFieldVariableListObjectBuilder():Ref<FormFieldVariableListObjectBuilder>
	export function refOfFormFieldVariableListObjectBuilder(x:FormFieldVariableListObjectBuilder,v:Ref<FormFieldVariableListObjectBuilder>)
	export function unRefFormFieldVariableListObjectBuilder(v:Ref<FormFieldVariableListObjectBuilder>):FormFieldVariableListObjectBuilder
	export function emptyFormFieldVariableRecordValueBuilder():FormFieldVariableRecordValueBuilder
	export function emptyRefFormFieldVariableRecordValueBuilder():Ref<FormFieldVariableRecordValueBuilder>
	export function refOfFormFieldVariableRecordValueBuilder(x:FormFieldVariableRecordValueBuilder,v:Ref<FormFieldVariableRecordValueBuilder>)
	export function unRefFormFieldVariableRecordValueBuilder(v:Ref<FormFieldVariableRecordValueBuilder>):FormFieldVariableRecordValueBuilder
	export function emptyGetDepartmentReqBuilder():GetDepartmentReqBuilder
	export function emptyRefGetDepartmentReqBuilder():Ref<GetDepartmentReqBuilder>
	export function refOfGetDepartmentReqBuilder(x:GetDepartmentReqBuilder,v:Ref<GetDepartmentReqBuilder>)
	export function unRefGetDepartmentReqBuilder(v:Ref<GetDepartmentReqBuilder>):GetDepartmentReqBuilder
	...
	export function emptySearchAssignedUserPathReqBodyBuilder():SearchAssignedUserPathReqBodyBuilder
	export function emptyRefSearchAssignedUserPathReqBodyBuilder():Ref<SearchAssignedUserPathReqBodyBuilder>
	export function refOfSearchAssignedUserPathReqBodyBuilder(x:SearchAssignedUserPathReqBodyBuilder,v:Ref<SearchAssignedUserPathReqBodyBuilder>)
	export function unRefSearchAssignedUserPathReqBodyBuilder(v:Ref<SearchAssignedUserPathReqBodyBuilder>):SearchAssignedUserPathReqBodyBuilder
	...
	export function emptyConvertCommonDataIdPathReqBodyBuilder():ConvertCommonDataIdPathReqBodyBuilder
	export function emptyRefConvertCommonDataIdPathReqBodyBuilder():Ref<ConvertCommonDataIdPathReqBodyBuilder>
	export function refOfConvertCommonDataIdPathReqBodyBuilder(x:ConvertCommonDataIdPathReqBodyBuilder,v:Ref<ConvertCommonDataIdPathReqBodyBuilder>)
	export function unRefConvertCommonDataIdPathReqBodyBuilder(v:Ref<ConvertCommonDataIdPathReqBodyBuilder>):ConvertCommonDataIdPathReqBodyBuilder
	...
	export function emptyQueryCustomFieldReqBuilder():QueryCustomFieldReqBuilder
	export function emptyRefQueryCustomFieldReqBuilder():Ref<QueryCustomFieldReqBuilder>
	export function refOfQueryCustomFieldReqBuilder(x:QueryCustomFieldReqBuilder,v:Ref<QueryCustomFieldReqBuilder>)
	export function unRefQueryCustomFieldReqBuilder(v:Ref<QueryCustomFieldReqBuilder>):QueryCustomFieldReqBuilder
	export function emptyAssignedOrganizationBuilder():AssignedOrganizationBuilder
	export function emptyRefAssignedOrganizationBuilder():Ref<AssignedOrganizationBuilder>
	export function refOfAssignedOrganizationBuilder(x:AssignedOrganizationBuilder,v:Ref<AssignedOrganizationBuilder>)
	export function unRefAssignedOrganizationBuilder(v:Ref<AssignedOrganizationBuilder>):AssignedOrganizationBuilder
	...
	export function emptyListPreHireReqBuilder():ListPreHireReqBuilder
	export function emptyRefListPreHireReqBuilder():Ref<ListPreHireReqBuilder>
	export function refOfListPreHireReqBuilder(x:ListPreHireReqBuilder,v:Ref<ListPreHireReqBuilder>)
	export function unRefListPreHireReqBuilder(v:Ref<ListPreHireReqBuilder>):ListPreHireReqBuilder
	export function emptyPatchEmploymentReqBuilder():PatchEmploymentReqBuilder
	export function emptyRefPatchEmploymentReqBuilder():Ref<PatchEmploymentReqBuilder>
	export function refOfPatchEmploymentReqBuilder(x:PatchEmploymentReqBuilder,v:Ref<PatchEmploymentReqBuilder>)
	export function unRefPatchEmploymentReqBuilder(v:Ref<PatchEmploymentReqBuilder>):PatchEmploymentReqBuilder
	...
	export function emptySortOptionBuilder():SortOptionBuilder
	export function emptyRefSortOptionBuilder():Ref<SortOptionBuilder>
	export function refOfSortOptionBuilder(x:SortOptionBuilder,v:Ref<SortOptionBuilder>)
	export function unRefSortOptionBuilder(v:Ref<SortOptionBuilder>):SortOptionBuilder
	...
	export function emptyPreHireQueryBuilder():PreHireQueryBuilder
	export function emptyRefPreHireQueryBuilder():Ref<PreHireQueryBuilder>
	export function refOfPreHireQueryBuilder(x:PreHireQueryBuilder,v:Ref<PreHireQueryBuilder>)
	export function unRefPreHireQueryBuilder(v:Ref<PreHireQueryBuilder>):PreHireQueryBuilder
	...
	export function emptyListContractReqBuilder():ListContractReqBuilder
	export function emptyRefListContractReqBuilder():Ref<ListContractReqBuilder>
	export function refOfListContractReqBuilder(x:ListContractReqBuilder,v:Ref<ListContractReqBuilder>)
	export function unRefListContractReqBuilder(v:Ref<ListContractReqBuilder>):ListContractReqBuilder
	...
	export function emptyPatchJobReqBuilder():PatchJobReqBuilder
	export function emptyRefPatchJobReqBuilder():Ref<PatchJobReqBuilder>
	export function refOfPatchJobReqBuilder(x:PatchJobReqBuilder,v:Ref<PatchJobReqBuilder>)
	export function unRefPatchJobReqBuilder(v:Ref<PatchJobReqBuilder>):PatchJobReqBuilder
	...
	export function emptySearchOffboardingPathReqBodyBuilder():SearchOffboardingPathReqBodyBuilder
	export function emptyRefSearchOffboardingPathReqBodyBuilder():Ref<SearchOffboardingPathReqBodyBuilder>
	export function refOfSearchOffboardingPathReqBodyBuilder(x:SearchOffboardingPathReqBodyBuilder,v:Ref<SearchOffboardingPathReqBodyBuilder>)
	export function unRefSearchOffboardingPathReqBodyBuilder(v:Ref<SearchOffboardingPathReqBodyBuilder>):SearchOffboardingPathReqBodyBuilder
	...
	export function emptyCreateJobReqBuilder():CreateJobReqBuilder
	export function emptyRefCreateJobReqBuilder():Ref<CreateJobReqBuilder>
	export function refOfCreateJobReqBuilder(x:CreateJobReqBuilder,v:Ref<CreateJobReqBuilder>)
	export function unRefCreateJobReqBuilder(v:Ref<CreateJobReqBuilder>):CreateJobReqBuilder
	export function emptyCreateNationalIdTypeReqBuilder():CreateNationalIdTypeReqBuilder
	export function emptyRefCreateNationalIdTypeReqBuilder():Ref<CreateNationalIdTypeReqBuilder>
	export function refOfCreateNationalIdTypeReqBuilder(x:CreateNationalIdTypeReqBuilder,v:Ref<CreateNationalIdTypeReqBuilder>)
	export function unRefCreateNationalIdTypeReqBuilder(v:Ref<CreateNationalIdTypeReqBuilder>):CreateNationalIdTypeReqBuilder
	...
	export function emptyGetCompanyReqBuilder():GetCompanyReqBuilder
	export function emptyRefGetCompanyReqBuilder():Ref<GetCompanyReqBuilder>
	export function refOfGetCompanyReqBuilder(x:GetCompanyReqBuilder,v:Ref<GetCompanyReqBuilder>)
	export function unRefGetCompanyReqBuilder(v:Ref<GetCompanyReqBuilder>):GetCompanyReqBuilder
	...
	export function emptyCreateJobLevelReqBuilder():CreateJobLevelReqBuilder
	export function emptyRefCreateJobLevelReqBuilder():Ref<CreateJobLevelReqBuilder>
	export function refOfCreateJobLevelReqBuilder(x:CreateJobLevelReqBuilder,v:Ref<CreateJobLevelReqBuilder>)
	export function unRefCreateJobLevelReqBuilder(v:Ref<CreateJobLevelReqBuilder>):CreateJobLevelReqBuilder
	...
	export function emptyNumberFieldSettingBuilder():NumberFieldSettingBuilder
	export function emptyRefNumberFieldSettingBuilder():Ref<NumberFieldSettingBuilder>
	export function refOfNumberFieldSettingBuilder(x:NumberFieldSettingBuilder,v:Ref<NumberFieldSettingBuilder>)
	export function unRefNumberFieldSettingBuilder(v:Ref<NumberFieldSettingBuilder>):NumberFieldSettingBuilder
	...
	export function emptyBackgroundCheckTargetBuilder():BackgroundCheckTargetBuilder
	export function emptyRefBackgroundCheckTargetBuilder():Ref<BackgroundCheckTargetBuilder>
	export function refOfBackgroundCheckTargetBuilder(x:BackgroundCheckTargetBuilder,v:Ref<BackgroundCheckTargetBuilder>)
	export function unRefBackgroundCheckTargetBuilder(v:Ref<BackgroundCheckTargetBuilder>):BackgroundCheckTargetBuilder
	...
	export function emptyCreateLeaveGrantingRecordReqBodyBuilder():CreateLeaveGrantingRecordReqBodyBuilder
	export function emptyRefCreateLeaveGrantingRecordReqBodyBuilder():Ref<CreateLeaveGrantingRecordReqBodyBuilder>
	export function refOfCreateLeaveGrantingRecordReqBodyBuilder(x:CreateLeaveGrantingRecordReqBodyBuilder,v:Ref<CreateLeaveGrantingRecordReqBodyBuilder>)
	export function unRefCreateLeaveGrantingRecordReqBodyBuilder(v:Ref<CreateLeaveGrantingRecordReqBodyBuilder>):CreateLeaveGrantingRecordReqBodyBuilder
	export function emptyEmployeeTypeBuilder():EmployeeTypeBuilder
	export function emptyRefEmployeeTypeBuilder():Ref<EmployeeTypeBuilder>
	export function refOfEmployeeTypeBuilder(x:EmployeeTypeBuilder,v:Ref<EmployeeTypeBuilder>)
	export function unRefEmployeeTypeBuilder(v:Ref<EmployeeTypeBuilder>):EmployeeTypeBuilder
	...
	export function emptyOffboardingBuilder():OffboardingBuilder
	export function emptyRefOffboardingBuilder():Ref<OffboardingBuilder>
	export function refOfOffboardingBuilder(x:OffboardingBuilder,v:Ref<OffboardingBuilder>)
	export function unRefOffboardingBuilder(v:Ref<OffboardingBuilder>):OffboardingBuilder
	...
	export function emptySearchAssignedUserReqBodyBuilder():SearchAssignedUserReqBodyBuilder
	export function emptyRefSearchAssignedUserReqBodyBuilder():Ref<SearchAssignedUserReqBodyBuilder>
	export function refOfSearchAssignedUserReqBodyBuilder(x:SearchAssignedUserReqBodyBuilder,v:Ref<SearchAssignedUserReqBodyBuilder>)
	export function unRefSearchAssignedUserReqBodyBuilder(v:Ref<SearchAssignedUserReqBodyBuilder>):SearchAssignedUserReqBodyBuilder
	...
	export function emptyP2ContractCreatedV1Handler():P2ContractCreatedV1Handler
	export function emptyRefP2ContractCreatedV1Handler():Ref<P2ContractCreatedV1Handler>
	export function refOfP2ContractCreatedV1Handler(x:P2ContractCreatedV1Handler,v:Ref<P2ContractCreatedV1Handler>)
	export function unRefP2ContractCreatedV1Handler(v:Ref<P2ContractCreatedV1Handler>):P2ContractCreatedV1Handler
	...
	export function emptyFormFieldVariableListValueBuilder():FormFieldVariableListValueBuilder
	export function emptyRefFormFieldVariableListValueBuilder():Ref<FormFieldVariableListValueBuilder>
	export function refOfFormFieldVariableListValueBuilder(x:FormFieldVariableListValueBuilder,v:Ref<FormFieldVariableListValueBuilder>)
	export function unRefFormFieldVariableListValueBuilder(v:Ref<FormFieldVariableListValueBuilder>):FormFieldVariableListValueBuilder
	...
	export function emptyPatchEmployeeTypeReqBuilder():PatchEmployeeTypeReqBuilder
	export function emptyRefPatchEmployeeTypeReqBuilder():Ref<PatchEmployeeTypeReqBuilder>
	export function refOfPatchEmployeeTypeReqBuilder(x:PatchEmployeeTypeReqBuilder,v:Ref<PatchEmployeeTypeReqBuilder>)
	export function unRefPatchEmployeeTypeReqBuilder(v:Ref<PatchEmployeeTypeReqBuilder>):PatchEmployeeTypeReqBuilder
	...
	export function emptyQueryTransferTypeReqBuilder():QueryTransferTypeReqBuilder
	export function emptyRefQueryTransferTypeReqBuilder():Ref<QueryTransferTypeReqBuilder>
	export function refOfQueryTransferTypeReqBuilder(x:QueryTransferTypeReqBuilder,v:Ref<QueryTransferTypeReqBuilder>)
	export function unRefQueryTransferTypeReqBuilder(v:Ref<QueryTransferTypeReqBuilder>):QueryTransferTypeReqBuilder
	...
	export function emptySearchOffboardingReqBodyBuilder():SearchOffboardingReqBodyBuilder
	export function emptyRefSearchOffboardingReqBodyBuilder():Ref<SearchOffboardingReqBodyBuilder>
	export function refOfSearchOffboardingReqBodyBuilder(x:SearchOffboardingReqBodyBuilder,v:Ref<SearchOffboardingReqBodyBuilder>)
	export function unRefSearchOffboardingReqBodyBuilder(v:Ref<SearchOffboardingReqBodyBuilder>):SearchOffboardingReqBodyBuilder
	...
	export function emptyCpstStandardTypeBuilder():CpstStandardTypeBuilder
	export function emptyRefCpstStandardTypeBuilder():Ref<CpstStandardTypeBuilder>
	export function refOfCpstStandardTypeBuilder(x:CpstStandardTypeBuilder,v:Ref<CpstStandardTypeBuilder>)
	export function unRefCpstStandardTypeBuilder(v:Ref<CpstStandardTypeBuilder>):CpstStandardTypeBuilder
	...
	export function emptyFormFieldVariableDateValueBuilder():FormFieldVariableDateValueBuilder
	export function emptyRefFormFieldVariableDateValueBuilder():Ref<FormFieldVariableDateValueBuilder>
	export function refOfFormFieldVariableDateValueBuilder(x:FormFieldVariableDateValueBuilder,v:Ref<FormFieldVariableDateValueBuilder>)
	export function unRefFormFieldVariableDateValueBuilder(v:Ref<FormFieldVariableDateValueBuilder>):FormFieldVariableDateValueBuilder
	...
	export function emptyCpstI18nBuilder():CpstI18nBuilder
	export function emptyRefCpstI18nBuilder():Ref<CpstI18nBuilder>
	export function refOfCpstI18nBuilder(x:CpstI18nBuilder,v:Ref<CpstI18nBuilder>)
	export function unRefCpstI18nBuilder(v:Ref<CpstI18nBuilder>):CpstI18nBuilder
	...
	export function emptyHrbpBuilder():HrbpBuilder
	export function emptyRefHrbpBuilder():Ref<HrbpBuilder>
	export function refOfHrbpBuilder(x:HrbpBuilder,v:Ref<HrbpBuilder>)
	export function unRefHrbpBuilder(v:Ref<HrbpBuilder>):HrbpBuilder
	...
	export function emptyP2ContractUpdatedV1Handler():P2ContractUpdatedV1Handler
	export function emptyRefP2ContractUpdatedV1Handler():Ref<P2ContractUpdatedV1Handler>
	export function refOfP2ContractUpdatedV1Handler(x:P2ContractUpdatedV1Handler,v:Ref<P2ContractUpdatedV1Handler>)
	export function unRefP2ContractUpdatedV1Handler(v:Ref<P2ContractUpdatedV1Handler>):P2ContractUpdatedV1Handler
	...
	export function emptyGetPreHireReqBuilder():GetPreHireReqBuilder
	export function emptyRefGetPreHireReqBuilder():Ref<GetPreHireReqBuilder>
	export function refOfGetPreHireReqBuilder(x:GetPreHireReqBuilder,v:Ref<GetPreHireReqBuilder>)
	export function unRefGetPreHireReqBuilder(v:Ref<GetPreHireReqBuilder>):GetPreHireReqBuilder
	...
	export function emptyListNationalIdTypeReqBuilder():ListNationalIdTypeReqBuilder
	export function emptyRefListNationalIdTypeReqBuilder():Ref<ListNationalIdTypeReqBuilder>
	export function refOfListNationalIdTypeReqBuilder(x:ListNationalIdTypeReqBuilder,v:Ref<ListNationalIdTypeReqBuilder>)
	export function unRefListNationalIdTypeReqBuilder(v:Ref<ListNationalIdTypeReqBuilder>):ListNationalIdTypeReqBuilder
	...
	export function emptyPermissionDetailBuilder():PermissionDetailBuilder
	export function emptyRefPermissionDetailBuilder():Ref<PermissionDetailBuilder>
	export function refOfPermissionDetailBuilder(x:PermissionDetailBuilder,v:Ref<PermissionDetailBuilder>)
	export function unRefPermissionDetailBuilder(v:Ref<PermissionDetailBuilder>):PermissionDetailBuilder
	export function emptyConvertCommonDataIdReqBuilder():ConvertCommonDataIdReqBuilder
	export function emptyRefConvertCommonDataIdReqBuilder():Ref<ConvertCommonDataIdReqBuilder>
	export function refOfConvertCommonDataIdReqBuilder(x:ConvertCommonDataIdReqBuilder,v:Ref<ConvertCommonDataIdReqBuilder>)
	export function unRefConvertCommonDataIdReqBuilder(v:Ref<ConvertCommonDataIdReqBuilder>):ConvertCommonDataIdReqBuilder
	...
	export function emptyGetSubregionReqBuilder():GetSubregionReqBuilder
	export function emptyRefGetSubregionReqBuilder():Ref<GetSubregionReqBuilder>
	export function refOfGetSubregionReqBuilder(x:GetSubregionReqBuilder,v:Ref<GetSubregionReqBuilder>)
	export function unRefGetSubregionReqBuilder(v:Ref<GetSubregionReqBuilder>):GetSubregionReqBuilder
	export function emptyDeleteEmploymentReqBuilder():DeleteEmploymentReqBuilder
	export function emptyRefDeleteEmploymentReqBuilder():Ref<DeleteEmploymentReqBuilder>
	export function refOfDeleteEmploymentReqBuilder(x:DeleteEmploymentReqBuilder,v:Ref<DeleteEmploymentReqBuilder>)
	export function unRefDeleteEmploymentReqBuilder(v:Ref<DeleteEmploymentReqBuilder>):DeleteEmploymentReqBuilder
	...
	export function emptyP2JobUpdatedV1Handler():P2JobUpdatedV1Handler
	export function emptyRefP2JobUpdatedV1Handler():Ref<P2JobUpdatedV1Handler>
	export function refOfP2JobUpdatedV1Handler(x:P2JobUpdatedV1Handler,v:Ref<P2JobUpdatedV1Handler>)
	export function unRefP2JobUpdatedV1Handler(v:Ref<P2JobUpdatedV1Handler>):P2JobUpdatedV1Handler
	...
	export function emptyFilterRuleValueBuilder():FilterRuleValueBuilder
	export function emptyRefFilterRuleValueBuilder():Ref<FilterRuleValueBuilder>
	export function refOfFilterRuleValueBuilder(x:FilterRuleValueBuilder,v:Ref<FilterRuleValueBuilder>)
	export function unRefFilterRuleValueBuilder(v:Ref<FilterRuleValueBuilder>):FilterRuleValueBuilder
	...
	export function emptyGetWorkingHoursTypeReqBuilder():GetWorkingHoursTypeReqBuilder
	export function emptyRefGetWorkingHoursTypeReqBuilder():Ref<GetWorkingHoursTypeReqBuilder>
	export function refOfGetWorkingHoursTypeReqBuilder(x:GetWorkingHoursTypeReqBuilder,v:Ref<GetWorkingHoursTypeReqBuilder>)
	export function unRefGetWorkingHoursTypeReqBuilder(v:Ref<GetWorkingHoursTypeReqBuilder>):GetWorkingHoursTypeReqBuilder
	...
	export function emptyP2DepartmentUpdatedV1Handler():P2DepartmentUpdatedV1Handler
	export function emptyRefP2DepartmentUpdatedV1Handler():Ref<P2DepartmentUpdatedV1Handler>
	export function refOfP2DepartmentUpdatedV1Handler(x:P2DepartmentUpdatedV1Handler,v:Ref<P2DepartmentUpdatedV1Handler>)
	export function unRefP2DepartmentUpdatedV1Handler(v:Ref<P2DepartmentUpdatedV1Handler>):P2DepartmentUpdatedV1Handler
	export function emptyP2JobChangeUpdatedV1Handler():P2JobChangeUpdatedV1Handler
	export function emptyRefP2JobChangeUpdatedV1Handler():Ref<P2JobChangeUpdatedV1Handler>
	export function refOfP2JobChangeUpdatedV1Handler(x:P2JobChangeUpdatedV1Handler,v:Ref<P2JobChangeUpdatedV1Handler>)
	export function unRefP2JobChangeUpdatedV1Handler(v:Ref<P2JobChangeUpdatedV1Handler>):P2JobChangeUpdatedV1Handler
	...
	export function emptyWorkCalendarFilterBuilder():WorkCalendarFilterBuilder
	export function emptyRefWorkCalendarFilterBuilder():Ref<WorkCalendarFilterBuilder>
	export function refOfWorkCalendarFilterBuilder(x:WorkCalendarFilterBuilder,v:Ref<WorkCalendarFilterBuilder>)
	export function unRefWorkCalendarFilterBuilder(v:Ref<WorkCalendarFilterBuilder>):WorkCalendarFilterBuilder
	...
	export function emptyP2OrgRoleAuthorizationUpdatedV1Handler():P2OrgRoleAuthorizationUpdatedV1Handler
	export function emptyRefP2OrgRoleAuthorizationUpdatedV1Handler():Ref<P2OrgRoleAuthorizationUpdatedV1Handler>
	export function refOfP2OrgRoleAuthorizationUpdatedV1Handler(x:P2OrgRoleAuthorizationUpdatedV1Handler,v:Ref<P2OrgRoleAuthorizationUpdatedV1Handler>)
	export function unRefP2OrgRoleAuthorizationUpdatedV1Handler(v:Ref<P2OrgRoleAuthorizationUpdatedV1Handler>):P2OrgRoleAuthorizationUpdatedV1Handler
	export function emptyUploadPersonReqBuilder():UploadPersonReqBuilder
	export function emptyRefUploadPersonReqBuilder():Ref<UploadPersonReqBuilder>
	export function refOfUploadPersonReqBuilder(x:UploadPersonReqBuilder,v:Ref<UploadPersonReqBuilder>)
	export function unRefUploadPersonReqBuilder(v:Ref<UploadPersonReqBuilder>):UploadPersonReqBuilder
	...
	export function emptyFormVariableDataBuilder():FormVariableDataBuilder
	export function emptyRefFormVariableDataBuilder():Ref<FormVariableDataBuilder>
	export function refOfFormVariableDataBuilder(x:FormVariableDataBuilder,v:Ref<FormVariableDataBuilder>)
	export function unRefFormVariableDataBuilder(v:Ref<FormVariableDataBuilder>):FormVariableDataBuilder
	...
	export function emptyP2PersonDeletedV1Handler():P2PersonDeletedV1Handler
	export function emptyRefP2PersonDeletedV1Handler():Ref<P2PersonDeletedV1Handler>
	export function refOfP2PersonDeletedV1Handler(x:P2PersonDeletedV1Handler,v:Ref<P2PersonDeletedV1Handler>)
	export function unRefP2PersonDeletedV1Handler(v:Ref<P2PersonDeletedV1Handler>):P2PersonDeletedV1Handler
	export function emptyBackgroundCheckCityBuilder():BackgroundCheckCityBuilder
	export function emptyRefBackgroundCheckCityBuilder():Ref<BackgroundCheckCityBuilder>
	export function refOfBackgroundCheckCityBuilder(x:BackgroundCheckCityBuilder,v:Ref<BackgroundCheckCityBuilder>)
	export function unRefBackgroundCheckCityBuilder(v:Ref<BackgroundCheckCityBuilder>):BackgroundCheckCityBuilder
	...
	export function emptyFormFieldVariableObjectValueBuilder():FormFieldVariableObjectValueBuilder
	export function emptyRefFormFieldVariableObjectValueBuilder():Ref<FormFieldVariableObjectValueBuilder>
	export function refOfFormFieldVariableObjectValueBuilder(x:FormFieldVariableObjectValueBuilder,v:Ref<FormFieldVariableObjectValueBuilder>)
	export function unRefFormFieldVariableObjectValueBuilder(v:Ref<FormFieldVariableObjectValueBuilder>):FormFieldVariableObjectValueBuilder
	export function emptyFormFieldVariableRecordValueExampleBuilder():FormFieldVariableRecordValueExampleBuilder
	export function emptyRefFormFieldVariableRecordValueExampleBuilder():Ref<FormFieldVariableRecordValueExampleBuilder>
	export function refOfFormFieldVariableRecordValueExampleBuilder(x:FormFieldVariableRecordValueExampleBuilder,v:Ref<FormFieldVariableRecordValueExampleBuilder>)
	export function unRefFormFieldVariableRecordValueExampleBuilder(v:Ref<FormFieldVariableRecordValueExampleBuilder>):FormFieldVariableRecordValueExampleBuilder
	...
	export function emptySupportCostCenterItemBuilder():SupportCostCenterItemBuilder
	export function emptyRefSupportCostCenterItemBuilder():Ref<SupportCostCenterItemBuilder>
	export function refOfSupportCostCenterItemBuilder(x:SupportCostCenterItemBuilder,v:Ref<SupportCostCenterItemBuilder>)
	export function unRefSupportCostCenterItemBuilder(v:Ref<SupportCostCenterItemBuilder>):SupportCostCenterItemBuilder
	export function emptyAssignedOrganizationWithCodeBuilder():AssignedOrganizationWithCodeBuilder
	export function emptyRefAssignedOrganizationWithCodeBuilder():Ref<AssignedOrganizationWithCodeBuilder>
	export function refOfAssignedOrganizationWithCodeBuilder(x:AssignedOrganizationWithCodeBuilder,v:Ref<AssignedOrganizationWithCodeBuilder>)
	export function unRefAssignedOrganizationWithCodeBuilder(v:Ref<AssignedOrganizationWithCodeBuilder>):AssignedOrganizationWithCodeBuilder
	...
	export function emptyCreateJobDataReqBuilder():CreateJobDataReqBuilder
	export function emptyRefCreateJobDataReqBuilder():Ref<CreateJobDataReqBuilder>
	export function refOfCreateJobDataReqBuilder(x:CreateJobDataReqBuilder,v:Ref<CreateJobDataReqBuilder>)
	export function unRefCreateJobDataReqBuilder(v:Ref<CreateJobDataReqBuilder>):CreateJobDataReqBuilder
	...
	export function emptySecurityGroupBuilder():SecurityGroupBuilder
	export function emptyRefSecurityGroupBuilder():Ref<SecurityGroupBuilder>
	export function refOfSecurityGroupBuilder(x:SecurityGroupBuilder,v:Ref<SecurityGroupBuilder>)
	export function unRefSecurityGroupBuilder(v:Ref<SecurityGroupBuilder>):SecurityGroupBuilder
	...
	export function emptyListDepartmentReqBuilder():ListDepartmentReqBuilder
	export function emptyRefListDepartmentReqBuilder():Ref<ListDepartmentReqBuilder>
	export function refOfListDepartmentReqBuilder(x:ListDepartmentReqBuilder,v:Ref<ListDepartmentReqBuilder>)
	export function unRefListDepartmentReqBuilder(v:Ref<ListDepartmentReqBuilder>):ListDepartmentReqBuilder
	export function emptyPatchJobLevelReqBuilder():PatchJobLevelReqBuilder
	export function emptyRefPatchJobLevelReqBuilder():Ref<PatchJobLevelReqBuilder>
	export function refOfPatchJobLevelReqBuilder(x:PatchJobLevelReqBuilder,v:Ref<PatchJobLevelReqBuilder>)
	export function unRefPatchJobLevelReqBuilder(v:Ref<PatchJobLevelReqBuilder>):PatchJobLevelReqBuilder
	...
	export function emptyDeletePersonReqBuilder():DeletePersonReqBuilder
	export function emptyRefDeletePersonReqBuilder():Ref<DeletePersonReqBuilder>
	export function refOfDeletePersonReqBuilder(x:DeletePersonReqBuilder,v:Ref<DeletePersonReqBuilder>)
	export function unRefDeletePersonReqBuilder(v:Ref<DeletePersonReqBuilder>):DeletePersonReqBuilder
	export function emptyFormFieldVariableEnumValueBuilder():FormFieldVariableEnumValueBuilder
	export function emptyRefFormFieldVariableEnumValueBuilder():Ref<FormFieldVariableEnumValueBuilder>
	export function refOfFormFieldVariableEnumValueBuilder(x:FormFieldVariableEnumValueBuilder,v:Ref<FormFieldVariableEnumValueBuilder>)
	export function unRefFormFieldVariableEnumValueBuilder(v:Ref<FormFieldVariableEnumValueBuilder>):FormFieldVariableEnumValueBuilder
	export function emptyP2JobCreatedV1Handler():P2JobCreatedV1Handler
	export function emptyRefP2JobCreatedV1Handler():Ref<P2JobCreatedV1Handler>
	export function refOfP2JobCreatedV1Handler(x:P2JobCreatedV1Handler,v:Ref<P2JobCreatedV1Handler>)
	export function unRefP2JobCreatedV1Handler(v:Ref<P2JobCreatedV1Handler>):P2JobCreatedV1Handler
	...
	export function emptySubregionBuilder():SubregionBuilder
	export function emptyRefSubregionBuilder():Ref<SubregionBuilder>
	export function refOfSubregionBuilder(x:SubregionBuilder,v:Ref<SubregionBuilder>)
	export function unRefSubregionBuilder(v:Ref<SubregionBuilder>):SubregionBuilder
	...
	export function emptyDeleteContractReqBuilder():DeleteContractReqBuilder
	export function emptyRefDeleteContractReqBuilder():Ref<DeleteContractReqBuilder>
	export function refOfDeleteContractReqBuilder(x:DeleteContractReqBuilder,v:Ref<DeleteContractReqBuilder>)
	export function unRefDeleteContractReqBuilder(v:Ref<DeleteContractReqBuilder>):DeleteContractReqBuilder
	export function emptyFormFieldVariableTextValueBuilder():FormFieldVariableTextValueBuilder
	export function emptyRefFormFieldVariableTextValueBuilder():Ref<FormFieldVariableTextValueBuilder>
	export function refOfFormFieldVariableTextValueBuilder(x:FormFieldVariableTextValueBuilder,v:Ref<FormFieldVariableTextValueBuilder>)
	export function unRefFormFieldVariableTextValueBuilder(v:Ref<FormFieldVariableTextValueBuilder>):FormFieldVariableTextValueBuilder
	...
	export function emptyBackgroundCheckBuilder():BackgroundCheckBuilder
	export function emptyRefBackgroundCheckBuilder():Ref<BackgroundCheckBuilder>
	export function refOfBackgroundCheckBuilder(x:BackgroundCheckBuilder,v:Ref<BackgroundCheckBuilder>)
	export function unRefBackgroundCheckBuilder(v:Ref<BackgroundCheckBuilder>):BackgroundCheckBuilder
	...
	export function emptyDeleteEmployeeTypeReqBuilder():DeleteEmployeeTypeReqBuilder
	export function emptyRefDeleteEmployeeTypeReqBuilder():Ref<DeleteEmployeeTypeReqBuilder>
	export function refOfDeleteEmployeeTypeReqBuilder(x:DeleteEmployeeTypeReqBuilder,v:Ref<DeleteEmployeeTypeReqBuilder>)
	export function unRefDeleteEmployeeTypeReqBuilder(v:Ref<DeleteEmployeeTypeReqBuilder>):DeleteEmployeeTypeReqBuilder
	...
	export function emptyWkCalendarI18nBuilder():WkCalendarI18nBuilder
	export function emptyRefWkCalendarI18nBuilder():Ref<WkCalendarI18nBuilder>
	export function refOfWkCalendarI18nBuilder(x:WkCalendarI18nBuilder,v:Ref<WkCalendarI18nBuilder>)
	export function unRefWkCalendarI18nBuilder(v:Ref<WkCalendarI18nBuilder>):WkCalendarI18nBuilder
	...
	export function emptyPermissionSecurityGroupBuilder():PermissionSecurityGroupBuilder
	export function emptyRefPermissionSecurityGroupBuilder():Ref<PermissionSecurityGroupBuilder>
	export function refOfPermissionSecurityGroupBuilder(x:PermissionSecurityGroupBuilder,v:Ref<PermissionSecurityGroupBuilder>)
	export function unRefPermissionSecurityGroupBuilder(v:Ref<PermissionSecurityGroupBuilder>):PermissionSecurityGroupBuilder
	...
	export function emptyQueryOffboardingPathReqBodyBuilder():QueryOffboardingPathReqBodyBuilder
	export function emptyRefQueryOffboardingPathReqBodyBuilder():Ref<QueryOffboardingPathReqBodyBuilder>
	export function refOfQueryOffboardingPathReqBodyBuilder(x:QueryOffboardingPathReqBodyBuilder,v:Ref<QueryOffboardingPathReqBodyBuilder>)
	export function unRefQueryOffboardingPathReqBodyBuilder(v:Ref<QueryOffboardingPathReqBodyBuilder>):QueryOffboardingPathReqBodyBuilder
	...
	export function emptyCreateJobFamilyReqBuilder():CreateJobFamilyReqBuilder
	export function emptyRefCreateJobFamilyReqBuilder():Ref<CreateJobFamilyReqBuilder>
	export function refOfCreateJobFamilyReqBuilder(x:CreateJobFamilyReqBuilder,v:Ref<CreateJobFamilyReqBuilder>)
	export function unRefCreateJobFamilyReqBuilder(v:Ref<CreateJobFamilyReqBuilder>):CreateJobFamilyReqBuilder
	...
	export function emptyP2JobDataChangedV1Handler():P2JobDataChangedV1Handler
	export function emptyRefP2JobDataChangedV1Handler():Ref<P2JobDataChangedV1Handler>
	export function refOfP2JobDataChangedV1Handler(x:P2JobDataChangedV1Handler,v:Ref<P2JobDataChangedV1Handler>)
	export function unRefP2JobDataChangedV1Handler(v:Ref<P2JobDataChangedV1Handler>):P2JobDataChangedV1Handler
	...
	export function emptyListJobFamilyReqBuilder():ListJobFamilyReqBuilder
	export function emptyRefListJobFamilyReqBuilder():Ref<ListJobFamilyReqBuilder>
	export function refOfListJobFamilyReqBuilder(x:ListJobFamilyReqBuilder,v:Ref<ListJobFamilyReqBuilder>)
	export function unRefListJobFamilyReqBuilder(v:Ref<ListJobFamilyReqBuilder>):ListJobFamilyReqBuilder
	...
	export function emptyEnumFieldOptionBuilder():EnumFieldOptionBuilder
	export function emptyRefEnumFieldOptionBuilder():Ref<EnumFieldOptionBuilder>
	export function refOfEnumFieldOptionBuilder(x:EnumFieldOptionBuilder,v:Ref<EnumFieldOptionBuilder>)
	export function unRefEnumFieldOptionBuilder(v:Ref<EnumFieldOptionBuilder>):EnumFieldOptionBuilder
	...
	export function emptyQueryTransferReasonReqBuilder():QueryTransferReasonReqBuilder
	export function emptyRefQueryTransferReasonReqBuilder():Ref<QueryTransferReasonReqBuilder>
	export function refOfQueryTransferReasonReqBuilder(x:QueryTransferReasonReqBuilder,v:Ref<QueryTransferReasonReqBuilder>)
	export function unRefQueryTransferReasonReqBuilder(v:Ref<QueryTransferReasonReqBuilder>):QueryTransferReasonReqBuilder
	export function emptyListJobLevelReqBuilder():ListJobLevelReqBuilder
	export function emptyRefListJobLevelReqBuilder():Ref<ListJobLevelReqBuilder>
	export function refOfListJobLevelReqBuilder(x:ListJobLevelReqBuilder,v:Ref<ListJobLevelReqBuilder>)
	export function unRefListJobLevelReqBuilder(v:Ref<ListJobLevelReqBuilder>):ListJobLevelReqBuilder
	...
	export function emptyPatchDepartmentReqBuilder():PatchDepartmentReqBuilder
	export function emptyRefPatchDepartmentReqBuilder():Ref<PatchDepartmentReqBuilder>
	export function refOfPatchDepartmentReqBuilder(x:PatchDepartmentReqBuilder,v:Ref<PatchDepartmentReqBuilder>)
	export function unRefPatchDepartmentReqBuilder(v:Ref<PatchDepartmentReqBuilder>):PatchDepartmentReqBuilder
	export function emptyDateTimeFieldSettingBuilder():DateTimeFieldSettingBuilder
	export function emptyRefDateTimeFieldSettingBuilder():Ref<DateTimeFieldSettingBuilder>
	export function refOfDateTimeFieldSettingBuilder(x:DateTimeFieldSettingBuilder,v:Ref<DateTimeFieldSettingBuilder>)
	export function unRefDateTimeFieldSettingBuilder(v:Ref<DateTimeFieldSettingBuilder>):DateTimeFieldSettingBuilder
	export function emptyDeleteCompanyReqBuilder():DeleteCompanyReqBuilder
	export function emptyRefDeleteCompanyReqBuilder():Ref<DeleteCompanyReqBuilder>
	export function refOfDeleteCompanyReqBuilder(x:DeleteCompanyReqBuilder,v:Ref<DeleteCompanyReqBuilder>)
	export function unRefDeleteCompanyReqBuilder(v:Ref<DeleteCompanyReqBuilder>):DeleteCompanyReqBuilder
	...
	export function emptyGetPersonReqBuilder():GetPersonReqBuilder
	export function emptyRefGetPersonReqBuilder():Ref<GetPersonReqBuilder>
	export function refOfGetPersonReqBuilder(x:GetPersonReqBuilder,v:Ref<GetPersonReqBuilder>)
	export function unRefGetPersonReqBuilder(v:Ref<GetPersonReqBuilder>):GetPersonReqBuilder
	export function emptyGetSubdivisionReqBuilder():GetSubdivisionReqBuilder
	export function emptyRefGetSubdivisionReqBuilder():Ref<GetSubdivisionReqBuilder>
	export function refOfGetSubdivisionReqBuilder(x:GetSubdivisionReqBuilder,v:Ref<GetSubdivisionReqBuilder>)
	export function unRefGetSubdivisionReqBuilder(v:Ref<GetSubdivisionReqBuilder>):GetSubdivisionReqBuilder
	...
	export function emptyMatchCompensationStandardReqBuilder():MatchCompensationStandardReqBuilder
	export function emptyRefMatchCompensationStandardReqBuilder():Ref<MatchCompensationStandardReqBuilder>
	export function refOfMatchCompensationStandardReqBuilder(x:MatchCompensationStandardReqBuilder,v:Ref<MatchCompensationStandardReqBuilder>)
	export function unRefMatchCompensationStandardReqBuilder(v:Ref<MatchCompensationStandardReqBuilder>):MatchCompensationStandardReqBuilder
	...
	export function emptySearchAssignedUserReqBuilder():SearchAssignedUserReqBuilder
	export function emptyRefSearchAssignedUserReqBuilder():Ref<SearchAssignedUserReqBuilder>
	export function refOfSearchAssignedUserReqBuilder(x:SearchAssignedUserReqBuilder,v:Ref<SearchAssignedUserReqBuilder>)
	export function unRefSearchAssignedUserReqBuilder(v:Ref<SearchAssignedUserReqBuilder>):SearchAssignedUserReqBuilder
	...
	export function emptyP2JobDataEmployedV1Handler():P2JobDataEmployedV1Handler
	export function emptyRefP2JobDataEmployedV1Handler():Ref<P2JobDataEmployedV1Handler>
	export function refOfP2JobDataEmployedV1Handler(x:P2JobDataEmployedV1Handler,v:Ref<P2JobDataEmployedV1Handler>)
	export function unRefP2JobDataEmployedV1Handler(v:Ref<P2JobDataEmployedV1Handler>):P2JobDataEmployedV1Handler
	...
	export function emptyFormFieldVariableDepartmentValueBuilder():FormFieldVariableDepartmentValueBuilder
	export function emptyRefFormFieldVariableDepartmentValueBuilder():Ref<FormFieldVariableDepartmentValueBuilder>
	export function refOfFormFieldVariableDepartmentValueBuilder(x:FormFieldVariableDepartmentValueBuilder,v:Ref<FormFieldVariableDepartmentValueBuilder>)
	export function unRefFormFieldVariableDepartmentValueBuilder(v:Ref<FormFieldVariableDepartmentValueBuilder>):FormFieldVariableDepartmentValueBuilder
	...
	export function emptyWorkCalendarDetailBuilder():WorkCalendarDetailBuilder
	export function emptyRefWorkCalendarDetailBuilder():Ref<WorkCalendarDetailBuilder>
	export function refOfWorkCalendarDetailBuilder(x:WorkCalendarDetailBuilder,v:Ref<WorkCalendarDetailBuilder>)
	export function unRefWorkCalendarDetailBuilder(v:Ref<WorkCalendarDetailBuilder>):WorkCalendarDetailBuilder
	...
	export function emptyCreateDepartmentReqBuilder():CreateDepartmentReqBuilder
	export function emptyRefCreateDepartmentReqBuilder():Ref<CreateDepartmentReqBuilder>
	export function refOfCreateDepartmentReqBuilder(x:CreateDepartmentReqBuilder,v:Ref<CreateDepartmentReqBuilder>)
	export function unRefCreateDepartmentReqBuilder(v:Ref<CreateDepartmentReqBuilder>):CreateDepartmentReqBuilder
	...
	export function emptyCostCenterQueryBuilder():CostCenterQueryBuilder
	export function emptyRefCostCenterQueryBuilder():Ref<CostCenterQueryBuilder>
	export function refOfCostCenterQueryBuilder(x:CostCenterQueryBuilder,v:Ref<CostCenterQueryBuilder>)
	export function unRefCostCenterQueryBuilder(v:Ref<CostCenterQueryBuilder>):CostCenterQueryBuilder
	...
	export function emptyP2EmploymentConvertedV1Handler():P2EmploymentConvertedV1Handler
	export function emptyRefP2EmploymentConvertedV1Handler():Ref<P2EmploymentConvertedV1Handler>
	export function refOfP2EmploymentConvertedV1Handler(x:P2EmploymentConvertedV1Handler,v:Ref<P2EmploymentConvertedV1Handler>)
	export function unRefP2EmploymentConvertedV1Handler(v:Ref<P2EmploymentConvertedV1Handler>):P2EmploymentConvertedV1Handler
	...
	export function emptyBackgroundCheckCountryBuilder():BackgroundCheckCountryBuilder
	export function emptyRefBackgroundCheckCountryBuilder():Ref<BackgroundCheckCountryBuilder>
	export function refOfBackgroundCheckCountryBuilder(x:BackgroundCheckCountryBuilder,v:Ref<BackgroundCheckCountryBuilder>)
	export function unRefBackgroundCheckCountryBuilder(v:Ref<BackgroundCheckCountryBuilder>):BackgroundCheckCountryBuilder
	...
	export function emptyListWorkingHoursTypeReqBuilder():ListWorkingHoursTypeReqBuilder
	export function emptyRefListWorkingHoursTypeReqBuilder():Ref<ListWorkingHoursTypeReqBuilder>
	export function refOfListWorkingHoursTypeReqBuilder(x:ListWorkingHoursTypeReqBuilder,v:Ref<ListWorkingHoursTypeReqBuilder>)
	export function unRefListWorkingHoursTypeReqBuilder(v:Ref<ListWorkingHoursTypeReqBuilder>):ListWorkingHoursTypeReqBuilder
	export function emptyP2PersonUpdatedV1Handler():P2PersonUpdatedV1Handler
	export function emptyRefP2PersonUpdatedV1Handler():Ref<P2PersonUpdatedV1Handler>
	export function refOfP2PersonUpdatedV1Handler(x:P2PersonUpdatedV1Handler,v:Ref<P2PersonUpdatedV1Handler>)
	export function unRefP2PersonUpdatedV1Handler(v:Ref<P2PersonUpdatedV1Handler>):P2PersonUpdatedV1Handler
	...
	export function emptyBpRoleOrganizationBuilder():BpRoleOrganizationBuilder
	export function emptyRefBpRoleOrganizationBuilder():Ref<BpRoleOrganizationBuilder>
	export function refOfBpRoleOrganizationBuilder(x:BpRoleOrganizationBuilder,v:Ref<BpRoleOrganizationBuilder>)
	export function unRefBpRoleOrganizationBuilder(v:Ref<BpRoleOrganizationBuilder>):BpRoleOrganizationBuilder
	export function emptyTransferTypeBuilder():TransferTypeBuilder
	export function emptyRefTransferTypeBuilder():Ref<TransferTypeBuilder>
	export function refOfTransferTypeBuilder(x:TransferTypeBuilder,v:Ref<TransferTypeBuilder>)
	export function unRefTransferTypeBuilder(v:Ref<TransferTypeBuilder>):TransferTypeBuilder
	...
	export function emptyDeleteJobDataReqBuilder():DeleteJobDataReqBuilder
	export function emptyRefDeleteJobDataReqBuilder():Ref<DeleteJobDataReqBuilder>
	export function refOfDeleteJobDataReqBuilder(x:DeleteJobDataReqBuilder,v:Ref<DeleteJobDataReqBuilder>)
	export function unRefDeleteJobDataReqBuilder(v:Ref<DeleteJobDataReqBuilder>):DeleteJobDataReqBuilder
	...
	export function emptyLeaveSubtypeBuilder():LeaveSubtypeBuilder
	export function emptyRefLeaveSubtypeBuilder():Ref<LeaveSubtypeBuilder>
	export function refOfLeaveSubtypeBuilder(x:LeaveSubtypeBuilder,v:Ref<LeaveSubtypeBuilder>)
	export function unRefLeaveSubtypeBuilder(v:Ref<LeaveSubtypeBuilder>):LeaveSubtypeBuilder
	export function emptyP2JobDeletedV1Handler():P2JobDeletedV1Handler
	export function emptyRefP2JobDeletedV1Handler():Ref<P2JobDeletedV1Handler>
	export function refOfP2JobDeletedV1Handler(x:P2JobDeletedV1Handler,v:Ref<P2JobDeletedV1Handler>)
	export function unRefP2JobDeletedV1Handler(v:Ref<P2JobDeletedV1Handler>):P2JobDeletedV1Handler
	export function emptyQuerySecurityGroupReqBodyBuilder():QuerySecurityGroupReqBodyBuilder
	export function emptyRefQuerySecurityGroupReqBodyBuilder():Ref<QuerySecurityGroupReqBodyBuilder>
	export function refOfQuerySecurityGroupReqBodyBuilder(x:QuerySecurityGroupReqBodyBuilder,v:Ref<QuerySecurityGroupReqBodyBuilder>)
	export function unRefQuerySecurityGroupReqBodyBuilder(v:Ref<QuerySecurityGroupReqBodyBuilder>):QuerySecurityGroupReqBodyBuilder
	...
	export function emptyRuleDimensionBuilder():RuleDimensionBuilder
	export function emptyRefRuleDimensionBuilder():Ref<RuleDimensionBuilder>
	export function refOfRuleDimensionBuilder(x:RuleDimensionBuilder,v:Ref<RuleDimensionBuilder>)
	export function unRefRuleDimensionBuilder(v:Ref<RuleDimensionBuilder>):RuleDimensionBuilder
	...
	export function emptyListObjectApiNameCustomFieldReqBuilder():ListObjectApiNameCustomFieldReqBuilder
	export function emptyRefListObjectApiNameCustomFieldReqBuilder():Ref<ListObjectApiNameCustomFieldReqBuilder>
	export function refOfListObjectApiNameCustomFieldReqBuilder(x:ListObjectApiNameCustomFieldReqBuilder,v:Ref<ListObjectApiNameCustomFieldReqBuilder>)
	export function unRefListObjectApiNameCustomFieldReqBuilder(v:Ref<ListObjectApiNameCustomFieldReqBuilder>):ListObjectApiNameCustomFieldReqBuilder
	...
	export function emptySubmitOffboardingPathReqBodyBuilder():SubmitOffboardingPathReqBodyBuilder
	export function emptyRefSubmitOffboardingPathReqBodyBuilder():Ref<SubmitOffboardingPathReqBodyBuilder>
	export function refOfSubmitOffboardingPathReqBodyBuilder(x:SubmitOffboardingPathReqBodyBuilder,v:Ref<SubmitOffboardingPathReqBodyBuilder>)
	export function unRefSubmitOffboardingPathReqBodyBuilder(v:Ref<SubmitOffboardingPathReqBodyBuilder>):SubmitOffboardingPathReqBodyBuilder
	...
	export function emptyP2OffboardingUpdatedV1Handler():P2OffboardingUpdatedV1Handler
	export function emptyRefP2OffboardingUpdatedV1Handler():Ref<P2OffboardingUpdatedV1Handler>
	export function refOfP2OffboardingUpdatedV1Handler(x:P2OffboardingUpdatedV1Handler,v:Ref<P2OffboardingUpdatedV1Handler>)
	export function unRefP2OffboardingUpdatedV1Handler(v:Ref<P2OffboardingUpdatedV1Handler>):P2OffboardingUpdatedV1Handler
	...
	export function emptyCpstGradeStandardValueBuilder():CpstGradeStandardValueBuilder
	export function emptyRefCpstGradeStandardValueBuilder():Ref<CpstGradeStandardValueBuilder>
	export function refOfCpstGradeStandardValueBuilder(x:CpstGradeStandardValueBuilder,v:Ref<CpstGradeStandardValueBuilder>)
	export function unRefCpstGradeStandardValueBuilder(v:Ref<CpstGradeStandardValueBuilder>):CpstGradeStandardValueBuilder
	...
	export function emptyPatchCompanyReqBuilder():PatchCompanyReqBuilder
	export function emptyRefPatchCompanyReqBuilder():Ref<PatchCompanyReqBuilder>
	export function refOfPatchCompanyReqBuilder(x:PatchCompanyReqBuilder,v:Ref<PatchCompanyReqBuilder>)
	export function unRefPatchCompanyReqBuilder(v:Ref<PatchCompanyReqBuilder>):PatchCompanyReqBuilder
	export function emptySubmitOffboardingReqBuilder():SubmitOffboardingReqBuilder
	export function emptyRefSubmitOffboardingReqBuilder():Ref<SubmitOffboardingReqBuilder>
	export function refOfSubmitOffboardingReqBuilder(x:SubmitOffboardingReqBuilder,v:Ref<SubmitOffboardingReqBuilder>)
	export function unRefSubmitOffboardingReqBuilder(v:Ref<SubmitOffboardingReqBuilder>):SubmitOffboardingReqBuilder
	...
	export function emptyDeleteJobReqBuilder():DeleteJobReqBuilder
	export function emptyRefDeleteJobReqBuilder():Ref<DeleteJobReqBuilder>
	export function refOfDeleteJobReqBuilder(x:DeleteJobReqBuilder,v:Ref<DeleteJobReqBuilder>)
	export function unRefDeleteJobReqBuilder(v:Ref<DeleteJobReqBuilder>):DeleteJobReqBuilder
	export function emptyFormFieldVariableBuilder():FormFieldVariableBuilder
	export function emptyRefFormFieldVariableBuilder():Ref<FormFieldVariableBuilder>
	export function refOfFormFieldVariableBuilder(x:FormFieldVariableBuilder,v:Ref<FormFieldVariableBuilder>)
	export function unRefFormFieldVariableBuilder(v:Ref<FormFieldVariableBuilder>):FormFieldVariableBuilder
	...
	export function emptyLeaveTypeBuilder():LeaveTypeBuilder
	export function emptyRefLeaveTypeBuilder():Ref<LeaveTypeBuilder>
	export function refOfLeaveTypeBuilder(x:LeaveTypeBuilder,v:Ref<LeaveTypeBuilder>)
	export function unRefLeaveTypeBuilder(v:Ref<LeaveTypeBuilder>):LeaveTypeBuilder
	...
	export function emptyObjectBuilder():ObjectBuilder
	export function emptyRefObjectBuilder():Ref<ObjectBuilder>
	export function refOfObjectBuilder(x:ObjectBuilder,v:Ref<ObjectBuilder>)
	export function unRefObjectBuilder(v:Ref<ObjectBuilder>):ObjectBuilder
	...
	export function emptyTempBuilder():TempBuilder
	export function emptyRefTempBuilder():Ref<TempBuilder>
	export function refOfTempBuilder(x:TempBuilder,v:Ref<TempBuilder>)
	export function unRefTempBuilder(v:Ref<TempBuilder>):TempBuilder
	...
	export function emptyP2ContractDeletedV1Handler():P2ContractDeletedV1Handler
	export function emptyRefP2ContractDeletedV1Handler():Ref<P2ContractDeletedV1Handler>
	export function refOfP2ContractDeletedV1Handler(x:P2ContractDeletedV1Handler,v:Ref<P2ContractDeletedV1Handler>)
	export function unRefP2ContractDeletedV1Handler(v:Ref<P2ContractDeletedV1Handler>):P2ContractDeletedV1Handler
	export function emptyP2EmploymentResignedV1Handler():P2EmploymentResignedV1Handler
	export function emptyRefP2EmploymentResignedV1Handler():Ref<P2EmploymentResignedV1Handler>
	export function refOfP2EmploymentResignedV1Handler(x:P2EmploymentResignedV1Handler,v:Ref<P2EmploymentResignedV1Handler>)
	export function unRefP2EmploymentResignedV1Handler(v:Ref<P2EmploymentResignedV1Handler>):P2EmploymentResignedV1Handler
	...
	export function emptyPreviousEmployerBuilder():PreviousEmployerBuilder
	export function emptyRefPreviousEmployerBuilder():Ref<PreviousEmployerBuilder>
	export function refOfPreviousEmployerBuilder(x:PreviousEmployerBuilder,v:Ref<PreviousEmployerBuilder>)
	export function unRefPreviousEmployerBuilder(v:Ref<PreviousEmployerBuilder>):PreviousEmployerBuilder
	export function emptyQueryOffboardingReqBodyBuilder():QueryOffboardingReqBodyBuilder
	export function emptyRefQueryOffboardingReqBodyBuilder():Ref<QueryOffboardingReqBodyBuilder>
	export function refOfQueryOffboardingReqBodyBuilder(x:QueryOffboardingReqBodyBuilder,v:Ref<QueryOffboardingReqBodyBuilder>)
	export function unRefQueryOffboardingReqBodyBuilder(v:Ref<QueryOffboardingReqBodyBuilder>):QueryOffboardingReqBodyBuilder
	export function emptySearchOffboardingReqBuilder():SearchOffboardingReqBuilder
	export function emptyRefSearchOffboardingReqBuilder():Ref<SearchOffboardingReqBuilder>
	export function refOfSearchOffboardingReqBuilder(x:SearchOffboardingReqBuilder,v:Ref<SearchOffboardingReqBuilder>)
	export function unRefSearchOffboardingReqBuilder(v:Ref<SearchOffboardingReqBuilder>):SearchOffboardingReqBuilder
	...
	export function emptyCreateJobChangePathReqBodyBuilder():CreateJobChangePathReqBodyBuilder
	export function emptyRefCreateJobChangePathReqBodyBuilder():Ref<CreateJobChangePathReqBodyBuilder>
	export function refOfCreateJobChangePathReqBodyBuilder(x:CreateJobChangePathReqBodyBuilder,v:Ref<CreateJobChangePathReqBodyBuilder>)
	export function unRefCreateJobChangePathReqBodyBuilder(v:Ref<CreateJobChangePathReqBodyBuilder>):CreateJobChangePathReqBodyBuilder
	...
	export function emptyObjectDataBuilder():ObjectDataBuilder
	export function emptyRefObjectDataBuilder():Ref<ObjectDataBuilder>
	export function refOfObjectDataBuilder(x:ObjectDataBuilder,v:Ref<ObjectDataBuilder>)
	export function unRefObjectDataBuilder(v:Ref<ObjectDataBuilder>):ObjectDataBuilder
	...
	export function emptySubmitOffboardingReqBodyBuilder():SubmitOffboardingReqBodyBuilder
	export function emptyRefSubmitOffboardingReqBodyBuilder():Ref<SubmitOffboardingReqBodyBuilder>
	export function refOfSubmitOffboardingReqBodyBuilder(x:SubmitOffboardingReqBodyBuilder,v:Ref<SubmitOffboardingReqBodyBuilder>)
	export function unRefSubmitOffboardingReqBodyBuilder(v:Ref<SubmitOffboardingReqBodyBuilder>):SubmitOffboardingReqBodyBuilder
	export function emptyCpstBandWidthBuilder():CpstBandWidthBuilder
	export function emptyRefCpstBandWidthBuilder():Ref<CpstBandWidthBuilder>
	export function refOfCpstBandWidthBuilder(x:CpstBandWidthBuilder,v:Ref<CpstBandWidthBuilder>)
	export function unRefCpstBandWidthBuilder(v:Ref<CpstBandWidthBuilder>):CpstBandWidthBuilder
	...
	export function emptyAttachmentFieldSettingBuilder():AttachmentFieldSettingBuilder
	export function emptyRefAttachmentFieldSettingBuilder():Ref<AttachmentFieldSettingBuilder>
	export function refOfAttachmentFieldSettingBuilder(x:AttachmentFieldSettingBuilder,v:Ref<AttachmentFieldSettingBuilder>)
	export function unRefAttachmentFieldSettingBuilder(v:Ref<AttachmentFieldSettingBuilder>):AttachmentFieldSettingBuilder
	...
	export function emptyBackgroundCheckReportObjectBuilder():BackgroundCheckReportObjectBuilder
	export function emptyRefBackgroundCheckReportObjectBuilder():Ref<BackgroundCheckReportObjectBuilder>
	export function refOfBackgroundCheckReportObjectBuilder(x:BackgroundCheckReportObjectBuilder,v:Ref<BackgroundCheckReportObjectBuilder>)
	export function unRefBackgroundCheckReportObjectBuilder(v:Ref<BackgroundCheckReportObjectBuilder>):BackgroundCheckReportObjectBuilder
	export function emptyCreateLeaveGrantingRecordPathReqBodyBuilder():CreateLeaveGrantingRecordPathReqBodyBuilder
	export function emptyRefCreateLeaveGrantingRecordPathReqBodyBuilder():Ref<CreateLeaveGrantingRecordPathReqBodyBuilder>
	export function refOfCreateLeaveGrantingRecordPathReqBodyBuilder(x:CreateLeaveGrantingRecordPathReqBodyBuilder,v:Ref<CreateLeaveGrantingRecordPathReqBodyBuilder>)
	export function unRefCreateLeaveGrantingRecordPathReqBodyBuilder(v:Ref<CreateLeaveGrantingRecordPathReqBodyBuilder>):CreateLeaveGrantingRecordPathReqBodyBuilder
	export function emptyDeleteJobLevelReqBuilder():DeleteJobLevelReqBuilder
	export function emptyRefDeleteJobLevelReqBuilder():Ref<DeleteJobLevelReqBuilder>
	export function refOfDeleteJobLevelReqBuilder(x:DeleteJobLevelReqBuilder,v:Ref<DeleteJobLevelReqBuilder>)
	export function unRefDeleteJobLevelReqBuilder(v:Ref<DeleteJobLevelReqBuilder>):DeleteJobLevelReqBuilder
	export function emptyOrgTruncationBuilder():OrgTruncationBuilder
	export function emptyRefOrgTruncationBuilder():Ref<OrgTruncationBuilder>
	export function refOfOrgTruncationBuilder(x:OrgTruncationBuilder,v:Ref<OrgTruncationBuilder>)
	export function unRefOrgTruncationBuilder(v:Ref<OrgTruncationBuilder>):OrgTruncationBuilder
	...
	export function emptyPatchJobFamilyReqBuilder():PatchJobFamilyReqBuilder
	export function emptyRefPatchJobFamilyReqBuilder():Ref<PatchJobFamilyReqBuilder>
	export function refOfPatchJobFamilyReqBuilder(x:PatchJobFamilyReqBuilder,v:Ref<PatchJobFamilyReqBuilder>)
	export function unRefPatchJobFamilyReqBuilder(v:Ref<PatchJobFamilyReqBuilder>):PatchJobFamilyReqBuilder
	...
	export function emptyQuerySecurityGroupReqBuilder():QuerySecurityGroupReqBuilder
	export function emptyRefQuerySecurityGroupReqBuilder():Ref<QuerySecurityGroupReqBuilder>
	export function refOfQuerySecurityGroupReqBuilder(x:QuerySecurityGroupReqBuilder,v:Ref<QuerySecurityGroupReqBuilder>)
	export function unRefQuerySecurityGroupReqBuilder(v:Ref<QuerySecurityGroupReqBuilder>):QuerySecurityGroupReqBuilder
	export function emptyWkOptionBuilder():WkOptionBuilder
	export function emptyRefWkOptionBuilder():Ref<WkOptionBuilder>
	export function refOfWkOptionBuilder(x:WkOptionBuilder,v:Ref<WkOptionBuilder>)
	export function unRefWkOptionBuilder(v:Ref<WkOptionBuilder>):WkOptionBuilder
	...
	export function emptyCreateLocationReqBuilder():CreateLocationReqBuilder
	export function emptyRefCreateLocationReqBuilder():Ref<CreateLocationReqBuilder>
	export function refOfCreateLocationReqBuilder(x:CreateLocationReqBuilder,v:Ref<CreateLocationReqBuilder>)
	export function unRefCreateLocationReqBuilder(v:Ref<CreateLocationReqBuilder>):CreateLocationReqBuilder
	...
	export function emptyCpstMatchItemBuilder():CpstMatchItemBuilder
	export function emptyRefCpstMatchItemBuilder():Ref<CpstMatchItemBuilder>
	export function refOfCpstMatchItemBuilder(x:CpstMatchItemBuilder,v:Ref<CpstMatchItemBuilder>)
	export function unRefCpstMatchItemBuilder(v:Ref<CpstMatchItemBuilder>):CpstMatchItemBuilder
	...
	export function emptyFormVariableValueInfoExampleBuilder():FormVariableValueInfoExampleBuilder
	export function emptyRefFormVariableValueInfoExampleBuilder():Ref<FormVariableValueInfoExampleBuilder>
	export function refOfFormVariableValueInfoExampleBuilder(x:FormVariableValueInfoExampleBuilder,v:Ref<FormVariableValueInfoExampleBuilder>)
	export function unRefFormVariableValueInfoExampleBuilder(v:Ref<FormVariableValueInfoExampleBuilder>):FormVariableValueInfoExampleBuilder
	...
	export function emptyP2DepartmentCreatedV1Handler():P2DepartmentCreatedV1Handler
	export function emptyRefP2DepartmentCreatedV1Handler():Ref<P2DepartmentCreatedV1Handler>
	export function refOfP2DepartmentCreatedV1Handler(x:P2DepartmentCreatedV1Handler,v:Ref<P2DepartmentCreatedV1Handler>)
	export function unRefP2DepartmentCreatedV1Handler(v:Ref<P2DepartmentCreatedV1Handler>):P2DepartmentCreatedV1Handler
	...
	export function emptyFilterExpressionBuilder():FilterExpressionBuilder
	export function emptyRefFilterExpressionBuilder():Ref<FilterExpressionBuilder>
	export function refOfFilterExpressionBuilder(x:FilterExpressionBuilder,v:Ref<FilterExpressionBuilder>)
	export function unRefFilterExpressionBuilder(v:Ref<FilterExpressionBuilder>):FilterExpressionBuilder
	...
	export function emptyOffboardingInfoBuilder():OffboardingInfoBuilder
	export function emptyRefOffboardingInfoBuilder():Ref<OffboardingInfoBuilder>
	export function refOfOffboardingInfoBuilder(x:OffboardingInfoBuilder,v:Ref<OffboardingInfoBuilder>)
	export function unRefOffboardingInfoBuilder(v:Ref<OffboardingInfoBuilder>):OffboardingInfoBuilder
	export function emptyEmploymentCreateBuilder():EmploymentCreateBuilder
	export function emptyRefEmploymentCreateBuilder():Ref<EmploymentCreateBuilder>
	export function refOfEmploymentCreateBuilder(x:EmploymentCreateBuilder,v:Ref<EmploymentCreateBuilder>)
	export function unRefEmploymentCreateBuilder(v:Ref<EmploymentCreateBuilder>):EmploymentCreateBuilder
	...
	export function emptyEmployeeDateTypeBuilder():EmployeeDateTypeBuilder
	export function emptyRefEmployeeDateTypeBuilder():Ref<EmployeeDateTypeBuilder>
	export function refOfEmployeeDateTypeBuilder(x:EmployeeDateTypeBuilder,v:Ref<EmployeeDateTypeBuilder>)
	export function unRefEmployeeDateTypeBuilder(v:Ref<EmployeeDateTypeBuilder>):EmployeeDateTypeBuilder
	export function emptyGetLocationReqBuilder():GetLocationReqBuilder
	export function emptyRefGetLocationReqBuilder():Ref<GetLocationReqBuilder>
	export function refOfGetLocationReqBuilder(x:GetLocationReqBuilder,v:Ref<GetLocationReqBuilder>)
	export function unRefGetLocationReqBuilder(v:Ref<GetLocationReqBuilder>):GetLocationReqBuilder
	...
	export function emptyDeleteWorkingHoursTypeReqBuilder():DeleteWorkingHoursTypeReqBuilder
	export function emptyRefDeleteWorkingHoursTypeReqBuilder():Ref<DeleteWorkingHoursTypeReqBuilder>
	export function refOfDeleteWorkingHoursTypeReqBuilder(x:DeleteWorkingHoursTypeReqBuilder,v:Ref<DeleteWorkingHoursTypeReqBuilder>)
	export function unRefDeleteWorkingHoursTypeReqBuilder(v:Ref<DeleteWorkingHoursTypeReqBuilder>):DeleteWorkingHoursTypeReqBuilder
	...
	export function emptyCpstCurrencyBuilder():CpstCurrencyBuilder
	export function emptyRefCpstCurrencyBuilder():Ref<CpstCurrencyBuilder>
	export function refOfCpstCurrencyBuilder(x:CpstCurrencyBuilder,v:Ref<CpstCurrencyBuilder>)
	export function unRefCpstCurrencyBuilder(v:Ref<CpstCurrencyBuilder>):CpstCurrencyBuilder
	...
	export function emptyDeleteLocationReqBuilder():DeleteLocationReqBuilder
	export function emptyRefDeleteLocationReqBuilder():Ref<DeleteLocationReqBuilder>
	export function refOfDeleteLocationReqBuilder(x:DeleteLocationReqBuilder,v:Ref<DeleteLocationReqBuilder>)
	export function unRefDeleteLocationReqBuilder(v:Ref<DeleteLocationReqBuilder>):DeleteLocationReqBuilder
	...
	export function emptyListSecurityGroupReqBuilder():ListSecurityGroupReqBuilder
	export function emptyRefListSecurityGroupReqBuilder():Ref<ListSecurityGroupReqBuilder>
	export function refOfListSecurityGroupReqBuilder(x:ListSecurityGroupReqBuilder,v:Ref<ListSecurityGroupReqBuilder>)
	export function unRefListSecurityGroupReqBuilder(v:Ref<ListSecurityGroupReqBuilder>):ListSecurityGroupReqBuilder
	export function emptyLookupFieldSettingBuilder():LookupFieldSettingBuilder
	export function emptyRefLookupFieldSettingBuilder():Ref<LookupFieldSettingBuilder>
	export function refOfLookupFieldSettingBuilder(x:LookupFieldSettingBuilder,v:Ref<LookupFieldSettingBuilder>)
	export function unRefLookupFieldSettingBuilder(v:Ref<LookupFieldSettingBuilder>):LookupFieldSettingBuilder
	...
	export function emptyGetContractReqBuilder():GetContractReqBuilder
	export function emptyRefGetContractReqBuilder():Ref<GetContractReqBuilder>
	export function refOfGetContractReqBuilder(x:GetContractReqBuilder,v:Ref<GetContractReqBuilder>)
	export function unRefGetContractReqBuilder(v:Ref<GetContractReqBuilder>):GetContractReqBuilder
	...
	export function emptyIdInfoBuilder():IdInfoBuilder
	export function emptyRefIdInfoBuilder():Ref<IdInfoBuilder>
	export function refOfIdInfoBuilder(x:IdInfoBuilder,v:Ref<IdInfoBuilder>)
	export function unRefIdInfoBuilder(v:Ref<IdInfoBuilder>):IdInfoBuilder
	...
	export function emptyListCountryRegionReqBuilder():ListCountryRegionReqBuilder
	export function emptyRefListCountryRegionReqBuilder():Ref<ListCountryRegionReqBuilder>
	export function refOfListCountryRegionReqBuilder(x:ListCountryRegionReqBuilder,v:Ref<ListCountryRegionReqBuilder>)
	export function unRefListCountryRegionReqBuilder(v:Ref<ListCountryRegionReqBuilder>):ListCountryRegionReqBuilder
	...
	export function emptyCpstGradeBuilder():CpstGradeBuilder
	export function emptyRefCpstGradeBuilder():Ref<CpstGradeBuilder>
	export function refOfCpstGradeBuilder(x:CpstGradeBuilder,v:Ref<CpstGradeBuilder>)
	export function unRefCpstGradeBuilder(v:Ref<CpstGradeBuilder>):CpstGradeBuilder
	...
	export function emptyListCompanyReqBuilder():ListCompanyReqBuilder
	export function emptyRefListCompanyReqBuilder():Ref<ListCompanyReqBuilder>
	export function refOfListCompanyReqBuilder(x:ListCompanyReqBuilder,v:Ref<ListCompanyReqBuilder>)
	export function unRefListCompanyReqBuilder(v:Ref<ListCompanyReqBuilder>):ListCompanyReqBuilder
	export function emptyCreateCompanyReqBuilder():CreateCompanyReqBuilder
	export function emptyRefCreateCompanyReqBuilder():Ref<CreateCompanyReqBuilder>
	export function refOfCreateCompanyReqBuilder(x:CreateCompanyReqBuilder,v:Ref<CreateCompanyReqBuilder>)
	export function unRefCreateCompanyReqBuilder(v:Ref<CreateCompanyReqBuilder>):CreateCompanyReqBuilder
	export function emptyDeleteDepartmentReqBuilder():DeleteDepartmentReqBuilder
	export function emptyRefDeleteDepartmentReqBuilder():Ref<DeleteDepartmentReqBuilder>
	export function refOfDeleteDepartmentReqBuilder(x:DeleteDepartmentReqBuilder,v:Ref<DeleteDepartmentReqBuilder>)
	export function unRefDeleteDepartmentReqBuilder(v:Ref<DeleteDepartmentReqBuilder>):DeleteDepartmentReqBuilder
	...
	export function emptyP2EmploymentCreatedV1Handler():P2EmploymentCreatedV1Handler
	export function emptyRefP2EmploymentCreatedV1Handler():Ref<P2EmploymentCreatedV1Handler>
	export function refOfP2EmploymentCreatedV1Handler(x:P2EmploymentCreatedV1Handler,v:Ref<P2EmploymentCreatedV1Handler>)
	export function unRefP2EmploymentCreatedV1Handler(v:Ref<P2EmploymentCreatedV1Handler>):P2EmploymentCreatedV1Handler
	...
	export function emptyPersonInfoMysBuilder():PersonInfoMysBuilder
	export function emptyRefPersonInfoMysBuilder():Ref<PersonInfoMysBuilder>
	export function refOfPersonInfoMysBuilder(x:PersonInfoMysBuilder,v:Ref<PersonInfoMysBuilder>)
	export function unRefPersonInfoMysBuilder(v:Ref<PersonInfoMysBuilder>):PersonInfoMysBuilder
	...
	export function emptyGetByParamCustomFieldReqBuilder():GetByParamCustomFieldReqBuilder
	export function emptyRefGetByParamCustomFieldReqBuilder():Ref<GetByParamCustomFieldReqBuilder>
	export function refOfGetByParamCustomFieldReqBuilder(x:GetByParamCustomFieldReqBuilder,v:Ref<GetByParamCustomFieldReqBuilder>)
	export function unRefGetByParamCustomFieldReqBuilder(v:Ref<GetByParamCustomFieldReqBuilder>):GetByParamCustomFieldReqBuilder
	...
	export function emptyFilterConditionBuilder():FilterConditionBuilder
	export function emptyRefFilterConditionBuilder():Ref<FilterConditionBuilder>
	export function refOfFilterConditionBuilder(x:FilterConditionBuilder,v:Ref<FilterConditionBuilder>)
	export function unRefFilterConditionBuilder(v:Ref<FilterConditionBuilder>):FilterConditionBuilder
	export function emptyCreateEmployeeTypeReqBuilder():CreateEmployeeTypeReqBuilder
	export function emptyRefCreateEmployeeTypeReqBuilder():Ref<CreateEmployeeTypeReqBuilder>
	export function refOfCreateEmployeeTypeReqBuilder(x:CreateEmployeeTypeReqBuilder,v:Ref<CreateEmployeeTypeReqBuilder>)
	export function unRefCreateEmployeeTypeReqBuilder(v:Ref<CreateEmployeeTypeReqBuilder>):CreateEmployeeTypeReqBuilder
	...
	export function emptyDeleteJobFamilyReqBuilder():DeleteJobFamilyReqBuilder
	export function emptyRefDeleteJobFamilyReqBuilder():Ref<DeleteJobFamilyReqBuilder>
	export function refOfDeleteJobFamilyReqBuilder(x:DeleteJobFamilyReqBuilder,v:Ref<DeleteJobFamilyReqBuilder>)
	export function unRefDeleteJobFamilyReqBuilder(v:Ref<DeleteJobFamilyReqBuilder>):DeleteJobFamilyReqBuilder
	...
	export function emptyOffboardingDataBuilder():OffboardingDataBuilder
	export function emptyRefOffboardingDataBuilder():Ref<OffboardingDataBuilder>
	export function refOfOffboardingDataBuilder(x:OffboardingDataBuilder,v:Ref<OffboardingDataBuilder>)
	export function unRefOffboardingDataBuilder(v:Ref<OffboardingDataBuilder>):OffboardingDataBuilder
	...
	export function emptyP2EmploymentDeletedV1Handler():P2EmploymentDeletedV1Handler
	export function emptyRefP2EmploymentDeletedV1Handler():Ref<P2EmploymentDeletedV1Handler>
	export function refOfP2EmploymentDeletedV1Handler(x:P2EmploymentDeletedV1Handler,v:Ref<P2EmploymentDeletedV1Handler>)
	export function unRefP2EmploymentDeletedV1Handler(v:Ref<P2EmploymentDeletedV1Handler>):P2EmploymentDeletedV1Handler
	...
	export function emptyP2PersonCreatedV1Handler():P2PersonCreatedV1Handler
	export function emptyRefP2PersonCreatedV1Handler():Ref<P2PersonCreatedV1Handler>
	export function refOfP2PersonCreatedV1Handler(x:P2PersonCreatedV1Handler,v:Ref<P2PersonCreatedV1Handler>)
	export function unRefP2PersonCreatedV1Handler(v:Ref<P2PersonCreatedV1Handler>):P2PersonCreatedV1Handler
	...
	export function emptyEnumFieldSettingBuilder():EnumFieldSettingBuilder
	export function emptyRefEnumFieldSettingBuilder():Ref<EnumFieldSettingBuilder>
	export function refOfEnumFieldSettingBuilder(x:EnumFieldSettingBuilder,v:Ref<EnumFieldSettingBuilder>)
	export function unRefEnumFieldSettingBuilder(v:Ref<EnumFieldSettingBuilder>):EnumFieldSettingBuilder
	export function emptyOffboardingReasonBuilder():OffboardingReasonBuilder
	export function emptyRefOffboardingReasonBuilder():Ref<OffboardingReasonBuilder>
	export function refOfOffboardingReasonBuilder(x:OffboardingReasonBuilder,v:Ref<OffboardingReasonBuilder>)
	export function unRefOffboardingReasonBuilder(v:Ref<OffboardingReasonBuilder>):OffboardingReasonBuilder
	...
	export function emptyConvertCommonDataIdReqBodyBuilder():ConvertCommonDataIdReqBodyBuilder
	export function emptyRefConvertCommonDataIdReqBodyBuilder():Ref<ConvertCommonDataIdReqBodyBuilder>
	export function refOfConvertCommonDataIdReqBodyBuilder(x:ConvertCommonDataIdReqBodyBuilder,v:Ref<ConvertCommonDataIdReqBodyBuilder>)
	export function unRefConvertCommonDataIdReqBodyBuilder(v:Ref<ConvertCommonDataIdReqBodyBuilder>):ConvertCommonDataIdReqBodyBuilder
	...
	export function emptyListSubdivisionReqBuilder():ListSubdivisionReqBuilder
	export function emptyRefListSubdivisionReqBuilder():Ref<ListSubdivisionReqBuilder>
	export function refOfListSubdivisionReqBuilder(x:ListSubdivisionReqBuilder,v:Ref<ListSubdivisionReqBuilder>)
	export function unRefListSubdivisionReqBuilder(v:Ref<ListSubdivisionReqBuilder>):ListSubdivisionReqBuilder
	...
	export function emptyOffboardingChecklistBuilder():OffboardingChecklistBuilder
	export function emptyRefOffboardingChecklistBuilder():Ref<OffboardingChecklistBuilder>
	export function refOfOffboardingChecklistBuilder(x:OffboardingChecklistBuilder,v:Ref<OffboardingChecklistBuilder>)
	export function unRefOffboardingChecklistBuilder(v:Ref<OffboardingChecklistBuilder>):OffboardingChecklistBuilder
	...
	export function emptyFormFieldVariableDatetimeValueBuilder():FormFieldVariableDatetimeValueBuilder
	export function emptyRefFormFieldVariableDatetimeValueBuilder():Ref<FormFieldVariableDatetimeValueBuilder>
	export function refOfFormFieldVariableDatetimeValueBuilder(x:FormFieldVariableDatetimeValueBuilder,v:Ref<FormFieldVariableDatetimeValueBuilder>)
	export function unRefFormFieldVariableDatetimeValueBuilder(v:Ref<FormFieldVariableDatetimeValueBuilder>):FormFieldVariableDatetimeValueBuilder
	export function emptyGetJobDataReqBuilder():GetJobDataReqBuilder
	export function emptyRefGetJobDataReqBuilder():Ref<GetJobDataReqBuilder>
	export function refOfGetJobDataReqBuilder(x:GetJobDataReqBuilder,v:Ref<GetJobDataReqBuilder>)
	export function unRefGetJobDataReqBuilder(v:Ref<GetJobDataReqBuilder>):GetJobDataReqBuilder
	...
	export function emptyLeaveBalancesLeaveReqBuilder():LeaveBalancesLeaveReqBuilder
	export function emptyRefLeaveBalancesLeaveReqBuilder():Ref<LeaveBalancesLeaveReqBuilder>
	export function refOfLeaveBalancesLeaveReqBuilder(x:LeaveBalancesLeaveReqBuilder,v:Ref<LeaveBalancesLeaveReqBuilder>)
	export function unRefLeaveBalancesLeaveReqBuilder(v:Ref<LeaveBalancesLeaveReqBuilder>):LeaveBalancesLeaveReqBuilder
	...
	export function emptyFormFieldVariableFileValueBuilder():FormFieldVariableFileValueBuilder
	export function emptyRefFormFieldVariableFileValueBuilder():Ref<FormFieldVariableFileValueBuilder>
	export function refOfFormFieldVariableFileValueBuilder(x:FormFieldVariableFileValueBuilder,v:Ref<FormFieldVariableFileValueBuilder>)
	export function unRefFormFieldVariableFileValueBuilder(v:Ref<FormFieldVariableFileValueBuilder>):FormFieldVariableFileValueBuilder
	export function emptyListSubregionReqBuilder():ListSubregionReqBuilder
	export function emptyRefListSubregionReqBuilder():Ref<ListSubregionReqBuilder>
	export function refOfListSubregionReqBuilder(x:ListSubregionReqBuilder,v:Ref<ListSubregionReqBuilder>)
	export function unRefListSubregionReqBuilder(v:Ref<ListSubregionReqBuilder>):ListSubregionReqBuilder
	export function emptyManagementScopeBuilder():ManagementScopeBuilder
	export function emptyRefManagementScopeBuilder():Ref<ManagementScopeBuilder>
	export function refOfManagementScopeBuilder(x:ManagementScopeBuilder,v:Ref<ManagementScopeBuilder>)
	export function unRefManagementScopeBuilder(v:Ref<ManagementScopeBuilder>):ManagementScopeBuilder
	...
	export function emptyPatchNationalIdTypeReqBuilder():PatchNationalIdTypeReqBuilder
	export function emptyRefPatchNationalIdTypeReqBuilder():Ref<PatchNationalIdTypeReqBuilder>
	export function refOfPatchNationalIdTypeReqBuilder(x:PatchNationalIdTypeReqBuilder,v:Ref<PatchNationalIdTypeReqBuilder>)
	export function unRefPatchNationalIdTypeReqBuilder(v:Ref<PatchNationalIdTypeReqBuilder>):PatchNationalIdTypeReqBuilder
	...
	export function emptyCreateWorkingHoursTypeReqBuilder():CreateWorkingHoursTypeReqBuilder
	export function emptyRefCreateWorkingHoursTypeReqBuilder():Ref<CreateWorkingHoursTypeReqBuilder>
	export function refOfCreateWorkingHoursTypeReqBuilder(x:CreateWorkingHoursTypeReqBuilder,v:Ref<CreateWorkingHoursTypeReqBuilder>)
	export function unRefCreateWorkingHoursTypeReqBuilder(v:Ref<CreateWorkingHoursTypeReqBuilder>):CreateWorkingHoursTypeReqBuilder
	export function emptyRoleAuthorizationBuilder():RoleAuthorizationBuilder
	export function emptyRefRoleAuthorizationBuilder():Ref<RoleAuthorizationBuilder>
	export function refOfRoleAuthorizationBuilder(x:RoleAuthorizationBuilder,v:Ref<RoleAuthorizationBuilder>)
	export function unRefRoleAuthorizationBuilder(v:Ref<RoleAuthorizationBuilder>):RoleAuthorizationBuilder
	...
	export function emptyDepartmentCreateBuilder():DepartmentCreateBuilder
	export function emptyRefDepartmentCreateBuilder():Ref<DepartmentCreateBuilder>
	export function refOfDepartmentCreateBuilder(x:DepartmentCreateBuilder,v:Ref<DepartmentCreateBuilder>)
	export function unRefDepartmentCreateBuilder(v:Ref<DepartmentCreateBuilder>):DepartmentCreateBuilder
	export function emptyNationalIdTypeBuilder():NationalIdTypeBuilder
	export function emptyRefNationalIdTypeBuilder():Ref<NationalIdTypeBuilder>
	export function refOfNationalIdTypeBuilder(x:NationalIdTypeBuilder,v:Ref<NationalIdTypeBuilder>)
	export function unRefNationalIdTypeBuilder(v:Ref<NationalIdTypeBuilder>):NationalIdTypeBuilder
	...
	export function emptyQuerySecurityGroupPathReqBodyBuilder():QuerySecurityGroupPathReqBodyBuilder
	export function emptyRefQuerySecurityGroupPathReqBodyBuilder():Ref<QuerySecurityGroupPathReqBodyBuilder>
	export function refOfQuerySecurityGroupPathReqBodyBuilder(x:QuerySecurityGroupPathReqBodyBuilder,v:Ref<QuerySecurityGroupPathReqBodyBuilder>)
	export function unRefQuerySecurityGroupPathReqBodyBuilder(v:Ref<QuerySecurityGroupPathReqBodyBuilder>):QuerySecurityGroupPathReqBodyBuilder
	...
	export function emptyFormFieldVariableEmploymentValueBuilder():FormFieldVariableEmploymentValueBuilder
	export function emptyRefFormFieldVariableEmploymentValueBuilder():Ref<FormFieldVariableEmploymentValueBuilder>
	export function refOfFormFieldVariableEmploymentValueBuilder(x:FormFieldVariableEmploymentValueBuilder,v:Ref<FormFieldVariableEmploymentValueBuilder>)
	export function unRefFormFieldVariableEmploymentValueBuilder(v:Ref<FormFieldVariableEmploymentValueBuilder>):FormFieldVariableEmploymentValueBuilder
	...
	export function emptyCreateJobChangeReqBodyBuilder():CreateJobChangeReqBodyBuilder
	export function emptyRefCreateJobChangeReqBodyBuilder():Ref<CreateJobChangeReqBodyBuilder>
	export function refOfCreateJobChangeReqBodyBuilder(x:CreateJobChangeReqBodyBuilder,v:Ref<CreateJobChangeReqBodyBuilder>)
	export function unRefCreateJobChangeReqBodyBuilder(v:Ref<CreateJobChangeReqBodyBuilder>):CreateJobChangeReqBodyBuilder
	export function emptyDeleteLeaveGrantingRecordReqBuilder():DeleteLeaveGrantingRecordReqBuilder
	export function emptyRefDeleteLeaveGrantingRecordReqBuilder():Ref<DeleteLeaveGrantingRecordReqBuilder>
	export function refOfDeleteLeaveGrantingRecordReqBuilder(x:DeleteLeaveGrantingRecordReqBuilder,v:Ref<DeleteLeaveGrantingRecordReqBuilder>)
	export function unRefDeleteLeaveGrantingRecordReqBuilder(v:Ref<DeleteLeaveGrantingRecordReqBuilder>):DeleteLeaveGrantingRecordReqBuilder
	...
	export function emptyListLocationReqBuilder():ListLocationReqBuilder
	export function emptyRefListLocationReqBuilder():Ref<ListLocationReqBuilder>
	export function refOfListLocationReqBuilder(x:ListLocationReqBuilder,v:Ref<ListLocationReqBuilder>)
	export function unRefListLocationReqBuilder(v:Ref<ListLocationReqBuilder>):ListLocationReqBuilder
	...
	export function emptyTextFieldSettingBuilder():TextFieldSettingBuilder
	export function emptyRefTextFieldSettingBuilder():Ref<TextFieldSettingBuilder>
	export function refOfTextFieldSettingBuilder(x:TextFieldSettingBuilder,v:Ref<TextFieldSettingBuilder>)
	export function unRefTextFieldSettingBuilder(v:Ref<TextFieldSettingBuilder>):TextFieldSettingBuilder
}