...
declare module 'github.com/larksuite/oapi-sdk-go/v3/service/calendar/v4'{
	...
	// @ts-ignore
	import type {Ref,Struct,bool,error,int,float64,Alias,Nothing} from 'go'
	...
	export interface CalendarFreebusyError extends Error,Struct<CalendarFreebusyError>{

			calendarId:Ref<string>
			errorMsg:Ref<string>
	}
	export interface CalendarFreebusyErrorBuilder extends Error,Struct<CalendarFreebusyErrorBuilder>{
	...
	export interface P2CalendarChangedV4Handler extends larkevent.EventHandler,Struct<P2CalendarChangedV4Handler>{
	...
	export function emptyExchangeBindingBuilder():ExchangeBindingBuilder
	export function emptyRefExchangeBindingBuilder():Ref<ExchangeBindingBuilder>
	export function refOfExchangeBindingBuilder(x:ExchangeBindingBuilder,v:Ref<ExchangeBindingBuilder>)
	export function unRefExchangeBindingBuilder(v:Ref<ExchangeBindingBuilder>):ExchangeBindingBuilder
	...
	export function emptyWorkhourBuilder():WorkhourBuilder
	export function emptyRefWorkhourBuilder():Ref<WorkhourBuilder>
	export function refOfWorkhourBuilder(x:WorkhourBuilder,v:Ref<WorkhourBuilder>)
	export function unRefWorkhourBuilder(v:Ref<WorkhourBuilder>):WorkhourBuilder
	export function emptyListCalendarEventAttendeeChatMemberReqBuilder():ListCalendarEventAttendeeChatMemberReqBuilder
	export function emptyRefListCalendarEventAttendeeChatMemberReqBuilder():Ref<ListCalendarEventAttendeeChatMemberReqBuilder>
	export function refOfListCalendarEventAttendeeChatMemberReqBuilder(x:ListCalendarEventAttendeeChatMemberReqBuilder,v:Ref<ListCalendarEventAttendeeChatMemberReqBuilder>)
	export function unRefListCalendarEventAttendeeChatMemberReqBuilder(v:Ref<ListCalendarEventAttendeeChatMemberReqBuilder>):ListCalendarEventAttendeeChatMemberReqBuilder
	export function emptyMyaiSearchDocResultBuilder():MyaiSearchDocResultBuilder
	export function emptyRefMyaiSearchDocResultBuilder():Ref<MyaiSearchDocResultBuilder>
	export function refOfMyaiSearchDocResultBuilder(x:MyaiSearchDocResultBuilder,v:Ref<MyaiSearchDocResultBuilder>)
	export function unRefMyaiSearchDocResultBuilder(v:Ref<MyaiSearchDocResultBuilder>):MyaiSearchDocResultBuilder
	...
	export function emptyDeleteCalendarEventMeetingChatReqBuilder():DeleteCalendarEventMeetingChatReqBuilder
	export function emptyRefDeleteCalendarEventMeetingChatReqBuilder():Ref<DeleteCalendarEventMeetingChatReqBuilder>
	export function refOfDeleteCalendarEventMeetingChatReqBuilder(x:DeleteCalendarEventMeetingChatReqBuilder,v:Ref<DeleteCalendarEventMeetingChatReqBuilder>)
	export function unRefDeleteCalendarEventMeetingChatReqBuilder(v:Ref<DeleteCalendarEventMeetingChatReqBuilder>):DeleteCalendarEventMeetingChatReqBuilder
	export function emptyReplyCalendarEventReqBuilder():ReplyCalendarEventReqBuilder
	export function emptyRefReplyCalendarEventReqBuilder():Ref<ReplyCalendarEventReqBuilder>
	export function refOfReplyCalendarEventReqBuilder(x:ReplyCalendarEventReqBuilder,v:Ref<ReplyCalendarEventReqBuilder>)
	export function unRefReplyCalendarEventReqBuilder(v:Ref<ReplyCalendarEventReqBuilder>):ReplyCalendarEventReqBuilder
	...
	export function emptyCreateCalendarEventAttendeeReqBodyBuilder():CreateCalendarEventAttendeeReqBodyBuilder
	export function emptyRefCreateCalendarEventAttendeeReqBodyBuilder():Ref<CreateCalendarEventAttendeeReqBodyBuilder>
	export function refOfCreateCalendarEventAttendeeReqBodyBuilder(x:CreateCalendarEventAttendeeReqBodyBuilder,v:Ref<CreateCalendarEventAttendeeReqBodyBuilder>)
	export function unRefCreateCalendarEventAttendeeReqBodyBuilder(v:Ref<CreateCalendarEventAttendeeReqBodyBuilder>):CreateCalendarEventAttendeeReqBodyBuilder
	export function emptyCreateExchangeBindingReqBuilder():CreateExchangeBindingReqBuilder
	export function emptyRefCreateExchangeBindingReqBuilder():Ref<CreateExchangeBindingReqBuilder>
	export function refOfCreateExchangeBindingReqBuilder(x:CreateExchangeBindingReqBuilder,v:Ref<CreateExchangeBindingReqBuilder>)
	export function unRefCreateExchangeBindingReqBuilder(v:Ref<CreateExchangeBindingReqBuilder>):CreateExchangeBindingReqBuilder
	...
	export function emptyEventCardBuilder():EventCardBuilder
	export function emptyRefEventCardBuilder():Ref<EventCardBuilder>
	export function refOfEventCardBuilder(x:EventCardBuilder,v:Ref<EventCardBuilder>)
	export function unRefEventCardBuilder(v:Ref<EventCardBuilder>):EventCardBuilder
	...
	export function emptyUserFreebusyBuilder():UserFreebusyBuilder
	export function emptyRefUserFreebusyBuilder():Ref<UserFreebusyBuilder>
	export function refOfUserFreebusyBuilder(x:UserFreebusyBuilder,v:Ref<UserFreebusyBuilder>)
	export function unRefUserFreebusyBuilder(v:Ref<UserFreebusyBuilder>):UserFreebusyBuilder
	...
	export function emptySearchCalendarPathReqBodyBuilder():SearchCalendarPathReqBodyBuilder
	export function emptyRefSearchCalendarPathReqBodyBuilder():Ref<SearchCalendarPathReqBodyBuilder>
	export function refOfSearchCalendarPathReqBodyBuilder(x:SearchCalendarPathReqBodyBuilder,v:Ref<SearchCalendarPathReqBodyBuilder>)
	export function unRefSearchCalendarPathReqBodyBuilder(v:Ref<SearchCalendarPathReqBodyBuilder>):SearchCalendarPathReqBodyBuilder
	export function emptyAclScopeEventBuilder():AclScopeEventBuilder
	export function emptyRefAclScopeEventBuilder():Ref<AclScopeEventBuilder>
	export function refOfAclScopeEventBuilder(x:AclScopeEventBuilder,v:Ref<AclScopeEventBuilder>)
	export function unRefAclScopeEventBuilder(v:Ref<AclScopeEventBuilder>):AclScopeEventBuilder
	...
	export function emptyReplyCalendarEventPathReqBodyBuilder():ReplyCalendarEventPathReqBodyBuilder
	export function emptyRefReplyCalendarEventPathReqBodyBuilder():Ref<ReplyCalendarEventPathReqBodyBuilder>
	export function refOfReplyCalendarEventPathReqBodyBuilder(x:ReplyCalendarEventPathReqBodyBuilder,v:Ref<ReplyCalendarEventPathReqBodyBuilder>)
	export function unRefReplyCalendarEventPathReqBodyBuilder(v:Ref<ReplyCalendarEventPathReqBodyBuilder>):ReplyCalendarEventPathReqBodyBuilder
	...
	export function emptyDeleteTimeoffEventReqBuilder():DeleteTimeoffEventReqBuilder
	export function emptyRefDeleteTimeoffEventReqBuilder():Ref<DeleteTimeoffEventReqBuilder>
	export function refOfDeleteTimeoffEventReqBuilder(x:DeleteTimeoffEventReqBuilder,v:Ref<DeleteTimeoffEventReqBuilder>)
	export function unRefDeleteTimeoffEventReqBuilder(v:Ref<DeleteTimeoffEventReqBuilder>):DeleteTimeoffEventReqBuilder
	...
	export function emptyFreeTimeAiBuilder():FreeTimeAiBuilder
	export function emptyRefFreeTimeAiBuilder():Ref<FreeTimeAiBuilder>
	export function refOfFreeTimeAiBuilder(x:FreeTimeAiBuilder,v:Ref<FreeTimeAiBuilder>)
	export function unRefFreeTimeAiBuilder(v:Ref<FreeTimeAiBuilder>):FreeTimeAiBuilder
	...
	export function emptyEventLocationBuilder():EventLocationBuilder
	export function emptyRefEventLocationBuilder():Ref<EventLocationBuilder>
	export function refOfEventLocationBuilder(x:EventLocationBuilder,v:Ref<EventLocationBuilder>)
	export function unRefEventLocationBuilder(v:Ref<EventLocationBuilder>):EventLocationBuilder
	...
	export function emptyGenerateCaldavConfSettingPathReqBodyBuilder():GenerateCaldavConfSettingPathReqBodyBuilder
	export function emptyRefGenerateCaldavConfSettingPathReqBodyBuilder():Ref<GenerateCaldavConfSettingPathReqBodyBuilder>
	export function refOfGenerateCaldavConfSettingPathReqBodyBuilder(x:GenerateCaldavConfSettingPathReqBodyBuilder,v:Ref<GenerateCaldavConfSettingPathReqBodyBuilder>)
	export function unRefGenerateCaldavConfSettingPathReqBodyBuilder(v:Ref<GenerateCaldavConfSettingPathReqBodyBuilder>):GenerateCaldavConfSettingPathReqBodyBuilder
	...
	export function emptyCalendarFreebusyBuilder():CalendarFreebusyBuilder
	export function emptyRefCalendarFreebusyBuilder():Ref<CalendarFreebusyBuilder>
	export function refOfCalendarFreebusyBuilder(x:CalendarFreebusyBuilder,v:Ref<CalendarFreebusyBuilder>)
	export function unRefCalendarFreebusyBuilder(v:Ref<CalendarFreebusyBuilder>):CalendarFreebusyBuilder
	export function emptyListFreebusyReqBodyBuilder():ListFreebusyReqBodyBuilder
	export function emptyRefListFreebusyReqBodyBuilder():Ref<ListFreebusyReqBodyBuilder>
	export function refOfListFreebusyReqBodyBuilder(x:ListFreebusyReqBodyBuilder,v:Ref<ListFreebusyReqBodyBuilder>)
	export function unRefListFreebusyReqBodyBuilder(v:Ref<ListFreebusyReqBodyBuilder>):ListFreebusyReqBodyBuilder
	...
	export function emptyOpenEventRsvpInfoBuilder():OpenEventRsvpInfoBuilder
	export function emptyRefOpenEventRsvpInfoBuilder():Ref<OpenEventRsvpInfoBuilder>
	export function refOfOpenEventRsvpInfoBuilder(x:OpenEventRsvpInfoBuilder,v:Ref<OpenEventRsvpInfoBuilder>)
	export function unRefOpenEventRsvpInfoBuilder(v:Ref<OpenEventRsvpInfoBuilder>):OpenEventRsvpInfoBuilder
	...
	export function emptyTimeSpanBuilder():TimeSpanBuilder
	export function emptyRefTimeSpanBuilder():Ref<TimeSpanBuilder>
	export function refOfTimeSpanBuilder(x:TimeSpanBuilder,v:Ref<TimeSpanBuilder>)
	export function unRefTimeSpanBuilder(v:Ref<TimeSpanBuilder>):TimeSpanBuilder
	...
	export function emptyGetCalendarEventReqBuilder():GetCalendarEventReqBuilder
	export function emptyRefGetCalendarEventReqBuilder():Ref<GetCalendarEventReqBuilder>
	export function refOfGetCalendarEventReqBuilder(x:GetCalendarEventReqBuilder,v:Ref<GetCalendarEventReqBuilder>)
	export function unRefGetCalendarEventReqBuilder(v:Ref<GetCalendarEventReqBuilder>):GetCalendarEventReqBuilder
	...
	export function emptyP2CalendarEventChangedV4Handler():P2CalendarEventChangedV4Handler
	export function emptyRefP2CalendarEventChangedV4Handler():Ref<P2CalendarEventChangedV4Handler>
	export function refOfP2CalendarEventChangedV4Handler(x:P2CalendarEventChangedV4Handler,v:Ref<P2CalendarEventChangedV4Handler>)
	export function unRefP2CalendarEventChangedV4Handler(v:Ref<P2CalendarEventChangedV4Handler>):P2CalendarEventChangedV4Handler
	...
	export function emptyCalendarEventBuilder():CalendarEventBuilder
	export function emptyRefCalendarEventBuilder():Ref<CalendarEventBuilder>
	export function refOfCalendarEventBuilder(x:CalendarEventBuilder,v:Ref<CalendarEventBuilder>)
	export function unRefCalendarEventBuilder(v:Ref<CalendarEventBuilder>):CalendarEventBuilder
	...
	export function emptyMyaiCardStatusBuilder():MyaiCardStatusBuilder
	export function emptyRefMyaiCardStatusBuilder():Ref<MyaiCardStatusBuilder>
	export function refOfMyaiCardStatusBuilder(x:MyaiCardStatusBuilder,v:Ref<MyaiCardStatusBuilder>)
	export function unRefMyaiCardStatusBuilder(v:Ref<MyaiCardStatusBuilder>):MyaiCardStatusBuilder
	...
	export function emptyGetCalendarReqBuilder():GetCalendarReqBuilder
	export function emptyRefGetCalendarReqBuilder():Ref<GetCalendarReqBuilder>
	export function refOfGetCalendarReqBuilder(x:GetCalendarReqBuilder,v:Ref<GetCalendarReqBuilder>)
	export function unRefGetCalendarReqBuilder(v:Ref<GetCalendarReqBuilder>):GetCalendarReqBuilder
	...
	export function emptyDeleteCalendarEventReqBuilder():DeleteCalendarEventReqBuilder
	export function emptyRefDeleteCalendarEventReqBuilder():Ref<DeleteCalendarEventReqBuilder>
	export function refOfDeleteCalendarEventReqBuilder(x:DeleteCalendarEventReqBuilder,v:Ref<DeleteCalendarEventReqBuilder>)
	export function unRefDeleteCalendarEventReqBuilder(v:Ref<DeleteCalendarEventReqBuilder>):DeleteCalendarEventReqBuilder
	...
	export function emptyDeleteExchangeBindingReqBuilder():DeleteExchangeBindingReqBuilder
	export function emptyRefDeleteExchangeBindingReqBuilder():Ref<DeleteExchangeBindingReqBuilder>
	export function refOfDeleteExchangeBindingReqBuilder(x:DeleteExchangeBindingReqBuilder,v:Ref<DeleteExchangeBindingReqBuilder>)
	export function unRefDeleteExchangeBindingReqBuilder(v:Ref<DeleteExchangeBindingReqBuilder>):DeleteExchangeBindingReqBuilder
	...
	export function emptyCalendarPrimaryBatchReqBuilder():CalendarPrimaryBatchReqBuilder
	export function emptyRefCalendarPrimaryBatchReqBuilder():Ref<CalendarPrimaryBatchReqBuilder>
	export function refOfCalendarPrimaryBatchReqBuilder(x:CalendarPrimaryBatchReqBuilder,v:Ref<CalendarPrimaryBatchReqBuilder>)
	export function unRefCalendarPrimaryBatchReqBuilder(v:Ref<CalendarPrimaryBatchReqBuilder>):CalendarPrimaryBatchReqBuilder
	...
	export function emptyMeetingSettingsBuilder():MeetingSettingsBuilder
	export function emptyRefMeetingSettingsBuilder():Ref<MeetingSettingsBuilder>
	export function refOfMeetingSettingsBuilder(x:MeetingSettingsBuilder,v:Ref<MeetingSettingsBuilder>)
	export function unRefMeetingSettingsBuilder(v:Ref<MeetingSettingsBuilder>):MeetingSettingsBuilder
	export function emptyP2CalendarAclDeletedV4Handler():P2CalendarAclDeletedV4Handler
	export function emptyRefP2CalendarAclDeletedV4Handler():Ref<P2CalendarAclDeletedV4Handler>
	export function refOfP2CalendarAclDeletedV4Handler(x:P2CalendarAclDeletedV4Handler,v:Ref<P2CalendarAclDeletedV4Handler>)
	export function unRefP2CalendarAclDeletedV4Handler(v:Ref<P2CalendarAclDeletedV4Handler>):P2CalendarAclDeletedV4Handler
	export function emptyPrimaryCalendarReqBuilder():PrimaryCalendarReqBuilder
	export function emptyRefPrimaryCalendarReqBuilder():Ref<PrimaryCalendarReqBuilder>
	export function refOfPrimaryCalendarReqBuilder(x:PrimaryCalendarReqBuilder,v:Ref<PrimaryCalendarReqBuilder>)
	export function unRefPrimaryCalendarReqBuilder(v:Ref<PrimaryCalendarReqBuilder>):PrimaryCalendarReqBuilder
	export function emptyCalendarUnderstandExtraBuilder():CalendarUnderstandExtraBuilder
	export function emptyRefCalendarUnderstandExtraBuilder():Ref<CalendarUnderstandExtraBuilder>
	export function refOfCalendarUnderstandExtraBuilder(x:CalendarUnderstandExtraBuilder,v:Ref<CalendarUnderstandExtraBuilder>)
	export function unRefCalendarUnderstandExtraBuilder(v:Ref<CalendarUnderstandExtraBuilder>):CalendarUnderstandExtraBuilder
	export function emptyFreeTimeBuilder():FreeTimeBuilder
	export function emptyRefFreeTimeBuilder():Ref<FreeTimeBuilder>
	export function refOfFreeTimeBuilder(x:FreeTimeBuilder,v:Ref<FreeTimeBuilder>)
	export function unRefFreeTimeBuilder(v:Ref<FreeTimeBuilder>):FreeTimeBuilder
	export function emptySearchUserResultAiBuilder():SearchUserResultAiBuilder
	export function emptyRefSearchUserResultAiBuilder():Ref<SearchUserResultAiBuilder>
	export function refOfSearchUserResultAiBuilder(x:SearchUserResultAiBuilder,v:Ref<SearchUserResultAiBuilder>)
	export function unRefSearchUserResultAiBuilder(v:Ref<SearchUserResultAiBuilder>):SearchUserResultAiBuilder
	export function emptyCalendarAttendeeResourceCustomizationBuilder():CalendarAttendeeResourceCustomizationBuilder
	export function emptyRefCalendarAttendeeResourceCustomizationBuilder():Ref<CalendarAttendeeResourceCustomizationBuilder>
	export function refOfCalendarAttendeeResourceCustomizationBuilder(x:CalendarAttendeeResourceCustomizationBuilder,v:Ref<CalendarAttendeeResourceCustomizationBuilder>)
	export function unRefCalendarAttendeeResourceCustomizationBuilder(v:Ref<CalendarAttendeeResourceCustomizationBuilder>):CalendarAttendeeResourceCustomizationBuilder
	...
	export function emptyCreateTimeoffEventReqBuilder():CreateTimeoffEventReqBuilder
	export function emptyRefCreateTimeoffEventReqBuilder():Ref<CreateTimeoffEventReqBuilder>
	export function refOfCreateTimeoffEventReqBuilder(x:CreateTimeoffEventReqBuilder,v:Ref<CreateTimeoffEventReqBuilder>)
	export function unRefCreateTimeoffEventReqBuilder(v:Ref<CreateTimeoffEventReqBuilder>):CreateTimeoffEventReqBuilder
	...
	export function emptySearchCalendarEventPathReqBodyBuilder():SearchCalendarEventPathReqBodyBuilder
	export function emptyRefSearchCalendarEventPathReqBodyBuilder():Ref<SearchCalendarEventPathReqBodyBuilder>
	export function refOfSearchCalendarEventPathReqBodyBuilder(x:SearchCalendarEventPathReqBodyBuilder,v:Ref<SearchCalendarEventPathReqBodyBuilder>)
	export function unRefSearchCalendarEventPathReqBodyBuilder(v:Ref<SearchCalendarEventPathReqBodyBuilder>):SearchCalendarEventPathReqBodyBuilder
	...
	export function emptyVchatBuilder():VchatBuilder
	export function emptyRefVchatBuilder():Ref<VchatBuilder>
	export function refOfVchatBuilder(x:VchatBuilder,v:Ref<VchatBuilder>)
	export function unRefVchatBuilder(v:Ref<VchatBuilder>):VchatBuilder
	...
	export function emptyP2CalendarAclCreatedV4Handler():P2CalendarAclCreatedV4Handler
	export function emptyRefP2CalendarAclCreatedV4Handler():Ref<P2CalendarAclCreatedV4Handler>
	export function refOfP2CalendarAclCreatedV4Handler(x:P2CalendarAclCreatedV4Handler,v:Ref<P2CalendarAclCreatedV4Handler>)
	export function unRefP2CalendarAclCreatedV4Handler(v:Ref<P2CalendarAclCreatedV4Handler>):P2CalendarAclCreatedV4Handler
	export function emptyP2CalendarChangedV4Handler():P2CalendarChangedV4Handler
	export function emptyRefP2CalendarChangedV4Handler():Ref<P2CalendarChangedV4Handler>
	export function refOfP2CalendarChangedV4Handler(x:P2CalendarChangedV4Handler,v:Ref<P2CalendarChangedV4Handler>)
	export function unRefP2CalendarChangedV4Handler(v:Ref<P2CalendarChangedV4Handler>):P2CalendarChangedV4Handler
	...
	export function emptyCalendarAclBuilder():CalendarAclBuilder
	export function emptyRefCalendarAclBuilder():Ref<CalendarAclBuilder>
	export function refOfCalendarAclBuilder(x:CalendarAclBuilder,v:Ref<CalendarAclBuilder>)
	export function unRefCalendarAclBuilder(v:Ref<CalendarAclBuilder>):CalendarAclBuilder
	...
	export function emptyInstancesCalendarEventReqBuilder():InstancesCalendarEventReqBuilder
	export function emptyRefInstancesCalendarEventReqBuilder():Ref<InstancesCalendarEventReqBuilder>
	export function refOfInstancesCalendarEventReqBuilder(x:InstancesCalendarEventReqBuilder,v:Ref<InstancesCalendarEventReqBuilder>)
	export function unRefInstancesCalendarEventReqBuilder(v:Ref<InstancesCalendarEventReqBuilder>):InstancesCalendarEventReqBuilder
	export function emptyOperateCardDataBuilder():OperateCardDataBuilder
	export function emptyRefOperateCardDataBuilder():Ref<OperateCardDataBuilder>
	export function refOfOperateCardDataBuilder(x:OperateCardDataBuilder,v:Ref<OperateCardDataBuilder>)
	export function unRefOperateCardDataBuilder(v:Ref<OperateCardDataBuilder>):OperateCardDataBuilder
	...
	export function emptyBatchDeleteCalendarEventAttendeeReqBuilder():BatchDeleteCalendarEventAttendeeReqBuilder
	export function emptyRefBatchDeleteCalendarEventAttendeeReqBuilder():Ref<BatchDeleteCalendarEventAttendeeReqBuilder>
	export function refOfBatchDeleteCalendarEventAttendeeReqBuilder(x:BatchDeleteCalendarEventAttendeeReqBuilder,v:Ref<BatchDeleteCalendarEventAttendeeReqBuilder>)
	export function unRefBatchDeleteCalendarEventAttendeeReqBuilder(v:Ref<BatchDeleteCalendarEventAttendeeReqBuilder>):BatchDeleteCalendarEventAttendeeReqBuilder
	...
	export function emptyCardCallbackBuilder():CardCallbackBuilder
	export function emptyRefCardCallbackBuilder():Ref<CardCallbackBuilder>
	export function refOfCardCallbackBuilder(x:CardCallbackBuilder,v:Ref<CardCallbackBuilder>)
	export function unRefCardCallbackBuilder(v:Ref<CardCallbackBuilder>):CardCallbackBuilder
	...
	export function emptyMyAiEventDetailBuilder():MyAiEventDetailBuilder
	export function emptyRefMyAiEventDetailBuilder():Ref<MyAiEventDetailBuilder>
	export function refOfMyAiEventDetailBuilder(x:MyAiEventDetailBuilder,v:Ref<MyAiEventDetailBuilder>)
	export function unRefMyAiEventDetailBuilder(v:Ref<MyAiEventDetailBuilder>):MyAiEventDetailBuilder
	export function emptySearchCalendarEventReqBuilder():SearchCalendarEventReqBuilder
	export function emptyRefSearchCalendarEventReqBuilder():Ref<SearchCalendarEventReqBuilder>
	export function refOfSearchCalendarEventReqBuilder(x:SearchCalendarEventReqBuilder,v:Ref<SearchCalendarEventReqBuilder>)
	export function unRefSearchCalendarEventReqBuilder(v:Ref<SearchCalendarEventReqBuilder>):SearchCalendarEventReqBuilder
	export function emptySearchUserDataAiBuilder():SearchUserDataAiBuilder
	export function emptyRefSearchUserDataAiBuilder():Ref<SearchUserDataAiBuilder>
	export function refOfSearchUserDataAiBuilder(x:SearchUserDataAiBuilder,v:Ref<SearchUserDataAiBuilder>)
	export function unRefSearchUserDataAiBuilder(v:Ref<SearchUserDataAiBuilder>):SearchUserDataAiBuilder
	...
	export function emptyListFreebusyPathReqBodyBuilder():ListFreebusyPathReqBodyBuilder
	export function emptyRefListFreebusyPathReqBodyBuilder():Ref<ListFreebusyPathReqBodyBuilder>
	export function refOfListFreebusyPathReqBodyBuilder(x:ListFreebusyPathReqBodyBuilder,v:Ref<ListFreebusyPathReqBodyBuilder>)
	export function unRefListFreebusyPathReqBodyBuilder(v:Ref<ListFreebusyPathReqBodyBuilder>):ListFreebusyPathReqBodyBuilder
	...
	export function emptyBatchDeleteCalendarEventAttendeePathReqBodyBuilder():BatchDeleteCalendarEventAttendeePathReqBodyBuilder
	export function emptyRefBatchDeleteCalendarEventAttendeePathReqBodyBuilder():Ref<BatchDeleteCalendarEventAttendeePathReqBodyBuilder>
	export function refOfBatchDeleteCalendarEventAttendeePathReqBodyBuilder(x:BatchDeleteCalendarEventAttendeePathReqBodyBuilder,v:Ref<BatchDeleteCalendarEventAttendeePathReqBodyBuilder>)
	export function unRefBatchDeleteCalendarEventAttendeePathReqBodyBuilder(v:Ref<BatchDeleteCalendarEventAttendeePathReqBodyBuilder>):BatchDeleteCalendarEventAttendeePathReqBodyBuilder
	export function emptyFreeTimeSlotBuilder():FreeTimeSlotBuilder
	export function emptyRefFreeTimeSlotBuilder():Ref<FreeTimeSlotBuilder>
	export function refOfFreeTimeSlotBuilder(x:FreeTimeSlotBuilder,v:Ref<FreeTimeSlotBuilder>)
	export function unRefFreeTimeSlotBuilder(v:Ref<FreeTimeSlotBuilder>):FreeTimeSlotBuilder
	...
	export function emptyDeleteCalendarAclReqBuilder():DeleteCalendarAclReqBuilder
	export function emptyRefDeleteCalendarAclReqBuilder():Ref<DeleteCalendarAclReqBuilder>
	export function refOfDeleteCalendarAclReqBuilder(x:DeleteCalendarAclReqBuilder,v:Ref<DeleteCalendarAclReqBuilder>)
	export function unRefDeleteCalendarAclReqBuilder(v:Ref<DeleteCalendarAclReqBuilder>):DeleteCalendarAclReqBuilder
	export function emptyMyaiReplyBuilder():MyaiReplyBuilder
	export function emptyRefMyaiReplyBuilder():Ref<MyaiReplyBuilder>
	export function refOfMyaiReplyBuilder(x:MyaiReplyBuilder,v:Ref<MyaiReplyBuilder>)
	export function unRefMyaiReplyBuilder(v:Ref<MyaiReplyBuilder>):MyaiReplyBuilder
	export function emptySearchCalendarEventReqBodyBuilder():SearchCalendarEventReqBodyBuilder
	export function emptyRefSearchCalendarEventReqBodyBuilder():Ref<SearchCalendarEventReqBodyBuilder>
	export function refOfSearchCalendarEventReqBodyBuilder(x:SearchCalendarEventReqBodyBuilder,v:Ref<SearchCalendarEventReqBodyBuilder>)
	export function unRefSearchCalendarEventReqBodyBuilder(v:Ref<SearchCalendarEventReqBodyBuilder>):SearchCalendarEventReqBodyBuilder
	export function emptyGenerateCaldavConfSettingReqBuilder():GenerateCaldavConfSettingReqBuilder
	export function emptyRefGenerateCaldavConfSettingReqBuilder():Ref<GenerateCaldavConfSettingReqBuilder>
	export function refOfGenerateCaldavConfSettingReqBuilder(x:GenerateCaldavConfSettingReqBuilder,v:Ref<GenerateCaldavConfSettingReqBuilder>)
	export function unRefGenerateCaldavConfSettingReqBuilder(v:Ref<GenerateCaldavConfSettingReqBuilder>):GenerateCaldavConfSettingReqBuilder
	...
	export function emptyBatchDeleteCalendarEventAttendeeReqBodyBuilder():BatchDeleteCalendarEventAttendeeReqBodyBuilder
	export function emptyRefBatchDeleteCalendarEventAttendeeReqBodyBuilder():Ref<BatchDeleteCalendarEventAttendeeReqBodyBuilder>
	export function refOfBatchDeleteCalendarEventAttendeeReqBodyBuilder(x:BatchDeleteCalendarEventAttendeeReqBodyBuilder,v:Ref<BatchDeleteCalendarEventAttendeeReqBodyBuilder>)
	export function unRefBatchDeleteCalendarEventAttendeeReqBodyBuilder(v:Ref<BatchDeleteCalendarEventAttendeeReqBodyBuilder>):BatchDeleteCalendarEventAttendeeReqBodyBuilder
	...
	export function emptyCreateCalendarEventAttendeeReqBuilder():CreateCalendarEventAttendeeReqBuilder
	export function emptyRefCreateCalendarEventAttendeeReqBuilder():Ref<CreateCalendarEventAttendeeReqBuilder>
	export function refOfCreateCalendarEventAttendeeReqBuilder(x:CreateCalendarEventAttendeeReqBuilder,v:Ref<CreateCalendarEventAttendeeReqBuilder>)
	export function unRefCreateCalendarEventAttendeeReqBuilder(v:Ref<CreateCalendarEventAttendeeReqBuilder>):CreateCalendarEventAttendeeReqBuilder
	export function emptyCreateCalendarEventReqBuilder():CreateCalendarEventReqBuilder
	export function emptyRefCreateCalendarEventReqBuilder():Ref<CreateCalendarEventReqBuilder>
	export function refOfCreateCalendarEventReqBuilder(x:CreateCalendarEventReqBuilder,v:Ref<CreateCalendarEventReqBuilder>)
	export function unRefCreateCalendarEventReqBuilder(v:Ref<CreateCalendarEventReqBuilder>):CreateCalendarEventReqBuilder
	export function emptyEventBriefInfoAiBuilder():EventBriefInfoAiBuilder
	export function emptyRefEventBriefInfoAiBuilder():Ref<EventBriefInfoAiBuilder>
	export function refOfEventBriefInfoAiBuilder(x:EventBriefInfoAiBuilder,v:Ref<EventBriefInfoAiBuilder>)
	export function unRefEventBriefInfoAiBuilder(v:Ref<EventBriefInfoAiBuilder>):EventBriefInfoAiBuilder
	...
	export function emptyEventSearchFilterBuilder():EventSearchFilterBuilder
	export function emptyRefEventSearchFilterBuilder():Ref<EventSearchFilterBuilder>
	export function refOfEventSearchFilterBuilder(x:EventSearchFilterBuilder,v:Ref<EventSearchFilterBuilder>)
	export function unRefEventSearchFilterBuilder(v:Ref<EventSearchFilterBuilder>):EventSearchFilterBuilder
	export function emptySearchCalendarReqBuilder():SearchCalendarReqBuilder
	export function emptyRefSearchCalendarReqBuilder():Ref<SearchCalendarReqBuilder>
	export function refOfSearchCalendarReqBuilder(x:SearchCalendarReqBuilder,v:Ref<SearchCalendarReqBuilder>)
	export function unRefSearchCalendarReqBuilder(v:Ref<SearchCalendarReqBuilder>):SearchCalendarReqBuilder
	...
	export function emptyVcInfoBuilder():VcInfoBuilder
	export function emptyRefVcInfoBuilder():Ref<VcInfoBuilder>
	export function refOfVcInfoBuilder(x:VcInfoBuilder,v:Ref<VcInfoBuilder>)
	export function unRefVcInfoBuilder(v:Ref<VcInfoBuilder>):VcInfoBuilder
	...
	export function emptyCreateCalendarEventAttendeePathReqBodyBuilder():CreateCalendarEventAttendeePathReqBodyBuilder
	export function emptyRefCreateCalendarEventAttendeePathReqBodyBuilder():Ref<CreateCalendarEventAttendeePathReqBodyBuilder>
	export function refOfCreateCalendarEventAttendeePathReqBodyBuilder(x:CreateCalendarEventAttendeePathReqBodyBuilder,v:Ref<CreateCalendarEventAttendeePathReqBodyBuilder>)
	export function unRefCreateCalendarEventAttendeePathReqBodyBuilder(v:Ref<CreateCalendarEventAttendeePathReqBodyBuilder>):CreateCalendarEventAttendeePathReqBodyBuilder
	export function emptyCreateCalendarEventMeetingChatReqBuilder():CreateCalendarEventMeetingChatReqBuilder
	export function emptyRefCreateCalendarEventMeetingChatReqBuilder():Ref<CreateCalendarEventMeetingChatReqBuilder>
	export function refOfCreateCalendarEventMeetingChatReqBuilder(x:CreateCalendarEventMeetingChatReqBuilder,v:Ref<CreateCalendarEventMeetingChatReqBuilder>)
	export function unRefCreateCalendarEventMeetingChatReqBuilder(v:Ref<CreateCalendarEventMeetingChatReqBuilder>):CreateCalendarEventMeetingChatReqBuilder
	...
	export function emptyUserCalendarBuilder():UserCalendarBuilder
	export function emptyRefUserCalendarBuilder():Ref<UserCalendarBuilder>
	export function refOfUserCalendarBuilder(x:UserCalendarBuilder,v:Ref<UserCalendarBuilder>)
	export function unRefUserCalendarBuilder(v:Ref<UserCalendarBuilder>):UserCalendarBuilder
	...
	export function emptySubscribeCalendarReqBuilder():SubscribeCalendarReqBuilder
	export function emptyRefSubscribeCalendarReqBuilder():Ref<SubscribeCalendarReqBuilder>
	export function refOfSubscribeCalendarReqBuilder(x:SubscribeCalendarReqBuilder,v:Ref<SubscribeCalendarReqBuilder>)
	export function unRefSubscribeCalendarReqBuilder(v:Ref<SubscribeCalendarReqBuilder>):SubscribeCalendarReqBuilder
	export function emptyUnsubscriptionCalendarAclReqBuilder():UnsubscriptionCalendarAclReqBuilder
	export function emptyRefUnsubscriptionCalendarAclReqBuilder():Ref<UnsubscriptionCalendarAclReqBuilder>
	export function refOfUnsubscriptionCalendarAclReqBuilder(x:UnsubscriptionCalendarAclReqBuilder,v:Ref<UnsubscriptionCalendarAclReqBuilder>)
	export function unRefUnsubscriptionCalendarAclReqBuilder(v:Ref<UnsubscriptionCalendarAclReqBuilder>):UnsubscriptionCalendarAclReqBuilder
	...
	export function emptyListCalendarAclReqBuilder():ListCalendarAclReqBuilder
	export function emptyRefListCalendarAclReqBuilder():Ref<ListCalendarAclReqBuilder>
	export function refOfListCalendarAclReqBuilder(x:ListCalendarAclReqBuilder,v:Ref<ListCalendarAclReqBuilder>)
	export function unRefListCalendarAclReqBuilder(v:Ref<ListCalendarAclReqBuilder>):ListCalendarAclReqBuilder
	...
	export function emptyListCalendarReqBuilder():ListCalendarReqBuilder
	export function emptyRefListCalendarReqBuilder():Ref<ListCalendarReqBuilder>
	export function refOfListCalendarReqBuilder(x:ListCalendarReqBuilder,v:Ref<ListCalendarReqBuilder>)
	export function unRefListCalendarReqBuilder(v:Ref<ListCalendarReqBuilder>):ListCalendarReqBuilder
	...
	export function emptyMeetingChatBuilder():MeetingChatBuilder
	export function emptyRefMeetingChatBuilder():Ref<MeetingChatBuilder>
	export function refOfMeetingChatBuilder(x:MeetingChatBuilder,v:Ref<MeetingChatBuilder>)
	export function unRefMeetingChatBuilder(v:Ref<MeetingChatBuilder>):MeetingChatBuilder
	export function emptyPatchCalendarEventReqBuilder():PatchCalendarEventReqBuilder
	export function emptyRefPatchCalendarEventReqBuilder():Ref<PatchCalendarEventReqBuilder>
	export function refOfPatchCalendarEventReqBuilder(x:PatchCalendarEventReqBuilder,v:Ref<PatchCalendarEventReqBuilder>)
	export function unRefPatchCalendarEventReqBuilder(v:Ref<PatchCalendarEventReqBuilder>):PatchCalendarEventReqBuilder
	export function emptyUnsubscriptionCalendarEventReqBuilder():UnsubscriptionCalendarEventReqBuilder
	export function emptyRefUnsubscriptionCalendarEventReqBuilder():Ref<UnsubscriptionCalendarEventReqBuilder>
	export function refOfUnsubscriptionCalendarEventReqBuilder(x:UnsubscriptionCalendarEventReqBuilder,v:Ref<UnsubscriptionCalendarEventReqBuilder>)
	export function unRefUnsubscriptionCalendarEventReqBuilder(v:Ref<UnsubscriptionCalendarEventReqBuilder>):UnsubscriptionCalendarEventReqBuilder
	...
	export function emptyMyAiEventInfoBuilder():MyAiEventInfoBuilder
	export function emptyRefMyAiEventInfoBuilder():Ref<MyAiEventInfoBuilder>
	export function refOfMyAiEventInfoBuilder(x:MyAiEventInfoBuilder,v:Ref<MyAiEventInfoBuilder>)
	export function unRefMyAiEventInfoBuilder(v:Ref<MyAiEventInfoBuilder>):MyAiEventInfoBuilder
	export function emptySearchCalendarReqBodyBuilder():SearchCalendarReqBodyBuilder
	export function emptyRefSearchCalendarReqBodyBuilder():Ref<SearchCalendarReqBodyBuilder>
	export function refOfSearchCalendarReqBodyBuilder(x:SearchCalendarReqBodyBuilder,v:Ref<SearchCalendarReqBodyBuilder>)
	export function unRefSearchCalendarReqBodyBuilder(v:Ref<SearchCalendarReqBodyBuilder>):SearchCalendarReqBodyBuilder
	export function emptyMeetingMinuteBuilder():MeetingMinuteBuilder
	export function emptyRefMeetingMinuteBuilder():Ref<MeetingMinuteBuilder>
	export function refOfMeetingMinuteBuilder(x:MeetingMinuteBuilder,v:Ref<MeetingMinuteBuilder>)
	export function unRefMeetingMinuteBuilder(v:Ref<MeetingMinuteBuilder>):MeetingMinuteBuilder
	...
	export function emptyWorkhourSettingBuilder():WorkhourSettingBuilder
	export function emptyRefWorkhourSettingBuilder():Ref<WorkhourSettingBuilder>
	export function refOfWorkhourSettingBuilder(x:WorkhourSettingBuilder,v:Ref<WorkhourSettingBuilder>)
	export function unRefWorkhourSettingBuilder(v:Ref<WorkhourSettingBuilder>):WorkhourSettingBuilder
	...
	export function emptyReplyCalendarEventReqBodyBuilder():ReplyCalendarEventReqBodyBuilder
	export function emptyRefReplyCalendarEventReqBodyBuilder():Ref<ReplyCalendarEventReqBodyBuilder>
	export function refOfReplyCalendarEventReqBodyBuilder(x:ReplyCalendarEventReqBodyBuilder,v:Ref<ReplyCalendarEventReqBodyBuilder>)
	export function unRefReplyCalendarEventReqBodyBuilder(v:Ref<ReplyCalendarEventReqBodyBuilder>):ReplyCalendarEventReqBodyBuilder
	...
	export function emptyCalendarBuilder():CalendarBuilder
	export function emptyRefCalendarBuilder():Ref<CalendarBuilder>
	export function refOfCalendarBuilder(x:CalendarBuilder,v:Ref<CalendarBuilder>)
	export function unRefCalendarBuilder(v:Ref<CalendarBuilder>):CalendarBuilder
	export function emptyCreateCalendarAclReqBuilder():CreateCalendarAclReqBuilder
	export function emptyRefCreateCalendarAclReqBuilder():Ref<CreateCalendarAclReqBuilder>
	export function refOfCreateCalendarAclReqBuilder(x:CreateCalendarAclReqBuilder,v:Ref<CreateCalendarAclReqBuilder>)
	export function unRefCreateCalendarAclReqBuilder(v:Ref<CreateCalendarAclReqBuilder>):CreateCalendarAclReqBuilder
	...
	export function emptyListCalendarEventAttendeeReqBuilder():ListCalendarEventAttendeeReqBuilder
	export function emptyRefListCalendarEventAttendeeReqBuilder():Ref<ListCalendarEventAttendeeReqBuilder>
	export function refOfListCalendarEventAttendeeReqBuilder(x:ListCalendarEventAttendeeReqBuilder,v:Ref<ListCalendarEventAttendeeReqBuilder>)
	export function unRefListCalendarEventAttendeeReqBuilder(v:Ref<ListCalendarEventAttendeeReqBuilder>):ListCalendarEventAttendeeReqBuilder
	export function emptyTimeoffEventBuilder():TimeoffEventBuilder
	export function emptyRefTimeoffEventBuilder():Ref<TimeoffEventBuilder>
	export function refOfTimeoffEventBuilder(x:TimeoffEventBuilder,v:Ref<TimeoffEventBuilder>)
	export function unRefTimeoffEventBuilder(v:Ref<TimeoffEventBuilder>):TimeoffEventBuilder
	export function emptyDeleteCalendarReqBuilder():DeleteCalendarReqBuilder
	export function emptyRefDeleteCalendarReqBuilder():Ref<DeleteCalendarReqBuilder>
	export function refOfDeleteCalendarReqBuilder(x:DeleteCalendarReqBuilder,v:Ref<DeleteCalendarReqBuilder>)
	export function unRefDeleteCalendarReqBuilder(v:Ref<DeleteCalendarReqBuilder>):DeleteCalendarReqBuilder
	...
	export function emptyInstanceViewCalendarEventReqBuilder():InstanceViewCalendarEventReqBuilder
	export function emptyRefInstanceViewCalendarEventReqBuilder():Ref<InstanceViewCalendarEventReqBuilder>
	export function refOfInstanceViewCalendarEventReqBuilder(x:InstanceViewCalendarEventReqBuilder,v:Ref<InstanceViewCalendarEventReqBuilder>)
	export function unRefInstanceViewCalendarEventReqBuilder(v:Ref<InstanceViewCalendarEventReqBuilder>):InstanceViewCalendarEventReqBuilder
	...
	export function emptyCalendarEventAttendeeIdBuilder():CalendarEventAttendeeIdBuilder
	export function emptyRefCalendarEventAttendeeIdBuilder():Ref<CalendarEventAttendeeIdBuilder>
	export function refOfCalendarEventAttendeeIdBuilder(x:CalendarEventAttendeeIdBuilder,v:Ref<CalendarEventAttendeeIdBuilder>)
	export function unRefCalendarEventAttendeeIdBuilder(v:Ref<CalendarEventAttendeeIdBuilder>):CalendarEventAttendeeIdBuilder
	...
	export function emptyPatchCalendarReqBuilder():PatchCalendarReqBuilder
	export function emptyRefPatchCalendarReqBuilder():Ref<PatchCalendarReqBuilder>
	export function refOfPatchCalendarReqBuilder(x:PatchCalendarReqBuilder,v:Ref<PatchCalendarReqBuilder>)
	export function unRefPatchCalendarReqBuilder(v:Ref<PatchCalendarReqBuilder>):PatchCalendarReqBuilder
	...
	export function emptyEventOrganizerBuilder():EventOrganizerBuilder
	export function emptyRefEventOrganizerBuilder():Ref<EventOrganizerBuilder>
	export function refOfEventOrganizerBuilder(x:EventOrganizerBuilder,v:Ref<EventOrganizerBuilder>)
	export function unRefEventOrganizerBuilder(v:Ref<EventOrganizerBuilder>):EventOrganizerBuilder
	...
	export function emptySearchEventDataBuilder():SearchEventDataBuilder
	export function emptyRefSearchEventDataBuilder():Ref<SearchEventDataBuilder>
	export function refOfSearchEventDataBuilder(x:SearchEventDataBuilder,v:Ref<SearchEventDataBuilder>)
	export function unRefSearchEventDataBuilder(v:Ref<SearchEventDataBuilder>):SearchEventDataBuilder
	...
	export function emptyCalendarFreebusyErrorBuilder():CalendarFreebusyErrorBuilder
	export function emptyRefCalendarFreebusyErrorBuilder():Ref<CalendarFreebusyErrorBuilder>
	export function refOfCalendarFreebusyErrorBuilder(x:CalendarFreebusyErrorBuilder,v:Ref<CalendarFreebusyErrorBuilder>)
	export function unRefCalendarFreebusyErrorBuilder(v:Ref<CalendarFreebusyErrorBuilder>):CalendarFreebusyErrorBuilder
	...
	export function emptyCalendarUnderstandScenarioContextBuilder():CalendarUnderstandScenarioContextBuilder
	export function emptyRefCalendarUnderstandScenarioContextBuilder():Ref<CalendarUnderstandScenarioContextBuilder>
	export function refOfCalendarUnderstandScenarioContextBuilder(x:CalendarUnderstandScenarioContextBuilder,v:Ref<CalendarUnderstandScenarioContextBuilder>)
	export function unRefCalendarUnderstandScenarioContextBuilder(v:Ref<CalendarUnderstandScenarioContextBuilder>):CalendarUnderstandScenarioContextBuilder
	...
	export function emptyFreebusyBuilder():FreebusyBuilder
	export function emptyRefFreebusyBuilder():Ref<FreebusyBuilder>
	export function refOfFreebusyBuilder(x:FreebusyBuilder,v:Ref<FreebusyBuilder>)
	export function unRefFreebusyBuilder(v:Ref<FreebusyBuilder>):FreebusyBuilder
	...
	export function emptyUserMetaBuilder():UserMetaBuilder
	export function emptyRefUserMetaBuilder():Ref<UserMetaBuilder>
	export function refOfUserMetaBuilder(x:UserMetaBuilder,v:Ref<UserMetaBuilder>)
	export function unRefUserMetaBuilder(v:Ref<UserMetaBuilder>):UserMetaBuilder
	...
	export function emptyCardPresentBuilder():CardPresentBuilder
	export function emptyRefCardPresentBuilder():Ref<CardPresentBuilder>
	export function refOfCardPresentBuilder(x:CardPresentBuilder,v:Ref<CardPresentBuilder>)
	export function unRefCardPresentBuilder(v:Ref<CardPresentBuilder>):CardPresentBuilder
	...
	export function emptyCustomizationOptionBuilder():CustomizationOptionBuilder
	export function emptyRefCustomizationOptionBuilder():Ref<CustomizationOptionBuilder>
	export function refOfCustomizationOptionBuilder(x:CustomizationOptionBuilder,v:Ref<CustomizationOptionBuilder>)
	export function unRefCustomizationOptionBuilder(v:Ref<CustomizationOptionBuilder>):CustomizationOptionBuilder
	...
	export function emptyBookMeetingRoomDataBuilder():BookMeetingRoomDataBuilder
	export function emptyRefBookMeetingRoomDataBuilder():Ref<BookMeetingRoomDataBuilder>
	export function refOfBookMeetingRoomDataBuilder(x:BookMeetingRoomDataBuilder,v:Ref<BookMeetingRoomDataBuilder>)
	export function unRefBookMeetingRoomDataBuilder(v:Ref<BookMeetingRoomDataBuilder>):BookMeetingRoomDataBuilder
	...
	export function emptyGenerateCaldavConfSettingReqBodyBuilder():GenerateCaldavConfSettingReqBodyBuilder
	export function emptyRefGenerateCaldavConfSettingReqBodyBuilder():Ref<GenerateCaldavConfSettingReqBodyBuilder>
	export function refOfGenerateCaldavConfSettingReqBodyBuilder(x:GenerateCaldavConfSettingReqBodyBuilder,v:Ref<GenerateCaldavConfSettingReqBodyBuilder>)
	export function unRefGenerateCaldavConfSettingReqBodyBuilder(v:Ref<GenerateCaldavConfSettingReqBodyBuilder>):GenerateCaldavConfSettingReqBodyBuilder
	...
	export function emptySubscriptionCalendarEventReqBuilder():SubscriptionCalendarEventReqBuilder
	export function emptyRefSubscriptionCalendarEventReqBuilder():Ref<SubscriptionCalendarEventReqBuilder>
	export function refOfSubscriptionCalendarEventReqBuilder(x:SubscriptionCalendarEventReqBuilder,v:Ref<SubscriptionCalendarEventReqBuilder>)
	export function unRefSubscriptionCalendarEventReqBuilder(v:Ref<SubscriptionCalendarEventReqBuilder>):SubscriptionCalendarEventReqBuilder
	...
	export function emptyListFreebusyReqBuilder():ListFreebusyReqBuilder
	export function emptyRefListFreebusyReqBuilder():Ref<ListFreebusyReqBuilder>
	export function refOfListFreebusyReqBuilder(x:ListFreebusyReqBuilder,v:Ref<ListFreebusyReqBuilder>)
	export function unRefListFreebusyReqBuilder(v:Ref<ListFreebusyReqBuilder>):ListFreebusyReqBuilder
	export function emptyCalendarAclEventBuilder():CalendarAclEventBuilder
	export function emptyRefCalendarAclEventBuilder():Ref<CalendarAclEventBuilder>
	export function refOfCalendarAclEventBuilder(x:CalendarAclEventBuilder,v:Ref<CalendarAclEventBuilder>)
	export function unRefCalendarAclEventBuilder(v:Ref<CalendarAclEventBuilder>):CalendarAclEventBuilder
	...
	export function emptyCalendarEventRespBuilder():CalendarEventRespBuilder
	export function emptyRefCalendarEventRespBuilder():Ref<CalendarEventRespBuilder>
	export function refOfCalendarEventRespBuilder(x:CalendarEventRespBuilder,v:Ref<CalendarEventRespBuilder>)
	export function unRefCalendarEventRespBuilder(v:Ref<CalendarEventRespBuilder>):CalendarEventRespBuilder
	...
	export function emptyRoomMetaBuilder():RoomMetaBuilder
	export function emptyRefRoomMetaBuilder():Ref<RoomMetaBuilder>
	export function refOfRoomMetaBuilder(x:RoomMetaBuilder,v:Ref<RoomMetaBuilder>)
	export function unRefRoomMetaBuilder(v:Ref<RoomMetaBuilder>):RoomMetaBuilder
	export function emptyUnsubscribeCalendarReqBuilder():UnsubscribeCalendarReqBuilder
	export function emptyRefUnsubscribeCalendarReqBuilder():Ref<UnsubscribeCalendarReqBuilder>
	export function refOfUnsubscribeCalendarReqBuilder(x:UnsubscribeCalendarReqBuilder,v:Ref<UnsubscribeCalendarReqBuilder>)
	export function unRefUnsubscribeCalendarReqBuilder(v:Ref<UnsubscribeCalendarReqBuilder>):UnsubscribeCalendarReqBuilder
	export function emptyAclScopeBuilder():AclScopeBuilder
	export function emptyRefAclScopeBuilder():Ref<AclScopeBuilder>
	export function refOfAclScopeBuilder(x:AclScopeBuilder,v:Ref<AclScopeBuilder>)
	export function unRefAclScopeBuilder(v:Ref<AclScopeBuilder>):AclScopeBuilder
	export function emptyCalendarEventAttendeeBuilder():CalendarEventAttendeeBuilder
	export function emptyRefCalendarEventAttendeeBuilder():Ref<CalendarEventAttendeeBuilder>
	export function refOfCalendarEventAttendeeBuilder(x:CalendarEventAttendeeBuilder,v:Ref<CalendarEventAttendeeBuilder>)
	export function unRefCalendarEventAttendeeBuilder(v:Ref<CalendarEventAttendeeBuilder>):CalendarEventAttendeeBuilder
	...
	export function emptyAttendeeChatMemberBuilder():AttendeeChatMemberBuilder
	export function emptyRefAttendeeChatMemberBuilder():Ref<AttendeeChatMemberBuilder>
	export function refOfAttendeeChatMemberBuilder(x:AttendeeChatMemberBuilder,v:Ref<AttendeeChatMemberBuilder>)
	export function unRefAttendeeChatMemberBuilder(v:Ref<AttendeeChatMemberBuilder>):AttendeeChatMemberBuilder
	export function emptyCalendarEventAttendeeRespBuilder():CalendarEventAttendeeRespBuilder
	export function emptyRefCalendarEventAttendeeRespBuilder():Ref<CalendarEventAttendeeRespBuilder>
	export function refOfCalendarEventAttendeeRespBuilder(x:CalendarEventAttendeeRespBuilder,v:Ref<CalendarEventAttendeeRespBuilder>)
	export function unRefCalendarEventAttendeeRespBuilder(v:Ref<CalendarEventAttendeeRespBuilder>):CalendarEventAttendeeRespBuilder
	export function emptyCreateCalendarReqBuilder():CreateCalendarReqBuilder
	export function emptyRefCreateCalendarReqBuilder():Ref<CreateCalendarReqBuilder>
	export function refOfCreateCalendarReqBuilder(x:CreateCalendarReqBuilder,v:Ref<CreateCalendarReqBuilder>)
	export function unRefCreateCalendarReqBuilder(v:Ref<CreateCalendarReqBuilder>):CreateCalendarReqBuilder
	...
	export function emptyListCalendarEventReqBuilder():ListCalendarEventReqBuilder
	export function emptyRefListCalendarEventReqBuilder():Ref<ListCalendarEventReqBuilder>
	export function refOfListCalendarEventReqBuilder(x:ListCalendarEventReqBuilder,v:Ref<ListCalendarEventReqBuilder>)
	export function unRefListCalendarEventReqBuilder(v:Ref<ListCalendarEventReqBuilder>):ListCalendarEventReqBuilder
	...
	export function emptyCalendarEventAttendeeChatMemberBuilder():CalendarEventAttendeeChatMemberBuilder
	export function emptyRefCalendarEventAttendeeChatMemberBuilder():Ref<CalendarEventAttendeeChatMemberBuilder>
	export function refOfCalendarEventAttendeeChatMemberBuilder(x:CalendarEventAttendeeChatMemberBuilder,v:Ref<CalendarEventAttendeeChatMemberBuilder>)
	export function unRefCalendarEventAttendeeChatMemberBuilder(v:Ref<CalendarEventAttendeeChatMemberBuilder>):CalendarEventAttendeeChatMemberBuilder
	...
	export function emptyGetExchangeBindingReqBuilder():GetExchangeBindingReqBuilder
	export function emptyRefGetExchangeBindingReqBuilder():Ref<GetExchangeBindingReqBuilder>
	export function refOfGetExchangeBindingReqBuilder(x:GetExchangeBindingReqBuilder,v:Ref<GetExchangeBindingReqBuilder>)
	export function unRefGetExchangeBindingReqBuilder(v:Ref<GetExchangeBindingReqBuilder>):GetExchangeBindingReqBuilder
	...
	export function emptyMyaiDocDetailBuilder():MyaiDocDetailBuilder
	export function emptyRefMyaiDocDetailBuilder():Ref<MyaiDocDetailBuilder>
	export function refOfMyaiDocDetailBuilder(x:MyaiDocDetailBuilder,v:Ref<MyaiDocDetailBuilder>)
	export function unRefMyaiDocDetailBuilder(v:Ref<MyaiDocDetailBuilder>):MyaiDocDetailBuilder
	...
	export function emptySubscriptionCalendarAclReqBuilder():SubscriptionCalendarAclReqBuilder
	export function emptyRefSubscriptionCalendarAclReqBuilder():Ref<SubscriptionCalendarAclReqBuilder>
	export function refOfSubscriptionCalendarAclReqBuilder(x:SubscriptionCalendarAclReqBuilder,v:Ref<SubscriptionCalendarAclReqBuilder>)
	export function unRefSubscriptionCalendarAclReqBuilder(v:Ref<SubscriptionCalendarAclReqBuilder>):SubscriptionCalendarAclReqBuilder
	...
	export function emptyTimeInfoBuilder():TimeInfoBuilder
	export function emptyRefTimeInfoBuilder():Ref<TimeInfoBuilder>
	export function refOfTimeInfoBuilder(x:TimeInfoBuilder,v:Ref<TimeInfoBuilder>)
	export function unRefTimeInfoBuilder(v:Ref<TimeInfoBuilder>):TimeInfoBuilder
}