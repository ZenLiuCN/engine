declare interface Excel {
    open(path?: string, option?: Option): ExcelFile

    themeColor(baseColor: string, tint: number): string

    newDataValidation(allowBlank: boolean): DataValidation
...
declare interface HyperLinkOption {
    display?: string
    tooltip?: string
}
...
declare interface WorkBookPropsOption {
    date1904?: boolean
    filterPrivacy?: boolean
    codeName?: string
}

declare interface WorkBookProtectionOption {
...
declare interface SheetProtectionOption {
...
declare interface ConditionalFormatOption {
    /**
     *  Type          | Parameters
     *
     * ---------------+---------------
...
declare interface SparklineOption {
    location: string[]
    range: string[]
    max?: number//int
    custMax?: number//int
...
declare interface PageLayoutOption {
    /**
     *  Index | Paper Size
     *
     * -------+-----------------------------------------------
...
declare interface SheetPropsOption {
...
declare interface PageLayoutMarginsOption {
...
declare interface PivotTableOption {
...
declare interface PivotTableField {
    compact: boolean
    data: string
    name: string
    outline: boolean
...
declare interface DocProperties {
    category: string
...
declare interface AppProperties {
    application: string
    scaleCrop: boolean
...
declare interface AutoFilterOption {
    column: string
    expression: string
}
